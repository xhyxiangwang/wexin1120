...
public class ConfigStorage
{
  ...
  private String fetchTextFromUrl(String paramString, Context paramContext)
  {
    ...
    //   0: aload_0
    //   1: aload_2
    //   2: invokespecial 95	com/tencent/qqvideo/proxy/common/ConfigStorage:getHttpsSSLContext	(Landroid/content/Context;)Ljavax/net/ssl/SSLContext;
    //   5: astore 14
    //   7: aconst_null
    //   8: astore_2
    //   9: aconst_null
    ...
    //   35: aload_0
    //   36: aload_1
    //   37: invokespecial 99	com/tencent/qqvideo/proxy/common/ConfigStorage:getBkDomain	(Ljava/lang/String;)Ljava/lang/String;
    //   40: astore 13
    //   42: iconst_4
    //   43: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   46: new 101	java/lang/StringBuilder
    //   49: dup
    //   50: ldc 103
    //   52: invokespecial 106	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   55: aload 13
    //   57: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   60: invokevirtual 114	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   63: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   66: iconst_0
    //   67: istore 4
    //   69: iload 4
    //   71: getstatic 65	com/tencent/qqvideo/proxy/common/ConfigStorage:retryTimes	[I
    //   74: iload_3
    //   75: iaload
    //   76: if_icmplt +10 -> 86
    //   79: iload_3
    ...
    //   93: astore 11
    //   95: iconst_4
    //   96: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   99: new 101	java/lang/StringBuilder
    //   102: dup
    //   103: ldc 122
    //   105: invokespecial 106	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   108: iload 4
    //   110: iconst_1
    //   111: iadd
    //   112: invokevirtual 125	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   115: ldc 127
    ...
    //   128: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   131: aload_2
    //   132: astore 12
    //   134: aload_2
    //   135: astore 10
    //   137: aload_2
    //   138: astore 11
    //   140: invokestatic 133	java/lang/System:currentTimeMillis	()J
    //   143: lstore 5
    //   145: aload_2
    //   146: astore 12
    //   148: aload_2
    ...
    //   151: aload_2
    //   152: astore 11
    //   154: new 135	java/net/URL
    //   157: dup
    //   158: aload 13
    //   160: invokespecial 136	java/net/URL:<init>	(Ljava/lang/String;)V
    //   163: invokevirtual 140	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   166: checkcast 142	javax/net/ssl/HttpsURLConnection
    //   169: astore 9
    //   171: aload_2
    //   172: astore 12
    //   174: aload_2
    ...
    //   178: astore 11
    //   180: aload 9
    //   182: getstatic 67	com/tencent/qqvideo/proxy/common/ConfigStorage:connectTimeOut	[I
    //   185: iload 4
    //   187: iaload
    //   188: invokevirtual 146	javax/net/ssl/HttpsURLConnection:setConnectTimeout	(I)V
    //   191: aload_2
    //   192: astore 12
    //   194: aload_2
    //   195: astore 10
    ...
    //   198: astore 11
    //   200: aload 9
    //   202: getstatic 69	com/tencent/qqvideo/proxy/common/ConfigStorage:readTimeOut	[I
    //   205: iload 4
    //   207: iaload
    //   208: invokevirtual 149	javax/net/ssl/HttpsURLConnection:setReadTimeout	(I)V
    //   211: aload_2
    //   212: astore 12
    //   214: aload_2
    //   215: astore 10
    ...
    //   220: aload 9
    //   222: aload 14
    //   224: invokevirtual 155	javax/net/ssl/SSLContext:getSocketFactory	()Ljavax/net/ssl/SSLSocketFactory;
    //   227: invokevirtual 159	javax/net/ssl/HttpsURLConnection:setSSLSocketFactory	(Ljavax/net/ssl/SSLSocketFactory;)V
    //   230: aload_2
    //   231: astore 12
    //   233: aload_2
    //   234: astore 10
    ...
    //   237: astore 11
    //   239: aload 9
    //   241: invokevirtual 163	javax/net/ssl/HttpsURLConnection:getInputStream	()Ljava/io/InputStream;
    //   244: astore_2
    //   245: aload_2
    //   246: astore 12
    //   248: aload_2
    ...
    //   251: aload_2
    //   252: astore 11
    //   254: new 101	java/lang/StringBuilder
    //   257: dup
    ...
    //   269: aload_2
    //   270: astore 11
    //   272: new 166	java/io/BufferedReader
    //   275: dup
    //   276: new 168	java/io/InputStreamReader
    //   279: dup
    //   280: aload_2
    //   281: ldc -86
    //   283: invokespecial 173	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;Ljava/lang/String;)V
    //   286: invokespecial 176	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   289: astore 9
    //   291: aload 9
    //   293: astore 10
    //   295: aload_2
    //   296: astore 8
    //   298: aload 9
    //   300: invokevirtual 179	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   303: astore 11
    //   305: aload 11
    ...
    //   315: astore 8
    //   317: aload 15
    //   319: invokevirtual 114	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   322: astore 11
    //   324: aload 9
    //   326: astore 10
    //   328: aload_2
    //   329: astore 8
    //   331: iconst_4
    //   332: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   335: new 101	java/lang/StringBuilder
    //   338: dup
    //   339: ldc -75
    //   341: invokespecial 106	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   344: invokestatic 133	java/lang/System:currentTimeMillis	()J
    //   347: lload 5
    //   349: lsub
    //   350: invokevirtual 184	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   353: ldc -70
    //   355: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   358: aload 11
    //   360: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   363: invokevirtual 114	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   366: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   369: aload 9
    //   371: astore 10
    //   373: aload_2
    //   374: astore 8
    //   376: aload 11
    //   378: invokestatic 192	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   381: ifne +232 -> 613
    //   384: aload 9
    //   386: astore 10
    //   388: aload_2
    //   389: astore 8
    //   391: aload 11
    //   393: invokevirtual 197	java/lang/String:trim	()Ljava/lang/String;
    //   396: invokevirtual 200	java/lang/String:isEmpty	()Z
    //   399: istore 7
    //   401: iload 7
    //   403: ifne +210 -> 613
    //   406: aload_2
    //   407: ifnull +7 -> 414
    //   410: aload_2
    //   411: invokevirtual 205	java/io/InputStream:close	()V
    //   414: aload 9
    //   416: invokevirtual 206	java/io/BufferedReader:close	()V
    //   419: aload 11
    //   421: areturn
    //   422: aload 9
    //   424: astore 10
    ...
    //   429: aload 15
    //   431: aload 11
    //   433: invokevirtual 110	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   436: pop
    //   437: goto -146 -> 291
    //   440: astore 8
    //   442: aload 9
    ...
    //   447: astore 8
    //   449: bipush 6
    //   451: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   454: new 101	java/lang/StringBuilder
    //   457: dup
    //   458: ldc -48
    //   460: invokespecial 106	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   463: getstatic 212	java/lang/System:err	Ljava/io/PrintStream;
    //   466: invokevirtual 215	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   469: invokevirtual 114	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   472: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   475: aload_2
    //   476: ifnull +7 -> 483
    //   479: aload_2
    //   480: invokevirtual 205	java/io/InputStream:close	()V
    //   483: aload 9
    //   485: astore 8
    //   487: aload_2
    //   488: astore 10
    ...
    //   492: ifnull +15 -> 507
    //   495: aload 9
    //   497: invokevirtual 206	java/io/BufferedReader:close	()V
    //   500: aload_2
    //   501: astore 10
    //   503: aload 9
    //   505: astore 8
    ...
    //   526: astore 8
    //   528: bipush 6
    //   530: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   533: ldc -39
    //   535: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   538: aload_2
    //   539: ifnull +7 -> 546
    //   542: aload_2
    //   543: invokevirtual 205	java/io/InputStream:close	()V
    //   546: aload 9
    //   548: astore 8
    //   550: aload_2
    //   551: astore 10
    ...
    //   555: ifnull -48 -> 507
    //   558: aload 9
    //   560: invokevirtual 206	java/io/BufferedReader:close	()V
    //   563: aload 9
    //   565: astore 8
    //   567: aload_2
    //   568: astore 10
    ...
    //   595: ifnull +8 -> 603
    //   598: aload 12
    //   600: invokevirtual 205	java/io/InputStream:close	()V
    //   603: aload_2
    //   604: ifnull +7 -> 611
    //   607: aload_2
    //   608: invokevirtual 206	java/io/BufferedReader:close	()V
    //   611: aload_1
    //   612: athrow
    //   613: aload_2
    //   614: ifnull +7 -> 621
    //   617: aload_2
    //   618: invokevirtual 205	java/io/InputStream:close	()V
    //   621: aload 9
    //   623: invokevirtual 206	java/io/BufferedReader:close	()V
    //   626: aload 9
    //   628: astore 8
    //   630: aload_2
    //   631: astore 10
  ...
  private javax.net.ssl.SSLContext getHttpsSSLContext(Context paramContext)
  {
    // Byte code:
    //   0: ldc -4
    //   2: invokestatic 258	java/security/cert/CertificateFactory:getInstance	(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    //   5: astore_3
    //   6: aload_1
    //   7: invokevirtual 262	android/content/Context:getAssets	()Landroid/content/res/AssetManager;
    //   10: ldc 40
    //   12: invokevirtual 268	android/content/res/AssetManager:open	(Ljava/lang/String;)Ljava/io/InputStream;
    //   15: astore_2
    //   16: aload_2
    //   17: astore_1
    //   18: aload_3
    //   19: aload_2
    //   20: invokevirtual 272	java/security/cert/CertificateFactory:generateCertificate	(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    //   23: astore 4
    //   25: aload_2
    //   26: astore_1
    //   27: invokestatic 277	java/security/KeyStore:getDefaultType	()Ljava/lang/String;
    //   30: invokestatic 280	java/security/KeyStore:getInstance	(Ljava/lang/String;)Ljava/security/KeyStore;
    //   33: astore_3
    //   34: aload_2
    //   35: astore_1
    //   36: aload_3
    //   37: aconst_null
    //   38: aconst_null
    //   39: invokevirtual 284	java/security/KeyStore:load	(Ljava/io/InputStream;[C)V
    //   42: aload_2
    //   43: astore_1
    //   44: aload_3
    //   45: ldc_w 286
    //   48: aload 4
    //   50: invokevirtual 290	java/security/KeyStore:setCertificateEntry	(Ljava/lang/String;Ljava/security/cert/Certificate;)V
    //   53: aload_2
    //   54: astore_1
    //   55: invokestatic 295	javax/net/ssl/TrustManagerFactory:getDefaultAlgorithm	()Ljava/lang/String;
    //   58: invokestatic 298	javax/net/ssl/TrustManagerFactory:getInstance	(Ljava/lang/String;)Ljavax/net/ssl/TrustManagerFactory;
    //   61: astore 4
    //   63: aload_2
    //   64: astore_1
    //   65: aload 4
    //   67: aload_3
    //   68: invokevirtual 302	javax/net/ssl/TrustManagerFactory:init	(Ljava/security/KeyStore;)V
    //   71: aload_2
    //   72: astore_1
    //   73: ldc_w 304
    //   76: invokestatic 307	javax/net/ssl/SSLContext:getInstance	(Ljava/lang/String;)Ljavax/net/ssl/SSLContext;
    //   79: astore_3
    //   80: aload_2
    //   81: astore_1
    //   82: aload_3
    //   83: aconst_null
    //   84: aload 4
    //   86: invokevirtual 311	javax/net/ssl/TrustManagerFactory:getTrustManagers	()[Ljavax/net/ssl/TrustManager;
    //   89: aconst_null
    //   90: invokevirtual 314	javax/net/ssl/SSLContext:init	([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    //   93: aload_2
    //   94: ifnull +7 -> 101
    //   97: aload_2
    //   98: invokevirtual 205	java/io/InputStream:close	()V
    //   101: aload_3
    //   102: areturn
    //   103: astore_3
    //   104: aconst_null
    ...
    //   107: astore_1
    //   108: bipush 6
    //   110: getstatic 63	com/tencent/qqvideo/proxy/common/ConfigStorage:TAG	Ljava/lang/String;
    //   113: new 101	java/lang/StringBuilder
    //   116: dup
    //   117: ldc_w 316
    //   120: invokespecial 106	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   123: aload_3
    //   124: invokestatic 322	android/util/Log:getStackTraceString	(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    //   133: invokestatic 120	com/tencent/qqvideo/proxy/httpproxy/HttpproxyFacade:print	(ILjava/lang/String;Ljava/lang/String;)V
    //   136: aload_2
    //   137: ifnull +7 -> 144
    //   140: aload_2
    //   141: invokevirtual 205	java/io/InputStream:close	()V
    //   144: aconst_null
    //   145: areturn
    //   146: astore_2
    //   147: aconst_null
    ...
    //   150: ifnull +7 -> 157
    //   153: aload_1
    //   154: invokevirtual 205	java/io/InputStream:close	()V
    //   157: aload_2
    //   158: athrow
    //   159: astore_1
    //   160: aload_3
  ...
  public void synGetConfig(Context paramContext)
  {
    if (!needGetConfig())
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/qqvideo/proxy/common/ConfigStorage.class
