...
public final class au
{
  ...
  public static final String[] uOL;
  public static ContentObserver uOM;
  public static WeakReference<a> uON;
  
  static
  {
    GMTrace.i(13950456430592L, 103939);
    uOK = MediaStore.Images.Media.EXTERNAL_CONTENT_URI.toString();
    uOL = new String[] { "_display_name", "_data", "date_added" };
  ...
  public static void a(a parama)
  {
    ...
    w.i("MicroMsg.ScreenShotUtil", "summerscreenshot setScreenShotCallback callback[%s], stack[%s]", new Object[] { parama, bg.bOd() });
    if (parama == null)
    {
      if (uOM != null)
      {
        ab.getContext().getContentResolver().unregisterContentObserver(uOM);
        uOM = null;
      }
      if (uON != null)
      {
    ...
    uON = new WeakReference(parama);
    if (uOM == null)
    {
      uOM = new ContentObserver(new Handler(Looper.myLooper()))
      {
        private long uOO;
        ...
        public final void onChange(boolean paramAnonymousBoolean, Uri paramAnonymousUri)
        {
          ...
          //   41: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   44: ifnull +12 -> 56
          //   47: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          ...
          //   64: dup
          //   65: iconst_0
          //   66: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   69: aastore
          ...
          //   83: aconst_null
          //   84: putstatic 105	com/tencent/mm/sdk/platformtools/au:uOM	Landroid/database/ContentObserver;
          //   87: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   90: ifnull +13 -> 103
          //   93: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   96: invokevirtual 109	java/lang/ref/WeakReference:clear	()V
          //   99: aconst_null
          //   100: putstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   103: aload_0
          //   104: iload_1
          //   105: aload_2
          ...
          //   122: getstatic 115	com/tencent/mm/sdk/platformtools/au:uOK	Ljava/lang/String;
          ...
          //   135: getstatic 115	com/tencent/mm/sdk/platformtools/au:uOK	Ljava/lang/String;
          ...
          //   150: aload_2
          //   151: getstatic 129	com/tencent/mm/sdk/platformtools/au:uOL	[Ljava/lang/String;
          //   154: aconst_null
          //   155: aconst_null
          //   156: ldc -125
          ...
          //   280: lload 6
          //   282: aload_0
          //   283: getfield 184	com/tencent/mm/sdk/platformtools/au$1:uOO	J
          //   286: lsub
          //   287: lconst_1
          //   288: lcmp
          //   289: ifle +325 -> 614
          //   292: aload 10
          //   294: invokestatic 189	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
          //   297: ifne +317 -> 614
          //   300: aload 10
          ...
          //   335: aload_0
          //   336: lload 6
          //   338: putfield 184	com/tencent/mm/sdk/platformtools/au$1:uOO	J
          //   341: aload 10
          //   343: astore 9
          //   345: lload 4
          //   347: lstore 6
          ...
          //   371: lstore 6
          //   373: aload 10
          //   375: invokestatic 189	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
          //   378: ifne -275 -> 103
          //   381: ldc 37
          ...
          //   413: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   416: ifnull +114 -> 530
          //   419: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   422: invokevirtual 76	java/lang/ref/WeakReference:get	()Ljava/lang/Object;
          //   425: ifnull +105 -> 530
          //   428: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          ...
          //   540: aconst_null
          //   541: putstatic 105	com/tencent/mm/sdk/platformtools/au:uOM	Landroid/database/ContentObserver;
          //   544: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   547: ifnull +13 -> 560
          //   550: getstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   553: invokevirtual 109	java/lang/ref/WeakReference:clear	()V
          //   556: aconst_null
          //   557: putstatic 70	com/tencent/mm/sdk/platformtools/au:uON	Ljava/lang/ref/WeakReference;
          //   560: ldc 37
          //   562: ldc -34
      ...
      ab.getContext().getContentResolver().registerContentObserver(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, true, uOM);
    }
    GMTrace.o(13949651124224L, 103933);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/sdk/platformtools/au.class
