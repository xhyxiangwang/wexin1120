...
public final class a
{
  ...
  public static void clean()
  {
    ...
    w.d("MicroMsg.CertUtilWx", "clean allcrt stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static void clearCert(String paramString)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "clearCert stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static void clearToken(String paramString)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "clearToken stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static String genUserSig(String paramString1, String paramString2)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "genUserSig stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static int getLastError()
  {
    ...
    w.d("MicroMsg.CertUtilWx", "getLastError stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static String getToken(String paramString)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "getToken stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static int getTokenCount(String paramString, boolean paramBoolean)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "getTokenCount stack %s", new Object[] { bg.bOd().toString() });
  ...
  public static void init(Context paramContext)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "init  %s", new Object[] { bg.bOd().toString() });
  ...
  public static boolean isCertExist(String paramString)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "isCertExist stack %s", new Object[] { bg.bOd().toString() });
    g.paX.a(414L, 5L, 1L, true);
    boolean bool = CertUtil.getInstance().isCertExist(paramString);
    g.paX.a(414L, 6L, 1L, true);
  ...
  public static boolean setTokens(String paramString1, String paramString2)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "setTokens stack %s", new Object[] { bg.bOd().toString() });
  ...
  public final String getCertApplyCSR(String paramString)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "getCertApplyCSR lock %s", new Object[] { bg.bOd().toString() });
    try
    {
      if (this.xfQ)
      {
  ...
  public final boolean importCert(String paramString1, String paramString2)
  {
    ...
    w.d("MicroMsg.CertUtilWx", "importCert  cid %s cert %s stack %s", new Object[] { paramString1, paramString2, bg.bOd().toString() });
    try
    {
      this.xfQ = false;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/wallet_core/c/a.class
