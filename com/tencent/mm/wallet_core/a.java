...
{
  private static Map<String, Class<?>> xfM;
  private static SparseArray<b> xfN;
  ...
  public static void X(Activity paramActivity)
  {
    ...
    b localb = aa(paramActivity);
    if (localb == null) {}
    for (String str = "";; str = localb.azd())
    {
  ...
  public static Bundle Z(Activity paramActivity)
  {
    GMTrace.i(1527263526912L, 11379);
    paramActivity = aa(paramActivity);
    if (paramActivity != null)
    {
      paramActivity = paramActivity.lRQ;
  ...
  public static void a(Activity paramActivity, Class<?> paramClass, Bundle paramBundle, b.a parama)
  {
    ...
    w.i("MicroMsg.ProcessManager", "startProcess to1 context:%s proc name: %s bundle %s", new Object[] { paramActivity, paramClass.getSimpleName(), al(paramBundle) });
    ...
    try
    {
      ...
      xfN.put(paramClass.hashCode(), paramBundle);
  ...
  public static void a(Activity paramActivity, String paramString, Bundle paramBundle, b.a parama)
  {
    ...
    try
    {
      w.i("MicroMsg.ProcessManager", "startProcess to2 context:%s proc name: %s bundle %s", new Object[] { paramActivity, paramString, al(paramBundle) });
      Class localClass = (Class)xfM.get(paramString);
      if (localClass == null)
      {
  ...
  public static b aa(Activity paramActivity)
  {
    ...
    paramActivity = (b)xfN.get(paramActivity.getIntent().getIntExtra("process_id", 0));
    GMTrace.o(1527531962368L, 11381);
    return paramActivity;
  }
  ...
  public static void c(Activity paramActivity, Bundle paramBundle, int paramInt)
  {
    ...
    if (localb == null) {}
    for (String str1 = "";; str1 = localb.azd())
    {
  ...
  public static void h(String paramString, Class<?> paramClass)
  {
    ...
    xfM.put(paramString, paramClass);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/wallet_core/a.class
