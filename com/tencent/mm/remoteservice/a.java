  ...
  extends b.a
{
  ...
  public Object CLIENT_CALL(String paramString, Object... paramVarArgs)
  {
    ...
    try
    {
      this.uIk.onCallback(paramString, paramVarArgs, true);
  ...
  public Object REMOTE_CALL(final String paramString, final Object... paramVarArgs)
  {
    ...
    if (this.lFI.isConnected())
    {
      paramVarArgs = objectsToBundle(paramVarArgs);
      this.lFI.a(this, paramString, paramVarArgs);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/remoteservice/a.class
