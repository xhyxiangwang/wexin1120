...
public final class c
{
  ...
  private static String aMv()
  {
    ...
    {
      ap.AS();
      String str = String.format("%s/masssend_%s.ini", new Object[] { com.tencent.mm.x.c.zo(), v.bMQ() });
  ...
  private boolean aMw()
  {
    ...
    try
    {
      this.nGv = ((e)new e().aC(arrayOfByte)).nGw;
      if (this.nGv == null)
      {
    ...
    w.i("MicroMsg.MassSendService", "info list[%s]", new Object[] { this.nGv.toString() });
    long l = bg.Po();
    Object localObject = this.nGv.iterator();
    while (((Iterator)localObject).hasNext())
    {
      d locald = (d)((Iterator)localObject).next();
      if ((locald.fiQ <= l) && (l <= locald.end))
      {
        GMTrace.o(11217649270784L, 83578);
        return true;
      }
  ...
  public static void cH(long paramLong)
  {
    ...
    ap.AS();
    com.tencent.mm.x.c.xi().set(102409, Long.valueOf(paramLong));
  ...
  public final void Bg(String paramString)
  {
    ...
    Object localObject1 = bh.p(paramString, "Festivals");
    ...
    for (paramString = "";; paramString = String.valueOf(i))
    {
      ...
      localObject2 = new d();
      ((d)localObject2).fiQ = bg.Rw((String)((Map)localObject1).get(paramString + ".StartTime"));
      ((d)localObject2).end = (bg.Rw((String)((Map)localObject1).get(paramString + ".EndTime")) + 86400000);
      locale.nGw.add(localObject2);
      i += 1;
      break;
    }
    label206:
    locale.count = locale.nGw.size();
    this.nGv = locale.nGw;
    for (;;)
    {
      try
      {
        ...
        {
          ap.AS();
          com.tencent.mm.x.c.xi().set(102408, Boolean.valueOf(false));
  ...
  public final void aMu()
  {
    ...
    boolean bool1 = aMw();
    ap.AS();
    boolean bool2 = ((Boolean)com.tencent.mm.x.c.xi().get(102408, Boolean.valueOf(false))).booleanValue();
    int i;
    if ((m.zQ() & 0x10000) == 0)
    {
      i = 1;
      ...
      ap.AS();
      if (com.tencent.mm.x.c.yQ().SV("masssendapp") != null) {
        break label260;
      }
      ap.AS();
      if (com.tencent.mm.x.c.yQ().SV("masssendapp") == null)
      {
        ...
        ((ae)localObject1).setContent(ab.getContext().getResources().getString(R.l.dNd));
        ((ae)localObject1).w(bg.Pp() + 2000L);
        ((ae)localObject1).dC(0);
        ((ae)localObject1).dz(0);
        ap.AS();
        com.tencent.mm.x.c.yQ().d((ae)localObject1);
      }
    }
    label260:
    Object localObject2;
    for (;;)
    {
      com.tencent.mm.plugin.report.service.g.paX.z(10425, "");
      ap.AS();
      com.tencent.mm.x.c.xi().set(102409, Long.valueOf(bg.Pp()));
      ap.AS();
      com.tencent.mm.x.c.xi().set(102408, Boolean.valueOf(true));
      GMTrace.o(11217246617600L, 83575);
      return;
      i = 0;
      break;
      localObject2 = h.aMy().hhi.a("select * from massendinfo ORDER BY createtime DESC  limit 1", null, 2);
      ...
      localObject1 = ab.getContext().getResources().getString(R.l.dNd);
      label300:
      localObject2 = new ae();
      ((ae)localObject2).setUsername("masssendapp");
      ((ae)localObject2).setContent((String)localObject1);
      ((ae)localObject2).w(bg.Pp() + 2000L);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/masssend/a/c.class
