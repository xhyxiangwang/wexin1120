...
final class f
{
  private static final long[] kgM;
  private static final long kgP;
  public int kgN;
  public boolean kgO;
  public int month;
  public int year;
  ...
  private f(Calendar paramCalendar)
  {
    ...
    int k = (int)((paramCalendar.getTime().getTime() - kgP) / 86400000L);
    int m = 0;
    int i = 1900;
    while ((i < 2050) && (k > 0))
    {
  ...
  private static int lc(int paramInt)
  {
    ...
    {
      int k = i;
      if ((kgM[(paramInt - 1900)] & j) != 0L) {
        k = i + 1;
      }
      j >>= 1;
      i = k;
    }
    paramInt = ld(paramInt);
    GMTrace.o(7625714434048L, 56816);
    return i + paramInt;
  }
  
  private static int ld(int paramInt)
  {
    GMTrace.i(7625848651776L, 56817);
    if (le(paramInt) != 0)
    {
      if ((kgM[(paramInt - 1900)] & 0x10000) != 0L)
      {
  ...
  private static int le(int paramInt)
  {
    GMTrace.i(7625982869504L, 56818);
    paramInt = (int)(kgM[(paramInt - 1900)] & 0xF);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/bottle/ui/f.class
