  ...
  extends MMActivity
{
  ...
  private void ahg()
  {
    ...
    Bitmap localBitmap = b.a(x.SA(m.zF()), false, -1);
    if (localBitmap == null) {
      localBitmap = b.a(m.zF(), false, -1);
    }
    for (;;)
    {
      this.kgA = ((ImageView)findViewById(R.h.bPt));
      if (localBitmap != null) {
        this.kgA.setImageBitmap(localBitmap);
      }
  ...
  private void ahh()
  {
    ...
    if (!k.c(this, e.gKA, "microMsg." + System.currentTimeMillis() + ".jpg", 3)) {
  ...
  protected final void MH()
  {
    ...
    oC(R.l.dDG);
    ((LinearLayout)findViewById(R.h.bPu)).setOnClickListener(new View.OnClickListener()
    {
  ...
  public void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    case 3: 
      ...
      ap.AS();
      paramIntent = k.b((Context)localObject1, paramIntent, c.yV());
      if (paramIntent == null)
      {
        GMTrace.o(7654705463296L, 57032);
        return;
      ...
      com.tencent.mm.plugin.bottle.a.ifM.a(this, (Intent)localObject1, 4);
      GMTrace.o(7654705463296L, 57032);
      return;
    case 2: 
      if (paramIntent == null)
      ...
      localObject1 = getApplicationContext();
      ap.AS();
      Object localObject2 = k.b((Context)localObject1, paramIntent, c.yV());
      ...
      n.Dh();
      ((Intent)localObject1).putExtra("CropImage_OutputPath", d.r(x.SA(m.zF()), true) + ".crop");
      com.tencent.mm.plugin.bottle.a.ifM.a((Intent)localObject1, 4, this, paramIntent);
      GMTrace.o(7654705463296L, 57032);
      return;
    }
    if (paramIntent == null)
    ...
    new o(this.vov.voR, paramIntent).b(2, new Runnable()
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/bottle/ui/BottleWizardStep1.class
