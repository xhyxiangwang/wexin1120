  ...
  extends cu
{
  ...
  public d(bbg parambbg)
  {
    GMTrace.i(6501104091136L, 48437);
    this.fJg = -1;
    this.field_username = parambbg.jWW;
    this.field_nickname = parambbg.jYc;
    this.field_signature = parambbg.huM;
    this.field_distance = parambbg.uff;
    this.field_reserved4 = String.valueOf(parambbg.utA);
    this.field_sex = parambbg.huJ;
    this.field_imgstatus = parambbg.tvr;
    this.field_hasHDImg = parambbg.uty;
    this.field_reserved1 = parambbg.ufg;
    this.field_reserved3 = parambbg.ufh;
    this.field_insertBatch = 2;
    if (parambbg.ufm != null)
    {
      this.field_snsFlag = parambbg.ufm.huU;
      this.field_sns_bgurl = parambbg.ufm.huV;
    }
    this.pvx = parambbg.utz;
    this.field_province = parambbg.huK;
    this.field_city = parambbg.huL;
    this.field_regionCode = RegionCodeDecoder.ae(parambbg.huS, this.field_province, this.field_city);
  ...
  public final String getCity()
  {
    ...
    Object localObject;
    if (!bg.mZ(this.field_regionCode))
    {
      ...
      if (localObject.length > 0)
      {
        ...
        this.field_city = RegionCodeDecoder.bRs().af(localObject[0], localObject[1], localObject[2]);
      }
    }
    for (;;)
    {
      ...
      label76:
      if (localObject.length == 2) {
        this.field_city = RegionCodeDecoder.bRs().eS(localObject[0], localObject[1]);
      } else {
        this.field_city = "";
      }
    }
  ...
  public final String getProvince()
  {
    ...
    label85:
    for (this.field_province = RegionCodeDecoder.bRs().eS(localObject[0], localObject[1]);; this.field_province = RegionCodeDecoder.bRs().TB(localObject[0]))
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/shake/b/d.class
