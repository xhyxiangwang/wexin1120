...
public final class a
{
  ...
  private static a a(Map<String, String> paramMap, int paramInt, String paramString)
  {
    ...
    locala.title = bg.mY((String)paramMap.get(paramString + ".title"));
    locala.mFm = bg.mY((String)paramMap.get(paramString + ".summary"));
    ...
    for (;;)
    {
      ...
      return locala;
      locala.pAz = bg.mY((String)paramMap.get(paramString + ".h5url.link"));
      locala.pAB = bg.mY((String)paramMap.get(paramString + ".h5url.title"));
      locala.pAC = bg.mY((String)paramMap.get(paramString + ".h5url.username"));
      continue;
      locala.pAz = bg.mY((String)paramMap.get(paramString + ".bizprofile.username"));
      locala.pAB = bg.mY((String)paramMap.get(paramString + ".bizprofile.showchat"));
      continue;
      locala.pAz = bg.mY((String)paramMap.get(paramString + ".nativepay.wx_pay_url"));
      continue;
      locala.pAz = bg.mY((String)paramMap.get(paramString + ".product.product_id"));
    }
  }
  ...
  public static LinkedList<a> j(Map<String, String> paramMap, String paramString)
  {
    ...
    if (j < 1000)
    {
      ...
      for (localObject1 = Integer.valueOf(k);; localObject1 = "")
      {
        ...
        if (!bg.mZ((String)paramMap.get((String)localObject3 + ".type"))) {
          break label228;
        }
        if (i == 0) {
          break label204;
      ...
      label204:
      i = 1;
      locala1.hNi = ((LinkedList)localObject2);
    }
    label213:
    label228:
    label430:
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          ((a)localObject1).pAz = bg.mY((String)paramMap.get((String)localObject3 + ".comment.id"));
          ((a)localObject1).title = bg.mY((String)paramMap.get((String)localObject3 + ".comment.title"));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/shake/e/a.class
