...
{
  public com.tencent.mm.plugin.fts.a.k gLW;
  private com.tencent.mm.plugin.fts.a.h lOk;
  public a lOl;
    ...
    this.lOn = new j.a()
    {
      public final void a(String paramAnonymousString, com.tencent.mm.sdk.e.l paramAnonymousl)
      {
        ...
        for (;;)
        {
          GMTrace.o(16651588206592L, 124064);
          return;
          b.this.gLW.a(65576, new b.e(b.this, l));
          GMTrace.o(16651588206592L, 124064);
          return;
          b.this.gLW.a(65576, new b.b(b.this, l));
        }
      }
    };
  ...
  private int a(String[] paramArrayOfString, int[] paramArrayOfInt, long paramLong1, long paramLong2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        this.lOl.a(196608, paramArrayOfInt[0], paramLong1, paramString, paramLong2, str2);
        j = 1;
        i = j;
        if (str1 != null)
        {
          ...
          if (str1.length() > 0)
          {
            this.lOl.a(196608, paramArrayOfInt[1], paramLong1, paramString, paramLong2, str1);
            i = 2;
          }
        }
        if ((paramArrayOfString != null) && (paramArrayOfString.length() > 0))
        {
          this.lOl.a(196608, paramArrayOfInt[2], paramLong1, paramString, paramLong2, paramArrayOfString);
          i += 1;
        }
        for (;;)
        {
  ...
  public final int a(c paramc)
  {
    ...
    int k = paramc.type;
    long l2 = paramc.iEK;
    String str2 = paramc.fFB;
    sz localsz = paramc.fKs;
    paramc = paramc.lOu;
    int j = 0;
    su localsu = com.tencent.mm.pluginsdk.model.c.a(k, localsz, paramc);
    if (localsu == null)
    {
    ...
    Object localObject2 = localsu.tQq;
    Object localObject3 = localsu.fFB;
    Object localObject1;
    ...
    {
      localObject1 = localsu.fFB;
      paramc = null;
    }
    String str3 = localsu.ftu;
    ...
    if (localObject1 != null)
    {
      ...
      {
        localObject4 = this.lOk.yg((String)localObject1);
        i = j;
        if (localObject4 != null)
        {
          localObject2 = ((af)localObject4).field_nickname;
          localObject1 = ((x)localObject4).qX();
          localObject3 = ((x)localObject4).qW();
    ...
    for (;;)
    {
      ...
      for (i = a(arrayOfString, arrayOfInt, l1, l2, str2) + j;; i = j)
      {
        ...
        if (paramc.length() > 0)
        {
          this.lOl.a(196608, 7, l1, str2, l2, paramc.toString());
          j = i + 1;
        }
        switch (k)
        {
        default: 
          paramc = localsu.title;
          k = j;
          if (!bg.mZ(paramc))
          {
            this.lOl.a(196608, 1, l1, str2, l2, paramc);
            k = j + 1;
          }
          paramc = localsu.desc;
          i = k;
          if (!bg.mZ(paramc))
          {
            this.lOl.a(196608, 2, l1, str2, l2, paramc);
            i = k + 1;
          }
          GMTrace.o(16653064601600L, 124075);
          return i;
        case 6: 
          paramc = localsz.iDL;
          if (!bg.mZ(paramc)) {
            this.lOl.a(196608, 4, l1, str2, l2, paramc);
          }
          break;
        }
        for (i = j + 1;; i = j)
        {
          paramc = localsz.tPL.fJh;
          j = i;
          if (!bg.mZ(paramc))
          {
            this.lOl.a(196608, 5, l1, str2, l2, paramc);
            j = i + 1;
          }
          paramc = localsz.tPL.label;
          if (!bg.mZ(paramc))
          {
            this.lOl.a(196608, 6, l1, str2, l2, paramc);
            i = j + 1;
            break;
            paramc = localsu.title;
            k = j;
            ...
            this.lOl.a(196608, 3, l1, str2, l2, paramc);
            i = k + 1;
            break;
            paramc = localsu.title;
            i = j;
            ...
            localObject2 = localsz.tQC.iterator();
            while (((Iterator)localObject2).hasNext())
            {
              localObject3 = com.tencent.mm.pluginsdk.model.c.p((sp)((Iterator)localObject2).next());
            ...
            this.lOl.a(196608, 23, l1, str2, l2, paramc);
            i = j + 1;
            break;
          }
          i = j;
  ...
  protected final boolean onCreate()
  {
    ...
    this.lOl = ((a)((com.tencent.mm.plugin.fts.a.l)com.tencent.mm.kernel.h.j(com.tencent.mm.plugin.fts.a.l.class)).getFTSIndexStorage(256));
    ...
    extends com.tencent.mm.plugin.fts.a.a.a
  {
    ...
    public final boolean execute()
    {
      ...
      //   8: aload_0
      //   9: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   12: getfield 58	com/tencent/mm/plugin/favorite/a/b:lOm	Lcom/tencent/mm/sdk/e/e;
      //   15: ifnonnull +20 -> 35
      //   18: ldc 60
      //   20: ldc 62
      ...
      //   42: aload_0
      //   43: getfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      //   46: ifnonnull +141 -> 187
      //   49: aload_0
      //   50: new 74	java/util/HashSet
      //   53: dup
      //   54: invokespecial 75	java/util/HashSet:<init>	()V
      //   57: putfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      //   60: aload_0
      //   61: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   64: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      //   67: getstatic 85	com/tencent/mm/plugin/fts/a/c:mjz	[I
      //   70: iconst_0
      //   71: iconst_1
      //   72: iconst_0
      //   73: iconst_0
      ...
      //   109: astore 5
      //   111: aload_0
      //   112: getfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      //   115: lload_3
      ...
      //   176: aload_0
      //   177: aload_0
      //   178: getfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      //   181: invokevirtual 116	java/util/HashSet:size	()I
      //   184: putfield 37	com/tencent/mm/plugin/favorite/a/b$a:lOq	I
      ...
      //   200: athrow
      //   201: aload_0
      //   202: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   205: getfield 58	com/tencent/mm/plugin/favorite/a/b:lOm	Lcom/tencent/mm/sdk/e/e;
      //   208: ldc 126
      //   210: aconst_null
      ...
      //   234: ifeq +43 -> 277
      //   237: aload_0
      //   238: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   241: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      ...
      //   280: dup
      //   281: aload_0
      //   282: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      ...
      //   297: aload_0
      //   298: getfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      //   301: aload 6
      //   303: getfield 147	com/tencent/mm/plugin/favorite/a/b$c:hze	J
      ...
      //   321: aload_0
      //   322: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   325: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      //   328: invokevirtual 135	com/tencent/mm/plugin/favorite/a/a:commit	()V
      //   331: aload_0
      //   332: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   335: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      ...
      //   345: iload_2
      //   346: aload_0
      //   347: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   350: aload 6
      ...
      //   359: aload_0
      //   360: aload_0
      //   361: getfield 39	com/tencent/mm/plugin/favorite/a/b$a:lOr	I
      //   364: iconst_1
      //   365: iadd
      //   366: putfield 39	com/tencent/mm/plugin/favorite/a/b$a:lOr	I
      //   369: iload_2
      //   370: istore_1
      //   371: goto -150 -> 221
      //   374: astore 6
      ...
      //   414: aload_0
      //   415: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   418: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      //   421: invokevirtual 135	com/tencent/mm/plugin/favorite/a/a:commit	()V
      //   424: aload_0
      //   425: getfield 35	com/tencent/mm/plugin/favorite/a/b$a:lOp	Ljava/util/HashSet;
      ...
      //   446: ifeq +21 -> 467
      //   449: aload_0
      //   450: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   453: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      ...
      //   473: aload_0
      //   474: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   477: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      //   480: invokevirtual 135	com/tencent/mm/plugin/favorite/a/a:commit	()V
      //   483: aload_0
      //   484: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   487: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      ...
      //   508: lstore_3
      //   509: aload_0
      //   510: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   513: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
      //   516: getstatic 85	com/tencent/mm/plugin/fts/a/c:mjz	[I
      //   519: lload_3
      ...
      //   527: aload_0
      //   528: aload_0
      //   529: getfield 41	com/tencent/mm/plugin/favorite/a/b$a:lOs	I
      //   532: iconst_1
      //   533: iadd
      //   534: putfield 41	com/tencent/mm/plugin/favorite/a/b$a:lOs	I
      //   537: aload 5
      //   539: invokeinterface 186 1 0
      //   544: goto -111 -> 433
      //   547: aload_0
      //   548: getfield 21	com/tencent/mm/plugin/favorite/a/b$a:lOo	Lcom/tencent/mm/plugin/favorite/a/b;
      //   551: getfield 79	com/tencent/mm/plugin/favorite/a/b:lOl	Lcom/tencent/mm/plugin/favorite/a/a;
    ...
    extends com.tencent.mm.plugin.fts.a.a.a
  {
    ...
    public final boolean execute()
    {
      ...
      long l = this.lOt;
      b.this.lOl.b(com.tencent.mm.plugin.fts.a.c.mjz, l);
  ...
  private final class c
  {
    ...
    public final void b(Cursor paramCursor)
    {
      ...
      this.hze = paramCursor.getLong(0);
      this.type = paramCursor.getInt(1);
      this.iEK = paramCursor.getLong(2);
      this.fFB = paramCursor.getString(3);
      ...
      for (this.fKs = new sz();; this.fKs = ((sz)new sz().aC(arrayOfByte)))
      {
      ...
      this.lOu = ((th)new th().aC(paramCursor));
      GMTrace.o(16653333037056L, 124077);
    }
  }
    ...
    extends com.tencent.mm.plugin.fts.a.a.a
  {
    ...
    public final boolean execute()
    {
      ...
      b.this.gLW.a(131122, new b.a(b.this));
    ...
    extends com.tencent.mm.plugin.fts.a.a.a
  {
    ...
    public final boolean execute()
    {
      ...
      Cursor localCursor2 = b.this.lOm.a("SELECT localId, type, updateTime, fromUser, favProto, tagProto FROM FavItemInfo WHERE localId = ? AND flag <> -1;", new String[] { String.valueOf(this.lOt) }, 2);
    ...
    extends com.tencent.mm.plugin.fts.a.a.e
  {
    ...
    protected final List<i> a(String[] paramArrayOfString, com.tencent.mm.plugin.fts.a.a.f paramf)
    {
      ...
      paramArrayOfString = b.this.lOl.a(paramArrayOfString, com.tencent.mm.plugin.fts.a.c.mjz, null, null, false, false);
      while (paramArrayOfString.moveToNext())
      {
        j localj = new j().e(paramArrayOfString);
        i locali = (i)((HashMap)localObject).get(Long.valueOf(localj.mkG));
        if ((locali == null) || (d.b(com.tencent.mm.plugin.fts.a.c.mjQ, localj.hJy, locali.hJy) < 0)) {
          ((HashMap)localObject).put(Long.valueOf(localj.mkG), localj);
        }
      ...
      if (paramf.mkz != null) {
        Collections.sort(paramArrayOfString, paramf.mkz);
      }
    ...
    extends com.tencent.mm.plugin.fts.a.a.e
  {
    ...
    protected final List<i> a(String[] paramArrayOfString, com.tencent.mm.plugin.fts.a.a.f paramf)
    {
      ...
      Object localObject = b.this.lOl;
      int i = paramf.mkx;
      paramArrayOfString = d.s(paramArrayOfString);
      paramArrayOfString = String.format("SELECT %s.docid, type, subtype, entity_id, aux_index, timestamp FROM %s NOT INDEXED JOIN %s ON (%s.docid = %s.rowid) WHERE %s MATCH '%s' ORDER BY -timestamp, subtype limit " + (i + 1 + 1) + ";", new Object[] { ((a)localObject).aBf(), ((a)localObject).aBf(), ((a)localObject).aBg(), ((a)localObject).aBf(), ((a)localObject).aBg(), ((a)localObject).aBg(), paramArrayOfString });
      paramArrayOfString = ((com.tencent.mm.plugin.fts.a.a)localObject).mjp.rawQuery(paramArrayOfString, null);
      ...
      while (paramArrayOfString.moveToNext()) {
        if (localHashSet.add(String.valueOf(paramArrayOfString.getLong(3))))
        {
          ...
          if (((List)localObject).size() <= paramf.mkx) {
            if (Thread.interrupted())
            {
              paramArrayOfString.close();
              throw new InterruptedException();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/a/b.class
