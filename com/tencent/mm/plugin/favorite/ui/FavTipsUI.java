  ...
  extends MMBaseActivity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle.UF(getString(R.l.dWZ));
    paramBundle.UG(getString(R.l.dWX) + "\n\n" + getString(R.l.dWY));
    paramBundle.Bj(R.l.dWW).a(new DialogInterface.OnClickListener()
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/ui/FavTipsUI.class
