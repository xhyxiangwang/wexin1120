...
{
  public static CharSequence e(Context paramContext, long paramLong)
  {
    ...
    if ((l > 0L) && (l <= 86400000L))
    {
      paramContext = paramContext.getString(R.l.eag);
      GMTrace.o(6294543007744L, 46898);
      return paramContext;
    }
    ...
    if (i > 30)
    {
      paramContext = DateFormat.format(paramContext.getString(R.l.dXg), paramLong);
      GMTrace.o(6294543007744L, 46898);
      return paramContext;
    }
  ...
  public static CharSequence t(Context paramContext, int paramInt)
  {
    ...
    if (paramInt <= 0)
    {
      paramContext = paramContext.getString(R.l.dXO, new Object[] { Integer.valueOf(0), Integer.valueOf(0) });
      GMTrace.o(6294408790016L, 46897);
      return paramContext;
    }
    int i = paramInt / 60;
    paramContext = paramContext.getString(R.l.dXO, new Object[] { Integer.valueOf(i), Integer.valueOf(paramInt % 60) });
    GMTrace.o(6294408790016L, 46897);
    return paramContext;
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/b/u.class
