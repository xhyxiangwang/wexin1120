  ...
  extends i<j>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(j.gLR, "FavItemInfo") };
    lOE = "xml,edittime" + ",ext,favProto" + ",flag,fromUser" + ",id,itemStatus" + ",localId,localSeq" + ",realChatName,sourceCreateTime" + ",sourceId,sourceType" + ",toUser,type" + ",updateSeq,updateTime" + ",tagProto,sessionId" + ",datatotalsize,rowid";
    GMTrace.o(6269175857152L, 46709);
  }
  
  public k(e parame)
  {
    super(parame, j.gLR, "FavItemInfo", null);
  ...
  public static long e(j paramj)
  {
    ...
    while (i < j)
    {
      if (localObject[i] == paramj.field_type)
      {
        ...
        {
          localObject = paramj.field_favProto.tQC.iterator();
          for (long l1 = 0L;; l1 = ((sp)((Iterator)localObject).next()).tOS + l1)
          {
            l2 = l1;
  ...
  public final ArrayList<j> a(List<Long> paramList, List<j> paramList1, Set<Integer> paramSet, x.a parama)
  {
    ...
    ((StringBuffer)localObject).append("select ").append(lOE).append(" from FavItemInfo where ");
    ...
    localObject = this.gMB.a(paramList, null, 2);
    if (localObject == null)
    {
      GMTrace.o(6268370550784L, 46703);
      return null;
  ...
  public final List<j> a(long paramLong, int paramInt, Set<Integer> paramSet, x.a parama)
  {
    ...
    //   65: getstatic 76	com/tencent/mm/plugin/favorite/b/k:lOE	Ljava/lang/String;
    ...
    //   167: astore 4
    //   169: aload_0
    //   170: getfield 89	com/tencent/mm/plugin/favorite/b/k:gMB	Lcom/tencent/mm/sdk/e/e;
    //   173: aload 4
    //   175: aconst_null
    //   176: iconst_2
  ...
  public final boolean a(j paramj, String... paramVarArgs)
  {
    ...
    if (paramj.field_favProto.tQA != null)
    {
      ...
      w.w("MicroMsg.FavItemInfoStorage", "update::favid %d favlocalid %d type %d, sourceTypeError %d", new Object[] { Integer.valueOf(paramj.field_id), Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_type), Integer.valueOf(localta.fwj) });
      localta.zs(1);
    }
    for (;;)
    {
      ...
      return bool;
      label172:
      localta.zs(localta.fwj);
    }
  }
  
  public final List<j> awR()
  {
    ArrayList localArrayList = null;
    GMTrace.i(6268236333056L, 46702);
    Object localObject = "select " + lOE + " from FavItemInfo where itemStatus" + "=3 or itemStatus" + "=6 or itemStatus" + "=11 or itemStatus" + "=14 or itemStatus" + "=16 or itemStatus" + "=18";
  ...
  public final boolean c(j paramj)
  {
    ...
    if (paramj.field_localId > 0L)
    {
      ...
      if (paramj.field_favProto.tQA != null)
      {
        ...
        w.w("MicroMsg.FavItemInfoStorage", "insert::favid %d favlocalid %d type %d, sourceTypeError %d", new Object[] { Integer.valueOf(paramj.field_id), Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_type), Integer.valueOf(localta.fwj) });
        localta.zs(1);
      }
    }
    for (;;)
  ...
  public final j cc(long paramLong)
  {
    ...
    Cursor localCursor = this.gMB.a("FavItemInfo", null, "localId=?", new String[] { String.valueOf(paramLong) }, null, null, null, 2);
  ...
  public final j cd(long paramLong)
  {
  ...
  public final void r(int paramInt, long paramLong)
  {
    ...
    this.gMB.eL("FavItemInfo", str);
    RZ(String.valueOf(paramLong));
    GMTrace.o(6267967897600L, 46700);
  }
  
  public final j xe(String paramString)
  {
    GMTrace.i(6267162591232L, 46694);
    Cursor localCursor = this.gMB.a("FavItemInfo", null, "sourceId=?", new String[] { paramString }, null, null, null, 2);
    if (localCursor.moveToFirst())
    {
      paramString = new j();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/b/k.class
