...
{
  public static j a(LinkedList<sp> paramLinkedList, long paramLong)
  {
    GMTrace.i(6265149325312L, 46679);
    Object localObject1 = null;
    if (paramLong != -1L)
    {
      localObject2 = h.awD().cc(paramLong);
      localObject1 = localObject2;
      if (localObject2 == null) {
        localObject1 = x.cq(paramLong);
      }
      ((j)localObject1).field_favProto.tQC.clear();
    }
    ...
    if (localObject1 == null)
    {
      ...
      f((j)localObject2);
      ((j)localObject2).field_favProto.zr(1);
      ((j)localObject2).field_favProto.zq(127);
    }
    ((j)localObject2).field_edittime = bg.Po();
    ((j)localObject2).field_updateTime = bg.Pp();
    ((j)localObject2).field_favProto.ey(((j)localObject2).field_edittime);
    ((j)localObject2).field_favProto.tQA.ez(bg.Pp());
    ((j)localObject2).field_favProto.aw(paramLinkedList);
    GMTrace.o(6265149325312L, 46679);
    return (j)localObject2;
  }
  
  public static boolean a(String paramString, LinkedList<sp> paramLinkedList, long paramLong)
  {
    ...
    if (-1L == paramLong) {}
    for (paramString = a(paramLinkedList, paramLong);; paramString = h.awD().cc(paramLong))
    {
      a.w(paramString);
      GMTrace.o(16937069314048L, 126191);
      return true;
  ...
  /* Error */
  private static List<String> at(List<String> paramList)
  {
    // Byte code:
    //   0: ldc2_w 146
    //   3: ldc -108
    ...
    //   146: aload_0
    //   147: astore_1
    //   148: getstatic 208	com/tencent/mm/plugin/report/service/g:paX	Lcom/tencent/mm/plugin/report/service/g;
    //   151: sipush 12712
    //   154: aload 5
    //   156: invokevirtual 212	com/tencent/mm/plugin/report/service/g:z	(ILjava/lang/String;)V
    //   159: goto -42 -> 117
    //   162: astore_1
    //   163: aload_0
  ...
  public static boolean au(List<String> paramList)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      sp localsp = new sp();
      localsp.PB(str);
      localsp.PA(x.aY(localsp.toString(), 2));
      d.b(str, 150, 150, Bitmap.CompressFormat.JPEG, 90, x.h(localsp));
      localsp.PC(x.h(localsp));
      localsp.zk(2);
      localj.field_favProto.tQC.add(localsp);
    }
    a.w(localj);
    g.paX.i(10648, new Object[] { Integer.valueOf(2), Integer.valueOf(paramList.size()) });
    GMTrace.o(6265417760768L, 46681);
    return true;
  }
  ...
  public static void f(j paramj)
  {
    ...
    String str = com.tencent.mm.x.m.zF();
    ta localta = new ta();
    localta.Qf(str);
    localta.Qg(str);
    localta.zs(paramj.field_sourceType);
    localta.ez(bg.Pp());
    paramj.field_favProto.a(localta);
    paramj.field_fromUser = localta.fFB;
    paramj.field_toUser = localta.toUser;
    GMTrace.o(6265551978496L, 46682);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/b/m.class
