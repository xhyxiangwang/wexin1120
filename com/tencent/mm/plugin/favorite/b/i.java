  ...
  implements com.tencent.mm.platformtools.i
{
  ...
  public final String Pg()
  {
    ...
    String str = x.axa() + g.n(this.url.getBytes());
  ...
  public final Bitmap Pm()
  {
    ...
    Bitmap localBitmap = BitmapFactory.decodeResource(ab.getContext().getResources(), R.g.bbs);
  ...
  public final Bitmap a(Bitmap paramBitmap, i.a parama, String paramString)
  {
    ...
    //   8: aload_1
    //   9: astore_3
    //   10: getstatic 148	com/tencent/mm/platformtools/i$a:iaZ	Lcom/tencent/mm/platformtools/i$a;
    //   13: aload_2
    ...
    //   33: aastore
    //   34: invokestatic 158	com/tencent/mm/sdk/platformtools/w:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   37: aload_1
    //   38: astore_3
    //   39: new 160	java/io/File
    //   42: dup
    //   43: invokestatic 61	com/tencent/mm/plugin/favorite/b/x:axa	()Ljava/lang/String;
    //   46: invokespecial 163	java/io/File:<init>	(Ljava/lang/String;)V
    //   49: astore_2
    //   50: aload_1
    //   51: astore_3
    //   52: aload_2
    //   53: invokevirtual 166	java/io/File:exists	()Z
    //   56: ifne +10 -> 66
    //   59: aload_1
    //   60: astore_3
    //   61: aload_2
    //   62: invokevirtual 169	java/io/File:mkdirs	()Z
    //   65: pop
    //   66: aload_1
    //   67: astore_2
    //   68: aload_1
    ...
    //   99: iconst_1
    //   100: invokestatic 174	com/tencent/mm/sdk/platformtools/d:a	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   103: astore_2
    //   104: aload_2
    //   105: astore_3
    //   106: new 160	java/io/File
    //   109: dup
    //   110: aload_0
    //   111: invokevirtual 176	com/tencent/mm/plugin/favorite/b/i:Pg	()Ljava/lang/String;
    //   114: invokespecial 163	java/io/File:<init>	(Ljava/lang/String;)V
    //   117: astore_1
    //   118: aload_2
    //   119: astore_3
    //   120: aload_1
    //   121: invokevirtual 179	java/io/File:createNewFile	()Z
    //   124: pop
    //   125: new 181	java/io/FileOutputStream
    //   128: dup
    //   129: aload_1
    //   130: invokespecial 184	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   133: astore_1
    //   134: aload_1
    //   135: astore_3
    //   136: aload_2
    //   137: getstatic 190	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   140: bipush 100
    //   142: aload_1
    //   143: invokevirtual 196	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   146: pop
    //   147: aload_1
    //   148: astore_3
    //   149: aload_1
    //   150: invokevirtual 199	java/io/FileOutputStream:flush	()V
    //   153: aload_2
    //   154: astore_3
    //   155: aload_1
    //   156: invokevirtual 202	java/io/FileOutputStream:close	()V
    //   159: aload_2
    //   160: astore_3
    //   161: ldc2_w 140
    //   164: ldc -114
    ...
    //   187: invokestatic 208	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: aload_2
    //   191: astore_3
    //   192: aload_1
    //   193: ifnull -32 -> 161
    ...
    //   197: astore_3
    //   198: aload_1
    //   199: invokevirtual 202	java/io/FileOutputStream:close	()V
    //   202: aload_2
    //   203: astore_3
    //   204: goto -43 -> 161
    //   207: astore_1
    ...
    //   217: invokestatic 208	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   220: goto -59 -> 161
    //   223: astore_1
    //   224: aconst_null
    //   225: astore 4
    ...
    //   233: astore_3
    //   234: aload 4
    //   236: invokevirtual 202	java/io/FileOutputStream:close	()V
    //   239: aload_2
    //   240: astore_3
    //   241: aload_1
    //   242: athrow
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/b/i.class
