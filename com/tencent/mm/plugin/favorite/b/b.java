  ...
  extends i<a>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(a.gLR, "FavCdnInfo") };
    GMTrace.o(6274007695360L, 46745);
  }
  
  public b(e parame)
  {
    super(parame, a.gLR, "FavCdnInfo", null);
  ...
  public final boolean a(a parama)
  {
    ...
    if (super.b(parama))
    {
      a[] arrayOfa = new a[this.hxh.size()];
      this.hxh.toArray(arrayOfa);
  ...
  public final boolean a(a parama, String... paramVarArgs)
  {
    ...
    {
      paramVarArgs = new a[this.hxh.size()];
      this.hxh.toArray(paramVarArgs);
  ...
  public final List<a> bZ(long paramLong)
  {
  ...
  public final a wZ(String paramString)
  {
    ...
    Cursor localCursor = this.gMB.a(paramString, null, 2);
    if (localCursor == null)
    {
      GMTrace.o(6272799735808L, 46736);
      return null;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/b/b.class
