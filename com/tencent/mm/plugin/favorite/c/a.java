...
public final class a
{
  public static int a(cd paramcd)
  {
    ...
    j localj1 = new j();
    localj1.field_favProto = paramcd.fwt.fwv;
    localj1.field_sessionId = paramcd.fwt.fwy;
    ta localta = localj1.field_favProto.tQA;
    if (localta != null)
    {
      localj1.field_sourceId = localta.tQF;
    ...
    for (int i = 0;; i = 1)
    {
      ...
      paramcd = com.tencent.mm.plugin.favorite.h.awD().xe(localj1.field_sourceId);
      if (paramcd != null) {
        x.cp(paramcd.field_localId);
      }
      GMTrace.o(6477615988736L, 48262);
      return 0;
      j localj2 = com.tencent.mm.plugin.favorite.h.awD().xe(localj1.field_sourceId);
      ...
      for (;;)
      {
        ...
        localanp.ujy = 1;
        localanp.ujz = ((int)(System.currentTimeMillis() / 1000L));
        ((LinkedList)localObject).add(localanp);
      ...
      break;
      label267:
      localj1.field_fromUser = localta.fFB;
      localj1.field_toUser = localta.toUser;
      localj1.field_sourceType = localta.fwj;
      localj1.field_sourceId = localta.tQF;
      localj1.field_sourceCreateTime = localta.hUw;
    ...
    x.cp(localj1.field_localId);
    localj1.field_type = paramcd.fwt.type;
    if ((paramcd.fwt.desc != null) && (paramcd.fwt.desc.length() >= 10001))
    {
      w.w("MicroMsg.AddFavService", "length more than 10000, do cut desc");
      localj1.field_favProto.Qe(paramcd.fwt.desc.substring(0, 10001));
    }
    for (;;)
    {
      ...
      x(localj1);
      x.r(localj1);
      localj1.xb("MicroMsg.AddFavService");
      GMTrace.o(6477615988736L, 48262);
      return 0;
      localj1.field_favProto.Qe(paramcd.fwt.desc);
    }
  }
  ...
  private static void x(j paramj)
  {
    GMTrace.i(6477884424192L, 48264);
    x.cg(paramj.field_localId);
    ...
    if (!x.v(paramj)) {
      com.tencent.mm.plugin.favorite.h.awD().c(paramj);
    }
    for (;;)
    {
      ...
      GMTrace.o(6477884424192L, 48264);
      return;
      com.tencent.mm.plugin.favorite.h.awD().a(paramj, new String[0]);
    }
  }
    ...
    implements Runnable
  {
    ...
    public final void run()
    {
      ...
      //   8: aload_0
      //   9: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      //   12: getfield 47	com/tencent/mm/plugin/favorite/b/j:field_favProto	Lcom/tencent/mm/protocal/c/sz;
      //   15: getfield 53	com/tencent/mm/protocal/c/sz:tQC	Ljava/util/LinkedList;
      //   18: astore 13
      //   20: aload 13
      ...
      //   52: iconst_0
      //   53: aload_0
      //   54: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      ...
      //   67: aload_0
      //   68: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      //   71: getfield 67	com/tencent/mm/plugin/favorite/b/j:field_type	I
      //   74: bipush 18
      //   76: if_icmpne +63 -> 139
      //   79: aload_0
      //   80: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      ...
      //   109: checkcast 87	com/tencent/mm/protocal/c/sp
      //   112: astore 9
      //   114: aload 9
      //   116: getfield 91	com/tencent/mm/protocal/c/sp:tPj	Z
      //   119: ifeq +11 -> 130
      //   122: aload 9
      //   124: getfield 94	com/tencent/mm/protocal/c/sp:tPl	Z
      //   127: ifne +801 -> 928
      //   130: iconst_1
      //   131: istore_3
      //   132: iload_1
      ...
      //   160: checkcast 87	com/tencent/mm/protocal/c/sp
      //   163: astore 14
      //   165: aload 14
      //   167: getfield 98	com/tencent/mm/protocal/c/sp:lUP	Ljava/lang/String;
      //   170: invokestatic 104	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
      //   173: ifeq +24 -> 197
      //   176: aload 14
      //   178: aload 14
      //   180: invokevirtual 108	java/lang/Object:toString	()Ljava/lang/String;
      //   183: aload_0
      //   184: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      //   187: getfield 67	com/tencent/mm/plugin/favorite/b/j:field_type	I
      //   190: invokestatic 114	com/tencent/mm/plugin/favorite/b/x:aY	(Ljava/lang/String;I)Ljava/lang/String;
      //   193: invokevirtual 118	com/tencent/mm/protocal/c/sp:PA	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   196: pop
      //   197: aload 14
      //   199: getfield 91	com/tencent/mm/protocal/c/sp:tPj	Z
      //   202: ifeq +11 -> 213
      //   205: aload 14
      //   207: getfield 94	com/tencent/mm/protocal/c/sp:tPl	Z
      //   210: ifne +5 -> 215
      //   213: iconst_1
      //   214: istore_3
      ...
      //   218: lstore 5
      //   220: aload 14
      //   222: getfield 127	com/tencent/mm/protocal/c/sp:tOV	Ljava/lang/String;
      //   225: astore 15
      //   227: aload 15
      ...
      //   249: aload 14
      //   251: aload 9
      //   253: invokevirtual 144	com/tencent/mm/protocal/c/sp:Py	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   256: pop
      //   257: aload 14
      //   259: aload 10
      //   261: invokevirtual 147	com/tencent/mm/protocal/c/sp:Pz	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   264: pop
      //   265: aload 14
      ...
      //   279: invokevirtual 159	com/tencent/mm/protocal/c/sp:et	(J)Lcom/tencent/mm/protocal/c/sp;
      //   282: pop
      //   283: aload 14
      //   285: invokestatic 163	com/tencent/mm/plugin/favorite/b/x:g	(Lcom/tencent/mm/protocal/c/sp;)Ljava/lang/String;
      //   288: astore 9
      //   290: aload 15
      //   292: aload 9
      ...
      //   307: pop2
      //   308: aload 14
      //   310: getfield 175	com/tencent/mm/protocal/c/sp:tOX	Ljava/lang/String;
      //   313: astore 9
      //   315: aload 9
      //   317: astore 11
      //   319: aload 9
      //   321: invokestatic 104	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
      //   324: ifeq +175 -> 499
      //   327: aload 9
      //   329: astore 11
      //   331: aload 15
      ...
      //   341: astore 11
      //   343: aload_0
      //   344: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      ...
      //   356: astore 11
      //   358: aload_0
      //   359: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      //   362: getfield 47	com/tencent/mm/plugin/favorite/b/j:field_favProto	Lcom/tencent/mm/protocal/c/sz;
      //   365: getfield 179	com/tencent/mm/protocal/c/sz:tQA	Lcom/tencent/mm/protocal/c/ta;
      //   368: getfield 184	com/tencent/mm/protocal/c/ta:fwj	I
      //   371: bipush 13
      ...
      //   383: aload 14
      //   385: invokestatic 163	com/tencent/mm/plugin/favorite/b/x:g	(Lcom/tencent/mm/protocal/c/sp;)Ljava/lang/String;
      ...
      //   399: astore 12
      //   401: aload 15
      //   403: invokestatic 200	com/tencent/mm/pluginsdk/model/c:Nq	(Ljava/lang/String;)Landroid/graphics/Bitmap;
      //   406: astore 9
      //   408: aload 9
      //   410: ifnull +20 -> 430
      //   413: ldc 61
      ...
      //   430: aload 14
      //   432: aload 12
      //   434: invokevirtual 219	com/tencent/mm/protocal/c/sp:PC	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   437: pop
      //   438: ldc 61
      //   440: ldc -35
      ...
      //   482: i2l
      //   483: invokestatic 239	com/tencent/mm/sdk/platformtools/bg:eI	(J)I
      //   486: invokevirtual 243	com/tencent/mm/protocal/c/sp:zj	(I)Lcom/tencent/mm/protocal/c/sp;
      //   489: pop
      //   490: aload 10
      ...
      //   536: invokestatic 256	com/tencent/mm/sdk/platformtools/bg:mY	(Ljava/lang/String;)Ljava/lang/String;
      //   539: astore 15
      //   541: aload 12
      //   543: astore 9
      //   545: aload 12
      //   547: astore 10
      //   549: aload 11
      //   551: invokestatic 260	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
      //   554: lstore 7
      //   556: aload 12
      //   558: astore 9
      //   560: aload 12
      ...
      //   583: aload 14
      //   585: aload 15
      //   587: invokevirtual 266	com/tencent/mm/protocal/c/sp:PD	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   590: pop
      //   591: aload 12
      //   593: astore 9
      //   595: aload 12
      ...
      //   599: aload 14
      //   601: aload 16
      //   603: invokevirtual 269	com/tencent/mm/protocal/c/sp:PE	(Ljava/lang/String;)Lcom/tencent/mm/protocal/c/sp;
      //   606: pop
      //   607: aload 12
      //   609: astore 9
      //   611: aload 12
      ...
      //   615: aload 14
      //   617: lload 7
      //   619: invokevirtual 272	com/tencent/mm/protocal/c/sp:eu	(J)Lcom/tencent/mm/protocal/c/sp;
      //   622: pop
      //   623: aload 12
      //   625: ifnull +8 -> 633
      //   628: aload 12
      ...
      //   633: aload 14
      //   635: invokestatic 280	com/tencent/mm/plugin/favorite/b/x:h	(Lcom/tencent/mm/protocal/c/sp;)Ljava/lang/String;
      //   638: astore 9
      //   640: aload 11
      //   642: aload 9
      ...
      //   668: iconst_0
      //   669: aload_0
      //   670: getfield 29	com/tencent/mm/plugin/favorite/c/a$a:lPM	Lcom/tencent/mm/plugin/favorite/b/j;
      ...
      //   712: iconst_0
      //   713: aload 14
      //   715: getfield 299	com/tencent/mm/protocal/c/sp:aHe	I
      ...
      //   896: invokestatic 323	com/tencent/mm/sdk/platformtools/af:u	(Ljava/lang/Runnable;)V
      //   899: ldc2_w 39
      //   902: ldc 41
      ...
      //   163	551	14	localsp	com.tencent.mm.protocal.c.sp
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/c/a.class
