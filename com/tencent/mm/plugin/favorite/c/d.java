  ...
  implements com.tencent.mm.ac.e
{
  ...
  public static void a(a parama, boolean paramBoolean)
  {
    ...
    if (parama.retryCount < 0)
    {
      ...
      {
        w.d("MicroMsg.FavEditService", "try mod item fail time limit, favid %d, localId %d, edit type %d", new Object[] { Integer.valueOf(parama.lPZ), Long.valueOf(parama.lQa.field_localId), Integer.valueOf(parama.lQa.field_type) });
    ...
    if (parama.lPZ <= 0)
    {
      localj = com.tencent.mm.plugin.favorite.h.awD().cc(parama.lQa.field_localId);
      if ((localj == null) || (localj.field_id <= 0))
      {
        w.w("MicroMsg.FavEditService", "want to start mod item, but favid is invalid, local id %d", new Object[] { Long.valueOf(parama.lQa.field_localId) });
        GMTrace.o(16032441827328L, 119451);
        return;
      }
      parama.lPZ = localj.field_id;
      w.d("MicroMsg.FavEditService", "want mod item, find id %d by local id %d", new Object[] { Integer.valueOf(parama.lPZ), Long.valueOf(parama.lQa.field_localId) });
    }
    while (paramBoolean)
    {
      j localj;
      w.d("MicroMsg.FavEditService", "try mod item, enforce %B, favid %d, edit type %d", new Object[] { Boolean.valueOf(paramBoolean), Integer.valueOf(parama.lPZ), Integer.valueOf(parama.lQa.field_type) });
      parama = new ah(parama.lPZ, parama.lQa);
      ap.wT().a(parama, 0);
      GMTrace.o(16032441827328L, 119451);
      return;
    }
    w.w("MicroMsg.FavEditService", "want to mod item, favid %d, it is running, but not enforce, return", new Object[] { Integer.valueOf(parama.lPZ) });
    GMTrace.o(16032441827328L, 119451);
  }
  ...
  public final void a(int paramInt1, int paramInt2, final String paramString, com.tencent.mm.ac.k paramk)
  {
    ...
    if (paramString.type != 0)
    {
      ...
      {
        paramk = r(paramString.axu(), paramString.axv());
        w.d("MicroMsg.FavEditService", "clear job, key %s", new Object[] { paramk });
        this.lQx.remove(paramk);
        paramk = com.tencent.mm.plugin.favorite.h.awz();
        l = paramString.axu();
        paramInt1 = paramString.axv();
        paramk.gMB.delete("FavEditInfo", "localId=? and type=?", new String[] { String.valueOf(l), String.valueOf(paramInt1) });
        paramk = com.tencent.mm.plugin.favorite.h.awD().cc(paramString.axu());
        ...
        if (paramk != null)
        {
          ...
          i = paramk.field_tagProto.tQM.size();
          j = com.tencent.mm.plugin.favorite.h.aww().awT();
          if (paramString.lQa != null) {
            break label316;
          }
        }
        label316:
        for (paramInt1 = 1;; paramInt1 = paramString.lQa.field_scene)
        {
  ...
  public final void run()
  {
    ...
    ap.xC().C(new Runnable()
    {
      public final void run()
      {
        ...
        Object localObject = com.tencent.mm.plugin.favorite.h.awz().awH();
        if (localObject == null)
        {
        ...
        while (((Iterator)localObject).hasNext())
        {
          ...
          d.a locala = (d.a)d.this.lQx.get(str);
          if (locala == null)
          {
  ...
  {
    int lPZ;
    com.tencent.mm.plugin.favorite.b.g lQa;
    int retryCount;
    long time;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/c/d.class
