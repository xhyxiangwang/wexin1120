...
{
  private static Map<String, g.a> lQF;
  private static com.tencent.mm.a.f<String, Bitmap> lQG;
  private static y<String, Bitmap> lQH;
  public Context context;
  public e lQC;
  public HashMap<String, String[]> lQD;
  ...
  public static Bitmap a(final sp paramsp, final j paramj)
  {
    GMTrace.i(6475736940544L, 48248);
    if (!com.tencent.mm.compatible.util.f.tD())
    {
      paramsp = BitmapFactory.decodeResource(ab.getContext().getResources(), R.g.bbq);
      GMTrace.o(6475736940544L, 48248);
      return paramsp;
    }
    if (x.xl(paramsp.lUP) == null)
    {
      GMTrace.o(6475736940544L, 48248);
      return null;
    }
    Bitmap localBitmap = a(paramsp, true, false);
    if (localBitmap == null)
    {
      String str = x.h(paramsp);
  ...
  public static Bitmap a(final sp paramsp, final j paramj, boolean paramBoolean)
  {
    ...
    Bitmap localBitmap = a(paramsp, false, false);
    if (localBitmap == null)
    {
      final String str = x.g(paramsp);
      ap.xC().C(new Runnable()
      {
        public final void run()
        {
          GMTrace.i(6492245721088L, 48371);
          if ((this.lQJ) || (g.xt(str))) {
            x.a(paramj, paramsp, this.lQJ);
          }
  ...
  private static Bitmap a(sp paramsp, boolean paramBoolean1, boolean paramBoolean2)
  {
    GMTrace.i(6475200069632L, 48244);
    if (paramBoolean1) {}
    for (paramsp = x.h(paramsp); !com.tencent.mm.a.e.aZ(paramsp); paramsp = x.g(paramsp))
    {
      w.w("MicroMsg.FavoriteImageLogic", "getBitmap file not exist");
      GMTrace.o(6475200069632L, 48244);
      return null;
    }
    paramsp = c.aL(paramsp, paramBoolean2);
    GMTrace.o(6475200069632L, 48244);
    return paramsp;
  }
  
  public static void a(final ImageView paramImageView, int paramInt1, final sp paramsp, final j paramj, final boolean paramBoolean, final int paramInt2, final int paramInt3)
  {
    GMTrace.i(6476005376000L, 48250);
    if (!com.tencent.mm.compatible.util.f.tD()) {
      paramImageView.setImageBitmap(BitmapFactory.decodeResource(ab.getContext().getResources(), R.g.bbq));
    }
    if (paramsp.lUP == null) {
      paramImageView.setImageResource(paramInt1);
    }
    Bitmap localBitmap = a(paramsp, paramj);
    String str = x.g(paramsp);
    ...
    if (localBitmap == null)
    {
      ...
      ap.xC().C(new Runnable()
      {
        public final void run()
        {
          ...
          final Bitmap localBitmap = g.c(this.gEQ, paramInt2, paramInt3, false);
          if (localBitmap == null)
          {
            g.c(paramj, paramsp, paramBoolean);
            GMTrace.o(6495332728832L, 48394);
            return;
          }
          String str = (String)paramImageView.getTag();
          if ((str != null) && (str.equals(this.gEQ)))
          {
            ap.xC();
            af.u(new Runnable()
            {
              public final void run()
              {
                ...
                g.6.this.lpJ.setImageBitmap(localBitmap);
  ...
  public static void a(j paramj, sp paramsp)
  {
    GMTrace.i(6476273811456L, 48252);
    c(paramj, paramsp, true);
    GMTrace.o(6476273811456L, 48252);
  }
  
  public static Bitmap b(final sp paramsp, final j paramj, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localObject = (Bitmap)lQG.get(str);
      if (localObject == null) {
        break;
      }
    ...
    for (;;)
    {
      ...
      int m = BackwardSupportUtil.ExifHelper.QG(str);
      int k;
      if (m != 90)
      {
        k = j;
  ...
  public static Bitmap c(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    Object localObject1 = (Bitmap)lQH.get(paramString);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject2 = localObject1;
        n = BackwardSupportUtil.ExifHelper.QG(paramString);
        if (n == 90) {
          break label631;
        }
        i = m;
      ...
      for (;;)
      {
        try
        {
          ...
          if (localObject1 != null)
          {
            ...
            localObject2 = localObject1;
            lQH.put(paramString, localObject1);
            break label276;
            localObject2 = localObject1;
            localRect.right = k;
            localObject2 = localObject1;
  ...
  public static void c(final j paramj, final sp paramsp, boolean paramBoolean)
  {
  ...
  public static Bitmap j(sp paramsp)
  {
  ...
  public static boolean xt(String paramString)
  {
    ...
    g.a locala = (g.a)lQF.get(paramString);
    if (locala == null)
    {
      locala = new g.a();
      lQF.put(paramString, locala);
      GMTrace.o(16032173391872L, 119449);
      return true;
    }
    if (locala.tI() > 30000L)
    {
      ...
      locala.gKP = SystemClock.elapsedRealtime();
      GMTrace.o(16032173391872L, 119449);
      return true;
    }
    GMTrace.o(16032173391872L, 119449);
  ...
  public final void a(ImageView paramImageView, sp paramsp, j paramj, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (!com.tencent.mm.compatible.util.f.tD())
    {
      paramImageView.setImageResource(R.g.bbq);
      GMTrace.o(6474931634176L, 48242);
      return;
    }
    if (paramj == null)
    ...
    case 7: 
      if (paramsp != null)
      {
        a(paramImageView, paramsp, paramj, paramsp.fwl, paramInt1, paramInt2, paramInt3);
        GMTrace.o(6474931634176L, 48242);
        return;
      }
      break;
    ...
    case 5: 
      ...
      {
        if (localObject != null) {
          this.lQC.a(paramImageView, null, ((tj)localObject).thumbUrl, paramInt1, paramInt2, paramInt3);
        }
        GMTrace.o(6474931634176L, 48242);
        return;
      }
    ...
    for (;;)
    {
      a(paramImageView, paramsp, paramj, (String)localObject, paramInt1, paramInt2, paramInt3);
      GMTrace.o(6474931634176L, 48242);
      return;
      localObject = ((tj)localObject).thumbUrl;
      break;
      paramsp = paramj.field_favProto.tPP;
      if (paramsp != null)
      {
        this.lQC.a(paramImageView, null, paramsp.thumbUrl, paramInt1, paramInt2, paramInt3);
        GMTrace.o(6474931634176L, 48242);
        return;
        paramsp = paramj.field_favProto.tPR;
        if (paramsp != null)
        {
          this.lQC.a(paramImageView, null, paramsp.thumbUrl, paramInt1, paramInt2, paramInt3);
          GMTrace.o(6474931634176L, 48242);
  ...
  public final void a(final ImageView paramImageView, final sp paramsp, final j paramj, String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    GMTrace.i(6474797416448L, 48241);
    String str = x.xl(paramsp.lUP);
    String[] arrayOfString = null;
    if (paramsp.lUP != null)
    {
      arrayOfString = (String[])this.lQE.get(str);
      if (arrayOfString != null) {
        break label145;
      }
      arrayOfString = new String[1];
      arrayOfString[0] = x.h(paramsp);
      this.lQE.put(str, arrayOfString);
    }
    label145:
    for (;;)
    {
      this.lQC.a(paramImageView, arrayOfString, paramString, paramInt1, paramInt2, paramInt3);
  ...
  public final void b(ImageView paramImageView, sp paramsp, j paramj, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      GMTrace.o(6475065851904L, 48243);
      return;
      w.w("MicroMsg.FavoriteImageLogic", "webpage: get data proto item null, dataid[%s], infoid[%d, %d]", new Object[] { paramsp.lUP, Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_id) });
      break;
      localObject = ((tj)localObject).thumbUrl;
      break label257;
      if (paramsp.tPr == null)
      {
        w.w("MicroMsg.FavoriteImageLogic", "good: get data proto item null, dataid[%s], infoid[%d, %d]", new Object[] { paramsp.lUP, Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_id) });
        GMTrace.o(6475065851904L, 48243);
        return;
      }
      paramsp = paramsp.tPr.tPP;
      if (paramsp != null)
      {
        this.lQC.a(paramImageView, null, paramsp.thumbUrl, paramInt1, paramInt2, paramInt3);
        GMTrace.o(6475065851904L, 48243);
        ...
        if (paramsp.tPr == null)
        {
          w.w("MicroMsg.FavoriteImageLogic", "tv: get data proto item null, dataid[%s], infoid[%d, %d]", new Object[] { paramsp.lUP, Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_id) });
          GMTrace.o(6475065851904L, 48243);
          return;
        }
        paramsp = paramsp.tPr.tPR;
        if (paramsp != null)
        {
          this.lQC.a(paramImageView, null, paramsp.thumbUrl, paramInt1, paramInt2, paramInt3);
          GMTrace.o(6475065851904L, 48243);
          ...
          if (paramsp.tPr == null)
          {
            w.w("MicroMsg.FavoriteImageLogic", "product: get data proto item null, dataid[%s], infoid[%d, %d]", new Object[] { paramsp.lUP, Long.valueOf(paramj.field_localId), Integer.valueOf(paramj.field_id) });
            GMTrace.o(6475065851904L, 48243);
            return;
          }
          paramsp = paramsp.tPr.tPP;
  ...
  public final void destory()
  {
    ...
    e locale = this.lQC;
    synchronized (locale.hur)
    {
      w.d("MicroMsg.ImageEngine", "do clear mark");
      locale.tlM.clear();
      locale.tlN.clear();
      locale.tlM = new HashMap();
      locale.tlN = new HashMap();
      this.lQD.clear();
      this.lQE.clear();
      this.lQC.destory();
      this.context = null;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/favorite/c/g.class
