...
public final class h
{
  boolean kaf;
  public a mdU;
  public BroadcastReceiver mdV;
  
  public h()
  {
    GMTrace.i(7130853670912L, 53129);
    this.kaf = false;
    this.mdV = new BroadcastReceiver()
    {
      public final void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent)
      {
        ...
        h.this.kaf = false;
        paramAnonymousContext.unregisterReceiver(h.this.mdV);
        ...
        try
        {
          ...
          else
          {
            ...
            if (h.this.mdU != null) {
              h.this.mdU.aC(paramAnonymousIntent);
            }
            GMTrace.o(7130451017728L, 53126);
            return;
          }
  ...
  public final boolean a(a parama)
  {
    ...
    ab.getContext().registerReceiver(this.mdV, localIntentFilter);
    parama.startScan();
    GMTrace.o(7130987888640L, 53130);
    return true;
  }
  ...
  {
    public abstract void aC(List<ScanResult> paramList);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/model/h.class
