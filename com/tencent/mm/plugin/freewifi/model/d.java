...
{
  private static Map<Integer, String> mdE;
  ...
  public static void a(String paramString, int paramInt, Intent paramIntent)
  {
    ...
    w.i("MicroMsg.FreeWifi.FreeWifiManager", "sessionKey=%s, step=%d, method=FreeWifiManager.updateConnectState, desc=it changes the connect state of the model to %s. state=%d", new Object[] { m.B(paramIntent), Integer.valueOf(m.C(paramIntent)), nI(paramInt), Integer.valueOf(paramInt) });
    paramIntent = j.aAe().yb(paramString);
    if (paramIntent != null)
    {
      paramIntent.field_connectState = paramInt;
      w.i("MicroMsg.FreeWifi.FreeWifiManager", "update %s, connect state : %d, return : %b", new Object[] { paramString, Integer.valueOf(paramInt), Boolean.valueOf(j.aAe().c(paramIntent, new String[0])) });
    }
  ...
  public static String azY()
  {
    ...
    try
    {
      ...
      localObject = m.xK((String)localObject);
      GMTrace.o(7134209114112L, 53154);
      return (String)localObject;
    }
    catch (Exception localException)
  ...
  public static String nI(int paramInt)
  {
    ...
    String str = (String)mdE.get(Integer.valueOf(paramInt));
    if (str == null)
    {
  ...
  public static int xR(String paramString)
  {
    ...
    c localc = j.aAe().yb(paramString);
    if ((localc != null) && (paramString.equalsIgnoreCase(localc.field_ssid)))
    {
      if ((localc.field_connectState == 2) && (localc.field_expiredTime > 0L) && (localc.field_expiredTime - bg.Po() <= 0L))
      {
        localc.field_connectState = 1;
        boolean bool = j.aAe().c(localc, new String[0]);
        w.i("MicroMsg.FreeWifi.FreeWifiManager", "Expired, re-auth, expired time : %d, current time : %d, ret : %b", new Object[] { Long.valueOf(localc.field_expiredTime), Long.valueOf(bg.Po()), Boolean.valueOf(bool) });
      }
  ...
  public static boolean xS(String paramString)
  {
    ...
    String str = azV();
    if ((!bg.mZ(str)) && (str.equals(paramString)))
    {
      GMTrace.o(7132195848192L, 53139);
      return true;
    }
  ...
  public static int xT(String paramString)
  {
    ...
    for (;;)
    {
      ...
      w.i("MicroMsg.FreeWifi.FreeWifiManager", "check is the same ssid is exist, %b", new Object[] { Boolean.valueOf(xU(paramString)) });
      localWifiConfiguration.allowedKeyManagement.set(0);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/model/d.class
