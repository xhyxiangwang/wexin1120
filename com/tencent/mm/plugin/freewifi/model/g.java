...
public final class g
{
  ...
  public static void a(String paramString, int paramInt, Intent paramIntent)
  {
    ...
    if (paramInt == 3)
    {
      ...
      com.tencent.mm.plugin.freewifi.g.c localc = j.aAe().ya(paramString);
      if (localc != null)
      {
        localc.field_expiredTime = (bg.Po() - 10L);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/model/g.class
