  ...
  extends b
{
  ...
  public a(Context paramContext)
  {
    ...
    this.hasInit = false;
    this.mge = new Runnable()
    {
      public final void run()
      {
        GMTrace.i(14551617634304L, 108418);
        final View localView = a.b(a.this).findViewById(R.h.bKs);
        ...
        ap.xC().C(new Runnable()
        {
          public final void run()
          {
            ...
            final com.tencent.mm.g.a.bg localbg = new com.tencent.mm.g.a.bg();
            long l = System.currentTimeMillis();
            com.tencent.mm.sdk.b.a.uLm.m(localbg);
            ...
            af.u(new Runnable()
            {
              public final void run()
              {
                ...
                if (com.tencent.mm.sdk.platformtools.bg.mZ(localbg.fvC.fvH))
                {
                  a.2.1.this.mgg.setVisibility(8);
                  GMTrace.o(14553899335680L, 108435);
                  return;
                }
                ((TextView)a.c(a.this).findViewById(R.h.bJI)).setText(localbg.fvC.fvH);
                final String str2 = localbg.fvC.fvE;
                if ("0".equalsIgnoreCase(localbg.fvC.fvD)) {}
                final String str3;
                final String str4;
                final String str5;
                final String str6;
                ...
                {
                  str3 = localbg.fvC.fvF;
                  str4 = localbg.fvC.ssid;
                  str5 = localbg.fvC.bssid;
                  str6 = localbg.fvC.fvG;
                  w.i("MicroMsg.FreeWifi.FreeWifiBanner", "desc=it tries to show bar. pingEnabled = %s,  pingUrl= %s", new Object[] { str1, str2 });
                  if ("1".equals(str1)) {
                    break;
                  }
                  a.2.1.this.mgg.setVisibility(0);
                  GMTrace.o(14553899335680L, 108435);
                  return;
                }
                ap.xC().C(new Runnable()
                {
                  ...
                  public final void run()
                  {
                    ...
                    //   17: iconst_0
                    //   18: aload_0
                    //   19: getfield 31	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mgk	Ljava/lang/String;
                    //   22: aastore
                    ...
                    //   39: dup
                    //   40: aload_0
                    //   41: getfield 31	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mgk	Ljava/lang/String;
                    ...
                    //   132: lsub
                    //   133: lstore_2
                    //   134: getstatic 119	com/tencent/mm/plugin/report/service/g:paX	Lcom/tencent/mm/plugin/report/service/g;
                    //   137: sipush 12907
                    //   140: bipush 10
                    ...
                    //   146: iconst_0
                    //   147: aload_0
                    //   148: getfield 33	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mdb	Ljava/lang/String;
                    //   151: aastore
                    //   152: dup
                    //   153: iconst_1
                    //   154: aload_0
                    //   155: getfield 35	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mdc	Ljava/lang/String;
                    //   158: aastore
                    //   159: dup
                    //   160: iconst_2
                    //   161: aload_0
                    //   162: getfield 37	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mgl	Ljava/lang/String;
                    //   165: aastore
                    //   166: dup
                    //   167: iconst_3
                    //   168: aload_0
                    //   169: getfield 39	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mcP	Ljava/lang/String;
                    //   172: aastore
                    //   173: dup
                    //   174: iconst_4
                    //   175: ldc 121
                    ...
                    //   254: invokestatic 146	com/tencent/mm/sdk/platformtools/af:u	(Ljava/lang/Runnable;)V
                    //   257: aload 5
                    //   259: ifnull +331 -> 590
                    //   262: aload 5
                    ...
                    //   390: aload 5
                    //   392: astore 4
                    //   394: getstatic 119	com/tencent/mm/plugin/report/service/g:paX	Lcom/tencent/mm/plugin/report/service/g;
                    //   397: astore 8
                    //   399: aload 5
                    //   401: astore 4
                    //   403: aload_0
                    //   404: getfield 33	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mdb	Ljava/lang/String;
                    //   407: astore 9
                    //   409: aload 5
                    //   411: astore 4
                    //   413: aload_0
                    //   414: getfield 35	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mdc	Ljava/lang/String;
                    //   417: astore 10
                    //   419: aload 5
                    //   421: astore 4
                    //   423: aload_0
                    //   424: getfield 37	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mgl	Ljava/lang/String;
                    //   427: astore 11
                    //   429: aload 5
                    //   431: astore 4
                    //   433: aload_0
                    //   434: getfield 39	com/tencent/mm/plugin/freewifi/ui/a$2$1$1$1:mcP	Ljava/lang/String;
                    //   437: astore 12
                    //   439: aload 6
                    //   441: astore 7
                    //   443: aload 5
  ...
  private void initialize()
  {
    ...
    if (this.view != null)
    {
      View localView = this.view.findViewById(R.h.bKs);
      if (this.hasInit)
      {
      ...
      localView.setOnClickListener(new View.OnClickListener()
      {
        public final void onClick(View paramAnonymousView)
        {
          ...
          if ((a.mgd != null) && (paramAnonymousView.getTime() - a.mgd.getTime() < 1000L))
          {
            GMTrace.o(14551349198848L, 108416);
            return;
          }
          a.mgd = paramAnonymousView;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/ui/a.class
