  ...
  protected void onResume()
  {
    ...
    for (;;)
    {
      ...
      default: 
        break;
      case 1: 
        if (1 != i.a.mbS.getInt("LOCAL_CONFIG_FEATURES_DEFINE_ONCE_USE_WECHAT_FREEWIFI", 0)) {
          i.a.mbS.ba("LOCAL_CONFIG_FEATURES_DEFINE_ONCE_USE_WECHAT_FREEWIFI", 1);
        }
        m.d(localIntent, localIntent.getStringExtra("free_wifi_mid"));
        localIntent.setClass(this, FreeWifiNetCheckUI.class);
        startActivity(localIntent);
        super.overridePendingTransition(R.a.aMp, R.a.aMo);
        break;
      case 3: 
        ...
        break;
      case 2: 
        localObject = j.aAe().yb(com.tencent.mm.plugin.freewifi.model.d.azY());
        if (localObject == null)
        {
        ...
        else
        {
          ...
          if ((((c)localObject).field_action == 2) && (!bg.mZ(((c)localObject).field_showUrl)))
          {
          ...
          else if ((((c)localObject).field_action == 1) && (!bg.mZ(((c)localObject).field_showUrl)))
          {
            ...
            com.tencent.mm.bi.d.b(this, "webview", ".ui.tools.WebViewUI", localIntent);
          }
          else
          {
      ...
      case 5: 
        ...
        if (!m.xJ((String)localObject))
        {
          ...
          if ("_p33beta".equalsIgnoreCase((String)localObject))
          {
            ...
            localIntent.putExtra("free_wifi_ssid", m.xM("MicroMsg.FreeWifi.FreeWifiEntryUI"));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/ui/FreeWifiEntryUI.class
