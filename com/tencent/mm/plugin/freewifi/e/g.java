  ...
  implements a
{
  ...
  public final void aAB()
  {
    ...
    this.meH.a(new a.a()
    {
      ...
      public final void onSuccess()
      {
        ...
        w.i("MicroMsg.FreeWifi.ProtocolOne", "sessionKey=%s, step=%d, desc=Network. ", new Object[] { m.B(g.this.intent), Integer.valueOf(m.C(g.this.intent)) });
        g.this.aAD();
  ...
  public final void aAC()
  {
    ...
    this.meA.a(FreeWifiFrontPageUI.d.mhe, FreeWifiFrontPageUI.a.mha);
  ...
  public final void aAD()
  {
    ...
    String str3 = d.azT();
    w.i("MicroMsg.FreeWifi.ProtocolOne", "get ap auth data : %s, url : %s, mac : %s", new Object[] { str2, this.meB, str3 });
    if (!bg.mZ(str2))
    {
      new com.tencent.mm.plugin.freewifi.d.a(this.meB, this.ssid, str3, "", str2, "", this.fjU, m.B(this.intent)).b(new com.tencent.mm.ac.e()
      {
        public final void a(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, k paramAnonymousk)
        {
          ...
          if ((paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0))
          {
            ...
            paramAnonymousString = paramAnonymousk.aAm();
            w.i("MicroMsg.FreeWifi.ProtocolOne", "authUrl : %s", new Object[] { paramAnonymousString });
            paramAnonymousk = paramAnonymousk.aAs();
            if (paramAnonymousk != null)
            {
              w.i("MicroMsg.FreeWifi.ProtocolOne", "backPageInfo appid: %s, nickName: %s, userName: %s, finishActionCode: %d, finishUrl: %s, signature: %s", new Object[] { paramAnonymousk.mGI, paramAnonymousk.jYc, paramAnonymousk.jWW, Integer.valueOf(paramAnonymousk.txV), paramAnonymousk.txW, paramAnonymousk.huM });
              g localg = g.this;
              j.aAh().azR().post(new g.4(localg, paramAnonymousString, paramAnonymousk));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/e/g.class
