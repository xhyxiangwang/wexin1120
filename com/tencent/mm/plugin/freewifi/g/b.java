  ...
  extends i<a>
{
  ...
  public static Map<String, String> mfH;
  
  static
  {
    GMTrace.i(7156891910144L, 53323);
    gMz = new String[] { i.a(a.gLR, "FreeWifiConfig"), "CREATE INDEX IF NOT EXISTS idx_freewificonfig_key  on FreeWifiConfig  (  key )" };
    mfH = new ConcurrentHashMap();
    GMTrace.o(7156891910144L, 53323);
  }
  
  public b(e parame)
  {
    super(parame, a.gLR, "FreeWifiConfig", null);
  ...
  public final void Mz()
  {
    ...
    super.eL("FreeWifiConfig", "delete from FreeWifiConfig");
  ...
  public final void cg(String paramString1, String paramString2)
  {
    ...
    //   5: invokestatic 21	com/tencent/gmtrace/GMTrace:i	(JI)V
    //   8: aload_1
    //   9: invokestatic 146	com/tencent/mm/plugin/freewifi/m:xJ	(Ljava/lang/String;)Z
    //   12: ifne +10 -> 22
    //   15: aload_2
    //   16: invokestatic 146	com/tencent/mm/plugin/freewifi/m:xJ	(Ljava/lang/String;)Z
    //   19: ifeq +12 -> 31
    //   22: ldc2_w 138
    //   25: ldc -116
    //   27: invokestatic 49	com/tencent/gmtrace/GMTrace:o	(JI)V
    //   30: return
    //   31: getstatic 46	com/tencent/mm/plugin/freewifi/g/b:mfH	Ljava/util/Map;
    //   34: ifnull +28 -> 62
    //   37: getstatic 46	com/tencent/mm/plugin/freewifi/g/b:mfH	Ljava/util/Map;
    //   40: invokeinterface 150 1 0
    //   45: sipush 1000
    //   48: if_icmpge +104 -> 152
    //   51: getstatic 46	com/tencent/mm/plugin/freewifi/g/b:mfH	Ljava/util/Map;
    //   54: aload_1
    //   55: aload_2
    ...
    //   151: return
    //   152: getstatic 46	com/tencent/mm/plugin/freewifi/g/b:mfH	Ljava/util/Map;
    //   155: invokeinterface 66 1 0
    //   160: getstatic 46	com/tencent/mm/plugin/freewifi/g/b:mfH	Ljava/util/Map;
    //   163: aload_1
    //   164: aload_2
  ...
  public final String xZ(String paramString)
  {
    ...
    try
    {
      if (mfH != null)
      {
        String str = (String)mfH.get(paramString);
        if (str != null)
        {
          GMTrace.o(7156489256960L, 53320);
          return str;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/g/b.class
