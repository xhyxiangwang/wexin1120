  ...
  extends i<c>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(c.gLR, "FreeWifiInfo"), "CREATE INDEX IF NOT EXISTS freewifi_md5_ssid  on FreeWifiInfo  (  ssidmd5 )" };
    GMTrace.o(7155683950592L, 53314);
  }
  
  public d(e parame)
  {
    super(parame, c.gLR, "FreeWifiInfo", null);
  ...
  public final c ya(String paramString)
  {
    ...
    paramString = "select * from FreeWifiInfo where ssidmd5 = '" + aa.QW(paramString) + "' and wifiType = 1";
  ...
  public final c yb(String paramString)
  {
    ...
    paramString = "select * from FreeWifiInfo where ssidmd5 = '" + aa.QW(paramString) + "'";
    w.d("MicroMsg.FreeWifi.FreeWifiInfoStorage", "getFreeWifiInfoBySSID, sql : %s", new Object[] { paramString });
    paramString = rawQuery(paramString, new String[0]);
    if (paramString == null)
    {
  ...
  public final void yc(String paramString)
  {
    ...
    paramString = "update FreeWifiInfo set connectState = -1 where ssidmd5 !='" + aa.QW(paramString) + "'";
    w.d("MicroMsg.FreeWifi.FreeWifiInfoStorage", "updateOtherAp : %s", new Object[] { paramString });
    w.d("MicroMsg.FreeWifi.FreeWifiInfoStorage", "update other ap  ret = %b", new Object[] { Boolean.valueOf(eL("FreeWifiInfo", paramString)) });
    GMTrace.o(7155549732864L, 53313);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/g/d.class
