...
{
  public static volatile boolean mfC;
  static Pattern mfD;
  static Pattern mfE;
  ...
  static
  {
    ...
    mfC = true;
    mfD = Pattern.compile("\"result\":(-?[0-9]+)");
    mfE = Pattern.compile("\"stageName\":\"(.+?)\"");
    GMTrace.o(7260507996160L, 54095);
  }
  
  static String M(LinkedList<tr> paramLinkedList)
  {
    ...
    {
      paramLinkedList = (tr)localIterator.next();
      localStringBuilder.append("|id=").append(m.xL(paramLinkedList.id)).append("|");
      String[] arrayOfString = m.xL(paramLinkedList.tRM).split("\\},");
      int j = arrayOfString.length;
      int i = 0;
      while (i < j)
      {
        String str = arrayOfString[i];
        Matcher localMatcher = mfE.matcher(str);
        paramLinkedList = "";
        if (localMatcher.find()) {
          paramLinkedList = localMatcher.group(1);
        }
        localMatcher = mfD.matcher(str);
        str = "0";
        if (localMatcher.find()) {
          str = localMatcher.group(1);
        }
        localStringBuilder.append(k.xI(paramLinkedList) + "=" + str).append("|");
        i += 1;
      }
    }
  ...
  public static void nK(int paramInt)
  {
    ...
    j.aAi().azR().post(new Runnable()
    {
      public final void run()
      {
        ...
        if (this.mfF == 0)
        {
          long l = System.currentTimeMillis() - i.a.mbS.na("LOCAL_CONFIG_LAST_MOBILE_NETWORK_REPORT_TIMEMILLIS");
          ...
          i.a.mbS.w("LOCAL_CONFIG_LAST_MOBILE_NETWORK_REPORT_TIMEMILLIS", System.currentTimeMillis());
        }
        b.mfC = false;
        Object localObject = j.aAg();
        m.a("FreeWifiLog", f.mfI, (com.tencent.mm.sdk.e.i)localObject, "MicroMsg.FreeWifi.FreeWifiLogStorage");
        localObject = ((f)localObject).aAH();
        String str = "ServerReportSimpleLog:" + b.M((LinkedList)localObject);
        m.xP(str);
        w.i("MicroMsg.FreeWifi.FreeWifiServerReporter", str);
        if (((LinkedList)localObject).size() > 0)
        {
          new com.tencent.mm.plugin.freewifi.d.e((LinkedList)localObject).b(new com.tencent.mm.ac.e()
          {
            /* Error */
            public final void a(int paramAnonymous2Int1, int paramAnonymous2Int2, String paramAnonymous2String, com.tencent.mm.ac.k paramAnonymous2k)
            {
              ...
              //   37: iload_1
              //   38: iload_2
              //   39: invokestatic 60	com/tencent/mm/plugin/freewifi/m:cc	(II)Z
              //   42: ifeq +199 -> 241
              //   45: aload 4
              //   47: checkcast 62	com/tencent/mm/plugin/freewifi/d/e
              //   50: invokevirtual 66	com/tencent/mm/plugin/freewifi/d/e:aAu	()Ljava/util/LinkedList;
              //   53: astore 4
              //   55: aload 4
              //   57: ifnull +184 -> 241
              //   60: aload 4
              ...
              //   65: ifle +176 -> 241
              //   68: invokestatic 78	com/tencent/mm/plugin/freewifi/model/j:aAg	()Lcom/tencent/mm/plugin/freewifi/g/f;
              //   71: astore_3
              //   72: aload 4
              ...
              //   96: checkcast 94	com/tencent/mm/protocal/c/tr
              //   99: astore 7
              //   101: aload 7
              //   103: getfield 98	com/tencent/mm/protocal/c/tr:id	Ljava/lang/String;
              //   106: astore 6
              //   108: aload 7
              //   110: getfield 102	com/tencent/mm/protocal/c/tr:fzx	I
              //   113: istore_1
              //   114: ldc 41
              //   116: ldc 104
              //   118: iconst_2
              ...
              //   137: aload 6
              //   139: invokestatic 108	com/tencent/mm/plugin/freewifi/m:xJ	(Ljava/lang/String;)Z
              //   142: ifne -63 -> 79
              //   145: iload_1
              //   146: ifne -67 -> 79
              //   149: ldc 110
              ...
              //   228: iconst_1
              //   229: putstatic 155	com/tencent/mm/plugin/freewifi/f/b:mfC	Z
              //   232: ldc2_w 37
              //   235: ldc 39
              //   237: invokestatic 31	com/tencent/gmtrace/GMTrace:o	(JI)V
              //   240: return
              //   241: iconst_1
              //   242: putstatic 155	com/tencent/mm/plugin/freewifi/f/b:mfC	Z
              //   245: ldc2_w 37
              //   248: ldc 39
              ...
              //   254: astore_3
              //   255: iconst_1
              //   256: putstatic 155	com/tencent/mm/plugin/freewifi/f/b:mfC	Z
              //   259: aload_3
              //   260: athrow
              ...
              //   0	261	4	paramAnonymous2k	com.tencent.mm.ac.k
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/freewifi/f/b.class
