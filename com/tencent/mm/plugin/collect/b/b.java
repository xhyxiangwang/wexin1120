    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject1 == null) {
          paramString3 = com.tencent.mm.ab.b.c(paramString2, j, j, (int)(j * 0.06F));
        }
        paramString2 = paramString3;
        if (paramString3 == null)
        {
          paramString2 = BackwardSupportUtil.b.a(ab.getContext().getAssets().open("avatar/default_nor_avatar.png"), com.tencent.mm.bq.a.getDensity(null));
        ...
        if (paramBoolean) {
          paramString3.drawBitmap(MMBitmapFactory.decodeStream(paramContext.getResources().openRawResource(R.g.aXY)), null, new Rect(i - paramInt2, i - paramInt2, i, i), localPaint);
        }
        ...
        if (paramInt1 > 0)
        {
          paramContext = com.tencent.mm.bn.a.a.a(paramContext, localBitmap, paramString2, paramString3, 0);
          if (paramContext == null)
          {
            w.i("MicroMsg.QRCodeBitmapFactory", "createBitmap bm is error result %d %s", new Object[] { Integer.valueOf(paramInt1), bg.bOd().toString() });
            localBitmap.recycle();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/collect/b/b.class
