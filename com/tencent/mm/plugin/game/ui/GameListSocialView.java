  ...
  extends LinearLayout
{
  ...
  public final void I(LinkedList<String> paramLinkedList)
  {
    ...
    if (getChildCount() < paramLinkedList.size() / 2)
    {
      ...
      while (i < j - k)
      {
        inflate(getContext(), R.i.cWE, this);
        i += 1;
      }
    }
    int i = 0;
    ...
    while (i < paramLinkedList.size() / 2)
    {
      ...
      TextView localTextView = (TextView)((View)localObject).findViewById(R.h.bNx);
      localObject = (TextView)((View)localObject).findViewById(R.h.bNy);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/ui/GameListSocialView.class
