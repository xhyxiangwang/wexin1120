  ...
  extends LinearLayout
{
  ...
  public final void a(q paramq, LinkedList<q.h> paramLinkedList, int paramInt1, int paramInt2, f<String, Bitmap> paramf)
  {
    ...
    {
      i = 1;
      j = this.mContext.getResources().getDimensionPixelSize(R.f.aQX);
      if (getChildCount() >= i) {
        break label159;
      }
      ...
      if (localGameMessageListUserIconView.mNJ == null) {
        break label137;
      }
      localGameMessageListUserIconView.mNJ.mBs = paramInt2;
    }
    for (;;)
    {
      ...
      break;
      label137:
      localGameMessageListUserIconView.mNJ = new r(localGameMessageListUserIconView.mContext, paramInt2);
    }
    label159:
    paramInt2 = 0;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/ui/GameMessageListContainerView.class
