  ...
  public final boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    if (i == 0) {
      if ((paramView instanceof ImageView))
      {
        ...
        {
          paramMotionEvent.setColorFilter(this.rE, PorterDuff.Mode.MULTIPLY);
    ...
    for (;;)
    {
      ...
      {
        paramView.getBackground().setColorFilter(this.rE, PorterDuff.Mode.MULTIPLY);
        continue;
        if ((i == 1) || (i == 3)) {
          if ((paramView instanceof ImageView))
          {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/ui/w.class
