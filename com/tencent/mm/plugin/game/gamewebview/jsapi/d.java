...
{
  private static Map<String, c> muk;
  
  private static void a(c paramc)
  {
    GMTrace.i(17025787232256L, 126852);
    if (bg.mZ(paramc.getName()))
    {
      GMTrace.o(17025787232256L, 126852);
      return;
    }
    muk.put(paramc.getName(), paramc);
    GMTrace.o(17025787232256L, 126852);
  }
  
  public static Map<String, c> aCQ()
  {
    GMTrace.i(17025653014528L, 126851);
    if ((muk == null) || (muk.size() == 0))
    {
      muk = new HashMap();
      a(new a());
      a(new b());
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/d.class
