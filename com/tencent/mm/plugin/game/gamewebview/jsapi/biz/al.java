  ...
  extends a
{
  ...
  public final void a(final com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    if ((paramJSONObject == null) || (bg.mZ(paramJSONObject.optString("localId"))))
    {
    ...
    paramJSONObject = com.tencent.mm.plugin.game.gamewebview.a.d.yG((String)localObject);
    if ((paramJSONObject == null) || (TextUtils.isEmpty(paramJSONObject.iGk)) || (!e.aZ(paramJSONObject.iGk)))
    {
    ...
    ((Intent)localObject).putExtra("key_video_path", paramJSONObject.iGk);
    ...
    com.tencent.mm.bi.d.b(paramJSONObject, "card", ".ui.CardGiftVideoUI", (Intent)localObject, hashCode() & 0xFFFF);
    GMTrace.o(17053167648768L, 127056);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/al.class
