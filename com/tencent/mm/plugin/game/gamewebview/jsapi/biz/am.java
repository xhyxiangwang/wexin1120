  ...
  extends a
{
  ...
  private static void a(d paramd, FileDownloadTaskInfo paramFileDownloadTaskInfo, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if ((str == "downloading") && (paramFileDownloadTaskInfo.fCd != 0L)) {
          localHashMap.put("progress", Long.valueOf(paramFileDownloadTaskInfo.fCc / paramFileDownloadTaskInfo.fCd * 100L));
        }
  ...
  public final void a(d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if ((localObject2 != null) && (((JSONArray)localObject2).length() > 0))
    {
      ...
      paramJSONObject.mvr = localArrayList;
      GameWebViewMainProcessService.b(paramJSONObject);
      paramJSONObject = paramJSONObject.lqf;
        ...
        if (((Iterator)localObject2).hasNext())
        {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramJSONObject == "downloading") && (localFileDownloadTaskInfo.fCd != 0L)) {
                localJSONObject.put("progress", localFileDownloadTaskInfo.fCc / localFileDownloadTaskInfo.fCd * 100L);
              }
    ...
    if (l > 0L)
    {
      ...
      ((QueryDownloadInfoTask)localObject1).fti = l;
      GameWebViewMainProcessService.b((GWMainProcessTask)localObject1);
      if ((((QueryDownloadInfoTask)localObject1).lqf == null) || (((QueryDownloadInfoTask)localObject1).lqf.size() == 0))
      {
        a(paramd, new FileDownloadTaskInfo(), paramInt);
        GMTrace.o(17051020165120L, 127040);
        return;
      }
      a(paramd, (FileDownloadTaskInfo)((QueryDownloadInfoTask)localObject1).lqf.get(0), paramInt);
      GMTrace.o(17051020165120L, 127040);
      return;
    }
    if (!bg.mZ(paramJSONObject))
    {
      ...
      ((QueryDownloadInfoTask)localObject1).mvr = new ArrayList();
      ((QueryDownloadInfoTask)localObject1).mvr.add(paramJSONObject);
      GameWebViewMainProcessService.b((GWMainProcessTask)localObject1);
      if ((((QueryDownloadInfoTask)localObject1).lqf == null) || (((QueryDownloadInfoTask)localObject1).lqf.size() == 0))
      {
        a(paramd, new FileDownloadTaskInfo(), paramInt);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/am.class
