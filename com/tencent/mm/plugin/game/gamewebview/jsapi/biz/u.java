  ...
  extends a
{
  ...
  public final void a(d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    localObject = paramd.mwO;
    if ((localObject != null) && (((e)localObject).mxY != null))
    {
      localObject = ((e)localObject).mxY;
      if (paramJSONObject != null)
      {
        int i = 0;
        while (i < paramJSONObject.length())
        {
          int j = bg.e((Integer)((i)localObject).myn.get(paramJSONObject.optString(i)));
          if ((j > 0) && (!((i)localObject).myo.contains(Integer.valueOf(j)))) {
            ((i)localObject).mym.add(Integer.valueOf(j));
          }
          i += 1;
        }
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/u.class
