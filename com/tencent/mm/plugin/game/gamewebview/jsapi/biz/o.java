  ...
  extends a
{
  ...
  public final void a(final d paramd, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    paramJSONObject = new e(paramJSONObject);
    paramd = new MMActivity.a()
    {
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        if (paramAnonymousInt2 == 5)
        {
          ...
          paramAnonymousIntent = bg.mY(paramAnonymousIntent.getStringExtra("key_jsapi_pay_err_msg"));
    ...
    f.a(localGameWebViewUI, paramJSONObject, hashCode() & 0xFFFF, paramd);
    GMTrace.o(17042027577344L, 126973);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/o.class
