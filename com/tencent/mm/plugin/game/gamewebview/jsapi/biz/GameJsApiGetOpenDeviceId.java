  ...
  extends a
{
  ...
  public final void a(d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    Object localObject2 = paramd.aDq();
    if ((!bg.mZ(((GetDeviceIdTask)localObject1).flE)) && (!bg.mZ(((GetDeviceIdTask)localObject1).muK)) && (!bg.mZ((String)localObject2)))
    {
      paramJSONObject = aa.QW(aa.QW((String)localObject2 + ((GetDeviceIdTask)localObject1).flE));
      localObject1 = aa.QW(aa.QW((String)localObject2 + ((GetDeviceIdTask)localObject1).muK));
    ...
    extends GWMainProcessTask
  {
    ...
    public final void f(Parcel paramParcel)
    {
      ...
      this.flE = paramParcel.readString();
    ...
    public void writeToParcel(Parcel paramParcel, int paramInt)
    {
      ...
      paramParcel.writeString(this.flE);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/GameJsApiGetOpenDeviceId.class
