  ...
  extends a
{
  ...
  public final void a(Context paramContext, String paramString, GameJsApiMMTask.a parama)
  {
    ...
    JSONObject localJSONObject = d.pQ(paramString);
    if (localJSONObject == null)
    {
      w.e("MicroMsg.GameJsApiLaunchMiniProgram", "data is null");
      parama.qb(a.d(a.d("launchMiniProgram:fail_null_data", null), null));
    ...
    if (bg.mZ(str2))
    {
      parama.qb(a.d("launchMiniProgram:fail_invalid_targetAppId", null));
      GMTrace.o(17036121997312L, 126929);
      return;
    }
    if (bg.mZ(paramString))
    {
      parama.qb(a.d("launchMiniProgram:fail_invalid_referrerAppId", null));
      GMTrace.o(17036121997312L, 126929);
      return;
    }
    str1 = bg.mY(localJSONObject.optString("envVersion"));
    int i = -1;
    ...
    for (;;)
    {
      ...
      parama.qb(a.d("launchMiniProgram:ok", null));
      GMTrace.o(17036121997312L, 126929);
      return;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/z.class
