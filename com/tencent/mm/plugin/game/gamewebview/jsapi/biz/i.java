  ...
  extends com.tencent.mm.plugin.game.gamewebview.jsapi.a
{
  ...
  public i()
  {
    ...
    this.mtR = new MMActivity.a()
    {
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        for (;;)
        {
          i.this.muE.v(i.this.iPM, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseMedia:fail", null));
          GMTrace.o(17066320986112L, 127154);
          return;
          i.this.muE.v(i.this.iPM, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseMedia:cancel", null));
          GMTrace.o(17066320986112L, 127154);
          return;
          ...
          Object localObject2 = com.tencent.mm.plugin.game.gamewebview.a.d.yG((String)localObject1);
          if ((localObject2 != null) && ((localObject2 instanceof WebViewJSSDKVideoItem)))
          {
            ...
            i.this.muE.v(i.this.iPM, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseMedia:ok", (Map)localObject1));
            GMTrace.o(17066320986112L, 127154);
            return;
          }
  ...
  public final void H(Intent paramIntent)
  {
    ...
    this.muD.vow = this.mtR;
    com.tencent.mm.bi.d.a(this.muD, "webview", ".ui.tools.OpenFileChooserUI", paramIntent, 0xFFFF & hashCode(), false);
  ...
  public final void a(final com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    this.iPM = paramInt;
    this.muD = paramd.aDm();
    boolean bool1 = com.tencent.mm.pluginsdk.h.a.a(this.muD, "android.permission.CAMERA", 119, "", "");
    w.i("MicroMsg.GameJsApiChooseMedia", " checkPermission checkcamera[%b]", new Object[] { Boolean.valueOf(bool1) });
    boolean bool2 = com.tencent.mm.pluginsdk.h.a.a(this.muD, "android.permission.RECORD_AUDIO", 120, "", "");
    ...
    String str1 = bg.mY(paramJSONObject.optString("sourceType"));
    ...
    for (paramJSONObject = "album|camera";; paramJSONObject = str1)
    {
      ...
      {
        paramJSONObject = new l(this.muD);
        paramJSONObject.b(null, new View.OnCreateContextMenuListener()new o.d
        {
          public final void onCreateContextMenu(ContextMenu paramAnonymousContextMenu, View paramAnonymousView, ContextMenu.ContextMenuInfo paramAnonymousContextMenuInfo)
          {
            GMTrace.i(17044846149632L, 126994);
            paramAnonymousContextMenu.add(0, 1, 0, i.this.muD.getString(R.l.dvx));
            paramAnonymousContextMenu.add(0, 2, 1, i.this.muD.getString(R.l.dvB));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/i.class
