    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          localGameWebViewUI.vow = new MMActivity.a()
          {
            public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
            {
              ...
              if (paramAnonymousInt1 == 45)
              {
                ...
                {
                default: 
                  this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("recordVideo:fail", null));
                  GMTrace.o(17033840295936L, 126912);
                  return;
                case 0: 
                  this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("recordVideo:cancel", null));
                  GMTrace.o(17033840295936L, 126912);
                  return;
                }
                ...
                localObject2 = com.tencent.mm.plugin.game.gamewebview.a.d.yG((String)localObject1);
                if ((localObject2 != null) && ((localObject2 instanceof WebViewJSSDKVideoItem)))
                {
                  ...
                  this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("recordVideo:ok", localHashMap));
                  GMTrace.o(17033840295936L, 126912);
                  return;
                }
                this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("recordVideo:fail", null));
              ...
              do
              {
                this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseVideo:fail", null));
                GMTrace.o(17033840295936L, 126912);
                return;
                this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseVideo:cancel", null));
                GMTrace.o(17033840295936L, 126912);
                return;
                paramAnonymousIntent = paramAnonymousIntent.getStringExtra("key_pick_local_media_local_id");
              } while (bg.mZ(paramAnonymousIntent));
              Object localObject1 = com.tencent.mm.plugin.game.gamewebview.a.d.yG(paramAnonymousIntent);
              if ((localObject1 != null) && ((localObject1 instanceof WebViewJSSDKVideoItem)))
              {
                ...
                this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseVideo:ok", (Map)localObject2));
                GMTrace.o(17033840295936L, 126912);
                return;
              }
              this.mup.v(paramInt1, com.tencent.mm.plugin.game.gamewebview.a.d.d("chooseVideo:fail", null));
          ...
          if (paramInt2 == 1)
          {
            com.tencent.mm.bi.d.a(localGameWebViewUI, "webview", ".ui.tools.OpenFileChooserUI", paramJSONObject, 45, false);
            GMTrace.o(17069273776128L, 127176);
            return;
          }
          com.tencent.mm.bi.d.a(localGameWebViewUI, "webview", ".ui.tools.OpenFileChooserUI", paramJSONObject, 32, false);
          GMTrace.o(17069273776128L, 127176);
          return;
        }
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/j.class
