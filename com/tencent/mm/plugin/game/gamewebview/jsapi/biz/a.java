  ...
  extends com.tencent.mm.plugin.game.gamewebview.jsapi.a
{
    ...
    if (!am.isNetworkConnected(paramd.getContext()))
    {
      ...
      com.tencent.mm.plugin.game.gamewebview.a.d.runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          Toast.makeText(paramd.getContext(), paramd.getContext().getString(R.l.edf), 0).show();
    ...
    if (!f.tD())
    {
      ...
      com.tencent.mm.plugin.game.gamewebview.a.d.runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          Toast.makeText(paramd.getContext(), paramd.getContext().getString(R.l.edh), 0).show();
    ...
    if ((l > 0L) && (!f.K(l)))
    {
      ...
      com.tencent.mm.plugin.game.gamewebview.a.d.runOnUiThread(new Runnable()
      {
        public final void run()
        {
          ...
          Toast.makeText(paramd.getContext(), paramd.getContext().getString(R.l.edg), 0).show();
  ...
  public final void b(com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    paramJSONObject.mul = ((String)localObject);
    paramJSONObject.url = str1;
    paramJSONObject.mum = str2;
    paramJSONObject.fwU = str3;
    paramJSONObject.extInfo = str4;
    paramJSONObject.mun = str5;
    paramJSONObject.appId = str6;
    paramJSONObject.packageName = str7;
    paramJSONObject.muo = l;
    paramJSONObject.scene = i;
    GameWebViewMainProcessService.b(paramJSONObject);
    if (paramJSONObject.fti <= 0L)
    {
      w.e("MicroMsg.GameJsApiAddDownloadTaskStraight", "fail, downloadId = " + paramJSONObject.fti);
      paramd.v(paramInt, com.tencent.mm.plugin.game.gamewebview.jsapi.a.d("add_download_task:fail", null));
      GMTrace.o(18025709305856L, 134302);
      return;
    }
    localObject = new HashMap();
    ((Map)localObject).put("download_id", Long.valueOf(paramJSONObject.fti));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/a.class
