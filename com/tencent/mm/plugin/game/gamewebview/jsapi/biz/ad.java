  ...
  extends a
{
  ...
  public final void a(final com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, final int paramInt)
  {
      ...
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        if (paramAnonymousInt1 == (ad.this.hashCode() & 0xFFFF))
        {
          if (paramAnonymousInt2 == -1)
          {
            ...
            {
              paramAnonymousIntent = bg.ap(paramAnonymousIntent.getStringExtra("gameRegionName"), "");
    ...
    com.tencent.mm.bi.d.a(paramJSONObject, "game", ".ui.GameRegionSelectUI", null, hashCode() & 0xFFFF, false);
    GMTrace.o(17030619070464L, 126888);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/ad.class
