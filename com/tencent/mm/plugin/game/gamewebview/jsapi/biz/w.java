  ...
  extends a
{
  ...
  public final void a(com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if (i < ((JSONArray)localObject3).length())
    {
      ...
      if ((bg.mZ((String)localObject2)) || (((String)localObject2).equalsIgnoreCase("null"))) {
      ...
      for (;;)
      {
        ...
        if (bg.mY((String)localObject2).startsWith("weixin://resourceid/"))
        {
          paramJSONObject = f.bAK().Ks((String)localObject2);
          if (paramJSONObject != null) {
            paramJSONObject = paramJSONObject.iGk;
          }
        }
        else
        {
    ...
    for (;;)
    {
      ...
      localObject3 = b.coE().getCookie(paramd.aDp());
      ...
      com.tencent.mm.bi.d.b(localGameWebViewUI, "subapp", ".ui.gallery.GestureGalleryUI", (Intent)localObject1);
      paramd.v(paramInt, a.d("imagePreview:ok", null));
      GMTrace.o(17034108731392L, 126914);
      return;
      if (((String)localObject1).startsWith("weixin://resourceid/"))
      {
        paramJSONObject = f.bAK().Ks((String)localObject1);
        if (paramJSONObject != null) {
          paramJSONObject = paramJSONObject.iGk;
        } else {
          paramJSONObject = "";
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/w.class
