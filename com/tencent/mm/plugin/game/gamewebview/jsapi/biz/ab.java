  ...
  extends a
{
  ...
  public final void a(d paramd, JSONObject paramJSONObject, int paramInt)
  {
    ...
    bg.mY(paramd.mwd).startsWith("http://game.weixin.qq.com/cgi-bin/h5/static/gameloading/index.html?appid=");
    ...
    for (;;)
    {
      ...
      if ((bool2) && (paramd.mwN.aDc())) {
        localIntent.putExtra("is_from_keep_top", true);
      }
      localIntent.putExtra("game_hv_menu_appid", bg.mY(paramJSONObject.optString("gameAppid")));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/ab.class
