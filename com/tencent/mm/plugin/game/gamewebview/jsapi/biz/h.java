  ...
  extends com.tencent.mm.plugin.game.gamewebview.jsapi.a
{
  ...
  public final void a(final com.tencent.mm.plugin.game.gamewebview.ui.d paramd, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    for (;;)
    {
      ...
      localGameWebViewUI.vow = new MMActivity.a()
      {
        public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
        {
          ...
          for (;;)
          {
            ...
            break;
            if (paramAnonymousIntent != null) {}
            for (String str = paramAnonymousIntent.getStringExtra("key_pick_local_pic_callback_local_ids"); !bg.mZ(str); str = null)
            {
      ...
      com.tencent.mm.bi.d.a(localGameWebViewUI, "webview", ".ui.tools.OpenFileChooserUI", (Intent)localObject1, 14, false);
      GMTrace.o(17060012752896L, 127107);
      return;
      if ((!((Boolean)localObject3).booleanValue()) && (((Boolean)localObject2).booleanValue()))
      {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/jsapi/biz/h.class
