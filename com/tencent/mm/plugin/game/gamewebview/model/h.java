...
public final class h
{
  public static void a(d paramd, JSONObject paramJSONObject)
  {
    ...
    Object localObject2 = (c.d)paramd.mxE.get(paramd.aDp());
    Object localObject1;
    int i;
    label112:
    String str3;
    if ((!TextUtils.isEmpty(str1)) && (localObject2 != null) && (((c.d)localObject2).syr != null) && (((c.d)localObject2).syr.size() > 0))
    {
      ...
      if (j == -1)
      {
        ...
        localObject2 = ((c.d)localObject2).syr.iterator();
        for (;;)
        {
  ...
  public static void c(d paramd)
  {
    ...
    paramd.yW("sendAppMessage");
    if (paramd.be("sendAppMessage", 89))
    {
      paramd.ck("menu:share:appmessage", "");
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/model/h.class
