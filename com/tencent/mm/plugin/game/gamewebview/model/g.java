...
public final class g
{
  ...
  public static k yO(String paramString)
  {
    ...
    if ((!bg.mZ(paramString)) && (paramString.startsWith("weixin://resourceid/"))) {
    ...
    for (;;)
    {
      try
      {
        ...
        localCommonLogicTask.lRQ.putString("localId", paramString);
        GameWebViewMainProcessService.b(localCommonLogicTask);
        paramString = ai.Ky(localCommonLogicTask.lRQ.getString("file_path"));
        if (paramString == null) {
          break label163;
        }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/gamewebview/model/g.class
