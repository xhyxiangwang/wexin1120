  ...
  extends i<q>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(q.gLR, "GameRawMessage") };
    GMTrace.o(12601836699648L, 93891);
  }
  
  public u(e parame)
  {
    super(parame, q.gLR, "GameRawMessage", null);
  ...
  public final void aEA()
  {
    ...
    eL("GameRawMessage", "update GameRawMessage set isRead=1 where isRead=0 and " + str + " and isHidden = 0");
  ...
  public final void aEz()
  {
    ...
    eL("GameRawMessage", "update GameRawMessage set isHidden = 0 where isHidden = 1");
  ...
  public final q cw(long paramLong)
  {
  ...
  public final boolean e(long[] paramArrayOfLong)
  {
    ...
    if (paramArrayOfLong.length != 0)
    {
      ...
      localStringBuilder.append(")");
      boolean bool = eL("GameRawMessage", String.format("update GameRawMessage set isRead=1 where %s", new Object[] { localStringBuilder.toString() }));
  ...
  public final q zc(String paramString)
  {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/model/u.class
