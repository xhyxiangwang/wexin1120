...
public final class ai
{
  ...
  public static String J(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (paramString2 != null) {
      paramString3 = cp(paramString1, paramString2.toString());
    }
    GMTrace.o(12604789489664L, 93913);
    return paramString3;
  }
  
  public static void K(String paramString1, String paramString2, String paramString3)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(10738, new Object[] { paramString1, paramString2, paramString1, paramString3 });
    GMTrace.o(12605192142848L, 93916);
  }
  ...
  public static void a(int paramInt1, int paramInt2, int paramInt3, long paramLong1, String paramString1, String paramString2, String paramString3, long paramLong2, long paramLong3, String paramString4)
  {
    ...
    SubCoreGameCenter.aFg().a(paramString1);
  ...
  public static void a(Context paramContext, int paramInt1, int paramInt2, String paramString1, int paramInt3, String paramString2)
  {
    ...
    w.i("MicroMsg.GameReportUtil", "reportExposureInfo : 10" + " , " + paramInt1 + " , " + paramInt2 + " , 1" + " , 0 , " + bg.mY(paramString1) + " , " + paramInt3 + " , 0 , " + bg.mY(null) + " , " + bg.mY(null) + " , " + bg.mY(paramString2));
    com.tencent.mm.plugin.report.service.g.paX.i(13384, new Object[] { Integer.valueOf(10), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(1), Integer.valueOf(0), paramString1, Integer.valueOf(paramInt3), Integer.valueOf(0), null, Integer.valueOf(bg.getInt(null, 0)), Integer.valueOf(cB(paramContext)), paramString2 });
  ...
  public static void a(Context paramContext, String paramString, long paramLong, int paramInt)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(14416, new Object[] { paramString, Long.valueOf(paramLong), Integer.valueOf(cB(paramContext)), Integer.valueOf(paramInt) });
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, int paramInt3, String paramString4, long paramLong, String paramString5)
  {
    ...
    paramContext = com.tencent.mm.pluginsdk.model.app.g.aM(paramString1, false);
    if (paramContext == null)
    {
    ...
    SubCoreGameCenter.aFg().a(ah.a.h(10531, new Object[] { paramString1, Integer.valueOf(Y(localContext, paramString2)), aEX(), paramString3, Integer.valueOf(paramInt1), paramString4, Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), Integer.valueOf(cB(localContext)), bg.mY(paramContext.field_packageName), bg.mY(paramContext.field_signature), Long.toString(paramLong), "", paramString5 }));
    GMTrace.o(12603178876928L, 93901);
  }
  ...
  public static void a(Context paramContext, String paramString1, String paramString2, String paramString3, int paramInt1, String paramString4, int paramInt2)
  {
    ...
    paramContext = ah.a.h(10583, new Object[] { paramString1, Integer.valueOf(Y(localContext, paramString2)), aEX(), paramString3, Integer.valueOf(paramInt1), paramString4, Integer.valueOf(paramInt2), Integer.valueOf(0), Integer.valueOf(cB(localContext)) });
    SubCoreGameCenter.aFg().a(paramContext);
    GMTrace.o(12603581530112L, 93904);
  }
  ...
  public static void a(String paramString1, int paramInt1, int paramInt2, long paramLong1, long paramLong2, String paramString2, int paramInt3, int paramInt4, String paramString3, long paramLong3, int paramInt5)
  {
    ...
    paramString1 = ah.a.h(14567, new Object[] { paramString1, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Long.valueOf(paramLong1), Long.valueOf(paramLong2), ze(paramString2), Integer.valueOf(cB(ab.getContext())), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4), paramString3, Long.valueOf(paramLong3), Integer.valueOf(paramInt5) });
    SubCoreGameCenter.aFg().a(paramString1);
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, int paramInt3)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(10546, new Object[] { paramString1, paramString2, Integer.valueOf(paramInt1), aEX(), Integer.valueOf(paramInt2), paramString3, Integer.valueOf(paramInt3) });
    GMTrace.o(12603447312384L, 93903);
  }
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, long paramLong)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(10532, new Object[] { paramString1, str, paramString2, Integer.valueOf(paramInt1), paramString3, Integer.valueOf(paramInt2) });
    GMTrace.o(12603044659200L, 93900);
  }
  ...
  private static String aEX()
  {
    ...
    if (mBX == null)
    {
      str = com.tencent.mm.compatible.d.p.tf();
      ...
      mBX = localStringBuilder.toString();
    }
    String str = mBX;
  ...
  public static void ab(int paramInt, String paramString)
  {
    ...
    locala.hPv = paramInt;
    locala.mBW = paramString;
    SubCoreGameCenter.aFg().a(locala);
  ...
  public static String co(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1 = ze(localJSONObject.toString());
      GMTrace.o(12604655271936L, 93912);
      return paramString1;
    }
  ...
  private static String cp(String paramString1, String paramString2)
  {
    ...
    String str = zf(paramString1);
    Object localObject = zf(paramString2);
    paramString1 = null;
    for (;;)
    {
      try
      ...
      try
      {
        ...
        paramString1 = ze(paramString2.toString());
      }
      catch (JSONException paramString1)
      {
        GMTrace.o(12604923707392L, 93914);
  ...
  public static void g(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(10700, new Object[] { paramString, Integer.valueOf(1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
    GMTrace.o(12603313094656L, 93902);
  }
  ...
  public static void o(Context paramContext, String paramString1, String paramString2)
  {
    ...
    com.tencent.mm.plugin.report.service.g.paX.i(10534, new Object[] { paramString1, Integer.valueOf(Y(paramContext, paramString2)), aEX(), Long.valueOf(System.currentTimeMillis() / 1000L) });
    GMTrace.o(12602910441472L, 93899);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/model/ai.class
