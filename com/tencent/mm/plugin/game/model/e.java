...
public final class e
{
  ...
  public static String a(GameRegionPreference.a parama)
  {
    ...
    if (parama != null)
    {
      str = bg.mY(com.tencent.mm.sdk.platformtools.v.bMQ());
      if (!"zh_CN".equalsIgnoreCase(str)) {
        break label60;
      }
      localStringBuffer.append(parama.mOZ);
    }
    for (;;)
    {
      ...
      if (("zh_TW".equalsIgnoreCase(str)) || ("zh_HK".equalsIgnoreCase(str))) {
        localStringBuffer.append(parama.mPa);
      } else {
        localStringBuffer.append(parama.mPb);
      }
    }
  }
  ...
  public static void a(Context paramContext, final String paramString1, String paramString2, String paramString3, final g.c paramc)
  {
    ...
    paramString1 = com.tencent.mm.pluginsdk.model.app.g.aM(paramString1, true);
    if ((paramString1 == null) || (bg.mZ(paramString1.field_appId)))
    {
    ...
    if (!p.b(paramContext, paramString1))
    {
      ...
      Toast.makeText(paramContext, paramContext.getString(R.l.edm, new Object[] { com.tencent.mm.pluginsdk.model.app.g.a(paramContext, paramString1, null) }), 1).show();
      if (paramc != null) {
        paramc.eR(false);
      }
      GMTrace.o(12622506229760L, 94045);
    ...
    localWXMediaMessage.sdkVer = 620757000;
    ...
    if (bg.mZ(paramString1.field_openId))
    {
      ...
      an.aUW().KL(paramString1.field_appId);
    }
  ...
  public static LinkedList<f> aEd()
  {
    ...
    localLinkedList1.addAll(SubCoreGameCenter.aFk().myW);
  ...
  public static LinkedList<String> aEe()
  {
    GMTrace.i(12622237794304L, 94043);
    LinkedList localLinkedList = new LinkedList();
    localLinkedList.addAll(SubCoreGameCenter.aFk().myV);
  ...
  public static int aEg()
  {
    ...
    com.tencent.mm.plugin.game.c.v localv = g.aEh().aEi();
    if (localv != null)
    {
      int i = localv.mDO;
  ...
  public static GameRegionPreference.a cx(Context paramContext)
  {
    GMTrace.i(12622774665216L, 94047);
    String str = cz(paramContext);
    paramContext = str;
    if (bg.mZ(str)) {
      paramContext = aEf();
    }
    paramContext = (GameRegionPreference.a)a.a.mRl.aFN().get(paramContext);
    GMTrace.o(12622774665216L, 94047);
    return paramContext;
  }
  
  public static Set<String> cy(Context paramContext)
  {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/model/e.class
