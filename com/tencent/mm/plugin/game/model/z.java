  ...
  extends i<y>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(y.gLR, "GamePBCache") };
    GMTrace.o(12606534320128L, 93926);
  }
  
  public z(e parame)
  {
    super(parame, y.gLR, "GamePBCache", null);
  ...
  public final byte[] zd(String paramString)
  {
    ...
    if (!v.bMQ().equals(ab.getContext().getSharedPreferences("game_center_pref", 0).getString("game_center_pref_lang", v.bMQ())))
    {
      GMTrace.o(12606131666944L, 93923);
      return null;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/game/model/z.class
