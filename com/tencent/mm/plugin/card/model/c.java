  ...
  extends i<CardInfo>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(CardInfo.gLR, "UserCardInfo"), "CREATE INDEX IF NOT EXISTS  stickyIndexIndex ON UserCardInfo ( stickyIndex ) " };
    GMTrace.o(4906597482496L, 36557);
  }
  
  public c(e parame)
  {
    super(parame, CardInfo.gLR, "UserCardInfo", null);
  ...
  /* Error */
  public final java.util.List<CardInfo> ajr()
  {
    // Byte code:
    //   0: ldc2_w 59
    //   3: ldc 61
    ...
    //   8: aload_0
    //   9: getfield 54	com/tencent/mm/plugin/card/model/c:gMB	Lcom/tencent/mm/sdk/e/e;
    //   12: ldc 63
    //   14: iconst_1
  ...
  public final Cursor lv(int paramInt)
  {
    ...
    this.gMB.eL("UserCardInfo", (String)localObject);
    localObject = new StringBuilder("select * from UserCardInfo");
    switch (1.koA[(paramInt - 1)])
    {
    }
    for (;;)
    {
      ...
      localObject = this.gMB.rawQuery(((StringBuilder)localObject).toString(), null);
  ...
  public final CardInfo tB(String paramString)
  {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/card/model/c.class
