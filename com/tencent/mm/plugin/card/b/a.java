...
{
  public static List<WeakReference<a>> kmu;
  ...
  public static void a(a parama)
  {
    ...
    kmu.add(new WeakReference(parama));
    GMTrace.o(5044573306880L, 37585);
  }
  ...
  public static void b(a parama)
  {
    ...
    while (i < kmu.size())
    {
      WeakReference localWeakReference = (WeakReference)kmu.get(i);
      if (localWeakReference != null)
      {
        a locala = (a)localWeakReference.get();
        if ((locala != null) && (locala.equals(parama)))
        {
          kmu.remove(localWeakReference);
          GMTrace.o(5044707524608L, 37586);
          return;
        }
      }
  ...
  public static void f(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    Object localObject = aa.QW(paramString1);
    File localFile = new File(m.kph);
    if (!localFile.mkdirs()) {
    ...
    for (final String str = localFile.getAbsolutePath() + (String)localObject + str;; str = localFile.getAbsolutePath() + File.separator + (String)localObject + str)
    {
      ...
      paramInt1 = i;
      while (paramInt1 < kmu.size())
      {
        paramString2 = (WeakReference)kmu.get(paramInt1);
        if (paramString2 != null)
        {
          paramString2 = (a)paramString2.get();
          if (paramString2 != null) {
            paramString2.bA(paramString1, str);
          }
        }
        paramInt1 += 1;
      }
    ...
    ((h)localObject).hsO = new h.a()
    {
      public final int a(String paramAnonymousString, int paramAnonymousInt, keep_ProgressInfo paramAnonymouskeep_ProgressInfo, keep_SceneResult paramAnonymouskeep_SceneResult, boolean paramAnonymousBoolean)
      {
        ...
        if (paramAnonymousInt != 0)
        {
          ...
          paramAnonymousInt = 0;
          while (paramAnonymousInt < a.kmu.size())
          {
            paramAnonymousString = (WeakReference)a.kmu.get(paramAnonymousInt);
            if (paramAnonymousString != null)
            {
              paramAnonymousString = (a.a)paramAnonymousString.get();
              if (paramAnonymousString != null) {
                paramAnonymousString.fail(this.hTT);
              }
            }
            paramAnonymousInt += 1;
          }
        ...
        for (paramAnonymousInt = paramAnonymouskeep_ProgressInfo.field_finishedLength * 100 / paramAnonymouskeep_ProgressInfo.field_toltalLength;; paramAnonymousInt = 0)
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              if (i < a.kmu.size())
              {
                paramAnonymousString = (WeakReference)a.kmu.get(i);
                if (paramAnonymousString != null)
                {
                  paramAnonymousString = (a.a)paramAnonymousString.get();
                  if (paramAnonymousString != null) {
                    paramAnonymousString.aI(this.hTT, paramAnonymousInt);
                  }
                }
                i += 1;
                continue;
            ...
            if (paramAnonymouskeep_SceneResult != null)
            {
              ...
              while (paramAnonymousInt < a.kmu.size())
              {
                ...
                if (paramAnonymousString != null)
                {
                  paramAnonymousString = (a.a)paramAnonymousString.get();
                  if (paramAnonymousString != null) {
                    paramAnonymousString.bA(this.hTT, str);
                  }
                }
                paramAnonymousInt += 1;
              }
    ...
    ((h)localObject).fRd = false;
    ((h)localObject).field_mediaId = d.a("cardgiftfile", bg.Pp(), paramString1, paramString1);
    ((h)localObject).field_fullpath = str;
    ((h)localObject).field_totalLen = paramInt1;
    ((h)localObject).field_fileType = b.hry;
    ((h)localObject).field_fileId = paramString1;
    ((h)localObject).field_aesKey = paramString2;
    ((h)localObject).field_priority = b.hrv;
    ((h)localObject).field_needStorage = true;
    boolean bool = g.Gi().b((h)localObject, -1);
    w.i("MicroMsg.CDNDownloadHelpper", "add download cdn task : %b, fileId : %s", new Object[] { Boolean.valueOf(bool), ((h)localObject).field_fileId });
    if (!bool)
    {
      paramInt1 = j;
      while (paramInt1 < kmu.size())
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/card/b/a.class
