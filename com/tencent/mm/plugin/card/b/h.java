...
public final class h
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramInt == 26)
        {
          ...
          localJSONStringer.value(locale.knp);
          if (paramInt != 26) {
            break label367;
          }
  ...
  public static ArrayList<jg> aJ(String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i < paramString.length())
        {
          ...
          {
            str = "cardId";
            localjg.knp = localJSONObject.optString(str);
            if (paramInt == 26)
            {
              str = "cardExt";
              localjg.fMw = localJSONObject.optString(str);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/card/b/h.class
