  ...
  extends i<ShareCardInfo>
{
  ...
  static
  {
    ...
    gMz = new String[] { i.a(ShareCardInfo.gLR, "ShareCardInfo") };
    GMTrace.o(5068866715648L, 37766);
  }
  
  public k(e parame)
  {
    super(parame, ShareCardInfo.gLR, "ShareCardInfo", null);
    GMTrace.i(5067658756096L, 37757);
    this.gMB = parame;
    GMTrace.o(5067658756096L, 37757);
  }
  
  public static String lz(int paramInt)
  {
    GMTrace.i(5067524538368L, 37756);
    Object localObject = new StringBuilder();
    ArrayList localArrayList = b.lw(paramInt);
  ...
  public final String bz(String paramString1, String paramString2)
  {
    ...
    Cursor localCursor = this.gMB.a(paramString2, null, 2);
    if (localCursor == null)
    {
  ...
  public final boolean lA(int paramInt)
  {
    ...
    boolean bool = this.gMB.eL("ShareCardInfo", (String)localObject);
  ...
  public final ArrayList<String> tN(String paramString)
  {
  ...
  public final String tP(String paramString)
  {
    ...
    localObject = this.gMB.a(paramString, null, 2);
    if (localObject == null)
    {
  ...
  public final void tQ(String paramString)
  {
    ...
    this.gMB.eL("ShareCardInfo", paramString);
    GMTrace.o(5068598280192L, 37764);
  }
  
  public final ShareCardInfo tR(String paramString)
  {
  ...
  public final boolean z(String paramString, int paramInt1, int paramInt2)
  {
    ...
    boolean bool = this.gMB.eL("ShareCardInfo", paramString);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/card/sharecard/model/k.class
