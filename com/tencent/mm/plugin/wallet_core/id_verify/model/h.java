  ...
  extends com.tencent.mm.wallet_core.f.a.h
{
  public h(String paramString1, String paramString2, String paramString3, Profession paramProfession)
  {
    ...
    {
      w.d("MicroMsg.NetSceneTenpaySetUserExInfo", "name: %s, type: %s", new Object[] { paramProfession.rMg, Integer.valueOf(paramProfession.rMh) });
      localHashMap.put("profession_name", paramProfession.rMg);
      localHashMap.put("profession_type", String.valueOf(paramProfession.rMh));
    }
    x(localHashMap);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wallet_core/id_verify/model/h.class
