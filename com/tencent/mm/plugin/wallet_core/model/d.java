...
public class d
{
  ...
  public Bankcard N(JSONObject paramJSONObject)
  {
    ...
    try
    {
      ...
      ((Bankcard)localObject).rMY = paramJSONObject.optString("h_bind_serialno");
      if (2 != paramJSONObject.optInt("bankacc_type", 2)) {
        break label746;
      }
      i = 1;
      if (i != 0) {
        ((Bankcard)localObject).field_cardType |= Bankcard.rMP;
      }
      ...
      if (bg.mZ(((Bankcard)localObject).field_bankcardTail)) {
        ((Bankcard)localObject).field_bankcardTail = paramJSONObject.optString("card_tail");
      }
      ((Bankcard)localObject).rMW = paramJSONObject.optString("card_mask");
      ...
      if (bg.mZ(((Bankcard)localObject).field_forbidWord)) {
        break label756;
      }
    ...
    if (((Bankcard)localObject).field_bankcardTag == 2)
    {
      i = j;
      if (i != 0) {
        ((Bankcard)localObject).field_cardType |= Bankcard.rMO;
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wallet_core/model/d.class
