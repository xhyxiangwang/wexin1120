  ...
  extends b
{
  ...
  public final b a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    this.rKJ = paramBundle.getString("key_relation_key");
    this.lYL = paramBundle.getString("key_pwd1");
    ...
    paramMMActivity = new d(paramMMActivity, paramf)
    {
      public final boolean d(int paramAnonymousInt1, int paramAnonymousInt2, String paramAnonymousString, k paramAnonymousk)
      {
        ...
        if ((paramAnonymousInt1 == 0) && (paramAnonymousInt2 == 0))
        {
          if ((paramAnonymousk instanceof p))
          {
            ...
            paramAnonymousString = (p)paramAnonymousk;
            paramAnonymousk = j.this.lRQ;
            paramAnonymousk.putString("key_jsapi_token", paramAnonymousString.rKT);
            j.this.b(paramMMActivity, paramAnonymousk);
            GMTrace.o(7004689006592L, 52189);
            return true;
          }
          if ((paramAnonymousk instanceof com.tencent.mm.plugin.wallet_core.b.j))
          {
            GMTrace.o(7004689006592L, 52189);
            return true;
          }
      ...
      public final boolean j(Object... paramAnonymousVarArgs)
      {
        ...
        if (paramAnonymousVarArgs.length == 2)
        {
          ...
          paramAnonymousVarArgs = new p(paramAnonymousVarArgs, j.this.rKJ);
      ...
      public final boolean q(Object... paramAnonymousVarArgs)
      {
        ...
        paramAnonymousVarArgs = new com.tencent.mm.plugin.wallet_core.b.j(j.this.lYL, j.this.token, (byte)0);
        paramf.a(paramAnonymousVarArgs, true, 1);
      ...
      public final CharSequence rQ(int paramAnonymousInt)
      {
        ...
        String str = String.format(paramMMActivity.getResources().getString(R.l.eZI), new Object[] { j.this.lRQ.getString("key_mobile") });
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wallet_core/ui/j.class
