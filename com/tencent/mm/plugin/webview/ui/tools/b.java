...
public final class b
{
  ...
  private String a(String paramString, SslError paramSslError)
  {
    ...
    try
    {
      ...
      if (paramSslError == null)
      {
        ...
        localStringBuilder.append(Base64.encodeToString(this.sps.format(new Date()).getBytes(), 0));
        localStringBuilder.append("</clienttime>");
        localStringBuilder.append("<currenturl>");
        if (!bg.mZ(paramString)) {
          localStringBuilder.append(bg.RD(paramString));
        }
        localStringBuilder.append("</currenturl>");
        if (paramSslError != null) {
          break label352;
  ...
  public final void a(final String paramString, com.tencent.xweb.g paramg, SslError paramSslError)
  {
    ...
    try
    {
      ...
      localObject = (Boolean)this.spr.get(paramString);
      if (localObject == null) {
        break label214;
      }
    ...
    return;
    label214:
    Object localObject = (List)this.spq.get(paramString);
    if ((localObject == null) || (((List)localObject).size() == 0))
    {
      ...
      com.tencent.mm.plugin.report.service.g.paX.z(11098, paramSslError);
      paramSslError = new ArrayList();
      paramSslError.add(paramg);
      this.spq.put(paramString, paramSslError);
      h.a(this.context, false, this.context.getString(R.l.fch, new Object[] { localURL.getHost() }), this.context.getString(R.l.fci), this.context.getString(R.l.duT), this.context.getString(R.l.dut), new DialogInterface.OnClickListener()new DialogInterface.OnClickListener
      {
        public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          GMTrace.i(12265487073280L, 91385);
          paramAnonymousDialogInterface = (List)b.this.spq.get(paramString);
          ...
          b.this.spr.put(paramString, Boolean.valueOf(true));
      ...
      }, new DialogInterface.OnClickListener()
      {
        public final void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          ...
          b.this.spr.put(paramString, Boolean.valueOf(false));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/webview/ui/tools/b.class
