  ...
  extends i
{
  ...
  private View b(int paramInt, View paramView, ViewGroup.LayoutParams paramLayoutParams)
  {
    ...
    if (aNT())
    {
      ...
      ((Window)localObject1).setWindowAnimations(R.m.fdp);
      ...
      localObject2 = (ViewGroup)LayoutInflater.from(this.mContext).inflate(R.i.cWJ, null);
      ...
      paramView = (FrameLayout)((ViewGroup)localObject2).findViewById(R.h.ccc);
      label148:
    ...
    for (;;)
    {
      ...
      ((Window)localObject1).setWindowAnimations(R.m.fde);
      break;
      label219:
      paramView = (FrameLayout)((ViewGroup)localObject2).findViewById(R.h.ccb);
      break label148;
      label234:
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/webview/ui/tools/game/menu/e.class
