...
public final class a
{
  ...
  public static Intent a(MMActivity paramMMActivity, Intent paramIntent, String paramString)
  {
    ...
    paramString.putExtra("title", paramMMActivity.getString(R.l.dKv));
  ...
  public static boolean a(MMActivity paramMMActivity, int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (2 == paramInt1)
    {
      ...
      if ((-1 == paramInt2) && (paramIntent != null))
      {
        ...
        u.bGo();
        paramIntent = (q)u.t(0, null);
        if (!paramIntent.No(str)) {
          break label217;
        }
        if (!paramIntent.dI(paramMMActivity)) {
          break label147;
        }
        q.aN(paramMMActivity, localBundle.getString("targeturl"));
        if (!bool) {
          break label187;
        }
        g.paX.i(10998, new Object[] { Integer.valueOf(4), Integer.valueOf(2) });
      }
      for (;;)
      {
        ...
        break;
        label187:
        g.paX.i(10998, new Object[] { Integer.valueOf(4), Integer.valueOf(1) });
        continue;
        label217:
        paramIntent = new Intent((Intent)localBundle.getParcelable("targetintent"));
        paramIntent.setPackage(str);
        paramIntent.addFlags(524288);
        paramMMActivity.startActivity(paramIntent);
        g.paX.i(10998, new Object[] { Integer.valueOf(5) });
        if (bool) {
          g.paX.i(10998, new Object[] { Integer.valueOf(5), Integer.valueOf(2) });
        } else {
          g.paX.i(10998, new Object[] { Integer.valueOf(5), Integer.valueOf(1) });
        }
      }
    }
    GMTrace.o(16316312322048L, 121566);
  ...
  public static void d(MMActivity paramMMActivity, String paramString)
  {
    ...
    if ((paramMMActivity == null) || (paramMMActivity.isFinishing()) || (bg.mZ(paramString)))
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/webview/modeltools/a.class
