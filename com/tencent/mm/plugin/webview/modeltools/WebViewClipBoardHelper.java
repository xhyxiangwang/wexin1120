  ...
  implements ClipboardManager.OnPrimaryClipChangedListener
{
  ...
  private WebViewUI soa;
  public ClipboardManager sob;
  
  public WebViewClipBoardHelper(WebViewUI paramWebViewUI)
  {
    GMTrace.i(19111664943104L, 142393);
    this.lastReportTime = 0L;
    this.soa = paramWebViewUI;
    this.sob = ((ClipboardManager)this.soa.getSystemService("clipboard"));
    this.sob.addPrimaryClipChangedListener(this);
  ...
  public final void onPrimaryClipChanged()
  {
    ...
    Object localObject = this.sob.getPrimaryClip();
    if (localObject == null)
    {
      GMTrace.o(19111799160832L, 142394);
      return;
    ...
    localClipBoardDataWrapper.url = this.soa.aDp();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/webview/modeltools/WebViewClipBoardHelper.class
