...
public final class m
{
  public static k a(k paramk, long paramLong)
  {
    ...
    w.d("MicroMsg.IPCallRecordStorageLogic", "recordSelfShutdownCall, localId: %d, talkTime: %d", new Object[] { Long.valueOf(paramk.uQF), Long.valueOf(paramLong) });
    if (paramk.uQF != -1L)
    {
  ...
  public static ArrayList<k> aHV()
  {
    GMTrace.i(11580305571840L, 86280);
    long l2 = System.currentTimeMillis();
    Object localObject1 = i.aHs();
    Object localObject2 = Calendar.getInstance();
    ((Calendar)localObject2).add(6, -30);
    long l1 = ((Calendar)localObject2).getTimeInMillis();
    localObject1 = ((l)localObject1).gMB.query("IPCallRecord", l.naz, "calltime>=?", new String[] { String.valueOf(l1) }, "addressId, phonenumber", null, "calltime desc");
    if (((Cursor)localObject1).getCount() < 30)
    {
      ((Cursor)localObject1).close();
      localObject1 = i.aHs().gMB.query("IPCallRecord", l.naz, null, null, "addressId, phonenumber", null, "calltime desc");
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception localException)
        {
          ...
          localObject4 = i.aHr().zG((String)localObject4);
          if (localObject4 == null) {
            break label602;
          }
          localObject5 = i.aHs();
          if ((((l)localObject5).gMB instanceof g))
          {
            l1 = ((g)((l)localObject5).gMB).cA(-1L);
            localObject5 = i.aHs().zJ(localk1.field_phonenumber);
            ...
            localk2.field_addressId = ((c)localObject4).uQF;
            i.aHs().a(localk2);
        ...
        continue;
        label502:
        Object localObject4 = i.aHs();
        if (((((l)localObject4).gMB instanceof g)) && (l1 != -1L)) {
          ((g)((l)localObject4).gMB).aJ(l1);
        }
  ...
  public static k b(k paramk)
  {
    ...
    w.d("MicroMsg.IPCallRecordStorageLogic", "recordCancelCall, localId: %d", new Object[] { Long.valueOf(paramk.uQF) });
    if (paramk.uQF != -1L)
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/ipcall/a/g/m.class
