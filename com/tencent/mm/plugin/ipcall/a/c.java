...
{
  private static c mVZ;
  public boolean isInit;
  private ArrayList<Integer> mWa;
  ArrayList<Integer> mWb;
  ...
  private void aGY()
  {
    ...
    this.mWa.clear();
    Object localObject = g.uz().getValue("WeChatOutTopCountryCode");
    ...
    if (!bg.mZ((String)localObject))
    {
      ...
      try
      {
        ...
        while (i < k)
        {
          ...
          this.mWa.add(localInteger);
          i.aHt().v(localInteger.intValue(), j);
          j -= 1;
          i += 1;
        }
  ...
  private void zC(String paramString)
  {
    ...
    try
    {
      ...
      while (i < paramString.length())
      {
        ...
        this.mWb.add(Integer.valueOf(j));
        i += 1;
      }
      GMTrace.o(11610236125184L, 86503);
      return;
  ...
  public final void aGZ()
  {
    ...
    localObject1 = ((j)localObject1).gMB.a("SELECT IPCallPopularCountry.countryCode,IPCallPopularCountry.callTimeCount,IPCallPopularCountry.lastCallTime FROM IPCallPopularCountry  " + ((StringBuilder)localObject2).toString(), null, 2);
  ...
  public final List<Integer> aHa()
  {
    GMTrace.i(11610638778368L, 86506);
    if (!this.isInit) {
      fh(false);
    }
    ArrayList localArrayList = this.mWa;
  ...
  public final void fh(boolean paramBoolean)
  {
    ...
    //   32: return
    //   33: aload_0
    //   34: invokevirtual 244	com/tencent/mm/plugin/ipcall/a/c:aGZ	()V
    //   37: new 177	java/lang/StringBuilder
    //   40: dup
    //   41: invokespecial 178	java/lang/StringBuilder:<init>	()V
    //   44: getstatic 250	com/tencent/mm/compatible/util/e:gZP	Ljava/lang/String;
    ...
    //   96: aload 5
    //   98: aastore
    //   99: invokestatic 79	com/tencent/mm/sdk/platformtools/w:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   102: aload_3
    //   103: astore_2
    //   104: aload_0
    //   105: iconst_1
    ...
    //   200: aload_2
    //   201: aastore
    //   202: invokestatic 79	com/tencent/mm/sdk/platformtools/w:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   205: aload_0
    //   206: aload_2
    //   207: invokespecial 286	com/tencent/mm/plugin/ipcall/a/c:zC	(Ljava/lang/String;)V
    //   210: aload_0
    //   211: iconst_1
    ...
    //   247: invokestatic 168	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   250: aload_3
    //   251: astore_2
    //   252: ldc 71
    //   254: ldc_w 288
    ...
    //   262: iconst_0
    //   263: aload 4
    //   265: invokevirtual 171	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   268: aastore
    //   269: invokestatic 135	com/tencent/mm/sdk/platformtools/w:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   272: aload_3
  ...
  public final boolean pa(int paramInt)
  {
    GMTrace.i(11610772996096L, 86507);
    if (!this.isInit) {
      fh(false);
    }
    if ((this.mWb == null) || (this.mWb.size() <= 0))
    {
      GMTrace.o(11610772996096L, 86507);
      return false;
    }
    boolean bool = this.mWb.contains(Integer.valueOf(paramInt));
    GMTrace.o(11610772996096L, 86507);
    return bool;
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/ipcall/a/c.class
