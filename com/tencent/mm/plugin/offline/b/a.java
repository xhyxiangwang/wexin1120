  ...
  extends i<q>
{
  ...
  public a(e parame)
  {
    super(parame, q.gLR, "OfflineOrderStatus", null);
    GMTrace.i(15376251355136L, 114562);
    this.gMB = parame;
    GMTrace.o(15376251355136L, 114562);
  }
  
  public final q Dq(String paramString)
  {
    Object localObject = null;
    GMTrace.i(15376519790592L, 114564);
    Cursor localCursor = this.gMB.a("select * from OfflineOrderStatus where reqkey=?", new String[] { paramString }, 2);
    if (localCursor == null)
    {
  ...
  public final q aTN()
  {
    ...
    w.i("MicroMsg.OfflineOrderStatusStorage", "in getLastestOrder: orders count: %d, latest 3 orders: %s", new Object[] { Integer.valueOf(aTP()), aTO() });
    Cursor localCursor = this.gMB.a("SELECT * FROM OfflineOrderStatus WHERE status!=-1 ORDER BY rowid DESC LIMIT 1", null, 2);
    if (localCursor == null)
    {
  ...
  public final String aTO()
  {
    ...
    Cursor localCursor = this.gMB.a(str, null, 2);
    str = "";
    if (localCursor == null)
    {
  ...
  public final void b(q paramq)
  {
    ...
    Cursor localCursor = this.gMB.a("select * from OfflineOrderStatus where reqkey=?", new String[] { paramq.field_reqkey }, 2);
    int i;
    if (localCursor == null)
    {
      i = 0;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/offline/b/a.class
