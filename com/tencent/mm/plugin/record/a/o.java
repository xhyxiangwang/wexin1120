  ...
  implements i
{
  ...
  public o(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    ap.AS();
    paramString1 = new File(c.zj() + "web/");
  ...
  public final String Pg()
  {
    ...
    ap.AS();
    localObject = c.zj() + "web/" + g.n(this.url.getBytes());
  ...
  public final Bitmap a(Bitmap paramBitmap, i.a parama, String paramString)
  {
    ...
    //   8: aload_1
    //   9: astore_3
    //   10: getstatic 167	com/tencent/mm/platformtools/i$a:iaZ	Lcom/tencent/mm/platformtools/i$a;
    //   13: aload_2
    ...
    //   33: aastore
    //   34: invokestatic 177	com/tencent/mm/sdk/platformtools/w:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   37: aload_1
    //   38: astore_2
    //   39: aload_1
    //   40: astore_3
    ...
    //   70: iconst_1
    //   71: invokestatic 182	com/tencent/mm/sdk/platformtools/d:a	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   74: astore_2
    //   75: aload_2
    //   76: astore_3
    ...
    //   80: dup
    //   81: aload_0
    //   82: invokevirtual 184	com/tencent/mm/plugin/record/a/o:Pg	()Ljava/lang/String;
    //   85: invokespecial 63	java/io/File:<init>	(Ljava/lang/String;)V
    //   88: astore_1
    //   89: aload_2
    //   90: astore_3
    //   91: aload_1
    //   92: invokevirtual 187	java/io/File:createNewFile	()Z
    //   95: pop
    //   96: new 189	java/io/FileOutputStream
    //   99: dup
    //   100: aload_1
    //   101: invokespecial 192	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   104: astore_1
    //   105: aload_1
    //   106: astore_3
    //   107: aload_2
    //   108: getstatic 198	android/graphics/Bitmap$CompressFormat:JPEG	Landroid/graphics/Bitmap$CompressFormat;
    //   111: bipush 100
    //   113: aload_1
    //   114: invokevirtual 204	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   117: pop
    //   118: aload_1
    //   119: astore_3
    //   120: aload_1
    //   121: invokevirtual 207	java/io/FileOutputStream:flush	()V
    //   124: aload_2
    //   125: astore_3
    //   126: aload_1
    //   127: invokevirtual 210	java/io/FileOutputStream:close	()V
    //   130: aload_2
    //   131: astore_3
    //   132: ldc2_w 159
    //   135: ldc -95
    ...
    //   158: invokestatic 216	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   161: aload_2
    //   162: astore_3
    //   163: aload_1
    //   164: ifnull -32 -> 132
    ...
    //   168: astore_3
    //   169: aload_1
    //   170: invokevirtual 210	java/io/FileOutputStream:close	()V
    //   173: aload_2
    //   174: astore_3
    //   175: goto -43 -> 132
    //   178: astore_1
    ...
    //   188: invokestatic 216	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   191: goto -59 -> 132
    //   194: astore_1
    //   195: aconst_null
    //   196: astore 4
    ...
    //   204: astore_3
    //   205: aload 4
    //   207: invokevirtual 210	java/io/FileOutputStream:close	()V
    //   210: aload_2
    //   211: astore_3
    //   212: aload_1
    //   213: athrow
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/record/a/o.class
