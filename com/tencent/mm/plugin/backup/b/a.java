  ...
  implements b.a
{
  ...
  public final void Q(byte[] paramArrayOfByte)
  {
    ...
    if (!Arrays.equals(jLo, (byte[])localObject))
    {
    ...
    b.kv(bg.bq((byte[])localObject));
    paramArrayOfByte = jLo;
    int m = b.adJ();
    if (s1 != 1)
    {
    ...
    for (paramArrayOfByte = "";; paramArrayOfByte = new String(localPByteArray.value))
    {
      ...
      for (paramArrayOfByte = (byte[])localObject;; paramArrayOfByte = k.a((byte[])localObject, com.tencent.mm.plugin.backup.a.e.adK()))
      {
    ...
    if (this.jLs != null)
    {
      this.jLs.a(j, s2, localPByteArray.value);
      GMTrace.o(16048950607872L, 119574);
      return;
    }
  ...
  public final boolean a(PString paramPString, PInt paramPInt)
  {
    ...
    com.tencent.mm.lan_cs.Server.gUA = new Server.a()
    {
      ...
      public final void onConnect(String paramAnonymousString, int paramAnonymousInt)
      {
        ...
        a.this.jLp = paramAnonymousString;
        a.this.jLq = paramAnonymousInt;
  ...
  public final void connect(String paramString, int paramInt)
  {
    ...
    this.mode = 2;
    this.jLp = paramString;
    this.jLq = paramInt;
    com.tencent.mm.lan_cs.Client.gUz = new Client.a()
    {
      public final void onRecv(String paramAnonymousString, int paramAnonymousInt, byte[] paramAnonymousArrayOfByte)
      {
  ...
  public final void i(final int paramInt, final byte[] paramArrayOfByte)
  {
    ...
    final long l = bg.Pp();
    w.v("MicroMsg.BackupCEngine", "send seq:%d buff:%d", new Object[] { Integer.valueOf(paramInt), Integer.valueOf(bg.bq(paramArrayOfByte)) });
    if ((this.jLr == null) || (!this.jLr.getLooper().getThread().isAlive()))
    {
      HandlerThread localHandlerThread = com.tencent.mm.sdk.f.e.Sc("BackupCEngine_sendHandler");
      localHandlerThread.setPriority(10);
      localHandlerThread.start();
      this.jLr = new ae(localHandlerThread.getLooper());
      w.w("MicroMsg.BackupCEngine", "BackupCEngine new writerHandler:%d", new Object[] { Long.valueOf(localHandlerThread.getId()) });
    }
    this.jLr.post(new Runnable()
    {
      public final void run()
      {
        GMTrace.i(9466107920384L, 70528);
        long l = bg.Pp();
        w.i("MicroMsg.BackupCEngine", "before send server mode:%d  seq:%d  buff:%d time:[%d]", new Object[] { Integer.valueOf(a.this.mode), Integer.valueOf(paramInt), Integer.valueOf(bg.bq(paramArrayOfByte)), Long.valueOf(l - l) });
        if (a.this.mode == 0)
        {
        ...
        if (a.this.mode == 1)
        {
          int j = Server.Java2C.send(a.this.jLp, a.this.jLq, paramArrayOfByte);
          i = j;
          if (j == 0) {}
        }
        for (;;)
        {
          b.kv(bg.bq(paramArrayOfByte));
          w.i("MicroMsg.BackupCEngine", "send result[%d], seq[%d], buff[%d], time[%d,%d]", new Object[] { Integer.valueOf(i), Integer.valueOf(paramInt), Integer.valueOf(bg.bq(paramArrayOfByte)), Long.valueOf(bg.aF(l)), Long.valueOf(bg.aF(l)) });
          GMTrace.o(9466107920384L, 70528);
          return;
          if (a.this.mode == 2) {
            i = Client.Java2C.send(a.this.jLp, a.this.jLq, paramArrayOfByte);
          }
        }
      }
    });
  ...
  public final int j(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    int i = 0;
    if (this.mode == 1) {
      i = Server.Java2C.send(this.jLp, this.jLq, paramArrayOfByte);
    }
    for (;;)
    {
      w.i("MicroMsg.BackupCEngine", "send result:%d seq:%d  buff:%d time[%d]", new Object[] { Integer.valueOf(i), Integer.valueOf(paramInt), Integer.valueOf(bg.bq(paramArrayOfByte)), Long.valueOf(bg.aF(l)) });
      GMTrace.o(9478187515904L, 70618);
      return i;
      if (this.mode == 2)
      {
        i = Client.Java2C.send(this.jLp, this.jLq, paramArrayOfByte);
        b.kv(bg.bq(paramArrayOfByte));
      }
    }
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/backup/b/a.class
