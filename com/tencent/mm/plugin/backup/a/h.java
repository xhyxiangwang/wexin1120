...
{
  private static List<String> jLn;
  ...
  public static String a(eh parameh, int paramInt)
  {
    GMTrace.i(14724758503424L, 109708);
    parameh = a(parameh, paramInt, null);
    GMTrace.o(14724758503424L, 109708);
    return parameh;
  }
  
  public static String a(eh parameh, int paramInt, String paramString)
  {
    GMTrace.i(14724892721152L, 109709);
    if ((parameh.tyv == paramInt) && (parameh.tyt != null))
    {
      parameh = g.n(parameh.tyt.ush.toK);
      GMTrace.o(14724892721152L, 109709);
      return parameh;
    }
    if (parameh.tys != null)
    {
      Iterator localIterator = parameh.tys.iterator();
      int i = 0;
      while (localIterator.hasNext()) {
        if (((axu)localIterator.next()).usl == paramInt)
        {
          String str = ((axt)parameh.tyr.get(i)).usj;
          if ((!bg.mZ(paramString)) && (!str.endsWith(paramString)))
          {
            i += 1;
          }
          else
  ...
  public static void a(String paramString, x paramx)
  {
    ...
    //   60: aload_1
    //   61: getfield 196	com/tencent/mm/plugin/backup/h/x:jXS	Ljava/lang/String;
    ...
    //   118: aload_0
    //   119: aload_1
    //   120: getfield 209	com/tencent/mm/plugin/backup/h/x:jXU	I
    //   123: i2l
    //   124: invokevirtual 213	java/io/RandomAccessFile:setLength	(J)V
    //   127: aload_0
    //   128: aload_1
    //   129: getfield 216	com/tencent/mm/plugin/backup/h/x:jXV	I
    //   132: i2l
    //   133: invokevirtual 219	java/io/RandomAccessFile:seek	(J)V
    //   136: aload_0
    //   137: aload_1
    //   138: getfield 222	com/tencent/mm/plugin/backup/h/x:jWD	Lcom/tencent/mm/bl/b;
    //   141: getfield 91	com/tencent/mm/bl/b:toK	[B
  ...
  public static int aB(String paramString, int paramInt)
  {
  ...
  public static m aP(long paramLong)
  {
    ...
    localm.jWZ = str1;
    localm.jXa = Build.MANUFACTURER;
    localm.jXb = Build.MODEL;
    localm.jXc = "Android";
    localm.jXd = Build.VERSION.RELEASE;
    localm.jXe = com.tencent.mm.protocal.d.toX;
    localm.jXf = paramLong;
    w.i("MicroMsg.BackupUtil", "getBackupStartGeneralInfo WechatVersion[%s], freespace[%d], deviceId[%s]", new Object[] { Integer.valueOf(com.tencent.mm.protocal.d.toX), Long.valueOf(paramLong), localm.jWZ });
  ...
  public static List<String> adR()
  {
    ...
    jLn = new LinkedList();
    Object localObject1 = o.heX;
    int j = localObject1.length;
    int i = 0;
    while (i < j)
    {
      Object localObject2 = localObject1[i];
      jLn.add(localObject2);
      i += 1;
    }
    jLn.add("weixin");
    jLn.add("weibo");
    ...
    jLn.add("feedsapp");
    jLn.add("voipapp");
    jLn.add("officialaccounts");
    jLn.add("helper_entry");
    jLn.add("pc_share");
    jLn.add("cardpackage");
    jLn.add("voicevoipapp");
    jLn.add("voiceinputapp");
    jLn.add("linkedinplugin");
    jLn.add("appbrandcustomerservicemsg");
    localObject1 = jLn;
    GMTrace.o(14725966462976L, 109717);
    return (List<String>)localObject1;
  }
  ...
  public static void b(String paramString, x paramx)
  {
    ...
    Object localObject;
    if ((TextUtils.isEmpty(paramx.jXS)) || (paramx.jWD == null) || (bg.bq(paramx.jWD.toK) <= 0))
    {
      localObject = paramx.jXS;
      b localb = paramx.jWD;
      if (paramx.jWD == null) {}
      for (paramString = "null";; paramString = Integer.valueOf(bg.bq(paramx.jWD.toK)))
      {
    ...
    if (i > 0)
    {
      l3 = sI(paramString + paramx.jXS);
      localObject = new File(paramString + paramx.jXS);
      if (((File)localObject).exists())
      {
        l1 = ((File)localObject).length();
        i = e.a(paramString, paramx.jXS, paramx.jWD.toK);
        localObject = new File(paramString + paramx.jXS);
        if (!((File)localObject).exists()) {
          break label479;
        }
        ...
        w.e("MicroMsg.BackupUtil", "append failed and try again:%s", new Object[] { paramString + paramx.jXS });
        i = e.a(paramString, paramx.jXS, paramx.jWD.toK) * 10000;
      }
    }
    label479:
    label556:
    for (;;)
    {
      l1 = sI(paramString + paramx.jXS);
      if ((i == 0) && (l1 >= paramx.jWD.toK.length))
      {
        w.d("MicroMsg.BackupUtil", "appendFile retry:%d append:%d  old:%d  new:%d  data:%d", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Long.valueOf(l3), Long.valueOf(l1), Integer.valueOf(paramx.jWD.toK.length) });
        GMTrace.o(14723550543872L, 109699);
        return;
        l1 = 0L;
        break label237;
      ...
      w.e("MicroMsg.BackupUtil", "appendFile retry:%d append:%d  old:%d  new:%d  data:%d", new Object[] { Integer.valueOf(j), Integer.valueOf(i), Long.valueOf(l3), Long.valueOf(l1), Integer.valueOf(paramx.jWD.toK.length) });
      i = j;
      break;
      GMTrace.o(14723550543872L, 109699);
      return;
  ...
  public static boolean b(eh parameh, int paramInt, String paramString)
  {
    GMTrace.i(14725429592064L, 109713);
    if (parameh.tyv == paramInt)
    {
      parameh = parameh.tyt.ush.toK;
      if (parameh.length <= 0)
      {
        GMTrace.o(14725429592064L, 109713);
        return false;
      }
      e.b(paramString, parameh, parameh.length);
      GMTrace.o(14725429592064L, 109713);
      return true;
    }
    parameh = a(parameh, paramInt, null);
    if (!bg.mZ(parameh))
    {
      j.r(sM(parameh), paramString, false);
      GMTrace.o(14725429592064L, 109713);
      return true;
    }
    GMTrace.o(14725429592064L, 109713);
  ...
  public static byte[] b(eh parameh, int paramInt)
  {
    ...
    if ((parameh.tys != null) && (parameh.tyr != null))
    {
      Iterator localIterator = parameh.tys.iterator();
      int i = 0;
      while (localIterator.hasNext())
      {
        if (((axu)localIterator.next()).usl == paramInt)
        {
          parameh = sM(((axt)parameh.tyr.get(i)).usj);
          paramInt = e.aY(parameh);
  ...
  private static boolean bG(int paramInt1, int paramInt2)
  {
  ...
  public static int c(eh parameh, int paramInt)
  {
    GMTrace.i(14725698027520L, 109715);
    if (parameh.tyv == paramInt)
    {
      paramInt = parameh.tyt.ush.toK.length;
    ...
    if ((parameh.tys != null) && (parameh.tyr != null))
    {
      ...
      while (localIterator.hasNext())
      {
        if (((axu)localIterator.next()).usl == paramInt)
        {
          paramInt = e.aY(sM(((axt)parameh.tyr.get(i)).usj));
          GMTrace.o(14725698027520L, 109715);
          return paramInt;
        }
        i += 1;
  ...
  public static boolean d(eh parameh, int paramInt)
  {
    ...
    parameh = parameh.tys.iterator();
    while (parameh.hasNext()) {
      if (((axu)parameh.next()).usl == paramInt)
      {
        GMTrace.o(14725832245248L, 109716);
        return true;
      }
  ...
  public static long sI(String paramString)
  {
  ...
  public static String sM(String paramString)
  {
    ...
    paramString = adP() + "backupMeida/" + sN(paramString) + paramString;
    GMTrace.o(14725026938880L, 109710);
    return paramString;
  }
  ...
  public static long sO(String paramString)
  {
    ...
    catch (ParseException localParseException)
    {
      for (;;)
      {
        w.e("MicroMsg.BackupUtil", "dateToTimeStamp failed. date:%s, stack:%s", new Object[] { paramString, bg.bOd() });
      }
    }
  ...
  public static LinkedList<String> t(LinkedList<d> paramLinkedList)
  {
    ...
    if (paramLinkedList != null)
    {
      ...
      while (paramLinkedList.hasNext()) {
        localLinkedList.add(((d)paramLinkedList.next()).jKU);
      }
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/backup/a/h.class
