  ...
  implements f
{
  ...
  private static String a(Random paramRandom)
  {
    ...
    paramRandom = g.n((bg.Pq() + paramRandom.nextDouble()).getBytes());
  ...
  public final void a(int paramInt1, int paramInt2, k paramk)
  {
    ...
    this.jTD += paramInt1;
    if (this.jTC == 0L) {}
    for (paramInt1 = 0;; paramInt1 = (int)(this.jTD * 100L / this.jTC))
    {
      if (paramInt1 > this.jTE)
      {
        this.jTE = paramInt1;
        h.setProgress(this.jTE);
      }
    ...
    if (this.jTD > this.jTC) {
      this.jTD = this.jTC;
    }
    if (this.jTD == 0L) {
      this.jTD = 1L;
    }
    paramInt1 = (int)((this.jTJ - this.jTK) * (this.jTC - this.jTD) / this.jTD) / 1000;
    if ((!this.fBD) && (!this.hng) && (this.jTz != null) && (this.jTE >= 0) && (this.jTE <= 100)) {
      this.jTz.b(this.jTD, this.jTC, paramInt1);
    }
    GMTrace.o(14751065178112L, 109904);
  }
  ...
  public final void afx()
  {
    ...
    synchronized (this.lock)
    {
      if (this.jTy.isEmpty())
      {
        com.tencent.mm.plugin.backup.f.b.b(6, this.jTA);
        if (this.jTz != null)
        {
          this.jTz.afy();
          cancel();
  ...
  public final boolean l(String arg1, String paramString2, int paramInt)
  {
    ...
    //   20: lstore 5
    //   22: invokestatic 226	com/tencent/mm/plugin/backup/g/a:afe	()Lcom/tencent/mm/plugin/backup/g/a;
    //   25: invokevirtual 230	com/tencent/mm/plugin/backup/g/a:aff	()Lcom/tencent/mm/plugin/backup/g/c;
    //   28: invokevirtual 236	com/tencent/mm/plugin/backup/g/c:yN	()Lcom/tencent/mm/plugin/messenger/foundation/a/a/c;
    //   31: aload_1
    //   32: invokeinterface 242 2 0
    //   37: astore 12
    //   39: aload_0
    //   40: getfield 79	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTF	I
    //   43: i2l
    //   44: lstore 7
    //   46: aload_0
    ...
    //   55: ladd
    //   56: l2i
    //   57: putfield 79	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTF	I
    ...
    //   112: monitorenter
    //   113: aload_0
    //   114: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    ...
    //   136: aload_0
    //   137: getfield 63	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:fBD	Z
    //   140: ifeq +21 -> 161
    //   143: aload_0
    //   144: getfield 65	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:hng	Z
    //   147: istore 9
    //   149: iload 9
    //   151: ifne +10 -> 161
    //   154: aload_0
    ...
    //   161: aload_0
    //   162: getfield 65	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:hng	Z
    //   165: ifeq +66 -> 231
    //   168: ldc -69
    //   170: ldc_w 259
    ...
    //   273: iconst_0
    //   274: lconst_0
    //   275: invokestatic 279	com/tencent/mm/plugin/backup/e/a$a:a	(Lcom/tencent/mm/storage/au;ZLjava/lang/String;Lcom/tencent/mm/pointers/PLong;Ljava/util/LinkedList;Ljava/util/HashMap;ZZJ)Lcom/tencent/mm/protocal/c/eh;
    //   278: astore 10
    //   280: aload_0
    //   281: aload_0
    //   282: getfield 81	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTG	I
    //   285: i2l
    ...
    //   292: ladd
    //   293: l2i
    //   294: putfield 81	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTG	I
    //   297: iload_3
    //   298: iconst_1
    //   299: isub
    //   300: istore_3
    ...
    //   313: aload_0
    //   314: aload_0
    //   315: getfield 83	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTH	I
    //   318: aload 14
    //   320: invokevirtual 284	java/util/LinkedList:size	()I
    //   323: iadd
    //   324: putfield 83	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTH	I
    //   327: aload 14
    ...
    //   372: aload_0
    //   373: invokespecial 309	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:<init>	(Ljava/lang/String;ILjava/util/LinkedList;Ljava/lang/String;Lcom/tencent/mm/ac/f;)V
    //   376: astore 16
    //   378: aload_0
    //   379: aload_0
    //   380: getfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   383: aload 16
    //   385: getfield 313	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:jRj	Lcom/tencent/mm/plugin/backup/h/x;
    //   388: getfield 318	com/tencent/mm/plugin/backup/h/x:jXU	I
    //   391: i2l
    //   392: ladd
    //   393: putfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   396: aload_0
    ...
    //   404: monitorenter
    //   405: aload 16
    //   407: invokevirtual 321	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:aeV	()Z
    //   410: pop
    //   411: aload_0
    //   412: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    //   415: aload 15
    ...
    //   434: iconst_0
    //   435: aload_0
    //   436: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    ...
    //   547: aload_0
    //   548: getfield 61	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:gNc	Ljava/util/Random;
    ...
    //   564: ldc_w 264
    //   567: aload_0
    //   568: invokespecial 309	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:<init>	(Ljava/lang/String;ILjava/util/LinkedList;Ljava/lang/String;Lcom/tencent/mm/ac/f;)V
    //   571: astore 11
    //   573: aload_0
    //   574: aload_0
    //   575: getfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   578: aload 11
    //   580: getfield 313	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:jRj	Lcom/tencent/mm/plugin/backup/h/x;
    //   583: getfield 318	com/tencent/mm/plugin/backup/h/x:jXU	I
    //   586: i2l
    //   587: ladd
    //   588: putfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   591: aload_0
    ...
    //   597: monitorenter
    //   598: aload 11
    //   600: invokevirtual 321	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:aeV	()Z
    //   603: pop
    //   604: aload_0
    //   605: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    //   608: aload 10
    ...
    //   624: iconst_0
    //   625: aload_0
    //   626: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    ...
    //   682: ifle +108 -> 790
    //   685: aload_0
    //   686: getfield 61	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:gNc	Ljava/util/Random;
    ...
    //   700: ldc_w 264
    //   703: aload_0
    //   704: invokespecial 309	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:<init>	(Ljava/lang/String;ILjava/util/LinkedList;Ljava/lang/String;Lcom/tencent/mm/ac/f;)V
    //   707: astore 10
    //   709: aload_0
    //   710: aload_0
    //   711: getfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   714: aload 10
    //   716: getfield 313	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:jRj	Lcom/tencent/mm/plugin/backup/h/x;
    //   719: getfield 318	com/tencent/mm/plugin/backup/h/x:jXU	I
    //   722: i2l
    //   723: ladd
    //   724: putfield 85	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTI	J
    //   727: aload_0
    ...
    //   733: monitorenter
    //   734: aload 10
    //   736: invokevirtual 321	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/h:aeV	()Z
    //   739: pop
    //   740: aload_0
    //   741: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
    //   744: aload_2
    ...
    //   759: iconst_0
    //   760: aload_0
    //   761: getfield 75	com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b:jTy	Ljava/util/HashSet;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/backup/bakoldlogic/bakoldmovemodel/b.class
