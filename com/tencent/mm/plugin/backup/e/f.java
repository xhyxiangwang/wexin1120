  ...
  implements e
{
  ...
  private static boolean sL(String paramString)
  {
  ...
  public final int a(eh parameh, boolean paramBoolean1, au paramau, String paramString, LinkedList<u> paramLinkedList, HashMap<Long, a.c> paramHashMap, boolean paramBoolean2, long paramLong)
  {
    ...
    for (int i = 0;; i = paramau.field_content.getBytes().length)
    {
      ...
      if (!sL(paramHashMap))
      {
        ...
        if (!sL(paramHashMap))
        {
          paramHashMap = a.a(paramau, parameh);
          paramString = paramHashMap;
      ...
      if ((paramString != null) && (sL(paramString))) {
        break;
      }
    ...
    paramau = a.afe().aff().afm().TQ(paramau.field_imgPath);
    if ((paramau != null) && (paramau.bRW()))
    {
      GMTrace.o(14814952816640L, 110380);
      return i;
    }
    if (paramau != null) {
      ...
      {
        paramString = a.afe().aff().zc();
        paramString = paramString + paramau.GP() + "_thumb";
        if (com.tencent.mm.a.e.aY(paramString) < 0)
        {
          GMTrace.o(14814952816640L, 110380);
          return -1;
        }
        i += b.a(new b.a(paramString, parameh, paramLinkedList, 4, paramBoolean1, "_thumb", paramBoolean2));
      }
    }
    for (;;)
    {
      if (paramau != null) {
        if ((TextUtils.isEmpty(paramau.field_groupId)) && (paramau.bRU()))
        {
          paramString = a.afe().aff().zc();
          paramau = paramString + paramau.GP();
          paramString = aj.Tm(n.a(parameh.tvq));
          i = b.a(new b.a(paramau, parameh, paramLinkedList, paramBoolean1, paramBoolean2, a.afe().aff().afm().TQ(paramString.fwU))) + i;
        }
      }
      label759:
      for (;;)
      {
        ...
        return i;
        paramString = a.afe().aff().zc();
        paramString = paramString + paramau.field_groupId + File.separator + paramau.GP() + "_cover";
        if (com.tencent.mm.a.e.aY(paramString) < 0)
        {
          GMTrace.o(14814952816640L, 110380);
          return -1;
        ...
        i += b.a(new b.a(paramString, parameh, paramLinkedList, 4, paramBoolean1, "_thumb", paramBoolean2));
        break;
        if ((paramau.field_catalog == EmojiInfo.vgk) || (paramau.field_catalog == EmojiInfo.vgn) || (paramau.field_catalog == EmojiInfo.vgm)) {}
        for (boolean bool = true;; bool = new File(paramau.oEW + paramau.field_groupId + File.separator + paramau.GP()).exists())
        {
          if (!bool) {
            break label759;
          }
          paramString = a.afe().aff().zc();
          paramau = paramString + paramau.field_groupId + File.separator + paramau.GP();
          paramString = aj.Tm(n.a(parameh.tvq));
          i = b.a(new b.a(paramau, parameh, paramLinkedList, paramBoolean1, paramBoolean2, a.afe().aff().afm().TQ(paramString.fwU))) + i;
          break;
        }
  ...
  public final int a(String paramString, eh parameh, au paramau)
  {
    ...
    paramString = parameh.tvo.usj;
    Object localObject1 = parameh.tvp.usj;
    if (((String)a.afe().aff().xi().get(2, null)).equals(paramString)) {
      paramString = (String)localObject1;
    }
    for (;;)
    {
      localObject2 = parameh.tvq.usj;
      localObject1 = bh.p((String)localObject2, "msg");
      paramString = ((com.tencent.mm.plugin.emoji.b.c)com.tencent.mm.kernel.h.j(com.tencent.mm.plugin.emoji.b.c.class)).getEmojiMgr().bO((String)localObject2, paramString);
      if (paramString != null) {
        break;
      }
    ...
    Object localObject2 = ((com.tencent.mm.plugin.emoji.b.c)com.tencent.mm.kernel.h.j(com.tencent.mm.plugin.emoji.b.c.class)).getEmojiMgr().vr(paramString.fwU);
    ...
    {
      localObject3 = a.sR(paramString.fwU);
      if (!bg.mZ((String)localObject3))
      {
        paramString.fwU = ((String)localObject3);
    ...
    if (!TextUtils.isEmpty((CharSequence)localObject1)) {
      paramString.fwY = ((String)localObject1);
    }
    paramau.setType(47);
    paramau.cX(paramString.fwU);
    Object localObject3 = paramString.hUr;
    boolean bool;
    if ((!((EmojiInfo)localObject2).bGw()) && (!((EmojiInfo)localObject2).isGif()))
    {
      bool = true;
      paramau.setContent(aj.a((String)localObject3, 0L, bool, paramString.fwU, false, ""));
      if ((localObject2 == null) || (!((EmojiInfo)localObject2).bRU()))
      {
        localObject2 = a.afe().aff().zc();
        if (!TextUtils.isEmpty((CharSequence)localObject1)) {
          break label557;
        }
        com.tencent.mm.plugin.backup.a.h.b(parameh, 4, (String)localObject2 + paramString.fwU + "_thumb");
        com.tencent.mm.plugin.backup.a.h.b(parameh, 5, (String)localObject2 + paramString.fwU);
      }
    }
    for (;;)
    {
      parameh = new EmojiInfo((String)localObject2);
      parameh.field_md5 = paramString.fwU;
      parameh.field_svrid = paramString.id;
      parameh.field_catalog = EmojiInfo.vgi;
      parameh.field_type = paramString.veJ;
      parameh.field_size = paramString.veK;
      parameh.field_state = EmojiInfo.vgu;
      if (!TextUtils.isEmpty((CharSequence)localObject1)) {
        parameh.field_groupId = ((String)localObject1);
      }
      if (!bg.mZ(paramString.veS)) {
        parameh.field_activityid = paramString.veS;
      }
      a.afe().aff().afm().a(parameh);
      ...
      com.tencent.mm.plugin.backup.a.h.b(parameh, 4, (String)localObject2 + (String)localObject1 + File.separator + paramString.fwU + "_cover");
      com.tencent.mm.plugin.backup.a.h.b(parameh, 5, (String)localObject2 + (String)localObject1 + File.separator + paramString.fwU);
    }
  }
  ...
  private static final class a
  {
    ...
    /* Error */
    public static String a(au paramau, eh parameh)
    {
      // Byte code:
      //   0: ldc2_w 45
      //   3: ldc 47
      //   5: invokestatic 21	com/tencent/gmtrace/GMTrace:i	(JI)V
      //   8: invokestatic 53	com/tencent/mm/plugin/backup/g/a:afe	()Lcom/tencent/mm/plugin/backup/g/a;
      //   11: invokevirtual 57	com/tencent/mm/plugin/backup/g/a:aff	()Lcom/tencent/mm/plugin/backup/g/c;
      //   14: invokevirtual 63	com/tencent/mm/plugin/backup/g/c:afm	()Lcom/tencent/mm/storage/emotion/d;
      //   17: aload_0
      //   18: getfield 68	com/tencent/mm/g/b/ce:field_imgPath	Ljava/lang/String;
      //   21: invokevirtual 74	com/tencent/mm/storage/emotion/d:TQ	(Ljava/lang/String;)Lcom/tencent/mm/storage/emotion/EmojiInfo;
      //   24: astore 4
      //   26: aload 4
      //   28: ifnonnull +13 -> 41
      //   31: ldc2_w 45
      ...
      //   40: areturn
      //   41: aload 4
      //   43: invokevirtual 80	com/tencent/mm/storage/emotion/EmojiInfo:GP	()Ljava/lang/String;
      //   46: invokestatic 86	com/tencent/mm/plugin/backup/e/d:sQ	(Ljava/lang/String;)Lcom/tencent/mm/plugin/backup/e/d$a;
      //   49: astore_2
      //   50: aload_2
      //   51: astore_0
      //   52: aload_2
      ...
      //   64: aload_0
      //   65: aload 4
      //   67: invokevirtual 80	com/tencent/mm/storage/emotion/EmojiInfo:GP	()Ljava/lang/String;
      //   70: putfield 94	com/tencent/mm/plugin/backup/e/d$a:jPK	Ljava/lang/String;
      //   73: aload_0
      //   74: aload 4
      //   76: invokevirtual 80	com/tencent/mm/storage/emotion/EmojiInfo:GP	()Ljava/lang/String;
      //   79: putfield 97	com/tencent/mm/plugin/backup/e/d$a:jPL	Ljava/lang/String;
      //   82: aload_0
      //   83: aload 4
      //   85: invokevirtual 80	com/tencent/mm/storage/emotion/EmojiInfo:GP	()Ljava/lang/String;
      //   88: putfield 100	com/tencent/mm/plugin/backup/e/d$a:jPM	Ljava/lang/String;
      //   91: aload_0
      //   92: aload 4
      //   94: invokevirtual 80	com/tencent/mm/storage/emotion/EmojiInfo:GP	()Ljava/lang/String;
      //   97: putfield 103	com/tencent/mm/plugin/backup/e/d$a:jPJ	Ljava/lang/String;
      ...
      //   156: ldc -112
      //   158: aload_1
      //   159: getfield 150	com/tencent/mm/protocal/c/eh:tvo	Lcom/tencent/mm/protocal/c/axt;
      //   162: getfield 155	com/tencent/mm/protocal/c/axt:usj	Ljava/lang/String;
      ...
      //   173: ldc -95
      //   175: aload_1
      //   176: getfield 164	com/tencent/mm/protocal/c/eh:tvp	Lcom/tencent/mm/protocal/c/axt;
      //   179: getfield 155	com/tencent/mm/protocal/c/axt:usj	Ljava/lang/String;
      ...
      //   240: ldc -67
      //   242: aload_0
      //   243: getfield 94	com/tencent/mm/plugin/backup/e/d$a:jPK	Ljava/lang/String;
      ...
      //   266: ldc -61
      //   268: aload_0
      //   269: getfield 103	com/tencent/mm/plugin/backup/e/d$a:jPJ	Ljava/lang/String;
      ...
      //   314: pop
      //   315: aload 4
      //   317: invokevirtual 209	com/tencent/mm/storage/emotion/EmojiInfo:bGw	()Z
      //   320: ifeq +132 -> 452
      //   323: aload_3
      //   324: aconst_null
      //   325: ldc -45
      ...
      //   332: pop
      //   333: aload 4
      //   335: invokevirtual 214	com/tencent/mm/storage/emotion/EmojiInfo:rh	()Ljava/lang/String;
      //   338: ldc -45
      //   340: invokestatic 220	com/tencent/mm/sdk/platformtools/bh:p	(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
      //   343: astore_1
      //   344: aload_1
      //   345: ldc -34
      ...
      //   355: ldc -71
      //   357: invokestatic 236	com/tencent/mm/sdk/platformtools/bg:ap	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
      //   360: astore_0
      //   361: aload_1
      //   362: ldc -18
      ...
      //   372: ldc -71
      //   374: invokestatic 236	com/tencent/mm/sdk/platformtools/bg:ap	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
      //   377: astore_1
      //   378: aload_0
      //   379: ldc -71
      ...
      //   484: aload_0
      //   485: aload_0
      //   486: getstatic 25	com/tencent/mm/plugin/backup/e/f$a:jPN	Ljava/lang/String;
      //   489: invokevirtual 264	java/lang/String:indexOf	(Ljava/lang/String;)I
      //   492: aload_0
      //   493: getstatic 29	com/tencent/mm/plugin/backup/e/f$a:jPO	Ljava/lang/String;
      //   496: invokevirtual 264	java/lang/String:indexOf	(Ljava/lang/String;)I
      //   499: getstatic 29	com/tencent/mm/plugin/backup/e/f$a:jPO	Ljava/lang/String;
    ...
    public static String sR(String paramString)
    {
      ...
      paramString = d.sP(paramString);
      if (paramString == null)
      {
        GMTrace.o(14812939550720L, 110365);
        return null;
      }
      paramString = paramString.jPJ;
      GMTrace.o(14812939550720L, 110365);
      return paramString;
    }
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/backup/e/f.class
