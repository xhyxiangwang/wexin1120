...
{
  private static AtomicInteger siA;
  
  static
  {
    GMTrace.i(9201027907584L, 68553);
    siA = new AtomicInteger();
  ...
  public static void a(int paramInt, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {
      arrayOfByte = a.bzo().shh.aS(paramArrayOfByte);
    }
    int i = siA.incrementAndGet();
    ...
    try
    {
      ...
      for (;;)
      {
        a.bzo().shh.aQ(paramArrayOfByte.toByteArray());
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wear/model/e/r.class
