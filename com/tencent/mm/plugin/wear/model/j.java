...
public final class j
{
  ...
  public j()
  {
    ...
    {
      this.handlerThread = e.Sc("WearWorker_worker_thread");
      this.handlerThread.start();
      this.jht = new a(this.handlerThread.getLooper());
  ...
  public final void a(com.tencent.mm.plugin.wear.model.f.d paramd)
  {
    ...
    if (this.jht != null)
    {
      paramd = this.jht.obtainMessage(0, paramd);
      this.jht.sendMessage(paramd);
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wear/model/j.class
