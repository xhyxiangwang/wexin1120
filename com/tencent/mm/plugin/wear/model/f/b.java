  ...
  extends c
{
  ...
  protected static String d(String paramString, au paramau)
  {
    ...
    if (o.dW(paramString))
    {
      int i = ay.gy(paramau.field_content);
  ...
  protected final String c(String paramString, au paramau)
  {
    ...
    if (o.dW(paramString))
    {
      ...
      paramString = String.format(ab.getContext().getString(R.l.esy), new Object[] { h.Kf(paramString), Character.valueOf('​'), h.Q(paramau).ovi });
      GMTrace.o(9192706408448L, 68491);
      return paramString;
    }
    paramString = String.format(ab.getContext().getString(R.l.esz), new Object[] { h.Q(paramau).ovi });
    GMTrace.o(9192706408448L, 68491);
    return paramString;
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wear/model/f/b.class
