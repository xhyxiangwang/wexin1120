...
public final class g
{
  ...
  public g()
  {
    ...
    this.shX = new HashMap();
    GMTrace.o(9177271369728L, 68376);
  }
  
  /* Error */
  public final f Ka(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   10: aload_0
    //   11: getfield 37	com/tencent/mm/plugin/wear/model/g:shX	Ljava/util/HashMap;
    //   14: aload_1
    //   15: invokevirtual 46	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   18: ifeq +33 -> 51
    //   21: aload_0
    //   22: getfield 37	com/tencent/mm/plugin/wear/model/g:shX	Ljava/util/HashMap;
    //   25: aload_1
    ...
    //   49: aload_1
    //   50: areturn
    //   51: getstatic 22	com/tencent/mm/plugin/wear/model/g:shW	I
    //   54: iconst_1
    //   55: iadd
    //   56: putstatic 22	com/tencent/mm/plugin/wear/model/g:shW	I
    ...
    //   67: aload_2
    //   68: aload_1
    //   69: putfield 61	com/tencent/mm/plugin/wear/model/f:fAJ	Ljava/lang/String;
    //   72: aload_2
    //   73: getstatic 22	com/tencent/mm/plugin/wear/model/g:shW	I
    //   76: putfield 64	com/tencent/mm/plugin/wear/model/f:id	I
    //   79: aload_2
    //   80: getstatic 70	com/tencent/mm/plugin/wear/model/f$a:shR	Lcom/tencent/mm/plugin/wear/model/f$a;
    //   83: putfield 73	com/tencent/mm/plugin/wear/model/f:shQ	Lcom/tencent/mm/plugin/wear/model/f$a;
    //   86: aload_0
    //   87: getfield 37	com/tencent/mm/plugin/wear/model/g:shX	Ljava/util/HashMap;
    //   90: aload_1
    //   91: aload_2
  ...
  public final void Kb(String paramString)
  {
    try
    {
      ...
      if (this.shX.containsKey(paramString))
      {
        ((f)this.shX.get(paramString)).shQ = f.a.shR;
        ((f)this.shX.get(paramString)).shP = 0;
      }
  ...
  public final void Kc(String paramString)
  {
    try
    {
      ...
      if (this.shX.containsKey(paramString))
      {
        paramString = (f)this.shX.get(paramString);
        paramString.shQ = f.a.shU;
        paramString.shP = 0;
  ...
  public final void a(f paramf)
  {
    try
    {
      ...
      this.shX.put(paramf.fAJ, paramf);
  ...
  public final void cg(String paramString, int paramInt)
  {
    try
    {
      ...
      {
        paramString = (f)this.shX.get(paramString);
        paramString.shQ = f.a.shT;
        paramString.shP = paramInt;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/wear/model/g.class
