...
{
  private static final Map<String, Object> jYP;
  ...
  static
  {
    ...
    jYP.put("_build_info_sdk_name_", "android 5.0.8");
    jYP.put("_wxapp_pay_entry_classname_", "com.tencent.mm.plugin.base.stub.WXPayEntryActivity");
  ...
  public static Cursor a(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    ...
    Object localObject = jYP.get(paramArrayOfString2);
    if (localObject == null)
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/base/stub/c.class
