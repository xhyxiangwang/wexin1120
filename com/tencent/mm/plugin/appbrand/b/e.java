...
{
  final WeakReference<Activity> iDb;
  public final BroadcastReceiver iDf;
  
  public e(Activity paramActivity)
  {
    GMTrace.i(18876112830464L, 140638);
    this.iDf = new BroadcastReceiver()
    {
        ...
        if ("android.intent.action.SCREEN_OFF".equals(paramAnonymousIntent.getAction())) {
          d.xC().C(new Runnable()
          {
            public final void run()
            {
              ...
              e locale = e.this;
              Object localObject2 = (Activity)locale.iDb.get();
              if (localObject2 != null)
              {
                ...
                localObject2 = bg.ab((Context)localObject2, ((Activity)localObject2).getTaskId());
                if (localObject2 != null) {}
                try
                {
    ...
    this.iDb = new WeakReference(paramActivity);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/b/e.class
