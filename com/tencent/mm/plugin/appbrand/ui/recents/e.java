...
{
  private final ArrayList<com.tencent.mm.plugin.appbrand.c.e> jvk;
  private final ArrayList<com.tencent.mm.plugin.appbrand.c.e> jvl;
  
  e()
  {
    GMTrace.i(16367180840960L, 121945);
    this.jvk = new ArrayList(10);
    this.jvl = new ArrayList(200);
  ...
  static e c(ArrayList<com.tencent.mm.plugin.appbrand.c.e> paramArrayList1, ArrayList<com.tencent.mm.plugin.appbrand.c.e> paramArrayList2)
  {
    ...
    e locale = new e();
    SysConfigUtil.e(locale.jvk, paramArrayList1);
    SysConfigUtil.e(locale.jvl, paramArrayList2);
    GMTrace.o(16367315058688L, 121946);
    return locale;
  }
  
  /* Error */
  private com.tencent.mm.plugin.appbrand.c.e jA(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   10: iload_1
    //   11: aload_0
    //   12: getfield 28	com/tencent/mm/plugin/appbrand/ui/recents/e:jvk	Ljava/util/ArrayList;
    //   15: invokevirtual 57	java/util/ArrayList:size	()I
    //   18: if_icmpge +27 -> 45
    //   21: aload_0
    //   22: getfield 28	com/tencent/mm/plugin/appbrand/ui/recents/e:jvk	Ljava/util/ArrayList;
    //   25: iload_1
    ...
    //   44: areturn
    //   45: aload_0
    //   46: getfield 30	com/tencent/mm/plugin/appbrand/ui/recents/e:jvl	Ljava/util/ArrayList;
    //   49: iload_1
    //   50: aload_0
    //   51: getfield 28	com/tencent/mm/plugin/appbrand/ui/recents/e:jvk	Ljava/util/ArrayList;
  ...
  final ArrayList<com.tencent.mm.plugin.appbrand.c.e> aaQ()
  {
    try
    {
      GMTrace.i(16367449276416L, 121947);
      ArrayList localArrayList = this.jvk;
  ...
  final ArrayList<com.tencent.mm.plugin.appbrand.c.e> aaR()
  {
    try
    {
      GMTrace.i(16367583494144L, 121948);
      ArrayList localArrayList = this.jvl;
  ...
  public final e aaS()
  {
    try
    {
      ...
      e locale = new e();
      locale.jvk.addAll(this.jvk);
      locale.jvl.addAll(this.jvl);
  ...
  public final boolean addAll(Collection<? extends com.tencent.mm.plugin.appbrand.c.e> paramCollection)
  {
    ...
    if (e.class.isInstance(paramCollection)) {
      try
      {
        ...
        this.jvk.addAll(paramCollection.jvk);
        this.jvl.addAll(paramCollection.jvl);
  ...
  /* Error */
  public final com.tencent.mm.plugin.appbrand.c.e jB(int paramInt)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/ui/recents/e.class
