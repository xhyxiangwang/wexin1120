  ...
  extends MMActivity
{
  ...
  private void aao()
  {
    ...
    this.jsv = new Runnable()
    {
      public final void run()
      {
        GMTrace.i(10513006198784L, 78328);
        AppBrandTBSDownloadProxyUI.aap();
    ...
    this.mHandler.postDelayed(this.jsv, 20000L);
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    this.ikZ = com.tencent.mm.ui.base.h.a(this.vov.voR, null, true, null);
    this.ikZ.setOnCancelListener(new DialogInterface.OnCancelListener()
    {
    ...
    if ((bool1) || (bool2))
    {
      if (bool3)
      {
        ...
        this.vov.voR.getString(p.i.dxm);
        this.ikZ = com.tencent.mm.ui.base.h.a(paramBundle, this.vov.voR.getString(p.i.iyP), true, null);
        if (this.ikZ.getWindow() != null)
        {
          paramBundle = this.ikZ.getWindow().getAttributes();
          paramBundle.dimAmount = 0.0F;
          this.ikZ.getWindow().setAttributes(paramBundle);
        }
        this.ikZ.setOnCancelListener(new DialogInterface.OnCancelListener()
        {
          public final void onCancel(DialogInterface paramAnonymousDialogInterface)
    ...
    f.a(this.vov.voR, false, true, paramBundle);
    GMTrace.o(10520522391552L, 78384);
  }
  ...
  protected final void onDestroy()
  {
    ...
    if ((this.mHandler != null) && (this.jsv != null)) {
      this.mHandler.removeCallbacks(this.jsv);
    }
    super.onDestroy();
    ...
    implements com.tencent.xweb.x5.sdk.h
  {
    ...
    public final void ju(int paramInt)
    {
      ...
      {
        com.tencent.mm.plugin.report.service.g.paX.a(366L, 4L, 1L, false);
        if (paramInt == 110) {
          break label231;
        }
        if ((paramInt != 100) && (paramInt != 120) && (paramInt != 122)) {
        ...
        com.tencent.mm.plugin.report.service.g.paX.a(64, 64, 4, 3, 1, 1, false);
      }
      for (;;)
      {
        ...
        return;
        com.tencent.mm.plugin.report.service.g.paX.a(366L, 5L, 1L, false);
        break;
        label172:
        ...
        com.tencent.mm.plugin.report.service.g.paX.a(64L, 3L, 1L, false);
    ...
    public final void jv(int paramInt)
    {
      ...
      if (AppBrandTBSDownloadProxyUI.this.ikZ != null)
      {
        AppBrandTBSDownloadProxyUI.this.ikZ.dismiss();
        AppBrandTBSDownloadProxyUI.this.ikZ = null;
      }
      j.dS(6, paramInt);
      if ((paramInt == 200) || (paramInt == 220))
      {
        com.tencent.mm.plugin.report.service.g.paX.a(64, 64, 7, 6, 1, 1, false);
        com.tencent.mm.plugin.report.service.g.paX.a(366L, 6L, 1L, false);
      ...
      com.tencent.mm.plugin.report.service.g.paX.a(64L, 6L, 1L, false);
      com.tencent.mm.plugin.report.service.g.paX.a(366L, 7L, 1L, false);
      AppBrandTBSDownloadProxyUI.d(AppBrandTBSDownloadProxyUI.this);
      d.a(AppBrandTBSDownloadProxyUI.e(AppBrandTBSDownloadProxyUI.this));
      Intent localIntent = new Intent();
      AppBrandTBSDownloadProxyUI.this.setResult(0, localIntent);
    ...
    public final void jw(final int paramInt)
    {
      ...
      if (AppBrandTBSDownloadProxyUI.this.ikZ != null) {
        af.u(new Runnable()
        {
          public final void run()
          {
            ...
            AppBrandTBSDownloadProxyUI.this.ikZ.setMessage(AppBrandTBSDownloadProxyUI.this.vov.voR.getString(p.i.iyQ, new Object[] { String.valueOf(paramInt) }));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/ui/AppBrandTBSDownloadProxyUI.class
