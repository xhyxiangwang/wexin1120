...
public enum g
{
  ...
  private static final Method jsZ;
  ...
  public static boolean a(Window paramWindow, boolean paramBoolean)
  {
    ...
    if ((Build.VERSION.SDK_INT >= 23) && ((!h.tJ()) || (!aae())))
    {
  ...
  private static boolean aae()
  {
    ...
    //   8: getstatic 38	com/tencent/mm/plugin/appbrand/ui/g:jqK	Ljava/lang/Boolean;
    //   11: ifnonnull +65 -> 76
    ...
    //   69: putstatic 38	com/tencent/mm/plugin/appbrand/ui/g:jqK	Ljava/lang/Boolean;
    //   72: aload_2
    //   73: invokevirtual 145	java/io/FileInputStream:close	()V
    //   76: getstatic 38	com/tencent/mm/plugin/appbrand/ui/g:jqK	Ljava/lang/Boolean;
    ...
    //   116: putstatic 38	com/tencent/mm/plugin/appbrand/ui/g:jqK	Ljava/lang/Boolean;
    //   119: aload_2
    //   120: ifnull -44 -> 76
    //   123: aload_2
  ...
  public static int aak()
  {
    ...
    int i = t.ac(ab.getContext(), com.tencent.mm.bq.a.fromDPToPix(ab.getContext(), 25));
  ...
  public static j bQ(Context paramContext)
  {
    GMTrace.i(10513945722880L, 78335);
    View localView = View.inflate(paramContext, p.g.ivD, null);
    final j localj = new j(paramContext, p.j.izd);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/ui/g.class
