...
public final class d
{
    ...
    if (j < k)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject2 instanceof String)) {
          ...
          {
            localObject1 = rL((String)localObject2);
          }
        }
      }
    }
  ...
  private static String rL(String paramString)
  {
    ...
    try
    {
      String str = bg.mY(p.encode(paramString));
      GMTrace.o(16166927990784L, 120453);
      return str;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/report/d.class
