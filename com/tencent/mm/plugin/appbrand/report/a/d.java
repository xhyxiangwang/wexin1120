...
public final class d
{
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong1, long paramLong2, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    Object localObject = com.tencent.mm.plugin.appbrand.a.nx(paramString1);
    if (localObject != null)
    {
      try
      {
      ...
      i = ((AppBrandSysConfig)localObject).iJa.iCy;
      j = ((AppBrandSysConfig)localObject).iJa.iCx + 1;
      str = com.tencent.mm.plugin.appbrand.report.a.bP(ab.getContext());
      g.paX.i(14510, new Object[] { paramString1, Integer.valueOf(i), Integer.valueOf(j), str, paramString2, paramString4, paramString3, Long.valueOf(paramLong1), Long.valueOf(paramLong2), Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3) });
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/report/a/d.class
