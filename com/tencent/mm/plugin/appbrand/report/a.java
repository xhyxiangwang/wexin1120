...
{
  private static Pattern jnX;
  
  static
  {
    GMTrace.i(10628299227136L, 79187);
    jnX = Pattern.compile(".*\"errMsg\":\"[^:]+:([^\"]+)\".*");
  ...
  public static void ZE()
  {
    ...
    int i = bg.bOj();
    w.i("MicroMsg.AppBrandReporterManager", "report now process mem : %d", new Object[] { Integer.valueOf(bg.bOj()) });
    if (i <= 90) {
      i = 2;
    }
    for (;;)
    {
      g.paX.a(386L, 1L, 1L, false);
      g.paX.a(386L, i, 1L, false);
  ...
  public static void a(int paramInt1, String paramString1, String paramString2, int paramInt2, String paramString3, String paramString4)
  {
    ...
    w.d("MicroMsg.AppBrandReporterManager", "stev report(%s), scene : %d, appid %s, appversion %d, appidlist %snearbyAppIdCount %s, nearbyAppIdList %s", new Object[] { Integer.valueOf(13533), Integer.valueOf(paramInt1), bg.mY(paramString1), Integer.valueOf(0), paramString2, Integer.valueOf(paramInt2), paramString3 });
    g.paX.i(13533, new Object[] { Integer.valueOf(paramInt1), bg.mY(paramString1), Integer.valueOf(0), paramString2, Integer.valueOf(paramInt2), paramString3, Integer.valueOf(0), paramString4 });
  ...
  public static void a(String paramString1, int paramInt1, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    g.paX.i(13801, new Object[] { paramString1, Integer.valueOf(0), Integer.valueOf(paramInt1), Long.valueOf(bg.Po()), Integer.valueOf(paramInt2), Integer.valueOf(paramInt3), paramString2 });
  ...
  public static void a(String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    g.paX.i(13537, new Object[] { Integer.valueOf(1000), "", "", paramString, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", str1, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2), Integer.valueOf(0), Long.valueOf(paramLong), Long.valueOf(l) });
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, int paramInt2, String paramString3, String paramString4, int paramInt3, String paramString5, long paramLong, int paramInt4, int paramInt5)
  {
    ...
    try
    {
      str2 = p.encode(bg.mY(str1), "UTF-8");
      paramString4 = str2;
    }
    ...
    paramString3 = bg.mY(paramString3);
    paramString5 = bg.mY(paramString5);
    paramString2 = bg.mY(paramString2);
    if (paramInt1 > 0)
    {
      i = paramInt1 - 1;
      bool = com.tencent.mm.plugin.appbrand.app.f.Sf().aa(paramString1, i);
      if (com.tencent.mm.plugin.appbrand.app.f.Sg().Z(paramString1, i)) {
        i = 1;
      }
    }
    else
    {
      ...
      g.paX.i(13540, new Object[] { Integer.valueOf(paramInt2), paramString3, paramString2, Integer.valueOf(0), Integer.valueOf(paramInt1), Integer.valueOf(i), paramString4, Integer.valueOf(paramInt3), paramString5, Long.valueOf(paramLong), Integer.valueOf(paramInt4), Integer.valueOf(paramInt5) });
      GMTrace.o(18352663691264L, 136738);
      return;
    }
  }
  ...
  public static void a(String paramString1, String paramString2, int paramInt1, String paramString3, long paramLong, int paramInt2, int paramInt3)
  {
    ...
    AppBrandStatObject localAppBrandStatObject = com.tencent.mm.plugin.appbrand.a.ny(paramString1);
    ...
    try
    {
      localObject2 = p.encode(bg.mY((String)localObject1), "UTF-8");
    ...
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      for (;;)
      {
        ...
        w.printErrStackTrace("MicroMsg.AppBrandReporterManager", localUnsupportedEncodingException, "", new Object[0]);
        continue;
        int i = localUnsupportedEncodingException.iJa.iCy;
        continue;
        int j = localUnsupportedEncodingException.iJa.iCx + 1;
      }
    }
    localObject2 = com.tencent.mm.plugin.appbrand.a.nx(paramString1);
  ...
  public static void a(String paramString1, final String paramString2, final String paramString3, final String paramString4, final int paramInt, final long paramLong, String paramString5)
  {
    ...
    com.tencent.mm.bu.a.post(new Runnable()
    {
      public final void run()
      {
        ...
        a.b(this.fnb, paramString2, paramString3, paramString4, paramInt, paramLong, this.joa);
  ...
  public static void b(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    g.paX.i(14369, new Object[] { paramString, Integer.valueOf(paramInt1), Integer.valueOf(paramInt2 + 1), Integer.valueOf(paramInt3), Integer.valueOf(paramInt4), Integer.valueOf(1) });
  ...
  public static void b(String paramString1, String paramString2, String paramString3, String paramString4, int paramInt, long paramLong, String paramString5)
  {
    ...
    for (;;)
    {
      ...
      catch (JSONException paramString4)
      {
        ...
        localObject2 = str1;
        localObject1 = com.tencent.mm.plugin.appbrand.j.nQ(paramString1).irO;
        continue;
        localObject2 = str1;
      ...
      try
      {
        localObject2 = p.encode(bg.mY(paramString4), "UTF-8");
        paramString2 = (String)localObject2;
      }
      ...
      try
      {
        str1 = p.encode(bg.mY((String)localObject1), "UTF-8");
        localObject2 = str1;
      }
      ...
      str1 = bg.mY(paramString3);
      if (bg.mZ(paramString5)) {
        break label992;
      }
      paramString3 = jnX.matcher(paramString5);
      if (!paramString3.matches()) {
        break label992;
      }
      paramString3 = bg.mY(paramString3.group(1));
      if ((bg.mZ(paramString3)) || (paramString3.startsWith("ok")) || (!paramString3.startsWith("fail"))) {
        break label998;
      }
      i = 2;
      paramString5 = bg.mY(localAppBrandStatObject.fty);
      str2 = bP(ab.getContext());
      if (localAppBrandStatObject.scene == 0) {
        localAppBrandStatObject.scene = 1000;
      }
      localAppBrandSysConfig = com.tencent.mm.plugin.appbrand.a.nx(paramString1);
      ...
      else
      {
        ...
        try
        {
          localObject1 = p.encode(bg.mY(paramString4.toString()), "UTF-8");
        }
    ...
    label1337:
    for (int k = 0;; k = localAppBrandSysConfig.iJa.iCx + 1)
    {
  ...
  public static void c(long paramLong, boolean paramBoolean)
  {
    ...
    if (paramLong <= 2000L) {
      ...
      {
        i = 8;
        g.paX.a(367L, i, 1L, false);
        if (!paramBoolean) {
          break label204;
        }
        g.paX.a(367L, 7L, 1L, false);
      }
    }
    for (;;)
    {
  ...
  public static void x(String paramString, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject2 = com.tencent.mm.plugin.appbrand.a.ny(paramString);
      if (localObject2 != null)
      {
        if (((AppBrandStatObject)localObject2).scene == 0)
        {
          i = 1000;
          localObject1 = bg.mY(((AppBrandStatObject)localObject2).fty);
          k = ((AppBrandStatObject)localObject2).joc;
          j = i;
          i = k;
        }
      }
      else
      {
        ...
        {
          k = i2;
          if (localAppBrandSysConfig.iJa != null) {
            k = localAppBrandSysConfig.iJa.iCy;
          }
        }
        m = i;
        localObject2 = localObject1;
        ...
        paramInt2 = localAppBrandSysConfig.iJa.iCx + 1;
        m = k;
        k = j;
        j = m;
      }
    ...
    for (;;)
    {
      ...
      g.paX.i(13541, new Object[] { Integer.valueOf(k), localObject1, paramString, Integer.valueOf(j), Integer.valueOf(paramInt2), Integer.valueOf(i), Integer.valueOf(paramInt1), Integer.valueOf(3), "" });
      GMTrace.o(18352797908992L, 136739);
      return;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/report/a.class
