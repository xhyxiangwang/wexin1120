  ...
  implements MMActivity.a
{
  ...
  public final MMActivity Vu()
  {
    ...
    MMActivity localMMActivity = this.iOQ.Vu();
  ...
  public final void a(final ProcessResult paramProcessResult)
  {
    ...
    paramProcessResult = new Runnable()
    {
      public final void run()
      {
        ...
        if (AppBrandProxyUIProcessTask.this.iOQ == null)
        {
          GMTrace.o(10280809529344L, 76598);
          return;
        }
        AppBrandProxyUIProcessTask.this.iOQ.a(paramProcessResult);
        GMTrace.o(10280809529344L, 76598);
      }
    };
    if (this.iOQ == null)
    ...
    this.iOQ.runOnUiThread(paramProcessResult);
    GMTrace.o(10277722521600L, 76575);
  }
    ...
    implements Parcelable
  {
    ...
    public abstract Class<? extends AppBrandProxyUIProcessTask> Vz();
  ...
  {
    static <_Model extends AppBrandProxyUIProcessTask> _Model pN(String paramString)
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/ipc/AppBrandProxyUIProcessTask.class
