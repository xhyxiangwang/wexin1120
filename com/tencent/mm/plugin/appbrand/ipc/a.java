...
{
  private static final Map<String, Class<? extends AppBrandTaskProxyUI>> iOr;
  ...
  static
  {
    ...
    iOr = Collections.unmodifiableMap(localHashMap);
  ...
  public static <_Req extends AppBrandProxyUIProcessTask.ProcessRequest, _Result extends AppBrandProxyUIProcessTask.ProcessResult> void b(Context paramContext, _Req param_Req, AppBrandProxyUIProcessTask.b<_Result> paramb)
  {
    ...
    Object localObject1 = ab.vR();
    Object localObject2 = ab.getPackageName();
    localObject2 = (Class)iOr.get(((String)localObject1).replaceFirst((String)localObject2, ""));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/ipc/a.class
