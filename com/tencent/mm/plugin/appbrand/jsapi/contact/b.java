  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(final k paramk, final JSONObject paramJSONObject, final int paramInt)
  {
    ...
    {
      w.e("MicroMsg.JsApiChooseContact", "getPageContext failed, appid is %s", new Object[] { paramk.iqL });
    ...
    com.tencent.mm.plugin.appbrand.a.a(paramk.iqL, new a.a()
    {
      public final void onRequestPermissionsResult(int paramAnonymousInt, String[] paramAnonymousArrayOfString, int[] paramAnonymousArrayOfInt)
      {
        ...
        {
          b.this.a(paramk, paramJSONObject, paramInt);
          GMTrace.o(19804765290496L, 147557);
          return;
        }
        paramk.v(paramInt, b.this.d("permission_denied", null));
        GMTrace.o(19804765290496L, 147557);
      }
    });
    ...
    localMMActivity.vow = new MMActivity.a()
    {
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        if (100 != paramAnonymousInt1)
        {
          ...
          paramk.v(paramInt, b.this.d("fail", null));
        ...
        if (paramAnonymousInt2 == -1)
        {
          ...
          if (!com.tencent.mm.pluginsdk.h.a.aR(localMMActivity, "android.permission.READ_CONTACTS"))
          {
            w.e("MicroMsg.JsApiChooseContact", "onActivityResult, no contact permission");
            paramk.v(paramInt, b.this.d("fail:system permission denied", null));
            GMTrace.o(19806375903232L, 147569);
            return;
          }
          try
          ...
          catch (SecurityException paramAnonymousIntent)
          {
            ...
            h.b(localMMActivity, ab.getResources().getString(p.i.iyx), "", true);
            paramk.v(paramInt, b.this.d("fail:system permission denied", null));
            GMTrace.o(19806375903232L, 147569);
            return;
          }
        ...
        for (;;)
        {
          try
          {
            ...
            if (!bg.mZ((String)localObject1))
            {
              ...
              paramk.v(paramInt, b.this.d("ok", (Map)localObject2));
              GMTrace.o(19806375903232L, 147569);
              return;
            }
          }
          catch (Exception localException)
          {
            continue;
            paramk.v(paramInt, b.this.d("fail", null));
            Toast.makeText(localMMActivity, p.i.iym, 0).show();
          }
          GMTrace.o(19806375903232L, 147569);
          return;
          label862:
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/contact/b.class
