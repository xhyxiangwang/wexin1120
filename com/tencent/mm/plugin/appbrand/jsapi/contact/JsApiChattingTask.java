  ...
  extends MainProcessTask
{
  ...
  public final void RS()
  {
    ...
    x localx = ((com.tencent.mm.plugin.messenger.foundation.a.h)com.tencent.mm.kernel.h.h(com.tencent.mm.plugin.messenger.foundation.a.h.class)).yL().SL(this.username);
    w.d("MicroMsg.JsApiChattingTask", "sessionFrom:%s,username:%s,nickname:%s", new Object[] { this.sessionFrom, this.username, this.fvS });
    if ((localx == null) || ((int)localx.gLS == 0))
    {
      localx = new x(this.username);
      localx.setType(0);
      localx.cg(this.fvS);
      ((com.tencent.mm.plugin.messenger.foundation.a.h)com.tencent.mm.kernel.h.h(com.tencent.mm.plugin.messenger.foundation.a.h.class)).yL().R(localx);
      w.i("MicroMsg.JsApiChattingTask", "%s save to contact_table", new Object[] { this.username });
    }
    ((b)com.tencent.mm.kernel.h.h(b.class)).oV(this.username);
    VC();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/contact/JsApiChattingTask.class
