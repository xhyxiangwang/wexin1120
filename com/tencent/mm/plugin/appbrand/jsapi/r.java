    ...
    localMMActivity.vow = new MMActivity.a()
    {
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        if ((paramAnonymousInt2 == -1) && (paramAnonymousIntent != null))
        {
          ...
          paramAnonymousIntent = bg.ap(paramAnonymousIntent.getStringExtra("choose_invoice_title_info"), "");
          ...
          paramk.v(paramInt, r.this.d("ok", localHashMap));
          GMTrace.o(18203010924544L, 135623);
          return;
        }
        if (paramAnonymousInt2 == 0)
        {
          paramk.v(paramInt, r.this.d("cancel", null));
          GMTrace.o(18203010924544L, 135623);
          return;
        }
        paramk.v(paramInt, r.this.d("fail", null));
        GMTrace.o(18203010924544L, 135623);
      }
    };
    com.tencent.mm.bi.d.a(localMMActivity, "address", ".ui.InvoiceListUI", paramJSONObject, hashCode() & 0xFFFF, false);
    GMTrace.o(18200863440896L, 135607);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/r.class
