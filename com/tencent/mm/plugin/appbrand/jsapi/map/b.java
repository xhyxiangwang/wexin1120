  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.c
{
  ...
  protected final boolean a(final AppBrandPageView paramAppBrandPageView, final int paramInt, View paramView, JSONObject paramJSONObject)
  {
    ...
    final Object localObject2 = paramAppBrandPageView.jla.t(paramInt, true);
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          Object localObject1 = (List)((q.b)localObject2).get("map_controls", null);
          if (localObject1 != null) {
            break label603;
          }
          localObject1 = new ArrayList();
          ((q.b)localObject2).k("map_controls", localObject1);
          int i;
          ...
          if (k < paramJSONObject.length())
          {
            ...
            try
            {
              ...
              {
                localObject5 = com.tencent.mm.plugin.appbrand.appstorage.c.aI(paramAppBrandPageView.iqL, (String)localObject5);
                i = n;
                j = m;
                if (localObject5 != null)
                {
                  localObject5 = d.decodeFile(((AppBrandLocalMediaObject)localObject5).hhT, null);
                ...
                localObject4 = (FrameLayout)paramView;
            ...
            localObject5 = n.g(paramAppBrandPageView.irS, (String)localObject5);
            i = n;
            int j = m;
            if (localObject5 == null) {
              continue;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/map/b.class
