        ...
        try
        {
          ...
          com.tencent.mm.plugin.appbrand.o.d.runOnUiThread(new Runnable()
          {
            public final void run()
            {
              ...
              if ((i >= 0) && (i < locald.adi()) && (locala != null))
              {
                locald.S(true);
                locald.kf(i).h(locala.jHw);
                if (!bg.D(locala.jHw)) {
                  locald.kf(i).setValue(locala.jHx);
                }
                locald.S(false);
              }
              g.1.this.e("ok", null);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/h/g.class
