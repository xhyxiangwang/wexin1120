  ...
  extends a
{
  ...
  public final void a(k paramk, JSONObject paramJSONObject, int paramInt)
  {
    ...
    Object localObject1 = paramk.iqL;
    w.i("MicroMsg.JsApiCaptureScreen", "captureScreen, appId:%s", new Object[] { localObject1 });
    paramJSONObject = b(paramk);
    if (paramJSONObject != null)
    {
      paramJSONObject = com.tencent.mm.sdk.platformtools.d.cX(paramJSONObject.jjY);
      Object localObject2 = c.aD((String)localObject1, "appbrand_capture_" + System.currentTimeMillis());
      ...
      try
      {
        ...
        ((HashMap)localObject2).put("tempFilePath", ((AppBrandLocalMediaObject)localObject1).fAx);
        w.i("MicroMsg.JsApiCaptureScreen", "capture bitmap tempFilePath:%s", new Object[] { ((AppBrandLocalMediaObject)localObject1).fAx });
      ...
      catch (IOException localIOException)
      {
        ...
        paramk.v(paramInt, d("fail:IOException", null));
        if ((paramJSONObject != null) && (!paramJSONObject.isRecycled())) {
          paramJSONObject.recycle();
        }
        GMTrace.o(17338648756224L, 129183);
      ...
      catch (Exception localException)
      {
        ...
        paramk.v(paramInt, d("fail:Exception", null));
        if ((paramJSONObject != null) && (!paramJSONObject.isRecycled())) {
          paramJSONObject.recycle();
        }
        GMTrace.o(17338648756224L, 129183);
    ...
    paramk.v(paramInt, d("fail:container or pageView is null", null));
    GMTrace.o(17338648756224L, 129183);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/q.class
