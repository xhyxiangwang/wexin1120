  ...
  extends a
{
  ...
  public final void a(k paramk, JSONObject paramJSONObject, int paramInt)
  {
    ...
    if ((bg.mZ((String)localObject6)) || (bg.mZ(str2)))
    {
    ...
    for (;;)
    {
      try
      {
        paramJSONObject = URLEncoder.encode(bg.mY(""), "UTF-8");
        localObject1 = localObject2;
      ...
      try
      {
        ...
        g.paX.i(13579, new Object[] { str1, Integer.valueOf(i), paramJSONObject, localObject6, "", localObject5, localObject2, Long.valueOf(l), Long.valueOf(l) });
      ...
      if (am.is4G(paramk.mContext))
      {
        i = 4;
        break;
      }
      if (am.is3G(paramk.mContext))
      {
        i = 3;
        break;
      }
  ...
  public final void a(AppBrandPageView paramAppBrandPageView, JSONObject paramJSONObject, int paramInt)
  {
    ...
    String str1 = paramAppBrandPageView.iqL;
    if (TextUtils.isEmpty(str1))
    {
      w.e("MicroMsg.JsApiReportAction", "doReportActionInfo, appId is empty");
      paramAppBrandPageView.v(paramInt, d("fail", null));
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/bh.class
