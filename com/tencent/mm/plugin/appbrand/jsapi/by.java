...
public final class by
{
  ...
  public static int g(String... paramVarArgs)
  {
    int j = 0;
  ...
  private static String q(File paramFile)
  {
    ...
    //   5: invokestatic 17	com/tencent/gmtrace/GMTrace:i	(JI)V
    //   8: aload_0
    //   9: invokevirtual 114	java/io/File:exists	()Z
    //   12: ifne +14 -> 26
    //   15: ldc2_w 109
    //   18: ldc 111
    ...
    //   23: ldc 116
    //   25: areturn
    //   26: new 118	java/lang/StringBuffer
    //   29: dup
    //   30: invokespecial 120	java/lang/StringBuffer:<init>	()V
    //   33: astore_3
    //   34: new 122	java/io/BufferedReader
    //   37: dup
    //   38: new 124	java/io/FileReader
    //   41: dup
    //   42: aload_0
    //   43: invokespecial 125	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   46: invokespecial 128	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   49: astore_2
    //   50: aload_2
    //   51: astore_0
    //   52: sipush 1024
    ...
    //   61: aload_2
    //   62: aload 4
    //   64: invokevirtual 132	java/io/BufferedReader:read	([C)I
    //   67: istore_1
    //   68: iload_1
    //   69: iconst_m1
    //   70: if_icmpeq +42 -> 112
    ...
    //   78: iconst_0
    //   79: iload_1
    //   80: invokestatic 136	java/lang/String:valueOf	([CII)Ljava/lang/String;
    //   83: invokevirtual 139	java/lang/StringBuffer:append	(Ljava/lang/String;)Ljava/lang/StringBuffer;
    //   86: pop
    //   87: goto -28 -> 59
    //   90: astore_3
    //   91: aload_2
    ...
    //   103: ifnull +7 -> 110
    //   106: aload_2
    //   107: invokevirtual 140	java/io/BufferedReader:close	()V
    //   110: aload_0
    //   111: athrow
    //   112: aload_2
    //   113: invokevirtual 140	java/io/BufferedReader:close	()V
    //   116: aload_3
    //   117: invokevirtual 141	java/lang/StringBuffer:toString	()Ljava/lang/String;
    //   120: astore_0
    //   121: ldc2_w 109
    //   124: ldc 111
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/by.class
