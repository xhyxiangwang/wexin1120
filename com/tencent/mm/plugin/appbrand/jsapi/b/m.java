  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(k paramk, JSONObject paramJSONObject, int paramInt)
  {
    ...
    Object localObject2 = a.g(paramk);
    Object localObject1 = (a)((q.b)localObject2).get("key_bluetooth_le_scaner", null);
    ...
    localObject1 = null;
    if (this.iUV.has("services"))
    {
      ArrayList localArrayList = new ArrayList();
      try
      {
        JSONArray localJSONArray = new JSONArray(this.iUV.optString("services"));
    ...
    try
    {
      ...
      paramk = ((b)localObject1).aj(paramk.iqL, paramk.hashCode());
      paramk.mData = paramJSONObject.toString();
      paramk.VI();
      GMTrace.o(14330695254016L, 106772);
      return;
    }
  ...
  {
    private Map<String, JSONObject> iUM;
    public k iUW;
    private aj iUX;
    public final ParcelUuid iUY;
    
    public a(k paramk)
    {
      GMTrace.i(14329755729920L, 106765);
      this.iUX = null;
      this.iUY = ParcelUuid.fromString("00000000-0000-1000-8000-00805F9B34FB");
      this.iUW = paramk;
      this.iUM = a.Wj();
      this.iUX = new aj(new aj.a()
      {
        public final boolean pO()
        {
          GMTrace.i(14336600834048L, 106816);
          Object localObject1 = new m.c();
          Object localObject2 = a.Wj();
          ...
          try
          {
            ...
            if ((localJSONArray.length() > 0) && (a.iUJ))
            {
              localObject1 = ((m.c)localObject1).aj(m.a.this.iUW.iqL, m.a.this.iUW.hashCode());
    ...
    private int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, List<ParcelUuid> paramList)
    {
      ...
      while (paramInt2 > 0)
      {
        ...
        else
        {
          ...
          {
            localObject = new ParcelUuid(new UUID(this.iUY.getUuid().getMostSignificantBits() + (l1 << 32), this.iUY.getUuid().getLeastSignificantBits()));
            break;
            l1 = localObject[0] & 0xFF;
    ...
    private void a(BluetoothDevice paramBluetoothDevice, int paramInt, byte[] paramArrayOfByte)
    {
      ...
      //   36: invokestatic 184	com/tencent/mm/sdk/platformtools/bg:mY	(Ljava/lang/String;)Ljava/lang/String;
      //   39: astore 6
      //   41: aload_1
      ...
      //   79: aload 7
      //   81: invokestatic 200	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
      //   84: ifeq +19 -> 103
      //   87: ldc2_w 161
      //   90: ldc -93
      ...
      //   102: athrow
      //   103: aload_0
      //   104: getfield 26	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUZ	Lcom/tencent/mm/plugin/appbrand/jsapi/b/m;
      //   107: aload_0
      //   108: getfield 26	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUZ	Lcom/tencent/mm/plugin/appbrand/jsapi/b/m;
      //   111: getfield 204	com/tencent/mm/plugin/appbrand/jsapi/b/m:iUV	Lorg/json/JSONObject;
      //   114: ldc -50
      //   116: invokevirtual 211	org/json/JSONObject:optBoolean	(Ljava/lang/String;)Z
      //   119: putfield 215	com/tencent/mm/plugin/appbrand/jsapi/b/m:iUU	Z
      ...
      //   297: monitorenter
      //   298: aload_0
      //   299: getfield 26	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUZ	Lcom/tencent/mm/plugin/appbrand/jsapi/b/m;
      //   302: getfield 215	com/tencent/mm/plugin/appbrand/jsapi/b/m:iUU	Z
      //   305: ifne +87 -> 392
      //   308: aload_0
      //   309: getfield 60	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUM	Ljava/util/Map;
      //   312: aload 7
      //   314: invokeinterface 281 2 0
      //   319: ifeq +73 -> 392
      //   322: aload_0
      //   323: getfield 60	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUM	Ljava/util/Map;
      //   326: aload 7
      //   328: aload 9
      ...
      //   389: goto -93 -> 296
      //   392: aload_0
      //   393: getfield 60	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUM	Ljava/util/Map;
      //   396: aload 7
      //   398: aload 9
      //   400: invokeinterface 284 3 0
      //   405: pop
      //   406: aload_0
      //   407: getfield 26	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUZ	Lcom/tencent/mm/plugin/appbrand/jsapi/b/m;
      //   410: getfield 204	com/tencent/mm/plugin/appbrand/jsapi/b/m:iUV	Lorg/json/JSONObject;
      //   413: ldc_w 293
      ...
      //   456: ifle +85 -> 541
      //   459: aload_0
      //   460: getfield 40	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUX	Lcom/tencent/mm/sdk/platformtools/aj;
      //   463: invokevirtual 302	com/tencent/mm/sdk/platformtools/aj:bNt	()Z
      //   466: ifeq +39 -> 505
      //   469: aload_0
      //   470: getfield 40	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUX	Lcom/tencent/mm/sdk/platformtools/aj;
      //   473: astore_1
      //   474: iload_2
      //   475: i2l
      //   476: lstore 4
      ...
      //   479: lload 4
      //   481: lload 4
      //   483: invokevirtual 305	com/tencent/mm/sdk/platformtools/aj:w	(JJ)V
      //   486: ldc -91
      //   488: ldc_w 307
      //   491: iconst_1
      ...
      //   539: aload_1
      //   540: athrow
      //   541: getstatic 322	com/tencent/mm/plugin/appbrand/jsapi/b/a:iUJ	Z
      //   544: ifne +24 -> 568
      //   547: ldc -91
      //   549: ldc_w 324
      ...
      //   568: aload_3
      //   569: aload_0
      //   570: getfield 52	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUW	Lcom/tencent/mm/plugin/appbrand/k;
      //   573: getfield 330	com/tencent/mm/plugin/appbrand/k:iqL	Ljava/lang/String;
      //   576: aload_0
      //   577: getfield 52	com/tencent/mm/plugin/appbrand/jsapi/b/m$a:iUW	Lcom/tencent/mm/plugin/appbrand/k;
      //   580: invokevirtual 334	java/lang/Object:hashCode	()I
      //   583: invokevirtual 338	com/tencent/mm/plugin/appbrand/jsapi/b/m$c:aj	(Ljava/lang/String;I)Lcom/tencent/mm/plugin/appbrand/jsapi/e;
      //   586: astore_3
      //   587: aload_3
      //   588: aload_1
      ...
      //   595: aload_3
      //   596: invokevirtual 347	com/tencent/mm/plugin/appbrand/jsapi/e:VI	()Z
      //   599: pop
      //   600: goto -95 -> 505
      //   603: aconst_null
      //   604: astore_1
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/b/m.class
