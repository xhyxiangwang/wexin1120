  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.base.c
{
  ...
  protected final boolean a(AppBrandPageView paramAppBrandPageView, int paramInt, View paramView, JSONObject paramJSONObject, final c.a parama)
  {
    GMTrace.i(19826374344704L, 147718);
    for (;;)
    {
      String str;
      try
      {
        ...
        float f1 = com.tencent.mm.plugin.appbrand.n.c.a(paramAppBrandPageView, "left", paramView.getX());
        float f2 = com.tencent.mm.plugin.appbrand.n.c.a(paramAppBrandPageView, "top", paramView.getY());
        ...
        else
        {
          ...
          GMTrace.o(19826374344704L, 147718);
          return true;
        }
      }
      catch (JSONException paramAppBrandPageView)
      {
        ...
        parama.qb(d("fail:missing finalStyle", null));
        GMTrace.o(19826374344704L, 147718);
        return false;
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/o.class
