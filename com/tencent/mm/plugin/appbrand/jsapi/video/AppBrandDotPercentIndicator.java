  ...
  extends LinearLayout
{
  ...
  public final void Q(float paramFloat)
  {
    ...
    for (;;)
    {
      int k = (int)Math.rint(this.jbG * paramFloat);
      ...
      for (;;)
      {
        ...
        ((ImageView)getChildAt(i)).setImageResource(p.e.isz);
        i += 1;
      }
      break;
    }
    ...
    {
      ((ImageView)getChildAt(j)).setImageResource(p.e.isy);
      j += 1;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/video/AppBrandDotPercentIndicator.class
