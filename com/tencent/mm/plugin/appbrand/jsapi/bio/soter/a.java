...
{
  public static String i(JSONArray paramJSONArray)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        int k = qc(paramJSONArray.getString(i));
        j = (byte)(j | k);
      }
  ...
  public static JSONArray iz(int paramInt)
  {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/bio/soter/a.class
