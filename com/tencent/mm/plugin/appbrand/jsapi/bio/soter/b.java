  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(k paramk, int paramInt, Bundle paramBundle, String paramString)
  {
    ...
    JSONArray localJSONArray = a.iz(i);
    Object localObject = "";
    ...
    try
    {
      ...
      paramk.v(paramInt, d(paramBundle, (Map)localObject));
  ...
  public final void a(final k paramk, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    {
      w.e("MicroMsg.JsApiStartSoterAuthentication", "JsApiStartSoterAuthentication context is null, appId is %s", new Object[] { paramk.iqL });
    ...
    localIntent.putExtra("auth_mode", a.i(localJSONArray));
      ...
      public final void a(int paramAnonymousInt1, int paramAnonymousInt2, Intent paramAnonymousIntent)
      {
        ...
        if (paramAnonymousInt1 == 1000)
        {
          if (paramAnonymousInt2 == -1)
          {
            ...
            localb.a((k)localObject2, paramAnonymousInt1, (Bundle)localObject1, "ok");
          ...
          if (paramAnonymousInt2 == 1)
          {
            ...
            ((b)localObject2).a(localk, paramAnonymousInt1, (Bundle)localObject1, "fail");
            GMTrace.o(16540455927808L, 123236);
            return;
          }
          ...
          localb.a(localk, paramAnonymousInt1, (Bundle)localObject1, "cancel");
        }
        GMTrace.o(16540455927808L, 123236);
      }
    };
    com.tencent.mm.bi.d.b(localMMActivity, "soter_mp", ".ui.SoterAuthenticationUI", localIntent, 1000);
    GMTrace.o(16542871846912L, 123254);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/bio/soter/b.class
