...
public final class c
{
  ...
  public static int addNetwork(WifiConfiguration paramWifiConfiguration)
  {
    ...
    try
    {
      i = aDZ.addNetwork(paramWifiConfiguration);
  ...
  public static boolean disableNetwork(int paramInt)
  {
    ...
    try
    {
      boolean bool = aDZ.disableNetwork(paramInt);
  ...
  public static List<WifiConfiguration> getConfiguredNetworks()
  {
    ...
    try
    {
      List localList = aDZ.getConfiguredNetworks();
  ...
  public static WifiInfo getConnectionInfo()
  {
    ...
    try
    {
      WifiInfo localWifiInfo = aDZ.getConnectionInfo();
  ...
  public static List<ScanResult> getScanResults()
  {
    ...
    try
    {
      List localList = aDZ.getScanResults();
  ...
  public static boolean iN(int paramInt)
  {
    ...
    try
    {
      boolean bool = aDZ.enableNetwork(paramInt, true);
  ...
  public static boolean isWifiEnabled()
  {
    ...
    try
    {
      boolean bool = aDZ.isWifiEnabled();
  ...
  public static boolean removeNetwork(int paramInt)
  {
    ...
    try
    {
      boolean bool = aDZ.removeNetwork(paramInt);
  ...
  public static boolean saveConfiguration()
  {
    ...
    try
    {
      boolean bool = aDZ.saveConfiguration();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/wifi/wifisdk/internal/c.class
