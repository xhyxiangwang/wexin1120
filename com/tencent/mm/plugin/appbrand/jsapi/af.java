  ...
  extends a
{
  ...
  public final void a(final k paramk, JSONObject paramJSONObject, final int paramInt)
  {
    ...
    localJsApiGetStorageTask.iQi = new Runnable()
    {
      public final void run()
      {
        ...
        for (String str2 = "";; str2 = localJsApiGetStorageTask.type)
        {
          ...
          paramk.v(paramInt, af.this.d(str1, localHashMap));
          localJsApiGetStorageTask.VE();
          w.i("MicroMsg.JsApiGetStorage", "getStorage: %s, time: %d", new Object[] { localJsApiGetStorageTask.amo, Long.valueOf(System.currentTimeMillis() - l) });
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/af.class
