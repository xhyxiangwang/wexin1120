  ...
  extends a
{
  ...
  public final void a(k paramk, JSONObject paramJSONObject, int paramInt)
  {
    ...
    try
    {
      l = g.rW(paramJSONObject.getString("frontColor"));
      if (l == -1L) {
        throw new Exception();
      }
    }
    ...
    int j = (int)l;
    long l = g.rW(paramJSONObject.getString("backgroundColor"));
    if (l == -1L) {
      throw new Exception();
    }
    int k = (int)l;
    ...
    {
      paramk.v(paramInt, d("fail:no page for now", null));
      GMTrace.o(17395288637440L, 129605);
      return;
    }
    int m = ((AppBrandPageView)localObject1).jkY.Co;
    int n = ((AppBrandPageView)localObject1).jkY.jyE;
    ...
    for (;;)
    {
      ...
      ((ValueAnimator)localObject2).addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
      {
        public final void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
        {
          ...
          localAppBrandPageView.jlh = true;
          localAppBrandPageView.jli = i;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/bq.class
