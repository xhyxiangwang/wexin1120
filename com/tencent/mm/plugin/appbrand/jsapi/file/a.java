  ...
  extends com.tencent.mm.plugin.appbrand.jsapi.a
{
  ...
  public final void a(final k paramk, final JSONObject paramJSONObject, final int paramInt)
  {
    ...
    for (paramJSONObject = "md5"; bg.mZ(str2); paramJSONObject = "sha1")
    {
    ...
    e.post(new Runnable()
    {
      public final void run()
      {
        ...
        Object localObject = c.aI(str1, str2);
        if (localObject == null)
        {
          paramk.v(paramInt, a.this.d("fail:file doesn't exist", null));
          GMTrace.o(17380658905088L, 129496);
          return;
        }
        File localFile = new File(((AppBrandLocalMediaObject)localObject).hhT);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/jsapi/file/a.class
