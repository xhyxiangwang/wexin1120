...
{
  public static final AppBrandLocalMediaObject iDA;
  static final String iDy;
  private static final Collection<a> iDz;
  
  static
  {
    GMTrace.i(10640647258112L, 79279);
    String str = com.tencent.mm.compatible.util.e.gZT;
    Object localObject = str;
    if (!str.endsWith("/")) {
      localObject = str + "/";
    }
    iDy = (String)localObject + "wxafiles/";
    localObject = new LinkedList();
    ((Collection)localObject).add(new d());
    ((Collection)localObject).add(new c());
    iDz = Collections.unmodifiableCollection((Collection)localObject);
    iDA = new AppBrandLocalMediaObjectManager.3();
  ...
  public static AppBrandLocalMediaObject a(AppBrandLocalMediaObject paramAppBrandLocalMediaObject)
  {
    ...
    Iterator localIterator = iDz.iterator();
  ...
  private static <T extends AppBrandLocalMediaObject> T a(String paramString1, String paramString2, Class<T> paramClass, String paramString3, boolean paramBoolean)
  {
    ...
    String str = com.tencent.mm.pluginsdk.ui.tools.s.OZ(paramString2);
    if (bg.mZ(str))
    {
      str = paramString3;
      paramString3 = null;
    ...
    try
    {
      ...
      paramString1.fAx = ((String)paramString3.get(0));
      paramString1.mimeType = com.tencent.mm.pluginsdk.ui.tools.s.OX(str);
      paramString1.hhT = ((String)paramString3.get(1));
      if (bg.mZ(paramString1.hhT))
      {
        w.e("MicroMsg.AppBrand.LocalMediaObjectManager", "attachCast appId %s, Null Or Nil fileFullPath");
        GMTrace.o(10638902427648L, 79266);
        return null;
      }
      paramString1.iDv = bg.ap((String)paramString3.get(3), bg.ap(str, "unknown"));
      paramClass = paramString1.hhT;
      if ((paramBoolean) && (aE(paramString2, paramClass))) {
        i = 1;
      }
      while (i != 0)
      {
        paramString2 = new File(paramString1.hhT);
        paramString1.ieX = paramString2.length();
        paramString1.iDx = paramString2.lastModified();
        GMTrace.o(10638902427648L, 79266);
        return paramString1;
        if (!paramBoolean)
        {
          paramBoolean = j.eD(paramString2, paramClass);
          if (paramBoolean)
          {
            i = 1;
            continue;
  ...
  public static String aD(String paramString1, String paramString2)
  {
    ...
    paramString1 = on(paramString1) + paramString2;
    GMTrace.o(10638097121280L, 79260);
    return paramString1;
  }
  ...
  public static boolean aE(String paramString1, String paramString2)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21) {
      try
      {
        ...
        w.d("MicroMsg.AppBrand.LocalMediaObjectManager", "renameToImpl, os rename works, cost = %d", new Object[] { Long.valueOf(bg.Pp() - l) });
  ...
  public static AppBrandLocalVideoObject aF(String paramString1, String paramString2)
  {
  ...
  public static String aG(String paramString1, String paramString2)
  {
    ...
    byte[] arrayOfByte = bg.RA(paramString1);
  ...
  private static AppBrandLocalMediaObject aH(String paramString1, String paramString2)
  {
    Object localObject = null;
    ...
    while (localIterator.hasNext())
    {
      AppBrandLocalMediaObject localAppBrandLocalMediaObject = ((a)localIterator.next()).aK(paramString1, paramString2);
      localObject = localAppBrandLocalMediaObject;
      if (localAppBrandLocalMediaObject != null) {
        localObject = localAppBrandLocalMediaObject;
      }
  ...
  public static AppBrandLocalMediaObject aI(String paramString1, String paramString2)
  {
    GMTrace.i(10639707734016L, 79272);
    if ((bg.mZ(paramString2)) || (!paramString2.startsWith("wxfile://")) || (bg.mZ(paramString1)))
    {
    ...
    if (localIterator.hasNext())
    {
      ...
      paramString2 = locala.aJ(paramString1, str);
  ...
  public static String encrypt(String paramString1, String paramString2)
  {
    ...
    paramString1 = bg.br(new com.tencent.mm.platformtools.s().encrypt(paramString1.getBytes(), paramString2.getBytes()));
    GMTrace.o(16057943195648L, 119641);
    return paramString1;
  }
  
  public static List<AppBrandLocalMediaObject> oj(String paramString)
  {
    GMTrace.i(10638365556736L, 79262);
    File[] arrayOfFile = ok(paramString);
    ...
    while (i < j)
    {
      AppBrandLocalMediaObject localAppBrandLocalMediaObject = aH(paramString, arrayOfFile[i].getName());
      if (localAppBrandLocalMediaObject != null) {
  ...
  private static File[] ok(String paramString)
  {
    GMTrace.i(10638499774464L, 79263);
    paramString = new File(on(paramString));
    ...
    paramString = paramString.listFiles(new FileFilter()
    {
      public final boolean accept(File paramAnonymousFile)
      {
        ...
        if ((paramAnonymousFile.exists()) && (!paramAnonymousFile.isDirectory()) && (!bg.mZ(paramAnonymousFile.getName())) && (paramAnonymousFile.getName().startsWith("store_")))
        {
  ...
  public static long ol(String paramString)
  {
    long l1 = 0L;
    ...
    for (paramString = null; (paramString == null) || (paramString.length <= 0); paramString = paramString.listFiles(new FileFilter()
        {
          public final boolean accept(File paramAnonymousFile)
          {
            ...
            if ((paramAnonymousFile.exists()) && (!paramAnonymousFile.isDirectory()) && (!bg.mZ(paramAnonymousFile.getName())) && (paramAnonymousFile.getName().startsWith("tmp_")))
            {
  ...
  public static long om(String paramString)
  {
    long l1 = 0L;
  ...
  public static long oo(String paramString)
  {
  ...
  private static abstract interface a
  {
    ...
    public abstract AppBrandLocalMediaObject aJ(String paramString1, String paramString2);
    ...
    implements c.a
  {
    ...
    public final AppBrandLocalMediaObject aJ(String paramString1, String paramString2)
    {
      ...
      try
      {
        String str1 = c.aG(paramString2, paramString1);
        localObject = str1;
      }
      catch (Exception localException)
      {
        ...
        GMTrace.o(10636889161728L, 79251);
        return null;
        localObject = c.on(paramString1) + paramString2 + ".dat";
        String str2 = c.on(paramString1) + paramString2 + ".tmp";
      ...
      paramString1.fAx = ("wxfile://" + paramString2);
      paramString1.hhT = ((String)localObject);
      paramString1.mimeType = str4;
      paramString1.iDv = com.tencent.mm.pluginsdk.ui.tools.s.Od(str4);
      paramString1.iDw = false;
      GMTrace.o(10636889161728L, 79251);
      return paramString1;
    }
    ...
    implements c.a
  {
    ...
    public final AppBrandLocalMediaObject a(AppBrandLocalMediaObject paramAppBrandLocalMediaObject)
    {
      ...
      String str = paramAppBrandLocalMediaObject.hhT.replaceFirst("tmp_", "store_");
      if (c.aE(paramAppBrandLocalMediaObject.hhT, str))
      {
        AppBrandLocalMediaObject localAppBrandLocalMediaObject = new AppBrandLocalMediaObject();
        localAppBrandLocalMediaObject.hhT = str;
        localAppBrandLocalMediaObject.fAx = paramAppBrandLocalMediaObject.fAx.replaceFirst("tmp_", "store_");
        localAppBrandLocalMediaObject.ieX = paramAppBrandLocalMediaObject.ieX;
        localAppBrandLocalMediaObject.iDv = paramAppBrandLocalMediaObject.iDv;
        localAppBrandLocalMediaObject.iDx = new File(localAppBrandLocalMediaObject.hhT).lastModified();
        localAppBrandLocalMediaObject.mimeType = paramAppBrandLocalMediaObject.mimeType;
        localAppBrandLocalMediaObject.iDw = true;
        GMTrace.o(10630446710784L, 79203);
    ...
    public final AppBrandLocalMediaObject aJ(String paramString1, String paramString2)
    {
      ...
      String str2 = com.tencent.mm.pluginsdk.ui.tools.s.OZ(paramString2);
      ...
      try
      {
        String str1 = c.aG((String)localObject1, paramString1);
        localObject2 = str1;
      }
      catch (Exception localException)
      {
        ...
        {
          localObject1 = c.on(paramString1) + (String)localObject2 + (String)localObject1;
        ...
        try
        {
          long l2 = c.oo((String)localObject1);
          if (l1 != l2)
          {
        ...
        paramString1 = new AppBrandLocalMediaObject();
        paramString1.fAx = ("wxfile://" + paramString2);
        paramString1.hhT = ((String)localObject1);
        paramString1.mimeType = com.tencent.mm.pluginsdk.ui.tools.s.OX((String)localObject3);
        paramString1.iDw = ((String)localObject2).equalsIgnoreCase("store_");
        paramString2 = new File(paramString1.hhT);
        paramString1.iDx = paramString2.lastModified();
        paramString1.ieX = paramString2.length();
        GMTrace.o(10630312493056L, 79202);
    ...
    public final AppBrandLocalMediaObject aK(String paramString1, String paramString2)
    {
      ...
      try
      {
        String str1 = c.aG(str2, paramString1);
        if (bg.mZ(str1))
        {
      ...
      for (Object localObject1 = "";; localObject1 = "." + (String)localObject1)
      {
        ...
        ((AppBrandLocalMediaObject)localObject1).fAx = ((String)localObject2);
        ((AppBrandLocalMediaObject)localObject1).hhT = (c.on(paramString1) + paramString2);
        ((AppBrandLocalMediaObject)localObject1).iDv = str2;
        ((AppBrandLocalMediaObject)localObject1).iDw = true;
        paramString1 = new File(((AppBrandLocalMediaObject)localObject1).hhT);
        ((AppBrandLocalMediaObject)localObject1).iDx = paramString1.lastModified();
        ((AppBrandLocalMediaObject)localObject1).ieX = paramString1.length();
        GMTrace.o(10630715146240L, 79205);
    ...
    public final a w(String paramString1, String paramString2, String paramString3)
    {
      ...
      //   8: aload_3
      //   9: ldc -49
      //   11: invokestatic 210	com/tencent/mm/sdk/platformtools/bg:ap	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
      //   14: astore_3
      //   15: aload_2
      //   16: invokestatic 163	com/tencent/mm/plugin/appbrand/appstorage/c:oo	(Ljava/lang/String;)J
      //   19: lstore 4
      ...
      //   51: astore_2
      //   52: aload_2
      //   53: invokestatic 107	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
      //   56: ifeq +60 -> 116
      //   59: ldc2_w 203
      //   62: ldc -51
      ...
      //   141: aload_1
      //   142: invokestatic 152	com/tencent/mm/plugin/appbrand/appstorage/c:on	(Ljava/lang/String;)Ljava/lang/String;
      ...
      //   171: astore 6
      //   173: aload_3
      //   174: invokestatic 107	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
      //   177: ifeq +81 -> 258
      //   180: ldc 102
      //   182: astore_1
      //   183: aload 6
      ...
      //   237: aload_3
      //   238: aastore
      //   239: putfield 242	com/tencent/mm/vending/j/a:xbK	[Ljava/lang/Object;
      //   242: aload 6
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/appstorage/c.class
