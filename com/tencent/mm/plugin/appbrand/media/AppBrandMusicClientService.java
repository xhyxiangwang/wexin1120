...
{
  public static AppBrandMusicClientService jhe;
  public HashMap<String, b> jhd;
  public volatile String jhf;
  
  static
  {
    GMTrace.i(18245692162048L, 135941);
    jhe = new AppBrandMusicClientService();
  ...
  public final void iR(int paramInt)
  {
    ...
    Iterator localIterator = this.jhd.entrySet().iterator();
    while (localIterator.hasNext())
    {
      ...
      if (localObject != null)
      {
        ...
        if ((!TextUtils.isEmpty(this.jhf)) && (this.jhf.equalsIgnoreCase(str)))
        {
          w.i("MicroMsg.AppBrandMusicClientService", "current play music appId is %s", new Object[] { this.jhf });
          if (localObject != null) {
            if (paramInt == 10) {
              ((b)localObject).SW();
            } else if (paramInt == 2) {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/media/AppBrandMusicClientService.class
