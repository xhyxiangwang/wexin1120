...
{
  int jhE;
  private MediaCodec jhF;
  MediaCodec.BufferInfo jhG;
  ...
  public final boolean a(boolean paramBoolean, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    if (this.jhF != null)
    {
      ...
      Object localObject2 = this.jhF.getInputBuffers();
      Object localObject1 = this.jhF.getOutputBuffers();
      paramInt = this.jhF.dequeueInputBuffer(100L);
      if (paramInt >= 0)
      {
        ...
        if (paramBoolean)
        {
          this.jhF.queueInputBuffer(paramInt, 0, paramArrayOfByte.length, System.nanoTime(), 4);
          paramArrayOfByte = (byte[])localObject1;
          paramInt = this.jhF.dequeueOutputBuffer(this.jhG, 100L);
          if (paramInt != -1) {
            break label251;
          }
      ...
      for (;;)
      {
        ...
        GMTrace.o(19852681019392L, 147914);
        return true;
        this.jhF.queueInputBuffer(paramInt, 0, paramArrayOfByte.length, System.nanoTime(), 0);
        paramArrayOfByte = (byte[])localObject1;
        break;
        ...
        if (paramInt == -3)
        {
          ...
          paramArrayOfByte = this.jhF.getOutputBuffers();
          break;
        }
        if (paramInt == -2)
        {
          localObject1 = this.jhF.getOutputFormat();
        ...
        if ((this.jhG.flags & 0x2) != 0) {
          w.e("MicroMsg.AACAudioEncoder", "flags is BUFFER_FLAG_CODEC_CONFIG, don't writ data into file");
        }
        for (;;)
        {
          this.jhF.releaseOutputBuffer(paramInt, false);
          if ((this.jhG.flags & 0x4) == 0) {
            break;
          }
          if (paramBoolean) {
            break label520;
  ...
  public final boolean e(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    try
    {
      ...
      this.jhG = new MediaCodec.BufferInfo();
      MediaFormat localMediaFormat = MediaFormat.createAudioFormat(this.jhI, paramInt1, paramInt2);
      localMediaFormat.setInteger("bitrate", paramInt3);
      localMediaFormat.setInteger("aac-profile", this.jhE);
      this.jhF = MediaCodec.createEncoderByType(this.jhI);
      this.jhF.configure(localMediaFormat, null, null, 1);
      this.jhF.start();
    ...
    catch (Exception localException)
    {
      ...
      if (M4aAudioFormatJni.createM4aFile(paramString, paramInt2, paramInt1, this.jhE) != 0) {
        break label255;
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/media/encode/a.class
