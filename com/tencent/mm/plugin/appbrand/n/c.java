...
{
  private static DisplayMetrics jwd;
  
  static
  {
    GMTrace.i(20014413381632L, 149119);
    jwd = ab.getContext().getResources().getDisplayMetrics();
  ...
  private static int a(JSONArray paramJSONArray, int paramInt)
  {
    ...
    try
    {
      paramInt = Math.round(W((float)paramJSONArray.getDouble(0)));
      GMTrace.o(20014010728448L, 149116);
      return paramInt;
    }
    catch (Exception paramJSONArray)
  ...
  public static int jE(int paramInt)
  {
    ...
    paramInt = (int)(paramInt / jwd.density);
    GMTrace.o(20012936986624L, 149108);
    return paramInt;
  }
  ...
  public static int jF(int paramInt)
  {
    ...
    paramInt = (int)(jwd.density * paramInt);
    GMTrace.o(20013205422080L, 149110);
    return paramInt;
  }
  
  public static int k(JSONArray paramJSONArray)
  {
  ...
  {
    GMTrace.i(20372640497664L, 151788);
    int i = a(paramJSONArray, 0);
    GMTrace.o(20372640497664L, 151788);
    return i;
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/n/c.class
