...
{
  public static CodingErrorAction jyt;
  
  static
  {
    GMTrace.i(10178938273792L, 75839);
    jyt = CodingErrorAction.REPORT;
  ...
  public static String m(ByteBuffer paramByteBuffer)
  {
    ...
    ((CharsetDecoder)localObject).onMalformedInput(jyt);
    ((CharsetDecoder)localObject).onUnmappableCharacter(jyt);
    try
    {
  ...
  public static byte[] sm(String paramString)
  {
  ...
  public static byte[] sn(String paramString)
  {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/p/f/b.class
