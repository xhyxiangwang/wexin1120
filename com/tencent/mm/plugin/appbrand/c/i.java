...
public final class i
{
    ...
    implements bp.a
  {
    ...
    public static void Tu()
    {
      ...
      ((com.tencent.mm.plugin.messenger.foundation.a.n)h.j(com.tencent.mm.plugin.messenger.foundation.a.n.class)).getSysCmdMsgExtension().a("UpdateWxaUsageListNotify", iEX, true);
        ...
        for (;;)
        {
          ...
          if (!bg.bX(paramString))
          {
            ...
            if (!bg.bX(paramString))
            {
              ...
              while (i < paramString.size())
              {
                com.tencent.mm.plugin.appbrand.app.f.Sg().h((String)paramString.get(i), ((Integer)localArrayList2.get(i)).intValue(), false);
                i += 1;
              }
            }
          }
    ...
    public static void unregister()
    {
      ...
      ((com.tencent.mm.plugin.messenger.foundation.a.n)h.j(com.tencent.mm.plugin.messenger.foundation.a.n.class)).getSysCmdMsgExtension().b("UpdateWxaUsageListNotify", iEX, true);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/c/i.class
