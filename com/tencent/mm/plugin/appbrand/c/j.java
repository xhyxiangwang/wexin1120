  ...
  extends com.tencent.mm.sdk.e.j
{
  ...
  static
  {
    ...
    iAV = new String[] { i.a(a.iBQ, "AppBrandLauncherLayoutItem") };
  ...
  private void Tx()
  {
    ...
    Object localObject1 = this.iCj.a(String.format(Locale.US, "select count(*) from %s where %s=?", new Object[] { "AppBrandLauncherLayoutItem", "scene" }), new String[] { "2" }, 0);
    int i;
    ...
    while (i > 200)
    {
      ...
      else
      {
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          this.iCj.delete("AppBrandLauncherLayoutItem", String.format(Locale.US, "%s=?", new Object[] { "recordId" }), new String[] { localObject3 });
        }
        this.iCj.aJ(l);
        ...
        {
          String str = p.pb((String)localArrayList1.get(i));
          if (!bg.mZ(str))
          {
        ...
        if (f.Sh() != null) {
          f.Sh().d((List)localObject2, (List)localObject3);
        }
  ...
  public static ArrayList<e> c(Cursor paramCursor)
  {
    ...
    if (paramCursor.moveToFirst())
    {
      ...
      do
      {
        ...
        if (!bg.mZ(((a)localObject).field_brandId)) {
          localLinkedList.add(p.a(String.valueOf(((a)localObject).field_recordId), ((a)localObject).field_brandId, ((a)localObject).field_versionType, ((a)localObject).field_updateTime));
        }
  ...
  final Cursor a(String[] paramArrayOfString, int paramInt1, int paramInt2)
  {
    ...
    paramArrayOfString = this.iCj.query("AppBrandLauncherLayoutItem", paramArrayOfString, String.format(Locale.US, "%s=? order by %s desc limit %d offset %d", new Object[] { "scene", "updateTime", Integer.valueOf(paramInt1), Integer.valueOf(paramInt2) }), new String[] { "2" }, null, null, null);
  ...
  final boolean a(a parama)
  {
    ...
    if (bg.mZ(parama.field_brandId))
    {
      GMTrace.o(10018682306560L, 74645);
      return false;
    }
    long l = this.iCj.insert("AppBrandLauncherLayoutItem", "", parama.qQ());
  ...
  public final boolean a(String paramString1, int paramInt1, boolean paramBoolean1, boolean paramBoolean2, int paramInt2, int paramInt3, String paramString2)
  {
    ...
    if ((bg.mZ(paramString1)) || (999 == paramInt1))
    {
    ...
    localObject = this.iCj.a((String)localObject, new String[] { "2" }, 0);
    long l;
    int i;
    label183:
    boolean bool1;
    ...
    {
      l = 0L;
      l = Math.max(l + 1L, bg.Po());
      int j = r(paramString1, paramInt1, 2);
      localObject = new ContentValues(1);
      ((ContentValues)localObject).put("updateTime", Long.valueOf(l));
      if (this.iCj.update("AppBrandLauncherLayoutItem", (ContentValues)localObject, String.format(Locale.US, "%s=?", new Object[] { "recordId" }), new String[] { String.valueOf(j) }) <= 0) {
        break label356;
      }
      i = 1;
      if (i != 0) {
  ...
  public final boolean aa(String paramString, int paramInt)
  {
    ...
    paramString = this.iCj.a(String.format(Locale.US, "select count(*) from %s where %s=? and %s=? and %s=?", new Object[] { "AppBrandLauncherLayoutItem", "brandId", "versionType", "scene" }), new String[] { paramString, String.valueOf(paramInt), "2" }, 0);
    if (paramString == null)
    {
      GMTrace.o(18297365987328L, 136326);
      return false;
  ...
  public final e oq(String paramString)
  {
    ...
    Cursor localCursor = this.iCj.query("AppBrandLauncherLayoutItem", null, String.format(Locale.US, "%s=? and %s=?", new Object[] { "scene", "recordId" }), new String[] { "2", paramString }, null, null, null);
    if (localCursor == null)
    {
      GMTrace.o(10018145435648L, 74641);
      return null;
  ...
  public final List<String> or(String paramString)
  {
    ...
    extends com.tencent.mm.g.b.j
  {
    ...
    static
    {
      ...
      iAT = new String[] { "brandId", "versionType", "scene" };
      c.a locala = new c.a();
      locala.hRR = new Field[5];
      locala.columns = new String[6];
      StringBuilder localStringBuilder = new StringBuilder();
      locala.columns[0] = "recordId";
      locala.uQH.put("recordId", "INTEGER PRIMARY KEY ");
      ...
      locala.uQH.put("versionType", "INTEGER");
    ...
    public final ContentValues qQ()
    {
      ...
      this.uQF = 0L;
      ContentValues localContentValues = super.qQ();
    ...
    extends i<j.a>
  {
    ...
    {
      super(j.a.iBQ, "AppBrandLauncherLayoutItem", j.a.fSf);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/c/j.class
