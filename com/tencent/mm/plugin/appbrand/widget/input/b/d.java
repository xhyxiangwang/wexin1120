...
{
  public static Integer aT(Object paramObject)
  {
  ...
  static <T extends Enum> T g(String paramString, Class<T> paramClass)
  {
    ...
    while ((bg.mZ(paramString)) || (paramString.length() > i))
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/widget/input/b/d.class
