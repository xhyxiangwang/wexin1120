...
public enum ac
{
  ...
  static
  {
    ...
    jEa = (Class)localObject;
    GMTrace.o(10054250004480L, 74910);
  }
  
  static boolean aS(Object paramObject)
  {
    GMTrace.i(19867713404928L, 148026);
    boolean bool = jEa.isInstance(paramObject);
  ...
  static boolean t(CharSequence paramCharSequence)
  {
    ...
    if ((paramCharSequence instanceof Spanned))
    {
      ...
      paramCharSequence = paramCharSequence.getSpans(0, paramCharSequence.length(), jEa);
  ...
  static enum b
  {
    ...
    static void c(EditText paramEditText)
    {
      ...
      ac.cb(paramEditText).hideSoftInputFromInputMethod(paramEditText.getWindowToken(), 2);
      GMTrace.o(14318213005312L, 106679);
    }
      ...
      catch (NoSuchMethodException localNoSuchMethodException)
      {
        ...
        catch (Exception localException)
        {
          ...
          if ((paramEditText.getContext() != null) && ((paramEditText.getContext() instanceof MMActivity))) {
            ((MMActivity)paramEditText.getContext()).da(paramEditText);
          }
          GMTrace.o(14318347223040L, 106680);
          return;
        }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/widget/input/ac.class
