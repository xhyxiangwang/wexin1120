...
public final class f
{
    ...
    implements a
  {
    ...
    public final void a(Bundle paramBundle, com.tencent.mm.ipcinvoker.c paramc)
    {
      ...
      Object localObject = d.UB().iKD.values();
      if ((localObject == null) || (((Collection)localObject).isEmpty()))
      {
        GMTrace.o(18317364428800L, 136475);
        return;
      }
      paramc = new com.tencent.mm.plugin.appbrand.dynamic.d.d();
      paramBundle = paramc.name;
      paramc = paramc.or().toString();
      localObject = ((Collection)localObject).iterator();
      while (((Iterator)localObject).hasNext())
      {
        c localc = (c)((Iterator)localObject).next();
        if (localc != null) {
          localc.aS(paramBundle, paramc);
        }
      }
      GMTrace.o(18317364428800L, 136475);
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/dynamic/f.class
