  ...
  implements e
{
  ...
  public final Bitmap a(final String paramString1, final String paramString2, final e.a parama)
  {
    ...
    {
      paramString1 = com.tencent.mm.plugin.appbrand.appstorage.c.aI(paramString1, paramString2);
      if ((paramString1 == null) || (TextUtils.isEmpty(paramString1.hhT)))
      {
        GMTrace.o(19914958045184L, 148378);
        return null;
      }
      paramString2 = paramString1.hhT;
      paramString1 = paramString2;
      if (!paramString2.startsWith("file://")) {
        paramString1 = "file://" + paramString2;
      }
      localObject = b.CT().hh(paramString1);
    }
    for (;;)
    {
      GMTrace.o(19914958045184L, 148378);
      ...
      {
        Bitmap localBitmap = b.CT().hh(paramString2);
      ...
      {
        localObject = a.aT(paramString1, paramString2);
      }
    }
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/dynamic/b/c.class
