...
{
  private static final Map<String, List<h.a>> gOl;
  private static final Map<String, DebuggerInfo> iLi;
  
  static
  {
    GMTrace.i(18315753816064L, 136463);
    gOl = new ConcurrentHashMap();
    iLi = new ConcurrentHashMap();
  ...
  public static void a(String paramString, DebuggerInfo paramDebuggerInfo)
  {
    ...
    iLi.put(paramString, paramDebuggerInfo);
  ...
  public static void a(String paramString, ArrayList<LogInfo> paramArrayList)
  {
    ...
    if ((bg.mZ(paramString)) || (paramArrayList == null) || (paramArrayList.isEmpty()))
    {
      GMTrace.o(18315485380608L, 136461);
      return;
    }
    paramString = (List)gOl.get(paramString);
    if (paramString == null)
    {
      GMTrace.o(18315485380608L, 136461);
      return;
  ...
  public static boolean c(String paramString, h.a parama)
  {
    ...
    if ((bg.mZ(paramString)) || (parama == null))
    {
      GMTrace.o(18315216945152L, 136459);
      return false;
    }
    Object localObject = (List)gOl.get(paramString);
    if (localObject == null)
    {
      localObject = new LinkedList();
      gOl.put(paramString, localObject);
  ...
  public static boolean d(String paramString, h.a parama)
  {
    ...
    List localList = (List)gOl.get(paramString);
    if (localList == null)
    {
      GMTrace.o(18315351162880L, 136460);
      return false;
  ...
  public static DebuggerInfo pq(String paramString)
  {
    GMTrace.i(18314948509696L, 136457);
    paramString = (DebuggerInfo)iLi.get(paramString);
  ...
  public static void r(String paramString, int paramInt)
  {
    ...
    paramString = new LinkedList(paramString).iterator();
    while (paramString.hasNext()) {
      ((h.a)paramString.next()).fy(paramInt);
    }
    GMTrace.o(18315619598336L, 136462);
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/dynamic/debugger/b.class
