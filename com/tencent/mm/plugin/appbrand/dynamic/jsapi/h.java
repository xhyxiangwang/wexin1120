  ...
  extends com.tencent.mm.jsapi.b.a
{
  ...
  {
    GMTrace.i(19931735261184L, 148503);
    parama = parama.ww();
    b localb = new b();
    localb.id = parama.getString("__page_view_id", "");
    localb.url = paramJSONObject.optString("url", "");
    XIPCInvoker.a(parama.getString("__process_name", ab.vR()), localb, a.class, new com.tencent.mm.ipcinvoker.h() {});
    GMTrace.o(19931735261184L, 148503);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/dynamic/jsapi/h.class
