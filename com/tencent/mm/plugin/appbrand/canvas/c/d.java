...
{
  private Map<String, a> iGa;
  
  public d()
  {
    GMTrace.i(10206989778944L, 76048);
    this.iGa = new HashMap();
    a(new g());
    a(new e());
    a(new f());
    a(new h());
  ...
  private void a(a parama)
  {
    ...
    this.iGa.put(parama.getMethod(), parama);
  ...
  public final Path f(JSONArray paramJSONArray)
  {
    ...
    while (i < paramJSONArray.length())
    {
      ...
      if (localObject2 != null)
      {
        ...
        localObject1 = (a)this.iGa.get(localObject1);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/canvas/c/d.class
