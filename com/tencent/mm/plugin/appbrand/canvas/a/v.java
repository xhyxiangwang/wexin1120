  ...
  implements d
{
  ...
  public final boolean a(com.tencent.mm.plugin.appbrand.canvas.d paramd, Canvas paramCanvas, JSONArray paramJSONArray)
  {
    ...
    {
      paramd.iFJ.setStrokeJoin(Paint.Join.MITER);
      paramd.iFI.setStrokeJoin(Paint.Join.MITER);
    }
    for (;;)
    {
      GMTrace.o(17711505604608L, 131961);
      ...
      {
        paramd.iFJ.setStrokeJoin(Paint.Join.ROUND);
        paramd.iFI.setStrokeJoin(Paint.Join.ROUND);
      }
      else if ("bevel".equalsIgnoreCase(paramCanvas))
      {
        paramd.iFJ.setStrokeJoin(Paint.Join.BEVEL);
        paramd.iFI.setStrokeJoin(Paint.Join.BEVEL);
      }
    }
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/canvas/a/v.class
