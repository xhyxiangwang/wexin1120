  ...
  implements d
{
  ...
  public final boolean a(com.tencent.mm.plugin.appbrand.canvas.d paramd, Canvas paramCanvas, JSONArray paramJSONArray)
  {
    ...
    {
      paramd.iFJ.setStrokeCap(Paint.Cap.BUTT);
      paramd.iFI.setStrokeCap(Paint.Cap.BUTT);
    }
    for (;;)
    {
      GMTrace.o(17711102951424L, 131958);
      ...
      {
        paramd.iFJ.setStrokeCap(Paint.Cap.ROUND);
        paramd.iFI.setStrokeCap(Paint.Cap.ROUND);
      }
      else if ("square".equalsIgnoreCase(paramCanvas))
      {
        paramd.iFJ.setStrokeCap(Paint.Cap.SQUARE);
        paramd.iFI.setStrokeCap(Paint.Cap.SQUARE);
      }
    }
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/canvas/a/t.class
