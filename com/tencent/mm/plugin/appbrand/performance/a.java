...
{
  private static List<a> jmQ;
  public static long sAppStartTime;
  
  static
  {
    GMTrace.i(17321871540224L, 129058);
    jmQ = Collections.synchronizedList(new LinkedList());
  ...
  public static void a(String paramString1, String paramString2, String paramString3, String paramString4, long paramLong1, long paramLong2, String paramString5)
  {
    ...
    if (!AppBrandPerformanceManager.rH(paramString1))
    {
  ...
  /* Error */
  private static final boolean bc(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_2
    ...
    //   10: invokestatic 156	com/tencent/mm/compatible/util/f:tD	()Z
    //   13: ifne +20 -> 33
    //   16: ldc -98
    //   18: ldc -96
  ...
  public static final boolean rK(String paramString)
  {
    ...
    synchronized (jmQ)
    {
      w.d("MicroMsg.AppBrandPerformanceTracer", "dumpTrace events size: %d", new Object[] { Integer.valueOf(jmQ.size()) });
      Iterator localIterator = jmQ.iterator();
    ...
    jmQ.clear();
    boolean bool = bc(paramString, localStringBuffer.toString());
    GMTrace.o(17664260964352L, 131609);
    return bool;
  }
  ...
  public static final class a
  {
    ...
    public final String toString()
    {
      ...
      String str = this.name + "," + this.category + "," + this.jmR + "," + (this.start - a.sAppStartTime) + "," + (this.jmS - a.sAppStartTime) + "," + this.jmT;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/appbrand/performance/a.class
