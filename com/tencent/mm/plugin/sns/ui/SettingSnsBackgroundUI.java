  ...
  extends MMPreference
{
  ...
  private void ahh()
  {
    ...
    if (!com.tencent.mm.pluginsdk.ui.tools.k.c(this, com.tencent.mm.compatible.util.e.gKA, "microMsg." + System.currentTimeMillis() + ".jpg", 2)) {
      Toast.makeText(this, getString(i.j.eFk), 1).show();
    }
  ...
  private void b(int paramInt, Intent paramIntent)
  {
    ...
    case 2: 
      ...
      com.tencent.mm.plugin.sns.c.a.ifM.a(this, paramIntent, 6);
      GMTrace.o(8671404752896L, 64607);
      return;
    case 5: 
      ...
      com.tencent.mm.plugin.sns.c.a.ifM.a(this, paramIntent, (Intent)localObject1, com.tencent.mm.plugin.sns.model.ae.getAccSnsTmpPath(), 6, new a.a()
      {
    ...
    Object localObject1 = com.tencent.mm.plugin.sns.model.ae.bhl();
    paramIntent = this.filePath;
    new LinkedList().add(new com.tencent.mm.plugin.sns.data.h(paramIntent, 2));
    if ((((av)localObject1).bgV() != null) && (!((av)localObject1).bgV().equals("")))
    {
      Object localObject2 = am.dt(com.tencent.mm.plugin.sns.model.ae.getAccSnsPath(), ((av)localObject1).bgV());
      FileOp.kL((String)localObject2);
      FileOp.deleteFile((String)localObject2 + ((av)localObject1).bgV() + "bg_");
      FileOp.o(paramIntent, (String)localObject2 + ((av)localObject1).bgV() + "bg_");
      localObject2 = com.tencent.mm.plugin.sns.model.ae.bhs();
      com.tencent.mm.plugin.sns.storage.k localk = ((l)localObject2).HE(((av)localObject1).bgV());
      localk.field_bgId = "";
      ((l)localObject2).c(localk);
    }
    ((av)localObject1).bhX();
    ((av)localObject1).bgV();
    localObject1 = new aw(7);
    ((aw)localObject1).dx(paramIntent, "");
    ((aw)localObject1).ul(1);
  ...
  protected final void MH()
  {
    ...
    oC(i.j.pRq);
    SnsArtistPreference localSnsArtistPreference = (SnsArtistPreference)this.ilZ.UM("settings_sns_bg_select_bg");
    if (localSnsArtistPreference != null)
    {
      String str = this.gZW.getString("artist_name", "");
      w.d("MicroMsg.SettingSnsBackgroundUI", "artistName" + str);
      localSnsArtistPreference.qGF = str;
      localSnsArtistPreference.bmw();
  ...
  public final boolean a(f paramf, Preference paramPreference)
  {
    ...
    if (paramf.equals("settings_sns_bg_take_photo"))
    {
      ...
      w.i("MicroMsg.SettingSnsBackgroundUI", "summerper checkPermission checkCamera[%b], stack[%s], activity[%s]", new Object[] { Boolean.valueOf(bool), bg.bOd(), this.vov.voR });
      if (!bool)
      {
        GMTrace.o(8671807406080L, 64610);
        return false;
  ...
  protected void onActivityResult(final int paramInt1, final int paramInt2, final Intent paramIntent)
  {
    ...
    com.tencent.mm.kernel.h.xA();
    w.d("MicroMsg.SettingSnsBackgroundUI", com.tencent.mm.kernel.h.xx().wM());
  ...
  public void onRequestPermissionsResult(int paramInt, String[] paramArrayOfString, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ...
      com.tencent.mm.ui.base.h.a(this, getString(i.j.etQ), getString(i.j.etW), getString(i.j.ejv), getString(i.j.duP), false, new DialogInterface.OnClickListener()
      {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/SettingSnsBackgroundUI.class
