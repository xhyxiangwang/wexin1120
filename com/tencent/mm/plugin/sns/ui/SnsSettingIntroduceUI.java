  ...
  extends MMActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.vov.bUK();
    this.qNS = getIntent();
    this.qNQ = ((Button)findViewById(i.f.bjy));
    this.qNQ.setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        GMTrace.i(8364985679872L, 62324);
        g.paX.i(14090, new Object[] { Integer.valueOf(3) });
    ...
    g.paX.i(14090, new Object[] { Integer.valueOf(1) });
    this.qNR = ((Button)findViewById(i.f.bNS));
    this.qNR.setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        GMTrace.i(8577720778752L, 63909);
        paramAnonymousView = new ao();
        paramAnonymousView.fuO.index = 3;
        a.uLm.m(paramAnonymousView);
        paramAnonymousView = new Intent();
        d.b(SnsSettingIntroduceUI.this.vov.voR, "setting", ".ui.setting.SettingsUI", paramAnonymousView);
        paramAnonymousView = new Intent();
        paramAnonymousView.putExtra("enter_scene", e.d.vkC);
        d.b(SnsSettingIntroduceUI.this.vov.voR, "setting", ".ui.setting.SettingsPrivacyUI", paramAnonymousView);
        g.paX.i(14090, new Object[] { Integer.valueOf(2) });
        SnsSettingIntroduceUI.this.finish();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/SnsSettingIntroduceUI.class
