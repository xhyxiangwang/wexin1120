      ...
      catch (IndexOutOfBoundsException localIndexOutOfBoundsException1)
      {
        if (this.qPg < '\003') {
          try
          {
            ...
            for (this.qPg = ((char)(this.qPg + '\001'));; this.qPg = 'd')
            {
          ...
          {
            w.i("MicroMsg.SnsTextView", "tryToFix error set origintext " + bg.mZ(this.noa));
            setText(this.noa);
            onMeasure(paramInt1, paramInt2);
            this.qPg = ((char)(this.qPg + '\001'));
            GMTrace.o(8749116817408L, 65186);
            return;
          }
        }
        w.i("MicroMsg.SnsTextView", "fix error set origintext " + bg.mZ(this.noa));
        setText(this.noa);
        onMeasure(paramInt1, paramInt2);
        this.qPg = ((char)(this.qPg + '\001'));
        GMTrace.o(8749116817408L, 65186);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/SnsTextView.class
