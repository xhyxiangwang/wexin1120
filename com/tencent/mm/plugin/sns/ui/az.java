...
public final class az
{
  ...
  private static HashMap<Long, Long> mRo;
  private static HashMap<Long, String> mRp;
  ...
  private static String G(Context paramContext, int paramInt)
  {
    ...
    paramContext = paramContext.getResources().getStringArray(i.b.aMR);
  ...
  public static CharSequence a(Context paramContext, long paramLong, boolean paramBoolean)
  {
    ...
    {
      paramContext = paramContext.getString(i.j.eag);
      GMTrace.o(8373441396736L, 62387);
      return paramContext;
    }
    ...
    if ((l > 0L) && (l <= 86400000L) && (paramBoolean))
    {
      paramContext = paramContext.getString(i.j.eah);
      GMTrace.o(8373441396736L, 62387);
      return paramContext;
    }
    new GregorianCalendar().setTimeInMillis(paramLong);
    paramContext = DateFormat.format(paramContext.getString(i.j.pQZ), paramLong);
    GMTrace.o(8373441396736L, 62387);
    return paramContext;
  }
  ...
  private static void aw(Context paramContext, String paramString)
  {
    ...
    mRn.put(paramString, localArrayList);
  ...
  public static String f(Context paramContext, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      label179:
      paramContext = paramContext.getResources().getQuantityString(i.h.dke, i, new Object[] { Integer.valueOf(i) });
    ...
    for (;;)
    {
      paramContext = paramContext.getResources().getQuantityString(i.h.dkd, i, new Object[] { Integer.valueOf(i) });
      mRp.put(Long.valueOf(paramLong), paramContext);
      mRo.put(Long.valueOf(paramLong), Long.valueOf(l1));
      GMTrace.o(8372904525824L, 62383);
      break;
      ...
      paramContext = paramContext.getResources().getQuantityString(i.h.dkf, i, new Object[] { Integer.valueOf(i) });
      mRp.put(Long.valueOf(paramLong), paramContext);
      mRo.put(Long.valueOf(paramLong), Long.valueOf(l1));
      GMTrace.o(8372904525824L, 62383);
      break;
  ...
  private static CharSequence g(Context paramContext, long paramLong)
  {
    GMTrace.i(8372367654912L, 62379);
    paramContext = DateFormat.format(paramContext.getString(i.j.eae), paramLong);
  ...
  public static String k(Context paramContext, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (m != 0)
        {
          paramContext = (String)g(paramContext, paramLong);
        ...
        if (i != 0)
        {
          paramContext = paramContext.getString(i.j.eah) + " " + (String)g(paramContext, paramLong);
          GMTrace.o(8372501872640L, 62380);
          return paramContext;
        }
        if (k != 0) {}
        for (String str = (String)DateFormat.format(paramContext.getString(i.j.dZP), paramLong);; str = (String)DateFormat.format(paramContext.getString(i.j.dZZ), paramLong))
        {
          localObject = str;
          if (str.indexOf("-") > 0)
          {
          ...
          paramContext = (String)localObject + " " + (String)g(paramContext, paramLong);
          GMTrace.o(8372501872640L, 62380);
          return paramContext;
        }
      }
  ...
  public static String l(Context paramContext, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        String str = (String)DateFormat.format(paramContext.getString(i.j.dZZ), paramLong);
        localObject = str;
        if (str.indexOf("-") > 0)
        {
          i = localCalendar.get(2);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/az.class
