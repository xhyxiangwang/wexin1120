  ...
  extends MMActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    An(8);
    this.qpM = ((Button)findViewById(i.f.pKl));
    this.qpM.setOnClickListener(new View.OnClickListener()
    {
  ...
  public boolean onKeyDown(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if ((paramInt == 4) && (paramKeyEvent.getAction() == 0))
    {
      ...
      paramKeyEvent.putExtra("KTouchCameraTime", bg.Po());
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/SnsLongMsgUI.class
