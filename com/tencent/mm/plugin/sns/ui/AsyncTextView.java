  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (int i = 3;; i = 2)
    {
      localObject1 = new m(new a(this.qxx, this.userName, this.qxy, 1), this.qxz, i);
      Object localObject2 = getContext();
      String str = this.qxw;
      getTextSize();
      localObject2 = new i(h.d((Context)localObject2, str, i));
      ((i)localObject2).f(localObject1, this.qxw);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/AsyncTextView.class
