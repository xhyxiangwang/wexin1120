  ...
  extends TagImageView
{
  ...
  public MaskImageView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.b = 0;
    this.fwS = true;
    this.qxq = new ae(Looper.getMainLooper());
    ...
    super.setContentDescription(getContext().getResources().getString(i.j.pSD));
  ...
  public final boolean d(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    while ((!isClickable()) && (!isLongClickable()))
    {
      ...
      this.qxq.removeCallbacks(this.qxr);
      continue;
      this.qxq.post(this.qxr);
    }
    GMTrace.o(8737439875072L, 65099);
    return false;
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/MaskImageView.class
