  ...
  extends MMEditText
{
  ...
  public SnsEditText(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.qJe = ((ClipboardManager)this.context.getSystemService("clipboard"));
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (paramMotionEvent.getAction() == 2) {
      if (Math.abs(this.y - paramMotionEvent.getY()) > this.qJi) {
        this.nkH = true;
      }
    }
    for (;;)
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/SnsEditText.class
