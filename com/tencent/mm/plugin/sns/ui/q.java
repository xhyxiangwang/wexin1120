  ...
  implements z
{
  ...
  {
    GMTrace.i(8490345037824L, 63258);
    this.w = -1;
    this.h = -1;
    this.hNh = "";
    this.title = "";
    ...
    GMTrace.o(8490345037824L, 63258);
  }
  
  public final void D(Bundle paramBundle)
  {
    GMTrace.i(8490479255552L, 63259);
    ...
    GMTrace.o(8490479255552L, 63259);
  }
  
  public final void E(Bundle paramBundle)
  {
    GMTrace.i(8490613473280L, 63260);
    GMTrace.o(8490613473280L, 63260);
  }
  ...
  {
    GMTrace.i(8491016126464L, 63263);
    paramString2 = new aw(22);
    ...
    ae.bhl().bgd();
    this.fsU.finish();
    GMTrace.o(8491016126464L, 63263);
    return false;
  }
  
  public final boolean a(int paramInt, Intent paramIntent)
  {
    GMTrace.i(8491150344192L, 63264);
    GMTrace.o(8491150344192L, 63264);
    return false;
  }
  
  public final boolean blb()
  {
    GMTrace.i(8490747691008L, 63261);
    GMTrace.o(8490747691008L, 63261);
    return true;
  }
  
  public final View blc()
  {
    GMTrace.i(8490881908736L, 63262);
    ...
    for (;;)
    {
      ...
      GMTrace.o(8490881908736L, 63262);
      return localView;
  ...
  {
    GMTrace.i(8491284561920L, 63265);
    if ((this.hkH != null) && (!this.hkH.isRecycled())) {
      this.hkH.recycle();
    }
    GMTrace.o(8491284561920L, 63265);
    return false;
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/q.class
