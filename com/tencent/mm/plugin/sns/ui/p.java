  ...
  implements z
{
  ...
  public final boolean a(int paramInt1, int paramInt2, org.a.d.i parami, String paramString1, List<String> paramList1, akv paramakv, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    ae.bhl().bgd();
    this.fsU.finish();
    parami = ((c)h.j(c.class)).getEmojiMgr().vx(this.qyB);
    com.tencent.mm.plugin.report.service.g.paX.i(10993, new Object[] { Integer.valueOf(1), parami });
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/ui/p.class
