  ...
  implements d
{
  ...
  static
  {
    ...
    gMz = new String[] { com.tencent.mm.sdk.e.i.a(i.gLR, "SnsComment") };
    GMTrace.o(8292776542208L, 61786);
  }
  
  public j(g paramg)
  {
    super(paramg, i.gLR, "SnsComment", db.fSf);
  ...
  public final int Mw()
  {
    ...
    Cursor localCursor = this.hhi.a(" select count(*) from SnsComment where isRead = ? and isSilence != ? ", new String[] { "0", "1" }, 2);
    if (localCursor == null)
    {
  ...
  public final boolean ajx()
  {
    ...
    boolean bool = this.hhi.eL("SnsComment", " update SnsComment set isRead = 1 where isRead = 0");
    GMTrace.o(8292508106752L, 61784);
    return bool;
  }
  
  public final Cursor bjR()
  {
    ...
    localObject = this.hhi.a((String)localObject, new String[] { "0", "1" }, 0);
  ...
  public final boolean l(long paramLong, boolean paramBoolean)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      paramBoolean = this.hhi.eL("SnsComment", str);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/storage/j.class
