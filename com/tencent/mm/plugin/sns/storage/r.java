  ...
  extends j
{
  ...
  private static int pVL;
  private static int pWz;
  ...
  static
  {
    ...
    gMz = new String[] { "CREATE TABLE IF NOT EXISTS SnsMedia ( local_id INTEGER PRIMARY KEY, seqId LONG, type INT, createTime LONG, userName VARCHAR(40), totallen INT, offset INT, local_flag INT, tmp_path TEXT, nums INT, try_times INT, StrId VARCHAR(40), upload_buf TEXT, reserved1 INT, reserved2 TEXT, reserved3 TEXT, reserved4 TEXT, reserved5 TEXT )", "CREATE INDEX IF NOT EXISTS serverSnsMediaTimeIndex ON SnsMedia ( createTime )" };
    pWz = 0;
    pVL = 0;
    qdz = new Point();
  ...
  public r(com.tencent.mm.bt.g paramg)
  {
  ...
  private static String HO(String paramString)
  {
  ...
  public static Bitmap HR(String paramString)
  {
    int j = 640;
    GMTrace.i(8307540492288L, 61896);
    localObject1 = com.tencent.mm.sdk.platformtools.d.QI(paramString);
    int i;
    ...
    for (;;)
    {
      ...
      if (((MMBitmapFactory.DecodeResultLogger)localObject2).getDecodeResult() >= 2000)
      {
        ...
        com.tencent.mm.plugin.report.service.g.paX.z(12712, paramString);
      }
  ...
  private int a(h paramh)
  {
    ...
    String str2 = i.FZ((String)localObject2);
    ...
    ((a)localObject1).qvB = ((String)localObject3);
    ((a)localObject1).qvD = j;
    ((a)localObject1).qvE = k;
    ((a)localObject1).qvF = m;
    ...
    j = (int)FileOp.kI(str1 + str2);
    localObject3 = a(paramh, str1 + str2);
    k = ((h)localObject3).width;
    m = ((h)localObject3).height;
    ((a)localObject1).qvG = k;
    ((a)localObject1).qvH = m;
    ((a)localObject1).qvI = j;
    paramh = new q();
    paramh.qvw = ((String)localObject2);
    paramh.hUw = ((int)bg.Po());
    paramh.type = i;
    localObject2 = new amq();
    ((amq)localObject2).uhC = ((h)localObject3).pYs;
    ((amq)localObject2).uhX = ((h)localObject3).pYr;
    ((amq)localObject2).token = ((h)localObject3).pYu;
    ((amq)localObject2).uih = ((h)localObject3).pYv;
    ((amq)localObject2).uiw = 0;
    ((amq)localObject2).uiv = new amk();
    ((amq)localObject2).hkI = 0;
    ((amq)localObject2).mCK = ((h)localObject3).desc;
    w.d("MicroMsg.snsMediaStorage", "upload.filterId " + ((h)localObject3).pYq);
    ((amq)localObject2).uhW = ((h)localObject3).pYq;
    ((amq)localObject2).uiy = 2;
    ((amq)localObject2).fwU = com.tencent.mm.a.g.bg(str1 + str2);
    try
    {
      paramh.qvA = ((amq)localObject2).toByteArray();
      paramh.bkC();
      paramh.qvv = j;
      w.i("MicroMsg.snsMediaStorage", "insert a local snsMedia  totallen  :" + j + " filepath: " + str1 + str2);
      j = (int)this.hhi.insert("SnsMedia", "local_id", paramh.bkB());
      w.d("MicroMsg.snsMediaStorage", "insert localId " + j);
      localObject2 = "Locall_path" + j;
      ((a)localObject1).qvC = String.valueOf(j);
      localObject3 = Exif.fromFile(((a)localObject1).qvB);
      i = 0;
      if (((a)localObject1).qvB.indexOf("png") >= 0)
      {
        i = 1;
        com.tencent.mm.modelsns.d locald = new com.tencent.mm.modelsns.d();
        locald.m("20 localID", ((a)localObject1).qvC + ",");
        locald.m("21 MediaType", i + ",");
        locald.m("22 OriginWidth", ((a)localObject1).qvD + ",");
        locald.m("23 OriginHeight", ((a)localObject1).qvE + ",");
        locald.m("24 CompressedWidth", ((a)localObject1).qvG + ",");
        locald.m("25 CompressedHeight", ((a)localObject1).qvH + ",");
        locald.m("26 OriginSize", ((a)localObject1).qvF + ",");
        locald.m("27 CompressedSize", ((a)localObject1).qvI + ",");
        locald.m("28 FNumber", ((Exif)localObject3).fNumber + ",");
        locald.m("29 ExposureTime", ((Exif)localObject3).exposureTime + ",");
        locald.m("30 ISO", ((Exif)localObject3).isoSpeedRatings + ",");
        locald.m("31 Flash", ((Exif)localObject3).flash + ",");
        locald.m("32 LensModel", a.HS(((Exif)localObject3).model) + ",");
        locald.m("33 CreatTime", a.HS(((Exif)localObject3).dateTimeOriginal) + ",");
        locald.m("34 IsFromWeChat", "0,");
        locald.m("35 Scene", "1,");
        w.v("MicroMsg.snsMediaStorage", "report logbuffer MMImageExifInfo(14525): %s, orgPath:%s", new Object[] { locald.LL(), ((a)localObject1).qvB });
        com.tencent.mm.plugin.report.service.g.paX.i(14525, new Object[] { locald });
        localObject1 = i.FZ((String)localObject2);
        localObject3 = HO((String)localObject2);
        FileOp.kL((String)localObject3);
        w.i("MicroMsg.snsMediaStorage", "checkcntpath " + (String)localObject3);
        FileOp.o(str1 + str2, (String)localObject3 + (String)localObject1);
        str1 = (String)localObject3 + i.FV((String)localObject2);
        str2 = (String)localObject3 + i.FW((String)localObject2);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        continue;
        if ((((a)localObject1).qvB.indexOf("jpg") >= 0) || (((a)localObject1).qvB.indexOf("jpeg") >= 0)) {
          i = 2;
        } else if (((a)localObject1).qvB.indexOf("mp3") >= 0) {
          i = 3;
        }
      }
    }
  ...
  private static h a(h paramh, String paramString)
  {
    ...
    //   194: aload_0
    //   195: aload_1
    //   196: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   199: l2i
      ...
      for (;;)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (((MMBitmapFactory.DecodeResultLogger)localObject4).getDecodeResult() >= 2000)
          {
            ...
            localObject3 = localObject5;
            com.tencent.mm.plugin.report.service.g.paX.z(12712, paramString1);
          }
        ...
        else
        {
          try
          {
            ...
            {
              localObject3 = localObject5;
              i = BackwardSupportUtil.ExifHelper.QG(paramString1);
              if (i == 90) {
                break;
              }
              paramInt3 = paramInt2;
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          localObject1 = localObject3;
          int n = BackwardSupportUtil.ExifHelper.QG(paramString1);
          if (n != 90)
          {
            k = j;
            m = paramInt3;
            if (n != 270)
            {
              ...
              if (localObject4 != null)
              {
                ...
                localObject1 = localObject3;
                localObject2 = FileOp.hk(paramString2 + paramString3);
                ...
                localObject1 = null;
                w.i("MicroMsg.snsMediaStorage", "createThumbNailUnScaleFixShort saving to %s, size:%d", new Object[] { paramString2 + paramString3, Long.valueOf(FileOp.kI(paramString2 + paramString3)) });
                GMTrace.o(20064342376448L, 149491);
                return true;
              }
            }
  ...
  private static boolean a(String paramString1, int paramInt1, int paramInt2, Bitmap.CompressFormat paramCompressFormat, int paramInt3, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    BitmapFactory.Options localOptions = com.tencent.mm.sdk.platformtools.d.QI(paramString1);
  ...
  public static boolean b(String paramString1, String paramString2, String paramString3, float paramFloat)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = com.tencent.mm.sdk.platformtools.d.QI(paramString1 + paramString2);
        if (localObject1 == null)
        {
        ...
        if ((((BitmapFactory.Options)localObject1).outMimeType != null) && ((((BitmapFactory.Options)localObject1).outMimeType.toLowerCase().endsWith("png")) || (((BitmapFactory.Options)localObject1).outMimeType.toLowerCase().endsWith("vcodec"))))
        {
          ...
          if (localDecodeResultLogger.getDecodeResult() >= 2000)
          {
            ...
            com.tencent.mm.plugin.report.service.g.paX.z(12712, paramString3);
          }
      ...
      else
      {
        ...
        long l = System.currentTimeMillis();
        localObject2 = l.yo().a(str, (Rect)localObject2, (BitmapFactory.Options)localObject1, localDecodeResultLogger);
        localObject1 = localObject2;
        if (localObject2 != null) {
  ...
  public static boolean bkE()
  {
    ...
    if ("hevc".equals(com.tencent.mm.platformtools.r.idd))
    {
  ...
  public static boolean bkF()
  {
    ...
    if ("wxpc".equals(com.tencent.mm.platformtools.r.idd))
    {
  ...
  public static boolean d(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    //   6: invokestatic 27	com/tencent/gmtrace/GMTrace:i	(JI)V
    //   9: aload_1
    //   10: invokestatic 173	com/tencent/mm/sdk/platformtools/d:QI	(Ljava/lang/String;)Landroid/graphics/BitmapFactory$Options;
    //   13: astore 20
    //   15: aload 20
    //   17: ifnull +951 -> 968
    //   20: aload 20
    ...
    //   122: iload 7
    //   124: istore 8
    //   126: invokestatic 845	com/tencent/mm/modelcdntran/g:Gi	()Lcom/tencent/mm/modelcdntran/c;
    //   129: pop
    //   130: iload 7
    //   132: istore 8
    //   134: bipush 64
    //   136: invokestatic 851	com/tencent/mm/modelcdntran/c:fI	(I)Z
    //   139: ifne +23 -> 162
    //   142: iload 7
    //   144: istore 8
    //   146: invokestatic 853	com/tencent/mm/plugin/sns/storage/r:bkE	()Z
    //   149: ifne +13 -> 162
    //   152: iload 7
    //   154: istore 8
    //   156: invokestatic 855	com/tencent/mm/plugin/sns/storage/r:bkF	()Z
    //   159: ifeq +933 -> 1092
    //   162: iload 7
    //   164: istore 8
    ...
    //   175: iload 7
    //   177: istore 8
    //   179: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   182: ldc_w 875
    ...
    //   369: istore 9
    //   371: aload_1
    //   372: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   375: l2i
    //   376: istore 14
    //   378: iconst_0
    //   379: istore 8
    ...
    //   399: iload 8
    //   401: istore 7
    //   403: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   406: ldc_w 912
    ...
    //   492: dup
    //   493: iconst_2
    //   494: getstatic 39	com/tencent/mm/plugin/sns/storage/r:pVL	I
    //   497: invokestatic 616	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   500: aastore
    //   501: dup
    //   502: iconst_3
    //   503: getstatic 37	com/tencent/mm/plugin/sns/storage/r:pWz	I
    ...
    //   541: sipush 1080
    //   544: istore 8
    //   546: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   549: ldc_w 928
    ...
    //   580: imul
    //   581: istore 15
    //   583: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   586: ldc_w 930
    ...
    //   619: imul
    //   620: istore 16
    //   622: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   625: ldc_w 932
    ...
    //   794: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   797: ldc_w 949
    ...
    //   1010: iload 7
    //   1012: istore 8
    //   1014: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1017: ldc_w 888
    ...
    //   1046: iload 7
    //   1048: istore 8
    //   1050: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1053: ldc_w 890
    ...
    //   1069: iload 7
    //   1071: istore 8
    //   1073: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1076: ldc_w 892
    ...
    //   1105: iload 7
    //   1107: istore 8
    //   1109: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1112: ldc_w 894
    ...
    //   1142: iload 7
    //   1144: istore 8
    //   1146: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1149: ldc_w 896
    ...
    //   1166: iload 7
    //   1168: istore 8
    //   1170: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1173: ldc_w 898
    ...
    //   1203: iload 8
    //   1205: istore 7
    //   1207: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1210: ldc_w 960
    ...
    //   1282: iload 8
    //   1284: istore 7
    //   1286: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1289: ldc_w 962
    ...
    //   1348: iload 8
    //   1350: istore 7
    //   1352: invokestatic 873	com/tencent/mm/k/g:uz	()Lcom/tencent/mm/k/e;
    //   1355: ldc_w 964
    ...
    //   1648: astore_0
    //   1649: getstatic 200	com/tencent/mm/plugin/report/service/g:paX	Lcom/tencent/mm/plugin/report/service/g;
    //   1652: sipush 12712
    //   1655: aload_0
    //   1656: invokevirtual 204	com/tencent/mm/plugin/report/service/g:z	(ILjava/lang/String;)V
    //   1659: aload 20
    //   1661: ifnull +8 -> 1669
    //   1664: aload 20
    ...
    //   1747: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   1750: lstore 18
    //   1752: ldc -119
    //   1754: ldc_w 974
    //   1757: iconst_3
    ...
    //   2438: aload_1
    //   2439: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   2442: ldc2_w 992
    //   2445: lcmp
    //   2446: ifge +149 -> 2595
    //   2449: iload 17
    ...
    //   2646: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   2649: lstore 18
    //   2651: ldc -119
    //   2653: ldc_w 974
    //   2656: iconst_3
    ...
    //   2857: invokestatic 316	com/tencent/mm/modelsfs/FileOp:kI	(Ljava/lang/String;)J
    //   2860: lstore 18
    //   2862: ldc -119
    //   2864: ldc_w 974
    //   2867: iconst_3
  ...
  public final q HP(String paramString)
  {
    GMTrace.i(8305393008640L, 61880);
    q localq = new q();
    paramString = this.hhi.a("SnsMedia", null, "StrId=?", new String[] { paramString }, null, null, null, 2);
  ...
  public final int a(int paramInt, q paramq)
  {
    ...
    paramq = paramq.bkB();
    paramInt = this.hhi.update("SnsMedia", paramq, "local_id=?", new String[] { String.valueOf(paramInt) });
  ...
  public final h a(h paramh, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    q localq = new q();
    localq.hUw = ((int)bg.Po());
    localq.type = paramh.type;
    amq localamq = new amq();
    localamq.uhC = paramh.pYs;
    localamq.uhX = paramh.pYr;
    localamq.token = paramh.pYu;
    localamq.uih = paramh.pYv;
    localamq.uiw = 0;
    localamq.uiv = new amk();
    localamq.hkI = 0;
    localamq.mCK = paramh.desc;
    w.d("MicroMsg.snsMediaStorage", "upload.filterId " + paramh.pYq);
    localamq.uhW = paramh.pYq;
    localamq.uiy = 2;
    localamq.fML = paramString1;
    localamq.uiA = paramString2;
    localamq.fwU = paramh.pYw;
    for (;;)
    {
      try
      {
        ...
        localq.bkC();
        i = (int)this.hhi.insert("SnsMedia", "local_id", localq.bkB());
        str1 = "Locall_path" + i;
        w.d("MicroMsg.snsMediaStorage", "insert localId " + i);
        String str2 = i.FZ(str1);
        String str3 = i.Ga(str1);
        String str4 = i.FY(str1);
        String str5 = i.Gb(str1);
        String str6 = HO(str1);
        FileOp.kL(str6);
        ...
        localamq.fML = (str6 + str5);
        localamq.uiA = (str6 + str3);
        localamq.fwU = paramh.pYw;
      }
      catch (Exception localException)
      {
        ...
        catch (Exception paramString2)
        {
          w.e("MicroMsg.snsMediaStorage", "uploadInfo to byteArray error");
          continue;
          paramString2 = new amk();
          paramString2.jXP = 1;
          paramString2.mDo = paramString3;
          localamq.uiv = paramString2;
          localamq.uiy = 0;
          com.tencent.mm.modelcdntran.g.Gj();
          localamq.uhV = b.jj(paramString1);
          if (!bg.mZ(paramString4))
          {
            paramString1 = new amk();
            paramString1.jXP = 1;
            paramString1.mDo = paramString4;
            localamq.uix.add(paramString1);
          }
        }
      }
      try
  ...
  public final boolean a(String paramString, q paramq)
  {
    ...
    Cursor localCursor = this.hhi.a("SnsMedia", null, "StrId=?", new String[] { paramString }, null, null, null, 2);
    if (localCursor.moveToFirst())
    {
      ...
      if (paramq != null)
      {
        paramString = paramq.bkB();
        if ((int)this.hhi.insert("SnsMedia", "local_id", paramString) != -1)
        {
    ...
    localCursor.close();
    paramq = paramq.bkB();
    if (this.hhi.update("SnsMedia", paramq, "StrId=?", new String[] { paramString }) > 0)
    {
      GMTrace.o(8305124573184L, 61878);
      return true;
    }
  ...
  public final List<h> bu(List<h> paramList)
  {
  ...
  public final q dQ(long paramLong)
  {
    GMTrace.i(8305527226368L, 61881);
    q localq = new q();
    Cursor localCursor = this.hhi.a("SnsMedia", null, "local_id=?", new String[] { String.valueOf(paramLong) }, null, null, null, 2);
    if (!localCursor.moveToFirst())
    {
      localCursor.close();
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/storage/r.class
