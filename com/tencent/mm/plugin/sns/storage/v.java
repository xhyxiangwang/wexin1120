...
public final class v
{
  ...
  public static void HY(String paramString)
  {
    ...
    Object localObject = FileOp.x(paramString, false);
    if (localObject == null)
    {
  ...
  public static int a(g paramg1, g paramg2, String paramString)
  {
    ...
    boolean bool = paramg2.eL("", paramg1);
  ...
  public static boolean a(g paramg1, g paramg2)
  {
    ...
    try
    {
      if (bg.mZ(paramg1.getKey())) {
        paramg2.eL("", "ATTACH DATABASE '" + paramg1.getPath() + "' AS old ");
      }
      for (;;)
      {
        ...
        return true;
        paramg2.eL("", "ATTACH DATABASE '" + paramg1.getPath() + "' AS old KEY '" + paramg1.getKey() + "'");
      }
      return false;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/storage/v.class
