  ...
  implements Serializable
{
  ...
  public DummyViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (;;)
    {
      ...
      this.yz = paramContext;
      if ((Build.VERSION.SDK_INT < 7) || (this.qsR == null)) {}
      try
      {
        this.qsR = ViewGroup.class.getDeclaredMethod("setChildrenDrawingOrderEnabled", new Class[] { Boolean.TYPE });
        try
        {
          if (this.qsR != null) {
            this.qsR.invoke(this, new Object[] { Boolean.valueOf(true) });
          }
          this.yA = 1;
          if (j != 0) {
            populate();
          }
          this.yw = new ViewPager.h()
          {
            public final void W(int paramAnonymousInt)
            {
              ...
              if (paramAnonymousInt == 0) {
                DummyViewPager.this.qsX = DummyViewPager.this.getScrollX();
              }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/storage/AdLandingPagesStorage/AdLandingPageComponent/component/widget/verticalviewpager/DummyViewPager.class
