...
public final class a
{
  public static n a(Bitmap paramBitmap, String paramString, int paramInt1, int paramInt2)
  {
    ...
    if (paramBitmap != null) {
      new Canvas(paramBitmap.yq()).drawColor(paramInt1);
    }
    try
    {
      d.a(paramBitmap.yq(), 70, Bitmap.CompressFormat.JPEG, paramString, false);
  ...
  public static n dp(String paramString1, String paramString2)
  {
    GMTrace.i(8801327513600L, 65575);
    int i = Color.argb(51, 255, 255, 255);
    paramString1 = i.Gc(paramString1);
    ...
    paramString1 = a(paramString1.yq(), paramString2, i, 55);
    GMTrace.o(8801327513600L, 65575);
    return paramString1;
  }
}
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/lucky/a/a.class
