...
{
  private static final Map<String, String> qeD;
  ...
  public static String dt(String paramString1, String paramString2)
  {
    ...
    if ((bool) && (qeD.containsKey(paramString1 + paramString2)))
    {
      str = (String)qeD.get(paramString1 + paramString2);
      if (!bg.mZ(str))
      {
        GMTrace.o(8147418742784L, 60703);
        return str;
    ...
    if (bool) {
      qeD.put(paramString1 + paramString2, localStringBuffer.toString());
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/model/am.class
