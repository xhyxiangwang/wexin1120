...
public final class i
{
  ...
  private static int pYB;
  private static int pYC;
  public static int pYD;
  public static int pYE;
  public static int pYy;
  public static String pYz;
  
  static
  {
    GMTrace.i(8793408667648L, 65516);
    pYy = Integer.MAX_VALUE;
    jPN = "<TimelineObject>";
    jPO = "</TimelineObject>";
    pYz = "/";
    pYA = "snsb";
  ...
  public static String FV(String paramString)
  {
    ...
    paramString = "snst_" + Gg(paramString);
  ...
  public static String FW(String paramString)
  {
    ...
    paramString = "snsu_" + Gg(paramString);
  ...
  public static String FX(String paramString)
  {
    ...
    paramString = "snsb_" + Gg(paramString);
  ...
  public static String FZ(String paramString)
  {
    ...
    paramString = "sns_tmpb_" + Gg(paramString);
  ...
  public static String Ga(String paramString)
  {
    ...
    paramString = "sns_tmpt_" + Gg(paramString);
  ...
  public static String Gb(String paramString)
  {
    ...
    paramString = "sns_tmps_" + Gg(paramString);
    GMTrace.o(8788979482624L, 65483);
    return paramString;
  }
  
  public static n Gc(String paramString)
  {
  ...
  /* Error */
  public static Bitmap Gd(String paramString)
  {
    // Byte code:
    //   0: ldc2_w 158
    //   3: ldc -96
    ...
    //   99: aload 7
    //   101: astore 6
    //   103: invokestatic 186	com/tencent/mm/sdk/platformtools/bg:Pq	()J
    //   106: lstore_3
    //   107: aload 7
    //   109: astore 5
    //   111: aload 7
    ...
    //   137: astore 6
    //   139: lload_3
    //   140: invokestatic 196	com/tencent/mm/sdk/platformtools/bg:aG	(J)J
    //   143: lstore_3
    //   144: aload 7
    //   146: astore 5
    //   148: aload 7
    ...
    //   223: aload_0
    //   224: lload_3
    //   225: invokestatic 214	com/tencent/mm/plugin/sns/h/c:U	(Ljava/lang/String;J)V
    //   228: aload 7
    //   230: ifnull +8 -> 238
    //   233: aload 7
    ...
    //   294: aload 7
    //   296: astore 6
    //   298: getstatic 235	com/tencent/mm/plugin/report/service/g:paX	Lcom/tencent/mm/plugin/report/service/g;
    //   301: sipush 12712
    //   304: aload 8
    //   306: invokevirtual 239	com/tencent/mm/plugin/report/service/g:z	(ILjava/lang/String;)V
    //   309: aload 9
    //   311: astore 8
    //   313: goto -85 -> 228
    //   316: astore 6
  ...
  public static n Ge(String paramString)
  {
        ...
        try
        {
          ...
          for (;;)
          {
            ...
            if (((MMBitmapFactory.DecodeResultLogger)localObject).getDecodeResult() >= 2000)
            {
              ...
              com.tencent.mm.plugin.report.service.g.paX.z(12712, (String)localObject);
            }
          }
        }
  ...
  public static boolean Gh(String paramString)
  {
    ...
    boolean bool = paramString.startsWith(e.gZR);
  ...
  public static int Gl(String paramString)
  {
    ...
    //   9: aload_0
    //   10: invokestatic 364	com/tencent/mm/sdk/platformtools/bg:mZ	(Ljava/lang/String;)Z
    //   13: istore_2
    //   14: iload_2
    //   15: ifeq +14 -> 29
    //   18: ldc2_w 359
    ...
    //   40: aload_0
    //   41: aastore
    //   42: invokestatic 354	com/tencent/mm/sdk/platformtools/w:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   45: new 368	android/media/MediaMetadataRetriever
    //   48: dup
    //   49: invokespecial 369	android/media/MediaMetadataRetriever:<init>	()V
    //   52: astore 4
    //   54: aload 4
    //   56: astore_3
    //   57: aload 4
    //   59: aload_0
    //   60: invokevirtual 372	android/media/MediaMetadataRetriever:setDataSource	(Ljava/lang/String;)V
    //   63: aload 4
    //   65: astore_3
    //   66: aload 4
    //   68: bipush 9
    //   70: invokevirtual 375	android/media/MediaMetadataRetriever:extractMetadata	(I)Ljava/lang/String;
    //   73: iconst_0
    //   74: invokestatic 379	com/tencent/mm/sdk/platformtools/bg:getInt	(Ljava/lang/String;I)I
    //   77: i2l
    //   78: invokestatic 383	com/tencent/mm/sdk/platformtools/bg:eI	(J)I
    //   81: istore_1
    //   82: aload 4
    //   84: invokevirtual 386	android/media/MediaMetadataRetriever:release	()V
    //   87: ldc2_w 359
    //   90: ldc_w 361
    ...
    //   116: aload_0
    //   117: aastore
    //   118: invokestatic 390	com/tencent/mm/sdk/platformtools/w:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   121: aload 4
    //   123: ifnull +8 -> 131
    //   126: aload 4
    //   128: invokevirtual 386	android/media/MediaMetadataRetriever:release	()V
    //   131: ldc2_w 359
    //   134: ldc_w 361
    ...
    //   146: ifnull +7 -> 153
    //   149: aload_3
    //   150: invokevirtual 386	android/media/MediaMetadataRetriever:release	()V
    //   153: aload_0
    //   154: athrow
    //   155: astore_0
    //   156: goto -11 -> 145
  ...
  public static SpannableString a(String paramString, Context paramContext, TextView paramTextView)
  {
    ...
    paramString = new SpannableString(h.c(paramContext, localStringBuilder.toString(), (int)paramTextView.getTextSize()));
    GMTrace.o(8792871796736L, 65512);
    return paramString;
  }
  ...
  public static String aq(int paramInt, String paramString)
  {
  ...
  public static void b(View paramView, Context paramContext)
  {
    ...
    if ((paramView != null) && (com.tencent.mm.ui.ab.dZ(paramContext) > 1.0F))
    {
      ...
      i = com.tencent.mm.bq.a.fromDPToPix(paramContext, 60);
  ...
  public static int bge()
  {
    ...
    int i = com.tencent.mm.sdk.platformtools.ab.getContext().getSharedPreferences(com.tencent.mm.sdk.platformtools.ab.bNa(), 0).getInt("sns_control_flag", 0);
  ...
  public static int bgf()
  {
    ...
    int i = com.tencent.mm.sdk.platformtools.ab.getContext().getSharedPreferences(com.tencent.mm.sdk.platformtools.ab.bNa(), 0).getInt("sns_respone_count", 20);
  ...
  public static String bn(List<amn> paramList)
  {
    ...
    int i = 0;
    paramList = (List<amn>)localObject;
    for (;;)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        paramList = (String)localObject + localamn.nas;
        i += 1;
        if (i >= 4) {
          localObject = paramList;
        }
  ...
  private static String c(amn paramamn)
  {
    GMTrace.i(8786295128064L, 65463);
    if (!bg.mZ(paramamn.uhO))
    {
      paramamn = paramamn.uhO;
    ...
    try
    {
      paramamn = com.tencent.mm.a.g.n(paramamn.toByteArray());
      GMTrace.o(8786295128064L, 65463);
      return paramamn;
    }
    catch (Exception paramamn)
    {
      for (;;)
      {
        paramamn = str;
  ...
  public static String d(amn paramamn)
  {
    GMTrace.i(8786697781248L, 65466);
    String str = "snsb_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String jdMethod_do(long paramLong)
  {
  ...
  public static String dp(long paramLong)
  {
    ...
    String str = Gf(new BigInteger(Long.toBinaryString(paramLong), 2).toString());
    GMTrace.o(8790590095360L, 65495);
    return str;
  }
  
  public static String e(amn paramamn)
  {
    GMTrace.i(8786831998976L, 65467);
    String str = "snst_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String f(amn paramamn)
  {
    GMTrace.i(8787100434432L, 65469);
    String str = "snsu_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String g(com.tencent.mm.plugin.sns.storage.m paramm)
  {
    ...
    paramm = jdMethod_do(paramm.field_snsId);
    GMTrace.o(8793006014464L, 65513);
    return paramm;
  }
  
  public static String g(amn paramamn)
  {
    GMTrace.i(8787234652160L, 65470);
    String str = "snsblurt_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String h(amn paramamn)
  {
    GMTrace.i(8787368869888L, 65471);
    String str = "snsblurs_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static Bitmap i(List<n> paramList, int paramInt)
  {
    ...
    if (i == 2)
    {
      ...
      localObject3 = ((n)paramList.get(paramInt)).yr();
  ...
  public static String i(amn paramamn)
  {
    GMTrace.i(8787637305344L, 65473);
    String str = "snstblur_src_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String j(amn paramamn)
  {
    GMTrace.i(8787771523072L, 65474);
    String str = "sight_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String k(amn paramamn)
  {
    GMTrace.i(8787905740800L, 65475);
    String str = "sightad_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str, paramamn.uhN);
  ...
  public static String l(amn paramamn)
  {
  ...
  public static String m(amn paramamn)
  {
    GMTrace.i(8788174176256L, 65477);
    String str = "sns_tmpb_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String n(amn paramamn)
  {
    GMTrace.i(8788442611712L, 65479);
    String str = "sns_tmpt_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String o(amn paramamn)
  {
    GMTrace.i(8788711047168L, 65481);
    String str = "sns_tmpu_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String p(amn paramamn)
  {
    GMTrace.i(8788845264896L, 65482);
    String str = "sns_tmps_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static String q(amn paramamn)
  {
    GMTrace.i(8789113700352L, 65484);
    String str = "sns_tmpsad_" + Gg(paramamn.nas);
    if (paramamn.uhM == 1)
    {
      paramamn = f.k(str + c(paramamn), paramamn.uhN);
  ...
  public static Bitmap r(String paramString, Bitmap paramBitmap)
  {
    ...
    while (bg.mZ(str))
    {
      GMTrace.o(8789784788992L, 65489);
      return paramBitmap;
      i = paramString.lastIndexOf(pYz);
      if ((i > 0) && (i + 1 < paramString.length()))
      {
        str = paramString.substring(i + 1);
        if ((str.startsWith(pYA)) || (str.startsWith("sns_tmpb_")))
        {
          str = paramString;
          continue;
        }
    ...
    try
    {
      w.i("MicroMsg.SnsUtil", "[tomys] parsing jpg, path: %s, size: %s", new Object[] { paramString, Long.valueOf(FileOp.kI(paramString)) });
      localObject2 = localObject3;
      localObject1 = localObject4;
  ...
  public static boolean tR(int paramInt)
  {
    ...
    com.tencent.mm.sdk.platformtools.ab.getContext().getSharedPreferences(com.tencent.mm.sdk.platformtools.ab.bNa(), 0).edit().putInt("sns_control_flag", paramInt).commit();
  ...
  public static boolean tS(int paramInt)
  {
    ...
    com.tencent.mm.sdk.platformtools.ab.getContext().getSharedPreferences(com.tencent.mm.sdk.platformtools.ab.bNa(), 0).edit().putInt("sns_respone_count", paramInt).commit();
    GMTrace.o(8791932272640L, 65505);
    return true;
  }
  
  public static String x(CharSequence paramCharSequence)
  {
    int i = 0;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/sns/data/i.class
