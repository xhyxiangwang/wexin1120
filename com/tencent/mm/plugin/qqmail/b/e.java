...
public final class e
{
  ...
  public e(String paramString, int paramInt)
  {
    ...
    this.oEW = paramString;
    paramString = new File(this.oEW);
  ...
  private static byte[] Ee(String paramString)
  {
  ...
  public final boolean a(String paramString, Map<String, String> paramMap, byte[] paramArrayOfByte)
  {
    ...
    paramMap = encrypt(paramArrayOfByte, Ee(paramString));
    if (paramMap == null)
    {
    ...
    boolean bool = q(this.oEW + paramString, paramMap);
    GMTrace.o(5457292820480L, 40660);
    return bool;
  }
  ...
  public final void aWO()
  {
    ...
    Object localObject = new File(this.oEW).list();
    if (localObject != null) {}
    for (int i = localObject.length; i < this.gET; i = 0)
    {
      GMTrace.o(5457695473664L, 40663);
      return;
    }
    String[] arrayOfString = new File(this.oEW).list();
    localObject = null;
  ...
  public final byte[] i(String paramString, Map<String, String> paramMap)
  {
    ...
    paramString = j(paramString, paramMap);
    paramMap = readFromFile(this.oEW + paramString);
    if (paramMap == null)
    {
    ...
    paramString = decrypt(paramMap, Ee(paramString));
    if (paramString == null)
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/qqmail/b/e.class
