  ...
  extends h
{
  ...
  private static String a(h.b paramb)
  {
    ...
    Object localObject = paramb.oFh.keySet().iterator();
    while (((Iterator)localObject).hasNext())
    {
      ...
      localStringBuilder.append((String)paramb.oFh.get(str));
      localStringBuilder.append("\r\n");
    }
    localObject = new File(paramb.oFj.filePath);
    if (!((File)localObject).isFile()) {
      throw new InvalidParameterException("The path to upload isnot a file.");
    }
    localObject = ((File)localObject).getName();
    localStringBuilder.append("------" + BOUNDARY + "\r\n");
    localStringBuilder.append("Content-Disposition: form-data; name=\"" + paramb.oFj.fCA + "\"; filename=\"" + (String)localObject + "\"\r\n");
    localStringBuilder.append("\r\n");
  ...
  public final h.c a(String paramString1, String paramString2, h.b paramb, h.a parama)
  {
    ...
    try
    {
      ...
      i = j;
      String str = paramb.oFj.filePath;
      i = j;
      StringBuilder localStringBuilder = new StringBuilder();
      i = j;
      localStringBuilder.append("\r\n");
      ...
      i = j;
      this.oEX = new HttpPost(c(paramString1, paramString2, paramb.oFh));
      i = j;
      this.oEX.setHeader("User-Agent", mbI);
      i = j;
      this.oEX.setHeader("Host", host);
      i = j;
      this.oEX.setHeader("Connection", "Keep-Alive");
      i = j;
      this.oEX.setHeader("Accept-Charset", "utf-8");
      i = j;
      this.oEX.setHeader("Cookie", G(paramb.oFi));
      i = j;
      this.oEX.setEntity((HttpEntity)localObject);
      i = j;
      paramb = parama.execute(this.oEX);
      i = j;
      ...
      i = j;
      paramString1 = new h.c(j, Eg(paramb), paramString1);
      i = j;
  ...
  public final void cancel()
  {
    ...
    if ((this.oEX != null) && (!this.oEX.isAborted())) {
      this.oEX.abort();
    }
    ...
    implements HttpEntity
  {
    ...
    public a(String paramString1, String paramString2, String paramString3)
    {
      ...
      this.oEY = paramString1;
      this.file = new File(paramString2);
      this.oEZ = paramString3;
    ...
    public final void writeTo(OutputStream paramOutputStream)
    {
      ...
      paramOutputStream.writeBytes(this.oEY);
      try
      {
      ...
      localFileInputStream.close();
      paramOutputStream.writeBytes(this.oEZ);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/qqmail/b/f.class
