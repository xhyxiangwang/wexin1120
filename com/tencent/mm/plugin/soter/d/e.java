  ...
  extends i
{
  ...
  protected final void a(String paramString, int[] paramArrayOfInt)
  {
    ...
    if (i < j)
    {
      ...
      if (k == 1) {}
      for (String str = h.boI();; str = String.format("SoterAuthKey_uid%d_salt%s_scene%d", new Object[] { Integer.valueOf(Process.myUid()), f.mY(paramString), Integer.valueOf(k) }))
      {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/plugin/soter/d/e.class
