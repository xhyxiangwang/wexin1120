  ...
  public static Bitmap b(Context paramContext, String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      if (paramContext == null) {
        w.i("MicroMsg.QRCodeBitmapFactory", "createBitmap bm is error result %d %s", new Object[] { Integer.valueOf(n), bg.bOd().toString() });
      }
      for (;;)
      {
      ...
      w.i("MicroMsg.QRCodeBitmapFactory", "result %d %s", new Object[] { Integer.valueOf(n), bg.bOd().toString() });
      GMTrace.o(1425660706816L, 10622);
      return null;
      label529:
      i = 0;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/mm/bn/a/a.class
