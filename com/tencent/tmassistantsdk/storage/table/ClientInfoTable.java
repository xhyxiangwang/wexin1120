  ...
  implements ITableBase
{
  ...
  public static void delete(String paramString1, String paramString2)
  {
    ...
    {
      w.printErrStackTrace("ClientInfoTable", paramString1, "", new Object[0]);
    }
  }
  ...
  public static void deleteItemsByURL(String paramString)
  {
    ...
    {
      w.printErrStackTrace("ClientInfoTable", paramString, "", new Object[0]);
    }
  }
  ...
  public static java.util.ArrayList<ClientInfo> query(String paramString)
  {
    ...
    //   0: aload_0
    //   1: ifnull +111 -> 112
    //   4: new 125	java/util/ArrayList
    //   7: dup
    //   8: invokespecial 126	java/util/ArrayList:<init>	()V
    //   11: astore_3
    //   12: invokestatic 72	com/tencent/tmassistantsdk/storage/helper/AstSDKDBHelper_V2:getInstance	()Lcom/tencent/tmassistantsdk/storage/helper/SqliteHelper;
    //   15: invokevirtual 129	com/tencent/tmassistantsdk/storage/helper/SqliteHelper:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   18: astore_2
    //   19: aload_2
    //   20: ldc 16
    //   22: iconst_1
    //   23: anewarray 82	java/lang/String
    //   26: dup
    //   27: iconst_0
    //   28: aload_0
    //   29: aastore
    //   30: invokevirtual 133	android/database/sqlite/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    //   33: astore_2
    //   34: aload_2
    //   35: ifnull +38 -> 73
    //   38: aload_2
    ...
    //   51: aload_3
    //   52: aload_2
    //   53: invokestatic 139	com/tencent/tmassistantsdk/storage/table/ClientInfoTable:cursor2object	(Landroid/database/Cursor;)Lcom/tencent/tmassistantsdk/storage/model/ClientInfo;
    //   56: invokevirtual 143	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   59: pop
    //   60: aload_2
    //   61: astore_0
    //   62: aload_2
    ...
    //   99: invokestatic 95	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   102: aload_2
    //   103: ifnull +9 -> 112
    //   106: aload_2
  ...
  public static void save(ClientInfo paramClientInfo)
  {
    ...
    {
      w.printErrStackTrace("ClientInfoTable", paramClientInfo, "", new Object[0]);
    }
  }
  ...
  public void dataMovement(SQLiteDatabase paramSQLiteDatabase1, SQLiteDatabase paramSQLiteDatabase2)
  {
    ...
    catch (Exception paramSQLiteDatabase1)
    {
      for (;;)
      {
        ...
        w.printErrStackTrace("ClientInfoTable", paramSQLiteDatabase1, "", new Object[0]);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/tmassistantsdk/storage/table/ClientInfoTable.class
