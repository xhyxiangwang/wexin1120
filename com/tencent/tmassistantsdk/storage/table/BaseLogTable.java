  ...
  implements ITableBase
{
  ...
  public DataWrapper getDatas(int paramInt)
  {
    ...
    //   49: iload_1
    //   50: invokevirtual 130	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   53: invokevirtual 98	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   56: astore 5
    //   58: aload_0
    //   59: invokevirtual 78	com/tencent/tmassistantsdk/storage/table/BaseLogTable:getHelper	()Lcom/tencent/tmassistantsdk/storage/helper/SqliteHelper;
    //   62: invokevirtual 133	com/tencent/tmassistantsdk/storage/helper/SqliteHelper:getReadableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   65: astore 6
    //   67: aload 6
    //   69: aload_0
    //   70: invokevirtual 87	com/tencent/tmassistantsdk/storage/table/BaseLogTable:getTableName	()Ljava/lang/String;
    //   73: aconst_null
    //   74: aconst_null
    //   75: aconst_null
    //   76: aconst_null
    ...
    //   78: ldc -121
    //   80: aload 5
    //   82: invokevirtual 139	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   85: astore 6
    //   87: aload 6
    //   89: ifnull +114 -> 203
    //   92: aload 6
    ...
    //   112: aload 6
    //   114: ldc -110
    //   116: invokeinterface 150 2 0
    //   121: invokeinterface 154 2 0
    //   126: lstore_2
    //   127: aload 6
    //   129: astore 5
    //   131: aload 7
    //   133: getfield 122	com/tencent/tmassistantsdk/storage/table/BaseLogTable$DataWrapper:idList	Ljava/util/List;
    //   136: lload_2
    //   137: invokestatic 158	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   140: invokeinterface 162 2 0
    //   145: pop
    //   146: aload 6
    //   148: astore 5
    //   150: aload 6
    //   152: aload 6
    //   154: ldc -92
    //   156: invokeinterface 150 2 0
    //   161: invokeinterface 168 2 0
    //   166: astore 9
    //   168: aload 6
    //   170: astore 5
    //   172: aload 7
    //   174: getfield 125	com/tencent/tmassistantsdk/storage/table/BaseLogTable$DataWrapper:dataList	Ljava/util/List;
    //   177: aload 9
    ...
    //   241: invokestatic 182	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   244: aload 8
    //   246: astore 5
    //   248: aload 6
    //   250: ifnull -31 -> 219
    //   253: aload 6
    //   255: invokeinterface 174 1 0
    //   260: aconst_null
    //   261: areturn
    //   262: astore 6
    //   264: aconst_null
    ...
    //   10	206	7	localDataWrapper	DataWrapper
    //   222	12	7	localException1	Exception
  ...
  public boolean save(List<byte[]> paramList)
  {
    ...
    //   69: invokestatic 182	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   72: aload_2
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/tmassistantsdk/storage/table/BaseLogTable.class
