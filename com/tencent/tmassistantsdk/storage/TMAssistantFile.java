...
public class TMAssistantFile
{
  ...
  private boolean writeData(FileOutputStream paramFileOutputStream, byte[] paramArrayOfByte, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        w.printErrStackTrace("TMAssistantFile", paramFileOutputStream, "", new Object[0]);
  ...
  public void close()
  {
    ...
    //   49: invokestatic 171	com/tencent/mm/sdk/platformtools/w:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   52: goto -31 -> 21
    //   55: astore_1
    //   56: aload_0
    //   57: monitorexit
  ...
  public boolean flush()
  {
    ...
    try
    {
      ...
      catch (IOException localIOException)
      {
        for (;;)
        {
          w.printErrStackTrace("TMAssistantFile", localIOException, "", new Object[0]);
    ...
    for (;;)
    {
      try
      {
        ...
        else
        {
          ...
          {
            w.printErrStackTrace("TMAssistantFile", paramArrayOfByte, "", new Object[0]);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/tmassistantsdk/storage/TMAssistantFile.class
