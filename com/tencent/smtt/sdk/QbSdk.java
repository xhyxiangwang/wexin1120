...
public class QbSdk
{
  ...
  private static boolean xvA;
  private static boolean xvB = false;
  private static boolean xvC = false;
  static q xvD = new q()
  {
    public final void ju(int paramAnonymousInt)
    {
      ...
      do
      {
        ...
        if (QbSdk.mTbsListener != null) {
          QbSdk.mTbsListener.ju(paramAnonymousInt);
        }
      } while (QbSdk.mTbsListenerForInit == null);
      QbSdk.mTbsListenerForInit.ju(paramAnonymousInt);
    }
    ...
    public final void jv(int paramAnonymousInt)
    {
      ...
      l.xwT = false;
      if (l.ckW()) {}
      for (l.xwT = true;; l.xwT = false)
      {
        if (QbSdk.mTbsListener != null) {
          QbSdk.mTbsListener.jv(paramAnonymousInt);
        }
        if (QbSdk.mTbsListenerForInit != null) {
          QbSdk.mTbsListenerForInit.jv(paramAnonymousInt);
        }
        return;
      }
    }
    ...
    {
      if (QbSdk.mTbsListenerForInit != null) {
        QbSdk.mTbsListenerForInit.jw(paramAnonymousInt);
      }
      if (QbSdk.mTbsListener != null) {
        QbSdk.mTbsListener.jw(paramAnonymousInt);
      }
    }
  };
  static Map<String, Object> xvE = null;
  private static int xvf = 0;
  private static String xvg = "";
  private static Class<?> xvh;
  private static Object xvi;
  static boolean xvj = false;
  static boolean xvk = false;
  static boolean xvl = true;
  private static boolean xvm = false;
  private static String[] xvn;
  private static String xvo = "NULL";
  private static String xvp = "UNKNOWN";
  static String xvq;
  static boolean xvr = false;
  static long xvs = 0L;
  static Object xvt;
  static boolean xvu;
  private static int xvv;
  private static int xvw;
  private static String xvx;
  private static String xvy;
  static volatile boolean xvz;
  ...
  static boolean ah(Context paramContext, int paramInt)
  {
    if (gb(paramContext))
    {
      paramContext = o.a(xvi, "isX5Disabled", new Class[] { Integer.TYPE, Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(paramInt), Integer.valueOf(43601), Integer.valueOf(20000) });
      if (paramContext != null) {
        return ((Boolean)paramContext).booleanValue();
      }
      paramContext = o.a(xvi, "isX5Disabled", new Class[] { Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(paramInt), Integer.valueOf(43601) });
      if (paramContext != null) {
        return ((Boolean)paramContext).booleanValue();
      }
    }
  ...
  /* Error */
  static void bw(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 105	com/tencent/smtt/sdk/QbSdk:xvj	Z
    //   6: istore_2
    //   7: iload_2
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   14: return
    //   15: iconst_1
    //   16: putstatic 105	com/tencent/smtt/sdk/QbSdk:xvj	Z
    ...
    //   35: putstatic 119	com/tencent/smtt/sdk/QbSdk:xvp	Ljava/lang/String;
    //   38: ldc -46
    //   40: new 195	java/lang/StringBuilder
    //   43: dup
    //   44: ldc -44
    //   46: invokespecial 200	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   49: getstatic 119	com/tencent/smtt/sdk/QbSdk:xvp	Ljava/lang/String;
    ...
    //   61: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   64: aload_0
    //   65: sipush 401
    //   68: new 226	java/lang/Throwable
    //   71: dup
    //   72: getstatic 119	com/tencent/smtt/sdk/QbSdk:xvp	Ljava/lang/String;
  ...
  static Object c(Context paramContext, String paramString, Bundle paramBundle)
  {
    ...
    {
      return paramContext;
      paramString = o.a(xvi, "miscCall", new Class[] { String.class, Bundle.class }, new Object[] { paramString, paramBundle });
  ...
  {
    Object localObject = o.a(xvi, "canLoadVideo", new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(0) });
    if (localObject != null) {
      if (!((Boolean)localObject).booleanValue()) {
        i.ckL().aj(paramContext, 313);
      }
    }
    while (localObject == null)
    {
      return false;
      i.ckL().aj(paramContext, 314);
    }
  ...
  public static boolean canLoadX5FirstTimeThirdApp(Context paramContext)
  {
    try
    {
      ...
      {
        p.clh();
        localObject = p.gI(paramContext);
        if (localObject == null)
        {
          TbsLog.e("QbSdk", "QbSdk canLoadX5FirstTimeThirdApp (false) optDir == null");
          return false;
        }
        localFile = new File(t.clv(), "tbs_sdk_extension_dex.jar");
        if (!localFile.exists())
        {
      ...
      label153:
      for (Object localObject = t.clr();; localObject = ((File)localObject).getAbsolutePath())
      {
        TbsLog.i("QbSdk", "QbSdk init optDirExtension #2 is " + (String)localObject);
        xvh = new DexClassLoader(localFile.getAbsolutePath(), (String)localObject, localFile.getAbsolutePath(), QbSdk.class.getClassLoader()).loadClass("com.tencent.tbs.sdk.extension.TbsSDKExtension");
        if (xvi != null) {
          break label235;
        }
        if (t.clr() != null) {
        ...
        r.gP(paramContext.getApplicationContext()).aQ(227, "host context is null!");
        return false;
      }
      xvh.getConstructor(new Class[] { Context.class, Context.class });
      xvi = xvh.getConstructor(new Class[] { Context.class, Context.class, String.class }).newInstance(new Object[] { paramContext, null, t.clr() });
      label235:
      paramContext = o.a(xvi, "canLoadX5CoreForThirdApp", new Class[0], new Object[0]);
  ...
  public static void canOpenFile(Context paramContext, final String paramString, final x<Boolean> paramx)
  {
    new Thread()
    {
      public final void run()
      {
        ...
        {
          localObject = ((ab)localObject).clK();
          Context localContext = this.val$context;
          String str = paramString;
          localObject = ((ac)localObject).xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "canOpenFile", new Class[] { Context.class, String.class }, new Object[] { localContext, str });
        ...
        for (;;)
        {
          new Handler(Looper.getMainLooper()).post(new Runnable()
          {
            public final void run()
            {
              QbSdk.1.this.xvF.onReceiveValue(Boolean.valueOf(bool));
            }
          });
          return;
          bool = false;
  ...
  public static boolean canOpenWebPlus(Context paramContext)
  {
    ...
    //   3: aconst_null
    //   4: astore 5
    //   6: getstatic 134	com/tencent/smtt/sdk/QbSdk:xvv	I
    //   9: ifne +9 -> 18
    //   12: invokestatic 373	com/tencent/smtt/sdk/a:cky	()I
    //   15: putstatic 134	com/tencent/smtt/sdk/QbSdk:xvv	I
    //   18: ldc -46
    //   20: new 195	java/lang/StringBuilder
    //   23: dup
    //   24: ldc_w 375
    //   27: invokespecial 200	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   30: getstatic 134	com/tencent/smtt/sdk/QbSdk:xvv	I
    ...
    //   45: bipush 7
    //   47: if_icmplt +12 -> 59
    //   50: getstatic 134	com/tencent/smtt/sdk/QbSdk:xvv	I
    //   53: getstatic 136	com/tencent/smtt/sdk/QbSdk:xvw	I
    //   56: if_icmpge +5 -> 61
    //   59: iconst_0
    //   60: ireturn
    //   61: aload_0
    //   62: ifnull -3 -> 59
    //   65: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   68: pop
    ...
    //   80: dup
    //   81: aload_0
    //   82: invokestatic 265	com/tencent/smtt/sdk/p:gI	(Landroid/content/Context;)Ljava/io/File;
    //   85: ldc_w 389
    ...
    //   256: dup
    //   257: aload_0
    //   258: invokestatic 429	com/tencent/smtt/sdk/p:gK	(Landroid/content/Context;)Ljava/io/File;
    //   261: ldc_w 431
    ...
    //   429: invokestatic 459	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   432: getfield 463	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   435: ldc_w 465
    //   438: iconst_0
  ...
  {
    paramContext = o.a(xvi, "canUseVideoFeatrue", new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(paramInt) });
    if ((paramContext != null) && ((paramContext instanceof Boolean))) {
      return ((Boolean)paramContext).booleanValue();
    }
    return false;
  ...
  protected static String ckA()
  {
    Object localObject = ab.clI();
    if ((localObject != null) && (((ab)localObject).clJ()))
    {
      localObject = ((ab)localObject).clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getGUID", new Class[0], new Object[0]);
  ...
  {
    // Byte code:
    //   0: new 512	android/webkit/WebView
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 514	android/webkit/WebView:<init>	(Landroid/content/Context;)V
    //   8: astore_2
    ...
    //   17: aload_2
    //   18: ldc_w 516
    //   21: invokevirtual 519	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   24: aload_2
    //   25: ldc_w 521
    //   28: invokevirtual 519	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   31: aload_2
    //   32: ldc_w 523
    //   35: invokevirtual 519	android/webkit/WebView:removeJavascriptInterface	(Ljava/lang/String;)V
    //   38: aload_2
    //   39: iconst_1
    //   40: invokevirtual 527	android/webkit/WebView:clearCache	(Z)V
    //   43: iload_1
    //   44: ifeq +14 -> 58
    //   47: aload_0
    //   48: invokestatic 533	android/webkit/CookieSyncManager:createInstance	(Landroid/content/Context;)Landroid/webkit/CookieSyncManager;
    //   51: pop
    //   52: invokestatic 539	android/webkit/CookieManager:getInstance	()Landroid/webkit/CookieManager;
    //   55: invokevirtual 542	android/webkit/CookieManager:removeAllCookie	()V
    //   58: aload_0
    //   59: invokestatic 547	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   62: invokevirtual 550	android/webkit/WebViewDatabase:clearUsernamePassword	()V
    //   65: aload_0
    //   66: invokestatic 547	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   69: invokevirtual 553	android/webkit/WebViewDatabase:clearHttpAuthUsernamePassword	()V
    //   72: aload_0
    //   73: invokestatic 547	android/webkit/WebViewDatabase:getInstance	(Landroid/content/Context;)Landroid/webkit/WebViewDatabase;
    //   76: invokevirtual 556	android/webkit/WebViewDatabase:clearFormData	()V
    //   79: invokestatic 561	android/webkit/WebStorage:getInstance	()Landroid/webkit/WebStorage;
    //   82: invokevirtual 564	android/webkit/WebStorage:deleteAllData	()V
    //   85: invokestatic 569	android/webkit/WebIconDatabase:getInstance	()Landroid/webkit/WebIconDatabase;
    //   88: invokevirtual 572	android/webkit/WebIconDatabase:removeAllIcons	()V
    //   91: new 574	com/tencent/smtt/sdk/WebView
    //   94: dup
    //   95: aload_0
    //   96: invokespecial 575	com/tencent/smtt/sdk/WebView:<init>	(Landroid/content/Context;)V
    //   99: invokevirtual 579	com/tencent/smtt/sdk/WebView:getWebViewClientExtension	()Lcom/tencent/smtt/export/external/extension/interfaces/IX5WebViewClientExtension;
    //   102: ifnull +68 -> 170
    //   105: invokestatic 482	com/tencent/smtt/sdk/ab:clI	()Lcom/tencent/smtt/sdk/ab;
    //   108: astore_2
    //   109: aload_2
    //   110: ifnull +60 -> 170
    //   113: aload_2
    //   114: invokevirtual 485	com/tencent/smtt/sdk/ab:clJ	()Z
    //   117: ifeq +53 -> 170
    //   120: aload_2
    //   121: invokevirtual 489	com/tencent/smtt/sdk/ab:clK	()Lcom/tencent/smtt/sdk/ac;
    //   124: astore_2
    //   125: ldc_w 581
    //   128: ldc_w 583
    //   131: invokestatic 586	com/tencent/smtt/utils/TbsLog:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   134: iload_1
    //   135: ifeq +65 -> 200
    //   138: aload_2
    //   139: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   142: ldc_w 497
    //   145: ldc_w 588
    //   148: iconst_1
    ...
    //   164: aload_0
    //   165: aastore
    //   166: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   169: pop
    //   170: return
    //   171: astore_2
    //   172: ldc -46
    ...
    //   197: goto -106 -> 91
    //   200: aload_2
    //   201: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   204: ldc_w 497
    //   207: ldc_w 588
    //   210: iconst_2
    ...
    //   220: dup
    //   221: iconst_1
    //   222: getstatic 591	java/lang/Boolean:TYPE	Ljava/lang/Class;
    //   225: aastore
    //   226: iconst_2
    ...
    //   235: iconst_1
    //   236: iload_1
    //   237: invokestatic 594	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   240: aastore
    //   241: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   244: pop
    //   245: return
    //   246: astore_3
    //   247: aload_2
    //   248: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   251: ldc_w 497
    //   254: ldc_w 596
    //   257: iconst_1
    ...
    //   273: aload_0
    //   274: aastore
    //   275: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   278: pop
    //   279: aload_2
    //   280: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   283: ldc_w 497
    //   286: ldc_w 598
    //   289: iconst_1
    ...
    //   305: aload_0
    //   306: aastore
    //   307: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   310: pop
    //   311: aload_2
    //   312: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   315: ldc_w 497
    //   318: ldc_w 600
    //   321: iconst_1
    ...
    //   337: aload_0
    //   338: aastore
    //   339: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   342: pop
    //   343: aload_2
    //   344: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   347: ldc_w 602
    //   350: ldc_w 604
    //   353: aconst_null
    //   354: iconst_0
    //   355: anewarray 4	java/lang/Object
    //   358: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   361: pop
    //   362: aload_2
    //   363: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   366: ldc_w 602
    //   369: ldc_w 606
    //   372: aconst_null
    //   373: iconst_0
    //   374: anewarray 4	java/lang/Object
    //   377: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   380: pop
    //   381: aload_2
    //   382: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   385: ldc_w 608
    //   388: ldc_w 609
    //   391: aconst_null
    //   392: iconst_0
    //   393: anewarray 4	java/lang/Object
    //   396: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   399: astore_0
    //   400: aload_0
    //   401: ifnull +23 -> 424
    //   404: aload_2
    //   405: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   408: aload_0
    //   409: ldc_w 608
    //   412: ldc_w 611
    //   415: aconst_null
    ...
    //   420: invokevirtual 615	com/tencent/smtt/export/external/DexLoader:invokeMethod	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   423: pop
    //   424: aload_2
    //   425: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   428: ldc_w 617
    //   431: ldc_w 609
    //   434: aconst_null
    //   435: iconst_0
    //   436: anewarray 4	java/lang/Object
    //   439: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   442: astore_0
    //   443: aload_0
    //   444: ifnull +23 -> 467
    //   447: aload_2
    //   448: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   451: aload_0
    //   452: ldc_w 617
    //   455: ldc_w 619
    //   458: aconst_null
    ...
    //   463: invokevirtual 615	com/tencent/smtt/export/external/DexLoader:invokeMethod	(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   466: pop
    //   467: aload_2
    //   468: getfield 495	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   471: ldc_w 497
    //   474: ldc_w 620
    //   477: aconst_null
    //   478: iconst_0
    //   479: anewarray 4	java/lang/Object
    //   482: invokevirtual 505	com/tencent/smtt/export/external/DexLoader:invokeStaticMethod	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    //   485: pop
    //   486: return
    //   487: astore_0
    //   488: return
  ...
  public static void closeFileReader(Context paramContext)
  {
    ...
    if (localab.clJ()) {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "closeFileReader", new Class[0], new Object[0]);
    }
  }
  ...
  public static boolean deleteMiniQBShortCut(Context paramContext, String paramString1, String paramString2)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return false;
        } while (l.gn(paramContext));
        localab = ab.clI();
      } while ((localab == null) || (!localab.clJ()));
    } while (localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "deleteMiniQBShortCut", new Class[] { Context.class, String.class, String.class }, new Object[] { paramContext, paramString1, paramString2 }) == null);
    return true;
  }
  ...
  static Bundle e(Context paramContext, Bundle paramBundle)
  {
    if (!ga(paramContext))
    {
      r.gP(paramContext).aP(216, "initForPatch return false!");
      return null;
    }
    paramBundle = o.a(xvi, "incrUpdate", new Class[] { Context.class, Bundle.class }, new Object[] { paramContext, paramBundle });
    if (paramBundle != null) {
      return (Bundle)paramBundle;
    }
    r.gP(paramContext).aP(216, "incrUpdate return null!");
    return null;
  }
  ...
  public static void fileInfoDetect(Context paramContext, String paramString, ValueCallback<String> paramValueCallback)
  {
    ...
    try
    {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "fileInfoDetect", new Class[] { Context.class, String.class, ValueCallback.class }, new Object[] { paramContext, paramString, paramValueCallback });
      return;
    }
    catch (Throwable paramContext) {}
  }
  ...
  {
    xvk = true;
    xvo = "SysWebViewForcedByOuter: " + Log.getStackTraceString(new Throwable());
  ...
  private static boolean ga(Context paramContext)
  {
    try
    {
      ...
      p.clh();
      Object localObject = p.gI(paramContext);
      if (localObject == null)
      {
      ...
      xvh = (Class)localObject;
      xvi = ((Class)localObject).getConstructor(new Class[] { Context.class, Context.class }).newInstance(new Object[] { paramContext, paramContext });
      return true;
    }
    catch (Throwable paramContext)
    {
  ...
  private static boolean gb(Context paramContext)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        p.clh();
        localObject1 = p.gI(paramContext);
        ...
        {
          i.ckL().aj(paramContext, 304);
          return false;
        }
        p.clh();
        Object localObject2 = new File(p.gI(paramContext), "tbs_sdk_extension_dex.jar");
        if (!((File)localObject2).exists())
        {
          i.ckL().a(paramContext, 406, new Exception("initForX5DisableConfig failure -- tbs_sdk_extension_dex.jar is not exist!"));
          return false;
        }
        if (t.clr() != null)
        {
        ...
        xvi = xvh.getConstructor(new Class[] { Context.class, Context.class, String.class }).newInstance(new Object[] { paramContext, null, t.clr() });
        paramContext = xvi;
        localObject1 = com.tencent.smtt.utils.c.aGY;
        localObject2 = com.tencent.smtt.utils.c.xzG;
        String str1 = com.tencent.smtt.utils.c.xzH;
        String str2 = com.tencent.smtt.utils.c.aKT;
        ...
        o.a(xvi, "setClientVersion", new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(1) });
        return true;
      }
      catch (Throwable paramContext)
      {
      ...
      label408:
      xvi = ((Constructor)localObject1).newInstance(new Object[] { paramContext, paramContext });
    }
  }
  ...
  public static long getApkFileSize(Context paramContext)
  {
    long l = 0L;
    if (paramContext != null) {
      l = k.gj(paramContext.getApplicationContext()).xwL.getLong("tbs_apkfilesize", 0L);
    }
    return l;
  }
  ...
  public static String[] getDexLoaderFileList(Context paramContext1, Context paramContext2, String paramString)
  {
    ...
    if ((xvn instanceof String[]))
    {
      ...
      for (;;)
      {
        ...
        paramContext2[i] = (paramString + xvn[i]);
        i += 1;
      }
    }
    paramContext1 = o.a(xvi, "getJarFiles", new Class[] { Context.class, Context.class, String.class }, new Object[] { paramContext1, paramContext2, paramString });
  ...
  public static String getMiniQBVersion(Context paramContext)
  {
    ...
    if ((localab != null) && (localab.clJ()))
    {
      paramContext = localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getMiniQBVersion", new Class[0], new Object[0]);
      if (paramContext == null) {
        return null;
      }
  ...
  public static int getTbsVersion(Context paramContext)
  {
    ...
    do
    {
      ...
      {
        return i;
        j = p.clh().gA(paramContext);
        i = j;
      } while (j != 0);
      i = j;
    } while (j.gi(paramContext).Xj("install_status") != 3);
    reset(paramContext);
    return j;
  }
    ...
    l.a(paramContext, false, false, new l.a()
    {
      public final void e(boolean paramAnonymousBoolean, int paramAnonymousInt)
      {
        if ((t.cly() == 0) && (!t.clu()))
        {
          ...
          if ((QbSdk.xvu) && (t.gS(this.val$context))) {
            m.clf().gp(this.val$context);
          }
          return;
        }
        if ((QbSdk.xvu) && (t.gS(this.val$context))) {
  ...
  public static boolean installLocalQbApk(Context paramContext, String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if ((locald != null) && (locald.xvL))
    {
      paramContext = locald.ckB().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "installLocalQbApk", new Class[] { Context.class, String.class, String.class, Bundle.class }, new Object[] { paramContext, paramString1, paramString2, paramBundle });
      if (paramContext == null) {
        return false;
      }
      return ((Boolean)paramContext).booleanValue();
  ...
  public static boolean intentDispatch(WebView paramWebView, Intent paramIntent, String paramString1, String paramString2)
  {
    ...
    for (paramIntent = paramString1.substring(i + 4);; paramIntent = null)
    {
      ...
      if ("miniqb://home".equals(paramIntent))
      {
        ...
        {
          paramString1 = ab.clI();
          if ((paramString1 != null) && (paramString1.clJ()) && (paramString1.clK().a(localContext, paramIntent, null, paramString2, null) == 0)) {
            return true;
          }
  ...
  public static boolean isMiniQBShortCutExist(Context paramContext, String paramString1, String paramString2)
  {
    ...
    paramString2 = ab.clI();
    if ((paramString2 != null) && (paramString2.clJ()))
    {
      paramContext = paramString2.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "isMiniQBShortCutExist", new Class[] { Context.class, String.class }, new Object[] { paramContext, paramString1 });
      if (paramContext != null) {
  ...
  {
    if (j.gi(paramContext).Xj("install_status") == 2) {}
    for (int i = 1; i != 0; i = 0) {
      return false;
    }
    if (!gb(paramContext)) {
    ...
    i = p.clh().gA(paramContext);
    paramContext = o.a(xvi, "isX5DisabledSync", new Class[] { Integer.TYPE, Integer.TYPE }, new Object[] { Integer.valueOf(i), Integer.valueOf(43601) });
    if (paramContext != null) {
      return ((Boolean)paramContext).booleanValue();
    }
    return true;
  ...
  private static boolean p(Context paramContext, boolean paramBoolean)
  {
    ...
    //   25: getstatic 105	com/tencent/smtt/sdk/QbSdk:xvj	Z
    //   28: ifeq +54 -> 82
    //   31: iload_1
    //   32: ifne +50 -> 82
    //   35: ldc -46
    ...
    //   47: getstatic 119	com/tencent/smtt/sdk/QbSdk:xvp	Ljava/lang/String;
    ...
    //   60: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   63: aload_0
    //   64: sipush 414
    //   67: new 226	java/lang/Throwable
    //   70: dup
    //   71: getstatic 119	com/tencent/smtt/sdk/QbSdk:xvp	Ljava/lang/String;
    ...
    //   80: iconst_0
    //   81: ireturn
    //   82: getstatic 107	com/tencent/smtt/sdk/QbSdk:xvk	Z
    //   85: ifeq +34 -> 119
    //   88: ldc -46
    //   90: ldc_w 877
    //   93: iconst_1
    //   94: invokestatic 286	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;Z)V
    //   97: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   100: aload_0
    //   101: sipush 402
    //   104: new 226	java/lang/Throwable
    //   107: dup
    //   108: getstatic 115	com/tencent/smtt/sdk/QbSdk:xvo	Ljava/lang/String;
    ...
    //   117: iconst_0
    //   118: ireturn
    //   119: getstatic 144	com/tencent/smtt/sdk/QbSdk:xvA	Z
    //   122: ifne +53 -> 175
    //   125: iconst_1
    //   126: putstatic 144	com/tencent/smtt/sdk/QbSdk:xvA	Z
    ...
    //   175: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   178: pop
    //   179: aload_0
    //   180: invokestatic 265	com/tencent/smtt/sdk/p:gI	(Landroid/content/Context;)Ljava/io/File;
    //   183: astore 8
    //   185: aload 8
    ...
    //   198: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   201: aload_0
    //   202: sipush 312
    ...
    //   233: iload_2
    //   234: istore 4
    //   236: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   239: aload_0
    //   240: invokevirtual 746	com/tencent/smtt/sdk/p:gA	(Landroid/content/Context;)I
    //   243: istore_3
    //   244: iload_3
    //   245: ifle -70 -> 175
    //   248: iload 4
    ...
    //   370: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   373: pop
    //   374: aload_0
    //   375: invokestatic 265	com/tencent/smtt/sdk/p:gI	(Landroid/content/Context;)Ljava/io/File;
    //   378: iconst_0
    //   379: invokestatic 915	com/tencent/smtt/utils/f:c	(Ljava/io/File;Z)V
    //   382: aload_0
    //   383: invokestatic 752	com/tencent/smtt/sdk/j:gi	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/j;
    //   386: pop
    //   387: invokestatic 919	com/tencent/smtt/sdk/j:ckM	()Ljava/io/File;
    //   390: astore 9
    //   392: aload 9
    //   394: ifnull +9 -> 403
    //   397: aload 9
    ...
    //   602: invokestatic 482	com/tencent/smtt/sdk/ab:clI	()Lcom/tencent/smtt/sdk/ab;
    //   605: aload_0
    //   606: aconst_null
    //   607: invokevirtual 625	com/tencent/smtt/sdk/ab:b	(Landroid/content/Context;Lcom/tencent/smtt/sdk/o;)V
    //   610: ldc -46
    //   612: ldc_w 937
    ...
    //   713: goto -53 -> 660
    //   716: aload_0
    //   717: invokestatic 689	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   720: ifne +135 -> 855
    //   723: getstatic 99	com/tencent/smtt/sdk/QbSdk:xvf	I
    //   726: ifeq +792 -> 1518
    //   729: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   732: iconst_1
    //   733: aload_0
    ...
    //   738: iload_3
    //   739: istore_2
    //   740: getstatic 99	com/tencent/smtt/sdk/QbSdk:xvf	I
    //   743: iload_3
    //   744: if_icmpeq +107 -> 851
    //   747: aconst_null
    //   748: putstatic 255	com/tencent/smtt/sdk/QbSdk:xvh	Ljava/lang/Class;
    //   751: aconst_null
    //   752: putstatic 166	com/tencent/smtt/sdk/QbSdk:xvi	Ljava/lang/Object;
    //   755: ldc -46
    ...
    //   790: getstatic 99	com/tencent/smtt/sdk/QbSdk:xvf	I
    ...
    //   803: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   806: aload_0
    //   807: sipush 303
    ...
    //   824: getstatic 99	com/tencent/smtt/sdk/QbSdk:xvf	I
    ...
    //   850: ireturn
    //   851: iload_2
    //   852: putstatic 99	com/tencent/smtt/sdk/QbSdk:xvf	I
    //   855: getstatic 255	com/tencent/smtt/sdk/QbSdk:xvh	Ljava/lang/Class;
    //   858: ifnull +5 -> 863
    //   861: iconst_1
    //   862: ireturn
    //   863: aload_0
    //   864: invokestatic 689	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   867: ifeq +25 -> 892
    //   870: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   873: aload_0
    //   874: sipush 304
    ...
    //   890: iconst_0
    //   891: ireturn
    //   892: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   895: pop
    //   896: new 269	java/io/File
    //   899: dup
    //   900: aload_0
    //   901: invokestatic 265	com/tencent/smtt/sdk/p:gI	(Landroid/content/Context;)Ljava/io/File;
    //   904: ldc_w 276
    ...
    //   930: invokestatic 261	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   933: aload_0
    //   934: invokevirtual 746	com/tencent/smtt/sdk/p:gA	(Landroid/content/Context;)I
    //   937: istore_2
    ...
    //   959: iload_2
    //   960: ifle +40 -> 1000
    //   963: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   966: aload_0
    //   967: sipush 4131
    ...
    //   997: goto +526 -> 1523
    //   1000: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   1003: aload_0
    //   1004: sipush 4132
    ...
    //   1037: iload_2
    //   1038: ifle +40 -> 1078
    //   1041: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   1044: aload_0
    //   1045: sipush 4121
    ...
    //   1075: goto +448 -> 1523
    //   1078: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   1081: aload_0
    //   1082: sipush 4122
    ...
    //   1112: goto +411 -> 1523
    //   1115: invokestatic 289	com/tencent/smtt/sdk/t:clr	()Ljava/lang/String;
    //   1118: ifnull +122 -> 1240
    //   1121: invokestatic 289	com/tencent/smtt/sdk/t:clr	()Ljava/lang/String;
    //   1124: astore 8
    //   1126: ldc -46
    ...
    //   1179: astore 8
    //   1181: aload 8
    //   1183: putstatic 255	com/tencent/smtt/sdk/QbSdk:xvh	Ljava/lang/Class;
    //   1186: aload 8
    //   1188: iconst_2
    ...
    //   1207: astore 8
    //   1209: aload_0
    //   1210: invokestatic 689	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   1213: ifeq +203 -> 1416
    //   1216: invokestatic 289	com/tencent/smtt/sdk/t:clr	()Ljava/lang/String;
    //   1219: ifnonnull +31 -> 1250
    //   1222: aload_0
    //   1223: invokevirtual 318	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   1226: invokestatic 324	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   1229: sipush 227
    //   1232: ldc_w 326
    //   1235: invokevirtual 330	com/tencent/smtt/sdk/r:aQ	(ILjava/lang/String;)V
    //   1238: iconst_0
    //   1239: ireturn
    //   1240: aload 8
    ...
    //   1245: astore 8
    //   1247: goto -121 -> 1126
    //   1250: getstatic 255	com/tencent/smtt/sdk/QbSdk:xvh	Ljava/lang/Class;
    //   1253: iconst_3
    ...
    //   1289: dup
    //   1290: iconst_2
    //   1291: invokestatic 289	com/tencent/smtt/sdk/t:clr	()Ljava/lang/String;
    //   1294: aastore
    //   1295: invokevirtual 340	java/lang/reflect/Constructor:newInstance	([Ljava/lang/Object;)Ljava/lang/Object;
    //   1298: putstatic 166	com/tencent/smtt/sdk/QbSdk:xvi	Ljava/lang/Object;
    //   1301: getstatic 166	com/tencent/smtt/sdk/QbSdk:xvi	Ljava/lang/Object;
    //   1304: astore 8
    //   1306: getstatic 697	com/tencent/smtt/utils/c:aGY	Ljava/lang/String;
    //   1309: astore 9
    //   1311: getstatic 700	com/tencent/smtt/utils/c:xzG	Ljava/lang/String;
    //   1314: astore 10
    //   1316: getstatic 703	com/tencent/smtt/utils/c:xzH	Ljava/lang/String;
    //   1319: astore 11
    //   1321: getstatic 706	com/tencent/smtt/utils/c:aKT	Ljava/lang/String;
    //   1324: astore 12
    //   1326: aload 8
    //   1328: ldc_w 708
    //   1331: iconst_4
    ...
    //   1382: pop
    //   1383: getstatic 166	com/tencent/smtt/sdk/QbSdk:xvi	Ljava/lang/Object;
    //   1386: ldc_w 710
    //   1389: iconst_1
    ...
    //   1433: putstatic 166	com/tencent/smtt/sdk/QbSdk:xvi	Ljava/lang/Object;
    //   1436: goto -135 -> 1301
    //   1439: astore 8
    //   1441: ldc -46
    ...
    //   1467: invokestatic 224	com/tencent/smtt/sdk/i:ckL	()Lcom/tencent/smtt/sdk/i;
    //   1470: aload_0
    //   1471: sipush 306
    //   1474: aload 8
    ...
    try
    {
      ...
      if (!xvm)
      {
        paramContext = new Thread()
        {
          public final void handleMessage(Message paramAnonymousMessage)
          {
            ...
            do
            {
              ...
              return;
              paramAnonymousMessage = ab.clI().clK();
              if (paramAnonymousMessage != null) {
                paramAnonymousMessage.hf(paramContext);
              }
              if (parama != null) {
                parama.jI(true);
              }
        ...
        }
        {
          public final void run()
          {
            if (p.clh().a(true, this.val$context) == 0) {
              p.clh().v(this.val$context, true);
            }
            d.mI(true).a(this.val$context, null);
            ab localab = ab.clI();
            localab.b(this.val$context, null);
            boolean bool = localab.clJ();
            this.xvI.sendEmptyMessage(3);
            if (!bool)
            {
              this.xvI.sendEmptyMessage(2);
              return;
            }
            this.xvI.sendEmptyMessage(1);
          }
        };
  ...
  static boolean q(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = o.a(xvi, "canLoadX5Core", new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(43601) });
      int i;
      label387:
      label619:
      Class localClass2;
      ...
      if (localObject2 != null)
      {
        ...
        {
          i.ckL().a(paramContext, 330, new Throwable(String.valueOf(localObject2)));
        ...
        {
          i.ckL().a(paramContext, 331, new Throwable(String.valueOf(localObject2)));
        ...
        try
        {
          ...
          if (i == 0)
          {
            ...
            d.Er(t.clw());
            localObject2 = String.valueOf(t.clw());
            xvg = (String)localObject2;
        ...
        catch (Exception localException2)
        {
          for (;;)
          {
            try
            {
              xvn = localBundle.getStringArray("tbs_jarfiles");
              if ((xvn instanceof String[])) {
                break label619;
              }
              i.ckL().a(paramContext, 307, new Throwable("sJarFiles not instanceof String[]: " + xvn));
              return false;
            }
            catch (Throwable localThrowable)
            {
              i.ckL().a(paramContext, 329, localThrowable);
              return false;
            }
            ...
            if (Build.VERSION.SDK_INT >= 12) {
              xvg = localBundle.getString("tbs_core_version", "0");
            }
            try
            {
              xvf = Integer.parseInt(xvg);
              d.Er(xvf);
              if (xvf == 0)
              {
                i.ckL().a(paramContext, 307, new Throwable("sTbsVersion is 0"));
                return false;
            ...
            catch (NumberFormatException localNumberFormatException)
            {
              ...
              if (j != 0)
              {
                TbsLog.e("TbsDownload", "is_obsolete --> delete old core:" + xvf);
                p.clh();
                f.M(p.gI(paramContext));
                i.ckL().a(paramContext, 307, new Throwable("is_obsolete --> delete old core:" + xvf));
                return false;
                j = 0;
              }
            }
        ...
        xvq = localThrowable.getString("tbs_librarypath");
        localClass2 = null;
      ...
      try
      {
        localObject1 = o.a(xvi, "getErrorCodeForLogReport", new Class[0], new Object[0]);
        switch (i)
        {
        default: 
          i.ckL().a(paramContext, 415, new Throwable("detail: " + localObject1 + "errcode" + i));
        }
        for (;;)
        {
          bool1 = paramBoolean;
          ...
          {
            i.ckL().a(paramContext, ((Integer)localObject1).intValue(), new Throwable("detail: " + localObject1));
          }
          else
          {
            i.ckL().a(paramContext, 307, new Throwable("detail: " + localObject1));
            continue;
            if ((localObject1 instanceof Integer))
            {
              i.ckL().a(paramContext, ((Integer)localObject1).intValue(), new Throwable("detail: " + localObject1));
            ...
            {
              i.ckL().a(paramContext, 404, new Throwable("detail: " + localObject1));
              continue;
              continue;
              localObject1 = xvi;
              ...
              if (localObject1 != null)
              {
                ...
                xvf = d.ckC();
                boolean bool3 = ah(paramContext, d.ckC());
                paramBoolean = bool2;
  ...
  public static void reset(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      {
        l.stopDownload();
        if ((paramBoolean) && (!t.gS(paramContext)))
        {
          p.clh();
          int j = p.gz(paramContext);
          int k = p.clh().gA(paramContext);
          if ((j > 43300) && (j != k))
          {
            l.go(paramContext);
            f.e(paramContext.getDir("tbs", 0), "core_share_decouple");
            TbsLog.i("QbSdk", "delete downloaded apk success", true);
            p.xxo.set(Integer.valueOf(0));
            ...
            {
              p.clh();
              localFile = p.gH(paramContext);
              p.clh();
              f.i(localFile, p.gL(paramContext));
              p.clh();
              p.w(paramContext, true);
              j.gi(paramContext).eQ(p.gz(paramContext), 2);
            }
            return;
          }
        }
  ...
  public static void setCurrentID(String paramString)
  {
    ...
    xvx = "0000000000000000".substring(paramString.length()) + paramString;
  }
  
  public static void setDeviceInfo(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    com.tencent.smtt.utils.c.aGY = paramString1;
    com.tencent.smtt.utils.c.xzG = paramString2;
    com.tencent.smtt.utils.c.xzH = paramString3;
    com.tencent.smtt.utils.c.aKT = paramString4;
  }
  ...
  public static int startMiniQBToLoadUrl(Context paramContext, String paramString, HashMap<String, String> paramHashMap, ValueCallback<String> paramValueCallback)
  {
    ...
    if (localab.clJ())
    {
      ...
      int i = localab.clK().a(paramContext, paramString, paramHashMap, null, paramValueCallback);
      if (i == 0)
      {
        i.ckL().aj(paramContext, 503);
        return i;
      }
      r.gP(paramContext).aQ(504, String.valueOf(i));
      return i;
    }
    i.ckL().aj(paramContext, 502);
    return -102;
  }
    ...
    try
    {
      ...
      else
      {
        ...
        if (localObject != null)
        {
          ...
          if (((ab)localObject).clJ())
          {
            localObject = ((ab)localObject).clK().xyA.invokeStaticMethod("com.tencent.smtt.webkit.WebViewList", "getCurrentMainWebviewJustForQQandWechat", new Class[0], new Object[0]);
            localWebView1 = paramWebView;
            if (localObject != null)
            {
  ...
  public static boolean startQbOrMiniQBToLoadUrl(Context paramContext, String paramString, HashMap<String, String> paramHashMap, x<String> paramx)
  {
    ...
    ab localab = ab.clI();
    localab.b(paramContext, null);
    if ((paramHashMap != null) && ("5".equals(paramHashMap.get("PosID"))) && (localab.clJ())) {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getAdWebViewInfoFromX5Core", new Class[0], new Object[0]);
    }
    if (com.tencent.smtt.sdk.a.c.a(paramContext, paramString, paramHashMap, "QbSdk.startMiniQBToLoadUrl", null) != 0)
    {
      if (localab.clJ())
      {
        ...
        if (localab.clK().a(paramContext, paramString, paramHashMap, null, paramx) == 0) {
          return true;
        }
      }
    }
  ...
  public static boolean useSoftWare()
  {
    ...
    Object localObject2 = o.a(xvi, "useSoftWare", new Class[0], new Object[0]);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/QbSdk.class
