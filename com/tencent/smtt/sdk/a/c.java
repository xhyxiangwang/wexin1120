...
public final class c
{
  public static int a(Context paramContext, String paramString, HashMap<String, String> paramHashMap, WebView paramWebView)
  {
    ...
    Object localObject2 = hl(paramContext);
    if (((a)localObject2).sSA == -1) {
      return 4;
    }
    if ((((a)localObject2).sSA == 2) && (((a)localObject2).ver < 33)) {
      return 5;
    }
    paramString = new Intent("android.intent.action.VIEW");
    if (((a)localObject2).sSA == 2) {
    ...
    for (;;)
    {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                if ((localObject2 != null) && (!TextUtils.isEmpty(((b)localObject2).classname))) {
                  paramString.setClassName(((b)localObject2).sSC, ((b)localObject2).classname);
                }
                break;
                if (((a)localObject2).sSA == 1)
                {
      ...
      try
      {
        paramString.putExtra("loginType", hk(paramContext));
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, HashMap<String, String> paramHashMap, Bundle paramBundle)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        localIntent.putExtra("loginType", hk(paramContext.getApplicationContext()));
        if (paramBundle != null) {
  ...
  private static b g(Context paramContext, Uri paramUri)
  {
    ...
    while (paramUri.hasNext())
    {
      ...
      if (str.contains("com.tencent.mtt"))
      {
        ...
        paramContext.sSC = ((ResolveInfo)localObject).activityInfo.packageName;
        return paramContext;
      }
  ...
  private static int hk(Context paramContext)
  {
    int i = 26;
  ...
  private static a hl(Context paramContext)
  {
        ...
        try
        {
          ...
          if (localObject6 != null)
          {
            ...
            if (((PackageInfo)localObject6).versionCode > 420000)
            {
              ...
              localObject1 = localObject6;
              locala.sSB += ((PackageInfo)localObject6).versionName.replaceAll("\\.", "");
              localObject1 = localObject6;
              locala.xzF = ((PackageInfo)localObject6).versionName.replaceAll("\\.", "");
              return locala;
            }
          }
        }
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException4)
          {
            ...
            catch (Exception localException)
            {
              ...
              try
              {
                ...
                if (TextUtils.isEmpty(((b)localObject6).sSC)) {
                  continue;
                }
                localObject5 = localObject2;
                paramContext = localPackageManager.getPackageInfo(((b)localObject6).sSC, 0);
                localObject5 = paramContext;
                locala.packageName = ((b)localObject6).sSC;
                localObject5 = paramContext;
                locala.sSA = 2;
                localObject5 = paramContext;
                locala.sSB = "ADRQB_";
    ...
    if (paramContext != null)
    {
      ...
      locala.sSB += paramContext.versionName.replaceAll("\\.", "");
      locala.xzF = paramContext.versionName.replaceAll("\\.", "");
    }
    return locala;
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/a/c.class
