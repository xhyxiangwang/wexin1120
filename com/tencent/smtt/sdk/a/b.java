...
{
  public static byte[] xzD = null;
  
  static
  {
    try
    {
      xzD = "65dRa93L".getBytes("utf-8");
      return;
    }
  ...
  public static org.json.JSONObject a(ThirdAppInfoNew paramThirdAppInfoNew, Context paramContext)
  {
    ...
    //   163: pop
    //   164: aload_1
    //   165: invokestatic 124	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   168: ifeq +148 -> 316
    //   171: aload_3
    //   172: ldc 126
    //   174: invokestatic 130	com/tencent/smtt/sdk/t:clt	()J
    ...
    //   209: pop
    //   210: getstatic 145	com/tencent/smtt/sdk/i:xwD	I
    //   213: istore_2
    //   214: aload_0
    ...
    //   222: ldc -109
    //   224: aload_1
    //   225: invokestatic 153	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   228: invokevirtual 157	com/tencent/smtt/sdk/k:ckU	()I
    ...
    //   262: ifeq +90 -> 352
    //   265: invokestatic 185	com/tencent/smtt/utils/k:clX	()Lcom/tencent/smtt/utils/k;
    //   268: pop
    //   269: aload_3
    //   270: ldc -69
    //   272: invokestatic 173	com/tencent/smtt/sdk/QbSdk:getTID	()Ljava/lang/String;
    //   275: invokestatic 191	com/tencent/smtt/utils/k:Xr	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   317: ldc 126
    //   319: aload_1
    //   320: invokestatic 201	com/tencent/smtt/sdk/l:gm	(Landroid/content/Context;)I
    //   323: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   326: pop
    //   327: aload_3
    //   328: ldc -53
    //   330: aload_1
    //   331: invokestatic 201	com/tencent/smtt/sdk/l:gm	(Landroid/content/Context;)I
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          paramString1 = c.hq(paramContext);
          paramString2 = c.W(paramContext);
          paramString3 = c.hp(paramContext);
          localObject3 = c.hr(paramContext);
          ...
          if (t.clz())
          {
            ...
            ((ThirdAppInfoNew)localObject1).sAppSignature = hj(paramContext);
            if (!paramBoolean)
            {
            ...
            new Thread("HttpUtils")
            {
              ...
              public final void run()
              {
                ...
                //   5: if_icmpge +4 -> 9
                //   8: return
                //   9: getstatic 44	com/tencent/smtt/sdk/a/b:xzD	[B
                //   12: ifnonnull +13 -> 25
                //   15: ldc 46
                //   17: ldc 48
                //   19: invokevirtual 54	java/lang/String:getBytes	(Ljava/lang/String;)[B
                //   22: putstatic 44	com/tencent/smtt/sdk/a/b:xzD	[B
                //   25: getstatic 44	com/tencent/smtt/sdk/a/b:xzD	[B
                //   28: ifnonnull +26 -> 54
                //   31: ldc 56
                //   33: ldc 58
                ...
                //   39: astore_2
                //   40: aconst_null
                //   41: putstatic 44	com/tencent/smtt/sdk/a/b:xzD	[B
                //   44: ldc 56
                //   46: ldc 66
                //   48: invokestatic 64	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
                //   51: goto -26 -> 25
                //   54: aload_0
                //   55: getfield 14	com/tencent/smtt/sdk/a/b$1:qqL	Landroid/content/Context;
                //   58: invokestatic 72	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
                //   61: getfield 76	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
                //   64: ldc 78
                //   66: ldc 80
                ...
                //   142: iconst_1
                //   143: istore_1
                //   144: invokestatic 112	com/tencent/smtt/utils/q:cmd	()Lcom/tencent/smtt/utils/q;
                //   147: astore 4
                //   149: iload_1
                //   150: ifeq +129 -> 279
                ...
                //   160: aload 4
                //   162: getfield 120	com/tencent/smtt/utils/q:xAC	Ljava/lang/String;
                //   165: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
                //   168: astore_3
                //   169: invokestatic 130	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
                //   172: pop
                //   173: aload_3
                //   174: invokestatic 134	com/tencent/smtt/utils/j:clV	()Ljava/lang/String;
                ...
                //   250: aload_0
                //   251: getfield 16	com/tencent/smtt/sdk/a/b$1:xzE	LMTT/ThirdAppInfoNew;
                //   254: aload_0
                //   255: getfield 14	com/tencent/smtt/sdk/a/b$1:qqL	Landroid/content/Context;
                ...
                //   286: aload 4
                //   288: getfield 181	com/tencent/smtt/utils/q:xAD	Ljava/lang/String;
                ...
                //   390: iload_1
                //   391: ifeq +92 -> 483
                //   394: invokestatic 130	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
                //   397: aload_3
                //   398: invokevirtual 198	com/tencent/smtt/utils/j:bD	([B)[B
                //   401: astore_2
                //   402: aload 4
                //   404: ldc -56
                //   406: ldc -54
        ...
        {
          ((ThirdAppInfoNew)localObject1).sQua2 = p.hw(paramContext);
          continue;
        }
        paramInt = 1;
      }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/a/b.class
