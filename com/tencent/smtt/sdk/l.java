...
{
  public static Context aHE;
  private static String xwM;
  private static Handler xwN;
  private static String xwO;
  public static boolean xwP = false;
  private static Object xwQ = new byte[0];
  public static h xwR;
  private static HandlerThread xwS;
  static boolean xwT;
  private static boolean xwU = false;
  private static boolean xwV = false;
  private static boolean xwW = false;
  private static long xwX = -1L;
  
  protected static File Ew(int paramInt)
  {
    ...
    if (i < 4)
    {
      ...
      if (((String)localObject2).equals(aHE.getApplicationInfo().packageName)) {
        break label128;
      }
      localObject2 = f.a(aHE, (String)localObject2, 4, false);
      if (!gn(aHE)) {
        break label115;
      }
    }
    ...
    for (localObject1 = "x5.oversea.tbs.org";; localObject1 = "x5.tbs.org")
    {
      ...
      if (a.c(aHE, (File)localObject1) != paramInt) {
        break;
      }
  ...
  protected static File Ex(int paramInt)
  {
    String[] arrayOfString = t.cls();
    ...
    for (;;)
    {
      ...
      for (localObject = "x5.oversea.tbs.org";; localObject = "x5.tbs.org")
      {
        ...
        if ((!((File)localObject).exists()) || (a.c(aHE, (File)localObject) != paramInt)) {
          break;
        }
        TbsLog.i("TbsDownload", "local tbs version fond,path = " + ((File)localObject).getAbsolutePath());
        return (File)localObject;
      }
      localObject = new File(f.a(aHE, str1, 4, false), "x5.tbs.decouple");
      if ((((File)localObject).exists()) && (a.c(aHE, (File)localObject) == paramInt))
      {
        TbsLog.i("TbsDownload", "local tbs version fond,path = " + ((File)localObject).getAbsolutePath());
        return (File)localObject;
  ...
  {
    Object localObject = null;
    k localk = k.gj(paramContext);
    if (Build.VERSION.SDK_INT < 8)
    {
      localk.Eu(-102);
      return false;
    }
    if (!localk.xwL.contains("is_oversea"))
    {
      ...
      localk.xwK.put("is_oversea", Boolean.valueOf(bool));
      localk.commit();
      xwV = bool;
      TbsLog.i("TbsDownload", "needDownload-first-called--isoversea = " + bool);
    }
    if ((gn(paramContext)) && (Build.VERSION.SDK_INT != 16) && (Build.VERSION.SDK_INT != 17) && (Build.VERSION.SDK_INT != 18))
    {
    ...
    paramContext = localk.xwL.getString("device_cpuabi", null);
    xwO = paramContext;
    if (!TextUtils.isEmpty(paramContext)) {}
    try
    {
      paramContext = Pattern.compile("i686|mips|x86_64").matcher(xwO);
  ...
  public static boolean a(Context paramContext, boolean paramBoolean1, boolean paramBoolean2, a parama)
  {
    ...
    aHE = (Context)localObject;
    k localk = k.gj((Context)localObject);
    localk.Eu(-100);
    if (!a(aHE, paramBoolean1, parama)) {
      return false;
    }
    ckY();
    if (xwU)
    ...
    localObject = aHE;
    int i = 0;
    localObject = k.gj((Context)localObject);
    r.b localb = null;
    String str1;
    int k;
    String str2;
    ...
    if (!paramBoolean2)
    {
      str1 = ((k)localObject).xwL.getString("app_versionname", null);
      k = ((k)localObject).xwL.getInt("app_versioncode", 0);
      str2 = ((k)localObject).xwL.getString("app_metadata", null);
      str3 = c.getAppVersionName(aHE);
      m = c.getAppVersionCode(aHE);
      str4 = c.bE(aHE, "com.tencent.mm.BuildInfo.CLIENT_VERSION");
      ...
      if (l1 - l2 <= l3 * 1000L) {
        if ((t.gS(aHE)) && (t.cly() == 0) && (!ckZ()))
        {
          ...
          if ((j == 0) && (t.gS(aHE)))
          {
            ...
            localb.Xp((String)localObject);
            r.gP(aHE).a(r.a.xxD, localb);
          }
          if (j != 0)
          {
            TbsLog.i("TbsDownload", "[TbsDownloader.queryConfig]");
            xwN.removeMessages(100);
            localObject = Message.obtain(xwN, 100);
            if (parama != null) {
          ...
          xwN.removeMessages(102);
          Message.obtain(xwN, 102).sendToTarget();
          if ((!QbSdk.xvl) && (t.gS(paramContext))) {
            break label1240;
          }
          paramBoolean1 = localk.xwL.contains("tbs_needdownload");
          TbsLog.i("TbsDownload", "[TbsDownloader.needDownload] hasNeedDownloadKey=" + paramBoolean1);
          if ((paramBoolean1) || (t.gS(paramContext))) {
            break label948;
          }
          paramBoolean1 = true;
        }
    ...
    for (;;)
    {
      ...
      if (paramBoolean1)
      {
        paramContext = k.gj(aHE);
        if (paramContext.xwL.getInt("tbs_download_success_retrytimes", 0) >= paramContext.ckS())
        {
      ...
      for (;;)
      {
        ...
        localObject = "timeNow - timeLastCheck is " + (l1 - l2) + " TbsShareManager.findCoreForThirdPartyApp(sAppContext) is " + t.cly() + " sendRequestWithSameHostCoreVersion() is " + ckZ() + " appVersionName is " + str3 + " appVersionCode is " + m + " appMetadata is " + str4 + " oldAppVersionName is " + str1 + " oldAppVersionCode is " + k + " oldAppVersionMetadata is " + str2;
        j = i;
        break;
        j = 1;
        localObject = localb;
        ...
        break label538;
        label948:
        paramBoolean1 = localk.xwL.getBoolean("tbs_needdownload", false);
        break label638;
        if (paramContext.xwL.getInt("tbs_download_failed_retrytimes", 0) >= paramContext.ckT())
        {
        ...
        if (System.currentTimeMillis() - paramContext.xwL.getLong("tbs_downloadstarttime", 0L) <= 86400000L)
        {
          l1 = paramContext.xwL.getLong("tbs_downloadflow", 0L);
          TbsLog.i("TbsDownload", "[TbsDownloader.needStartDownload] downloadFlow=" + l1);
          if (l1 >= paramContext.ckP())
          {
        ...
        if ((j != 0) || (i <= 0))
        {
          xwN.removeMessages(103);
          if ((i <= 0) && (j == 0)) {
            Message.obtain(xwN, 103, 0, 0, aHE).sendToTarget();
          }
          for (;;)
          {
            localk.Eu(-121);
            break;
            Message.obtain(xwN, 103, 1, 0, aHE).sendToTarget();
          }
        }
        localk.Eu(-119);
      }
  ...
  private static boolean c(String paramString, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    //   22: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   25: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   28: astore 25
    //   30: aload_0
    ...
    //   41: aload 25
    //   43: bipush -108
    //   45: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   48: iconst_0
    //   49: ireturn
    //   50: aload 25
    //   52: sipush 65328
    //   55: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   58: goto -10 -> 48
    ...
    //   86: aload 25
    //   88: bipush -109
    //   90: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   93: iconst_0
    //   94: ireturn
    //   95: aload 25
    //   97: sipush 65327
    //   100: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   103: goto -10 -> 93
    //   106: aload 26
    //   108: ldc_w 513
    ...
    //   245: istore 4
    //   247: aload 25
    //   249: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   252: ldc_w 553
    //   255: iload 4
    ...
    //   266: iload_2
    //   267: ifeq +59 -> 326
    //   270: getstatic 556	com/tencent/smtt/sdk/QbSdk:xvu	Z
    //   273: ifeq +53 -> 326
    //   276: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   279: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   282: ifeq +44 -> 326
    //   285: aload 26
    //   287: ldc_w 558
    //   290: iconst_0
    ...
    //   294: istore 4
    //   296: invokestatic 564	com/tencent/smtt/sdk/m:clf	()Lcom/tencent/smtt/sdk/m;
    //   299: astore_0
    //   300: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   303: astore 24
    //   305: iload 4
    //   307: iconst_1
    ...
    //   344: iconst_1
    //   345: istore 17
    //   347: invokestatic 564	com/tencent/smtt/sdk/m:clf	()Lcom/tencent/smtt/sdk/m;
    //   350: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   353: ldc_w 574
    //   356: iload 17
    ...
    //   519: iload 9
    //   521: istore 8
    //   523: getstatic 38	com/tencent/smtt/sdk/l:xwQ	Ljava/lang/Object;
    //   526: astore 29
    //   528: aload 29
    //   530: monitorenter
    //   531: iload 4
    //   533: ifeq +19 -> 552
    //   536: aload 25
    //   538: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   541: ldc_w 598
    //   544: ldc -115
    ...
    //   588: invokestatic 610	com/tencent/smtt/utils/j:clW	()Ljava/lang/String;
    ...
    //   597: astore 24
    //   599: aload 25
    //   601: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   604: ldc_w 598
    //   607: aload 24
    ...
    //   628: aload 25
    //   630: bipush -110
    //   632: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   635: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   638: astore_0
    //   639: iload 8
    //   641: iconst_1
    ...
    //   777: aload 25
    //   779: sipush 65326
    //   782: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   785: goto -150 -> 635
    //   788: iconst_0
    //   789: istore_2
    //   790: goto -143 -> 647
    ...
    //   795: iconst_1
    //   796: if_icmpne +9 -> 805
    //   799: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   802: invokestatic 622	com/tencent/smtt/sdk/QbSdk:resetDecoupleCore	(Landroid/content/Context;)V
    //   805: iload 5
    //   807: iconst_1
    //   808: if_icmpne +22 -> 830
    //   811: getstatic 397	com/tencent/smtt/sdk/l:xwN	Landroid/os/Handler;
    //   814: bipush 104
    //   816: invokevirtual 402	android/os/Handler:removeMessages	(I)V
    //   819: getstatic 397	com/tencent/smtt/sdk/l:xwN	Landroid/os/Handler;
    //   822: bipush 104
    ...
    //   853: lcmp
    //   854: ifle +1787 -> 2641
    //   857: getstatic 48	com/tencent/smtt/sdk/l:xwX	J
    //   860: lconst_0
    //   861: lcmp
    //   862: iflt +8 -> 870
    //   865: getstatic 48	com/tencent/smtt/sdk/l:xwX	J
    //   868: lstore 18
    //   870: aload 25
    //   872: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   875: ldc_w 626
    //   878: lload 18
    ...
    //   909: iload 6
    //   911: istore 4
    //   913: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   916: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   919: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   922: ldc_w 635
    //   925: iconst_0
    ...
    //   945: iload 4
    //   947: istore 6
    //   949: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   952: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   955: ifne +24 -> 979
    //   958: iload 4
    //   960: istore 6
    //   962: iload 4
    //   964: ifne +15 -> 979
    //   967: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   970: pop
    //   971: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   974: invokestatic 638	com/tencent/smtt/sdk/p:gz	(Landroid/content/Context;)I
    //   977: istore 6
    //   979: ldc 105
    ...
    //   1002: aload 25
    //   1004: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1007: ldc_w 642
    //   1010: iload 6
    ...
    //   1020: pop
    //   1021: aload 25
    //   1023: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1026: ldc_w 635
    //   1029: iload 5
    //   1031: invokestatic 360	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   1034: invokeinterface 192 3 0
    //   1039: pop
    //   1040: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1043: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   1046: ifne +47 -> 1093
    //   1049: iload 6
    //   1051: ifle +124 -> 1175
    //   1054: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1057: pop
    //   1058: iload 6
    //   1060: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1063: invokestatic 638	com/tencent/smtt/sdk/p:gz	(Landroid/content/Context;)I
    //   1066: if_icmpeq +109 -> 1175
    //   1069: iload 6
    //   1071: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1074: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1077: invokevirtual 645	com/tencent/smtt/sdk/p:gA	(Landroid/content/Context;)I
    //   1080: if_icmpne +95 -> 1175
    //   1083: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1086: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1089: invokevirtual 648	com/tencent/smtt/sdk/p:gE	(Landroid/content/Context;)Z
    //   1092: pop
    //   1093: aload 27
    //   1095: invokestatic 225	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   1098: ifeq +103 -> 1201
    //   1101: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1104: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   1107: ifeq +94 -> 1201
    //   1110: aload 25
    //   1112: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1115: ldc_w 424
    //   1118: iconst_0
    ...
    //   1133: iload_2
    //   1134: ifeq +12 -> 1146
    //   1137: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1140: iload 10
    //   1142: iconst_0
    //   1143: invokestatic 651	com/tencent/smtt/sdk/t:c	(Landroid/content/Context;IZ)V
    //   1146: iconst_0
    //   1147: ireturn
    //   1148: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1151: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1154: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   1157: ldc_w 642
    //   1160: iconst_0
    ...
    //   1175: iload 6
    //   1177: ifne -84 -> 1093
    //   1180: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1183: pop
    //   1184: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1187: invokestatic 655	com/tencent/smtt/sdk/p:gH	(Landroid/content/Context;)Ljava/io/File;
    //   1190: invokestatic 351	com/tencent/smtt/utils/f:M	(Ljava/io/File;)V
    //   1193: goto -100 -> 1093
    //   1196: astore 24
    //   1198: goto -105 -> 1093
    //   1201: ldc 105
    ...
    //   1226: ifne +114 -> 1340
    //   1229: aload 25
    //   1231: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1234: ldc_w 659
    //   1237: iload 11
    ...
    //   1247: pop
    //   1248: aload 25
    //   1250: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1253: ldc_w 424
    //   1256: iconst_0
    ...
    //   1267: ifeq +42 -> 1309
    //   1270: aload 25
    //   1272: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1275: ldc_w 661
    //   1278: bipush -111
    ...
    //   1294: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1297: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   1300: ifne +7 -> 1307
    //   1303: invokestatic 664	com/tencent/smtt/sdk/l:ckW	()Z
    //   1306: pop
    //   1307: iconst_0
    //   1308: ireturn
    //   1309: aload 25
    //   1311: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1314: ldc_w 661
    //   1317: sipush 65325
    ...
    //   1329: aload 25
    //   1331: sipush 65325
    //   1334: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   1337: goto -48 -> 1289
    //   1340: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1343: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1346: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   1349: ldc_w 666
    //   1352: iconst_0
    ...
    //   1367: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   1370: invokevirtual 673	com/tencent/smtt/sdk/h:clearCache	()V
    //   1373: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1376: pop
    //   1377: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1380: invokestatic 676	com/tencent/smtt/sdk/p:gG	(Landroid/content/Context;)V
    //   1383: iconst_0
    //   1384: istore 4
    //   1386: iconst_0
    //   1387: istore 6
    //   1389: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1392: invokestatic 334	com/tencent/smtt/sdk/t:gS	(Landroid/content/Context;)Z
    //   1395: ifne +63 -> 1458
    //   1398: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   1401: pop
    //   1402: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   1405: invokestatic 679	com/tencent/smtt/sdk/p:gy	(Landroid/content/Context;)I
    //   1408: istore 8
    //   1410: iload 6
    //   1412: istore 4
    //   1414: iload 8
    ...
    //   1483: aload 25
    //   1485: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1488: ldc_w 424
    //   1491: iconst_0
    ...
    //   1510: ifeq +84 -> 1594
    //   1513: aload 25
    //   1515: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1518: ldc_w 661
    //   1521: bipush -124
    ...
    //   1596: ifgt +25 -> 1621
    //   1599: aload 25
    //   1601: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1604: ldc_w 661
    //   1607: bipush -125
    ...
    //   1627: aload 25
    //   1629: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1632: ldc_w 661
    //   1635: bipush -127
    ...
    //   1646: goto -114 -> 1532
    //   1649: aload 25
    //   1651: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1654: ldc_w 661
    //   1657: bipush -112
    ...
    //   1687: istore 4
    //   1689: aload 25
    //   1691: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1694: ldc_w 661
    //   1697: iload 4
    ...
    //   1708: aload 25
    //   1710: iload 4
    //   1712: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   1715: goto -183 -> 1532
    //   1718: iload 10
    //   1720: ifgt +11 -> 1731
    //   1723: sipush 65318
    ...
    //   1745: aload 27
    //   1747: aload 25
    //   1749: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   1752: ldc_w 693
    //   1755: aconst_null
    //   1756: invokeinterface 217 3 0
    //   1761: invokevirtual 76	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1764: ifne +45 -> 1809
    //   1767: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   1770: invokevirtual 673	com/tencent/smtt/sdk/h:clearCache	()V
    //   1773: aload 25
    //   1775: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1778: ldc_w 462
    //   1781: iconst_0
    ...
    //   1790: pop
    //   1791: aload 25
    //   1793: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1796: ldc_w 428
    //   1799: iconst_0
    ...
    //   1808: pop
    //   1809: aload 25
    //   1811: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1814: ldc_w 666
    //   1817: iload 10
    ...
    //   1862: aload 25
    //   1864: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1867: ldc_w 697
    //   1870: iconst_1
    ...
    //   1903: aload 25
    //   1905: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1908: ldc_w 693
    //   1911: aload 27
    //   1913: invokeinterface 192 3 0
    //   1918: pop
    //   1919: aload 25
    //   1921: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1924: ldc_w 701
    //   1927: aload 28
    //   1929: invokeinterface 192 3 0
    //   1934: pop
    //   1935: aload 25
    //   1937: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1940: ldc_w 659
    //   1943: iload 11
    ...
    //   1953: pop
    //   1954: aload 25
    //   1956: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1959: ldc_w 703
    //   1962: iload 12
    ...
    //   1972: pop
    //   1973: aload 25
    //   1975: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1978: ldc_w 705
    //   1981: iload 13
    ...
    //   1991: pop
    //   1992: aload 25
    //   1994: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   1997: ldc_w 707
    //   2000: iload 14
    ...
    //   2010: pop
    //   2011: aload 25
    //   2013: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2016: ldc_w 709
    //   2019: iload 15
    ...
    //   2029: pop
    //   2030: aload 25
    //   2032: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2035: ldc_w 711
    //   2038: lload 20
    ...
    //   2048: pop
    //   2049: aload 25
    //   2051: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2054: ldc_w 713
    //   2057: lload 22
    ...
    //   2074: ifnull +18 -> 2092
    //   2077: aload 25
    //   2079: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2082: ldc_w 715
    //   2085: aload_0
    ...
    //   2092: iload_3
    //   2093: ifne +148 -> 2241
    //   2096: invokestatic 489	com/tencent/smtt/sdk/p:clh	()Lcom/tencent/smtt/sdk/p;
    //   2099: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2102: iload 10
    //   2104: invokevirtual 719	com/tencent/smtt/sdk/p:ak	(Landroid/content/Context;I)Z
    //   2107: ifeq +134 -> 2241
    //   2110: iload_2
    //   2111: ifeq +99 -> 2210
    //   2114: aload 25
    //   2116: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2119: ldc_w 661
    //   2122: bipush -113
    ...
    //   2132: pop
    //   2133: aload 25
    //   2135: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2138: ldc_w 424
    //   2141: iconst_0
    ...
    //   2164: aload 25
    //   2166: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2169: ldc_w 723
    //   2172: iconst_1
    ...
    //   2188: ireturn
    //   2189: aload 25
    //   2191: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2194: ldc_w 697
    //   2197: iconst_0
    ...
    //   2207: goto -327 -> 1880
    //   2210: aload 25
    //   2212: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2215: ldc_w 661
    //   2218: sipush 65323
    ...
    //   2230: aload 25
    //   2232: sipush 65323
    //   2235: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   2238: goto -105 -> 2133
    //   2241: iload_3
    //   2242: ifne +149 -> 2391
    //   2245: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   2248: astore_0
    //   2249: iload 11
    //   2251: iconst_1
    ...
    //   2263: aload_0
    //   2264: iload_3
    //   2265: invokevirtual 727	com/tencent/smtt/sdk/h:mJ	(Z)Z
    //   2268: ifeq +123 -> 2391
    //   2271: aload 25
    //   2273: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2276: ldc_w 424
    //   2279: iconst_0
    //   2280: invokestatic 186	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   2283: invokeinterface 192 3 0
    //   2288: pop
    //   2289: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2292: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2295: pop
    //   2296: invokestatic 376	com/tencent/smtt/sdk/r:clk	()Lcom/tencent/smtt/sdk/r$b;
    //   2299: astore_0
    //   2300: aload_0
    //   2301: bipush 100
    ...
    //   2317: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   2320: getfield 732	com/tencent/smtt/sdk/h:xww	Ljava/lang/String;
    ...
    //   2329: invokevirtual 384	com/tencent/smtt/sdk/r$b:Xp	(Ljava/lang/String;)V
    //   2332: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2335: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2338: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   2341: ldc_w 635
    //   2344: iconst_0
    //   2345: invokeinterface 273 3 0
    //   2350: iconst_1
    //   2351: if_icmpne +24 -> 2375
    //   2354: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2357: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2360: getstatic 735	com/tencent/smtt/sdk/r$a:xxG	Lcom/tencent/smtt/sdk/r$a;
    //   2363: aload_0
    ...
    //   2371: istore_3
    //   2372: goto -109 -> 2263
    //   2375: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2378: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2381: getstatic 390	com/tencent/smtt/sdk/r$a:xxD	Lcom/tencent/smtt/sdk/r$a;
    //   2384: aload_0
    //   2385: invokevirtual 393	com/tencent/smtt/sdk/r:a	(Lcom/tencent/smtt/sdk/r$a;Lcom/tencent/smtt/sdk/r$b;)V
    //   2388: goto -237 -> 2151
    //   2391: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2394: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2397: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   2400: ldc_w 697
    //   2403: iconst_0
    //   2404: invokeinterface 273 3 0
    //   2409: iconst_1
    //   2410: if_icmpne +127 -> 2537
    //   2413: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   2416: invokevirtual 738	com/tencent/smtt/sdk/h:ckG	()Z
    //   2419: ifeq +118 -> 2537
    //   2422: aload 25
    //   2424: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2427: ldc_w 424
    //   2430: iconst_0
    //   2431: invokestatic 186	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   2434: invokeinterface 192 3 0
    //   2439: pop
    //   2440: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2443: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2446: pop
    //   2447: invokestatic 376	com/tencent/smtt/sdk/r:clk	()Lcom/tencent/smtt/sdk/r$b;
    //   2450: astore_0
    //   2451: aload_0
    //   2452: bipush 100
    ...
    //   2468: getstatic 668	com/tencent/smtt/sdk/l:xwR	Lcom/tencent/smtt/sdk/h;
    //   2471: getfield 732	com/tencent/smtt/sdk/h:xww	Ljava/lang/String;
    ...
    //   2480: invokevirtual 384	com/tencent/smtt/sdk/r$b:Xp	(Ljava/lang/String;)V
    //   2483: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2486: invokestatic 150	com/tencent/smtt/sdk/k:gj	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2489: getfield 164	com/tencent/smtt/sdk/k:xwL	Landroid/content/SharedPreferences;
    //   2492: ldc_w 635
    //   2495: iconst_0
    //   2496: invokeinterface 273 3 0
    //   2501: iconst_1
    //   2502: if_icmpne +19 -> 2521
    //   2505: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2508: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2511: getstatic 735	com/tencent/smtt/sdk/r$a:xxG	Lcom/tencent/smtt/sdk/r$a;
    //   2514: aload_0
    //   2515: invokevirtual 393	com/tencent/smtt/sdk/r:a	(Lcom/tencent/smtt/sdk/r$a;Lcom/tencent/smtt/sdk/r$b;)V
    //   2518: goto -367 -> 2151
    //   2521: getstatic 59	com/tencent/smtt/sdk/l:aHE	Landroid/content/Context;
    //   2524: invokestatic 372	com/tencent/smtt/sdk/r:gP	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/r;
    //   2527: getstatic 390	com/tencent/smtt/sdk/r$a:xxD	Lcom/tencent/smtt/sdk/r$a;
    //   2530: aload_0
    ...
    //   2541: aload 25
    //   2543: sipush 65320
    //   2546: invokevirtual 160	com/tencent/smtt/sdk/k:Eu	(I)V
    //   2549: aload 25
    //   2551: getfield 180	com/tencent/smtt/sdk/k:xwK	Ljava/util/Map;
    //   2554: ldc_w 424
    //   2557: iconst_1
    ...
    do
    {
      do
      {
        ...
        do
        {
          ...
          {
            return false;
          } while (k.gj(aHE).xwL.getInt("tbs_downloaddecouplecore", 0) == 1);
          l = k.gj(aHE).xwL.getLong("last_download_decouple_core", 0L);
        } while (System.currentTimeMillis() - l < 1000L * k.gj(aHE).ckQ());
        i = k.gj(aHE).xwL.getInt("tbs_decouplecoreversion", 0);
      } while (i <= 0);
      p.clh();
    } while ((i == p.gz(aHE)) || (k.gj(aHE).xwL.getInt("tbs_download_version", 0) == i));
    return true;
  }
  ...
  public static boolean ckW()
  {
    ...
    int i = k.gj(aHE).xwL.getInt("tbs_decouplecoreversion", 0);
    if (i > 0)
    {
      p.clh();
      if (i != p.gz(aHE))
      {
        if ((k.gj(aHE).xwL.getInt("tbs_download_version", 0) != i) || (k.gj(aHE).xwL.getInt("tbs_download_version_type", 0) == 1))
        {
          TbsLog.i("TbsDownload", "startDecoupleCoreIfNeeded #4");
          xwT = true;
          xwN.removeMessages(108);
          localObject = Message.obtain(xwN, 108, QbSdk.xvD);
          ((Message)localObject).arg1 = 0;
          ((Message)localObject).sendToTarget();
          k.gj(aHE).xwK.put("last_download_decouple_core", Long.valueOf(System.currentTimeMillis()));
          return true;
        }
        TbsLog.i("TbsDownload", "startDecoupleCoreIfNeeded no need, KEY_TBS_DOWNLOAD_V is " + k.gj(aHE).xwL.getInt("tbs_download_version", 0) + " deCoupleCoreVersion is " + i + " KEY_TBS_DOWNLOAD_V_TYPE is " + k.gj(aHE).xwL.getInt("tbs_download_version_type", 0));
        return false;
      }
    }
  ...
  public static boolean ckX()
  {
    ...
    {
      h localh = xwR;
      TbsLog.i("TbsDownload", "[TbsApkDownloader.isDownloadForeground] mIsDownloadForeground=" + localh.xwv);
      if (localh.xwv) {
        return true;
      }
    }
      ...
      try
      {
        ...
        xwN = new Handler(xwS.getLooper())
        {
          public final void handleMessage(Message paramAnonymousMessage)
          {
            ...
            case 100: 
              ...
              for (i = 1;; i = 0)
              {
                ...
                if ((paramAnonymousMessage.obj != null) && ((paramAnonymousMessage.obj instanceof l.a)))
                {
                  ...
                  if ((!bool1) || (i != 0)) {
                    ((l.a)paramAnonymousMessage.obj).e(bool1, k.gj(l.aHE).xwL.getInt("tbs_download_version", 0));
                  }
                }
                if ((!t.gS(l.aHE)) || (!bool1)) {
                  break;
            ...
            case 108: 
              localObject1 = null;
              Object localObject2 = "tbs_download_lock_file" + k.gj(l.aHE).xwL.getInt("tbs_download_version", 0) + ".txt";
              FileOutputStream localFileOutputStream = f.c(l.aHE, false, (String)localObject2);
              ...
              if (paramAnonymousMessage.arg1 == 1)
              {
                ...
                if ((!bool1) || (!p.clh().ak(l.aHE, k.gj(l.aHE).xwL.getInt("tbs_download_version", 0)))) {
                  break label428;
                }
                QbSdk.xvD.ju(122);
                ((k)localObject2).Eu(65323);
              }
              for (;;)
              {
                ...
                bool2 = false;
                break label338;
                if (((k)localObject2).xwL.getBoolean("tbs_needdownload", false))
                {
                  k.gj(l.aHE).Eu(65321);
                  localObject2 = l.xwR;
                  if (108 == paramAnonymousMessage.what) {}
            ...
            case 102: 
              ...
              if (t.gS(l.aHE)) {}
              for (i = t.clx();; i = p.clh().gC(l.aHE))
              {
                TbsLog.i("TbsDownload", "[TbsDownloader.handleMessage] localTbsVersion=" + i);
                paramAnonymousMessage = l.xwR;
                try
                {
                  localObject1 = new File(paramAnonymousMessage.xwg, "x5.tbs");
            ...
            {
              p.clh().u((Context)paramAnonymousMessage.obj, true);
              return;
            }
            p.clh().u((Context)paramAnonymousMessage.obj, false);
          }
        };
      }
  ...
  private static boolean ckZ()
  {
    try
    {
      JSONArray localJSONArray = cla();
      boolean bool = k.gj(aHE).xwL.getString("last_thirdapp_sendrequest_coreversion", "").equals(localJSONArray.toString());
      return bool;
    }
    catch (Exception localException) {}
    return false;
  ...
  private static JSONArray cla()
  {
    int k = 0;
    if (t.gS(aHE))
    {
      JSONArray localJSONArray = new JSONArray();
      String[] arrayOfString1 = t.cls();
      String str = aHE.getApplicationContext().getPackageName();
      if (str.equals(t.gU(aHE)))
      {
  ...
  static String cld()
  {
    ...
    xwM = (String)localObject;
    return (String)localObject;
  }
  
  private static JSONArray cle()
  {
    JSONArray localJSONArray = new JSONArray();
    String[] arrayOfString = t.cls();
    int i = 0;
    ...
    if (i < 4)
    {
      ...
      String str = f.a(aHE, (String)localObject, 4, false);
      if (gn(aHE))
      {
  ...
  private static JSONObject d(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    Object localObject4 = k.gj(aHE);
    String str2 = cld();
    String str3 = c.hp(aHE);
    String str4 = c.W(aHE);
    String str5 = c.hr(aHE);
    ...
    if (localObject1 != null)
    {
      ...
      try
      {
        localObject3 = (TelephonyManager)aHE.getSystemService("phone");
      ...
      catch (Exception localException2)
      {
        ...
        label127:
        for (;;) {}
        i = k.gj(aHE).xwL.getInt("tbs_download_version", 0);
      }
      if (localObject1 != null) {
    ...
    if (paramBoolean1)
    {
      ...
      if (t.gS(aHE))
      {
        ...
        ((k)localObject4).xwK.put("last_thirdapp_sendrequest_coreversion", ((JSONArray)localObject1).toString());
        ((k)localObject4).commit();
        if (QbSdk.xvl) {
          ((JSONObject)localObject3).put("THIRDREQ", 1);
        }
        ((JSONObject)localObject3).put("APPN", aHE.getPackageName());
        ((JSONObject)localObject3).put("APPVN", Xl(((k)localObject4).xwL.getString("app_versionname", null)));
        ((JSONObject)localObject3).put("APPVC", ((k)localObject4).xwL.getInt("app_versioncode", 0));
        ((JSONObject)localObject3).put("APPMETA", Xl(((k)localObject4).xwL.getString("app_metadata", null)));
        ...
        localObject1 = ((k)localObject4).xwK;
        if (!paramBoolean3) {
          break label1025;
        }
        j = 1;
        ...
        {
          localObject1 = xwR;
          localObject2 = h.gf(((h)localObject1).mContext);
          if (localObject2 != null) {
            break label898;
          }
          j = 0;
        ...
        ((JSONObject)localObject3).put("CPU", xwO);
        ((JSONObject)localObject3).put("UA", str2);
        ((JSONObject)localObject3).put("IMSI", Xl(str3));
        ((JSONObject)localObject3).put("IMEI", Xl(str4));
        ((JSONObject)localObject3).put("ANDROID_ID", Xl(str5));
        if (!t.gS(aHE))
        {
          if (i == 0) {
            break label941;
          ...
          p.clh();
          ((JSONObject)localObject3).put("TBSDV", p.gz(aHE));
        }
        paramBoolean3 = k.gj(aHE).xwL.getBoolean("request_full_package", false);
        localObject1 = QbSdk.c(aHE, "can_unlzma", null);
    ...
    for (;;)
    {
      ...
      break label204;
      localObject1 = cle();
      if ((b.hn(aHE) == 3) || (((JSONArray)localObject1).length() == 0) || (i != 0) || (!paramBoolean1)) {
        break label269;
      }
  ...
  public static boolean e(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    final k localk = k.gj(aHE);
    Object localObject2 = f.am(aHE, 1);
    Object localObject1;
    label84:
    Object localObject3;
    if (gn(aHE))
    {
      ...
      Object localObject4 = f.am(aHE, 3);
      if (!gn(aHE)) {
        break label598;
      }
      localObject1 = "x5.oversea.tbs.org";
      ...
      {
        xwO = c.clN();
        localk.xwK.put("device_cpuabi", xwO);
        localk.commit();
      }
      if (TextUtils.isEmpty(xwO)) {
        break label732;
      }
      localObject1 = null;
    }
    try
    {
      localObject2 = Pattern.compile("i686|mips|x86_64").matcher(xwO);
      localObject1 = localObject2;
    }
    catch (Exception localException2)
    {
    ...
    if ((localObject1 != null) && (((Matcher)localObject1).find())) {
      if (t.gS(aHE))
      {
        ...
        if (paramBoolean1)
        {
          ...
          ((r.b)localObject1).Xp("mycpu is " + xwO);
          r.gP(aHE).a(r.a.xxD, (r.b)localObject1);
        }
      }
    }
    label732:
    for (int i = 1;; i = 0)
    {
      ...
      try
      {
        ...
        if ((i != 0) || (j != -1))
        {
          ...
          localk.xwK.put("last_check", Long.valueOf(l));
          localk.xwK.put("app_versionname", c.getAppVersionName(aHE));
          localk.xwK.put("app_versioncode", Integer.valueOf(c.getAppVersionCode(aHE)));
          localk.xwK.put("app_metadata", c.bE(aHE, "com.tencent.mm.BuildInfo.CLIENT_VERSION"));
          localk.commit();
          if (i != 0) {
            break;
          }
        ...
        try
        {
          localObject2 = com.tencent.smtt.utils.q.hz(aHE).xAG;
  ...
  public static int gm(Context paramContext)
  {
    p.clh();
    return p.gz(paramContext);
  }
  ...
  public static boolean gn(Context paramContext)
  {
    try
    {
      ...
      {
        xwW = true;
        paramContext = k.gj(paramContext);
        if (paramContext.xwL.contains("is_oversea"))
        {
          xwV = paramContext.xwL.getBoolean("is_oversea", false);
          TbsLog.i("TbsDownload", "[TbsDownloader.getOverSea]  first called. sOverSea = " + xwV);
        }
        TbsLog.i("TbsDownload", "[TbsDownloader.getOverSea]  sOverSea = " + xwV);
      }
      boolean bool = xwV;
      return bool;
    }
  ...
  @TargetApi(11)
  static void go(Context paramContext)
  {
    Object localObject = k.gj(paramContext);
    try
    {
      ((k)localObject).xwK.clear();
      localObject = ((k)localObject).xwL.edit();
      ((SharedPreferences.Editor)localObject).clear();
      ((SharedPreferences.Editor)localObject).commit();
      localObject = r.gP(paramContext);
      try
      {
        localObject = ((r)localObject).clp().edit();
        ((SharedPreferences.Editor)localObject).clear();
        ((SharedPreferences.Editor)localObject).commit();
        h.gh(paramContext);
  ...
  public static boolean isDownloading()
  {
    try
    {
      TbsLog.i("TbsDownload", "[TbsDownloader.isDownloading] is " + xwT);
      boolean bool = xwT;
      return bool;
    }
    finally
  ...
  public static void r(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        TbsLog.i("TbsDownload", "[TbsDownloader.startDownload] sAppContext=" + aHE);
        boolean bool = p.xxr;
        if (bool) {
          return;
        }
    ...
    xwN.removeMessages(101);
    xwN.removeMessages(100);
    paramContext = Message.obtain(xwN, 101, QbSdk.xvD);
    if (paramBoolean) {}
    for (;;)
    {
      paramContext.arg1 = i;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/l.class
