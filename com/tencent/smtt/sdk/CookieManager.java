...
public class CookieManager
{
  ...
  private static CookieManager xuG;
  ArrayList<b> xuH;
  String xuI;
  int xuJ = a.xuM;
  ...
  public boolean acceptCookie()
  {
    ...
    {
      localObject = ((ab)localObject).clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_acceptCookie", new Class[0], new Object[0]);
      if (localObject == null) {
        return false;
      }
  ...
  public boolean acceptThirdPartyCookies(WebView paramWebView)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 93	com/tencent/smtt/sdk/ab:clI	()Lcom/tencent/smtt/sdk/ab;
    //   5: astore_3
    //   6: aload_3
    //   7: ifnull +70 -> 77
    //   10: aload_3
    //   11: invokevirtual 96	com/tencent/smtt/sdk/ab:clJ	()Z
    //   14: ifeq +63 -> 77
    //   17: aload_3
    //   18: invokevirtual 100	com/tencent/smtt/sdk/ab:clK	()Lcom/tencent/smtt/sdk/ac;
    //   21: getfield 106	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   24: astore_3
    //   25: aload_1
  ...
  final void ckx()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = ab.clI();
        if ((localObject1 == null) || (!((ab)localObject1).clJ())) {
          break;
        }
        localObject1 = this.xuH.iterator();
        if (!((Iterator)localObject1).hasNext()) {
          break label292;
        }
        localObject3 = (b)((Iterator)localObject1).next();
        switch (((b)localObject3).xuQ)
        {
        case 1: 
          setCookie(((b)localObject3).url, ((b)localObject3).value, ((b)localObject3).xuR);
          break;
        case 2: 
    ...
    Iterator localIterator = this.xuH.iterator();
    for (;;)
    {
      Object localObject4;
      ...
      case 1: 
        if (Build.VERSION.SDK_INT >= 21)
        {
          ...
          localObject4 = ((b)localObject4).xuR;
  ...
  public void flush()
  {
    ...
    if ((localab != null) && (localab.clJ())) {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_flush", new Class[0], new Object[0]);
    }
  ...
  public String getCookie(String paramString)
  {
    ...
    if ((localab != null) && (localab.clJ()))
    {
      paramString = localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getCookie", new Class[] { String.class }, new Object[] { paramString });
      if (paramString == null) {
        return null;
      }
  ...
  public boolean hasCookies()
  {
    ...
    if ((localObject != null) && (((ab)localObject).clJ()))
    {
      localObject = ((ab)localObject).clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_hasCookies", new Class[0], new Object[0]);
      if (localObject == null) {
        return false;
      }
      return ((Boolean)localObject).booleanValue();
  ...
  protected final void o(Context paramContext, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if ((this.xuJ != a.xuM) && (paramContext != null) && (m.clf().bx(paramContext, "cookie_switch.txt")))
        {
          bool = this.xuK;
          if (!bool) {}
        }
        ...
        if ((QbSdk.getIsSysWebViewForcedByOuter()) || (QbSdk.xvj)) {
          break label479;
        }
        bool = m.clf().bx(paramContext, "usex5.txt");
        TbsLog.i(LOGTAG, "usex5 : mUseX5LastProcess->" + bool + ",useX5:" + paramBoolean);
        m.clf().n(paramContext, "usex5.txt", paramBoolean);
        if (bool == paramBoolean) {
          continue;
        }
        r.gP(paramContext);
        localb = r.clk();
        if (TextUtils.isEmpty(this.xuI)) {
          break label450;
        }
        if ((p.clh().gC(paramContext) > 0) && (p.clh().gC(paramContext) < 36001)) {
          continue;
        }
        if (!bool) {
          break label329;
      ...
      label254:
      localb.Xp("x5->sys:" + bool + " from:" + j + " to:" + i + ",timeused:" + l1);
      r.gP(paramContext).a(r.a.xxI, localb);
      continue;
      label329:
      i = g.ge(paramContext);
      int j = i;
      if (i > 0)
      {
        String str = p.clh().bB(paramContext, "cookies_database_version");
      ...
      do
      {
        do
        {
          ...
          g.a(paramContext, this.xuJ, this.xuI, paramBoolean);
  ...
  public void removeAllCookie()
  {
    ...
    if ((localab != null) && (localab.clJ()))
    {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeAllCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeAllCookies(x<Boolean> paramx)
  {
    ...
    ab localab = ab.clI();
    if ((localab != null) && (localab.clJ())) {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeAllCookies", new Class[] { ValueCallback.class }, new Object[] { paramx });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
  ...
  public void removeExpiredCookie()
  {
    ...
    if ((localab != null) && (localab.clJ()))
    {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeExpiredCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeSessionCookie()
  {
    ...
    if ((localab != null) && (localab.clJ()))
    {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeSessionCookies(x<Boolean> paramx)
  {
    ab localab = ab.clI();
    if ((localab != null) && (localab.clJ())) {
      localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookies", new Class[] { ValueCallback.class }, new Object[] { paramx });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
  ...
  public void setCookie(String paramString1, String paramString2, x<Boolean> paramx)
  {
    ...
    //   9: ifnull +66 -> 75
    //   12: aload 4
    //   14: invokevirtual 96	com/tencent/smtt/sdk/ab:clJ	()Z
    //   17: ifeq +58 -> 75
    //   20: aload 4
    //   22: invokevirtual 100	com/tencent/smtt/sdk/ab:clK	()Lcom/tencent/smtt/sdk/ac;
    //   25: getfield 106	com/tencent/smtt/sdk/ac:xyA	Lcom/tencent/smtt/export/external/DexLoader;
    //   28: ldc 108
    //   30: ldc_w 410
    //   33: iconst_3
    ...
    //   73: monitorexit
    //   74: return
    //   75: invokestatic 93	com/tencent/smtt/sdk/ab:clI	()Lcom/tencent/smtt/sdk/ab;
    //   78: getfield 413	com/tencent/smtt/sdk/ab:xvM	Z
    //   81: ifne +65 -> 146
    ...
    //   94: aload 4
    //   96: iconst_1
    //   97: putfield 173	com/tencent/smtt/sdk/CookieManager$b:xuQ	I
    //   100: aload 4
    //   102: aload_1
    ...
    //   112: aload 4
    //   114: aload_3
    //   115: putfield 183	com/tencent/smtt/sdk/CookieManager$b:xuR	Lcom/tencent/smtt/sdk/x;
    //   118: aload_0
    //   119: getfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   122: ifnonnull +14 -> 136
    //   125: aload_0
    //   126: new 153	java/util/ArrayList
    //   129: dup
    //   130: invokespecial 417	java/util/ArrayList:<init>	()V
    //   133: putfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   136: aload_0
    //   137: getfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   140: aload 4
    //   142: invokevirtual 421	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   145: pop
    //   146: aload_0
    //   147: getfield 42	com/tencent/smtt/sdk/CookieManager:xuL	Z
    //   150: ifeq -78 -> 72
  ...
  public void setCookie(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   65: return
    //   66: aload_0
    //   67: getfield 42	com/tencent/smtt/sdk/CookieManager:xuL	Z
    //   70: ifne +7 -> 77
    //   73: iload_3
    //   74: ifeq +11 -> 85
    ...
    //   85: invokestatic 93	com/tencent/smtt/sdk/ab:clI	()Lcom/tencent/smtt/sdk/ab;
    //   88: getfield 413	com/tencent/smtt/sdk/ab:xvM	Z
    //   91: ifne -28 -> 63
    ...
    //   104: aload 4
    //   106: iconst_2
    //   107: putfield 173	com/tencent/smtt/sdk/CookieManager$b:xuQ	I
    //   110: aload 4
    //   112: aload_1
    ...
    //   122: aload 4
    //   124: aconst_null
    //   125: putfield 183	com/tencent/smtt/sdk/CookieManager$b:xuR	Lcom/tencent/smtt/sdk/x;
    //   128: aload_0
    //   129: getfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   132: ifnonnull +14 -> 146
    //   135: aload_0
    //   136: new 153	java/util/ArrayList
    //   139: dup
    //   140: invokespecial 417	java/util/ArrayList:<init>	()V
    //   143: putfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   146: aload_0
    //   147: getfield 151	com/tencent/smtt/sdk/CookieManager:xuH	Ljava/util/ArrayList;
    //   150: aload 4
  ...
  public boolean setCookieCompatialbeMode$4fb4c7d(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramContext == null) || (!m.clf().bx(paramContext, "cookie_switch.txt"))) {
      return false;
    }
    this.xuJ = paramInt;
    if (paramString != null) {
      this.xuI = paramString;
    }
    if ((this.xuJ != a.xuM) && (paramBoolean) && (!ab.clI().xvM)) {
      ab.clI().b(paramContext, null);
    }
    return true;
  }
  ...
  public void setCookies(Map<String, String[]> paramMap)
  {
    ...
    if ((localObject != null) && (((ab)localObject).clJ()))
    {
      localObject = ((ab)localObject).clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_setCookies", new Class[] { Map.class }, new Object[] { paramMap });
      if (localObject == null) {
        bool = false;
      }
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/CookieManager.class
