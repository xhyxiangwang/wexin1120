    ...
    public static Uri[] parseResult(int paramInt, Intent paramIntent)
    {
      for (;;)
      {
        try
        {
          ...
          {
            paramIntent = localab.clK().xyA.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "parseFileChooserResult", new Class[] { Integer.TYPE, Intent.class }, new Object[] { Integer.valueOf(paramInt), paramIntent });
            if (paramIntent == null) {
              return null;
            }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/WebChromeClient.class
