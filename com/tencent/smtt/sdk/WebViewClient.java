...
public class WebViewClient
{
  ...
  {
    if (this.xzg != null) {
      this.xzg.v(paramString, paramBitmap);
    }
  }
  ...
  {
    if ((this.xzg != null) && (paramWebResourceRequest.isForMainFrame())) {
      this.xzg.onReceivedError(paramWebView.xyK, paramWebResourceError.getErrorCode(), paramWebResourceError.getDescription().toString(), paramWebResourceRequest.getUrl().toString());
    }
  }
  ...
  {
    if (this.xzg != null) {
      return this.xzg.shouldInterceptRequest(paramWebView.xyK, paramWebResourceRequest.getUrl().toString());
    }
    return null;
  }
  ...
  {
    if (this.xzg != null) {
      return this.xzg.shouldInterceptRequest(paramWebView.xyK, paramWebResourceRequest);
    }
    return null;
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/WebViewClient.class
