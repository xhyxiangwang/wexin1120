...
public final class g
{
  ...
  public static void a(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramInt == CookieManager.a.xuN) && (TextUtils.isEmpty(paramString)));
        arrayOfString = paramString.split(",");
      } while ((arrayOfString == null) || (arrayOfString.length <= 0));
      localSQLiteDatabase = gd(paramContext);
      ...
      try
      {
        ...
        if (((Cursor)localObject2).getCount() > 0)
        {
          ...
          if (((Cursor)localObject2).moveToFirst())
          {
            ...
            paramString = (String)localObject2;
            localObject1 = localObject2;
            if (paramInt == CookieManager.a.xuN)
            {
              paramString = (String)localObject2;
              localObject1 = localObject2;
  ...
  private static File gc(Context paramContext)
  {
    if ((xwa == null) && (paramContext != null)) {
      xwa = new File(paramContext.getDir("webview", 0), "Cookies");
    }
    if (xwa == null) {
      xwa = new File("/data/data/" + paramContext.getPackageName() + File.separator + "app_webview" + File.separator + "Cookies");
    }
    return xwa;
  }
  
  private static SQLiteDatabase gd(Context paramContext)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    if (paramContext == null) {}
  ...
  public static int ge(Context paramContext)
  {
    ...
    //   19: pop2
    //   20: aload_0
    //   21: invokestatic 44	com/tencent/smtt/sdk/g:gd	(Landroid/content/Context;)Landroid/database/sqlite/SQLiteDatabase;
    //   24: astore_0
    //   25: aload_0
    //   26: ifnonnull +22 -> 48
    //   29: aload_0
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/g.class
