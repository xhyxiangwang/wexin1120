...
class j
{
  ...
  private static j xwI = null;
  
  static File ckM()
  {
    p.clh();
    File localFile = new File(p.gK(mContext), "tbscoreinstall.txt");
    if (!localFile.exists()) {}
    try
    {
  ...
  private static Properties ckN()
  {
    ...
    //   2: aconst_null
    //   3: astore_2
    //   4: invokestatic 52	com/tencent/smtt/sdk/j:ckM	()Ljava/io/File;
    //   7: astore_1
  ...
  static j gi(Context paramContext)
  {
    if (xwI == null) {}
    try
    {
  ...
  final int Xj(String paramString)
  {
    Properties localProperties = ckN();
  ...
  final int Xk(String paramString)
  {
    Properties localProperties = ckN();
    if ((localProperties != null) && (localProperties.getProperty(paramString) != null)) {
      return Integer.parseInt(localProperties.getProperty(paramString));
  ...
  final void dp(String paramString, int paramInt)
  {
    fk(paramString, String.valueOf(paramInt));
  }
  
  final void eP(int paramInt1, int paramInt2)
  {
    dp("copy_core_ver", paramInt1);
    dp("copy_status", paramInt2);
  }
  
  final void eQ(int paramInt1, int paramInt2)
  {
    dp("install_core_ver", paramInt1);
    dp("install_status", paramInt2);
  }
  
  /* Error */
  final void fk(String paramString1, String paramString2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 4
    //   3: aconst_null
    //   4: astore 5
    //   6: invokestatic 84	com/tencent/smtt/sdk/j:ckN	()Ljava/util/Properties;
    //   9: astore 6
    //   11: aload 5
    //   13: astore_3
    //   14: aload 6
    ...
    //   26: pop
    //   27: invokestatic 52	com/tencent/smtt/sdk/j:ckM	()Ljava/io/File;
    //   30: astore_2
    //   31: aload 5
    //   33: astore_3
    //   34: aload_2
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/j.class
