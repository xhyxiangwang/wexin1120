...
public class m
{
  ...
  /* Error */
  public final boolean bx(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
  ...
  public final void gp(Context paramContext)
  {
    for (;;)
    {
      try
      {
        boolean bool = this.xxa;
        if (bool) {
          return;
        }
        if (!bx(paramContext, "bugly_switch.txt"))
        {
      ...
      for (Object localObject1 = t.clv();; localObject1 = ((File)localObject1).getAbsolutePath())
      {
      ...
      label130:
      p.clh();
      Object localObject2 = p.gI(paramContext);
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/m.class
