...
class r
{
  private static r xxz;
  Context mContext;
  private Handler xxA = null;
  boolean xxB = false;
  ...
  private r(Context paramContext)
  {
    ...
    paramContext.start();
    this.xxA = new Handler(paramContext.getLooper())
    {
      public final void handleMessage(Message paramAnonymousMessage)
      {
        if (paramAnonymousMessage.what == 600) {
          if ((paramAnonymousMessage.obj instanceof r.b))
          {
            ...
            localStringBuilder.append(r.Ez(j));
            localStringBuilder.append(r.Xn(c.W(localr.mContext)));
            localStringBuilder.append(r.Xn(com.tencent.smtt.utils.p.hw(localr.mContext)));
            localStringBuilder.append(r.Ez(p.clh().gC(localr.mContext)));
            ...
            catch (Exception localException)
            {
              try
              {
                ...
                localStringBuilder.append(r.Ez(c.getAppVersionCode(localr.mContext)));
              }
              ...
              localEditor.commit();
              if ((!localr.xxB) && (j == r.a.xxF.value)) {
                break label667;
              }
              localr.clo();
            }
            localStringBuilder.append(r.Xn(paramAnonymousMessage));
            paramAnonymousMessage = localr.mContext.getPackageName();
            localStringBuilder.append(r.Xn(paramAnonymousMessage));
            if ("com.tencent.mm".equals(paramAnonymousMessage))
            {
              localStringBuilder.append(r.Xn(c.bE(localr.mContext, "com.tencent.mm.BuildInfo.CLIENT_VERSION")));
              localStringBuilder.append(r.Xn(r.av(((r.b)localObject2).xxK)));
              localStringBuilder.append(r.Xn(((r.b)localObject2).xxL));
              localStringBuilder.append(r.Xn(((r.b)localObject2).xxM));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxN));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxO));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxP));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxQ));
              localStringBuilder.append(r.Xn(((r.b)localObject2).xxR));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxS));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxT));
              localStringBuilder.append(r.fm(((r.b)localObject2).xxZ));
              localStringBuilder.append(r.fm(((r.b)localObject2).xxU));
              localStringBuilder.append(r.fm(((r.b)localObject2).xxV));
              localStringBuilder.append(r.Ez(((r.b)localObject2).xxW));
              localStringBuilder.append(r.Ez(((r.b)localObject2).keB));
              localStringBuilder.append(r.Xn(((r.b)localObject2).xxX));
              localStringBuilder.append(r.Xn(((r.b)localObject2).xxY));
              localStringBuilder.append(r.Ez(k.gj(localr.mContext).xwL.getInt("tbs_download_version", 0)));
              localStringBuilder.append(r.Xn(c.hr(localr.mContext)));
              localStringBuilder.append(r.Xn("3.6.0.1026_43601"));
              localStringBuilder.append(false);
              localSharedPreferences = localr.clp();
              localObject1 = localr.clm();
  ...
  static String Ez(int paramInt)
  {
    return paramInt + "|";
  }
  
  static String Xn(String paramString)
  {
  ...
  private void a(int paramInt, b paramb, a parama)
  {
    ...
    paramb.xxK = System.currentTimeMillis();
    QbSdk.xvD.jv(paramInt);
    a(parama, paramb);
  }
  ...
  static String fm(long paramLong)
  {
    return paramLong + "|";
  }
  
  public static r gP(Context paramContext)
  {
    if (xxz == null) {}
    try
    {
      if (xxz == null) {
        xxz = new r(paramContext);
      }
      return xxz;
    }
    finally {}
  ...
  public final void a(a parama, b paramb)
  {
    try
    {
      ...
      Message localMessage = this.xxA.obtainMessage();
      localMessage.what = 600;
      localMessage.arg1 = parama.value;
      localMessage.obj = paramb;
      this.xxA.sendMessage(localMessage);
      return;
    }
  ...
  public final void aQ(int paramInt, String paramString)
  {
    ...
    localb.xxK = System.currentTimeMillis();
    localb.Xp(paramString);
    a(a.xxF, localb);
  }
  ...
  public final void c(int paramInt, Throwable paramThrowable)
  {
    ...
    a(paramInt, localb, a.xxE);
  }
  
  public final void cll()
  {
    this.xxA.sendEmptyMessage(601);
  }
  
  final JSONArray clm()
  {
    Object localObject = clp().getString("tbs_download_upload", null);
    if (localObject == null) {
  ...
  public final void cln()
  {
    ...
    //   7: invokestatic 271	com/tencent/smtt/utils/b:hn	(Landroid/content/Context;)I
    //   10: iconst_3
    //   11: if_icmpeq +4 -> 15
    //   14: return
    ...
    //   20: aload 9
    //   22: ifnull -8 -> 14
    //   25: invokestatic 280	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
    //   28: pop
    //   29: invokestatic 283	com/tencent/smtt/utils/j:clV	()Ljava/lang/String;
    //   32: astore 7
    //   34: aload_0
    //   35: getfield 44	com/tencent/smtt/sdk/r:mContext	Landroid/content/Context;
    //   38: invokestatic 289	com/tencent/smtt/utils/c:W	(Landroid/content/Context;)Ljava/lang/String;
    //   41: astore_3
    //   42: aload_0
    //   43: getfield 44	com/tencent/smtt/sdk/r:mContext	Landroid/content/Context;
    //   46: invokestatic 292	com/tencent/smtt/utils/c:hr	(Landroid/content/Context;)Ljava/lang/String;
    //   49: astore_2
    //   50: aload_3
    ...
    //   61: aload_3
    //   62: astore_2
    //   63: invokestatic 280	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
    //   66: aload_3
    //   67: invokevirtual 302	com/tencent/smtt/utils/j:bD	([B)[B
    //   70: astore_3
    //   71: aload_3
    //   72: astore_2
    //   73: invokestatic 280	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
    //   76: aload 4
    //   78: invokevirtual 302	com/tencent/smtt/utils/j:bD	([B)[B
    //   81: astore 6
    //   83: aload 6
    //   85: astore_2
    //   86: aload_3
    ...
    //   113: invokestatic 312	com/tencent/smtt/utils/q:hz	(Landroid/content/Context;)Lcom/tencent/smtt/utils/q;
    //   116: getfield 316	com/tencent/smtt/utils/q:xAH	Ljava/lang/String;
    ...
    //   187: invokestatic 341	com/tencent/smtt/utils/p:hw	(Landroid/content/Context;)Ljava/lang/String;
    //   190: invokeinterface 330 3 0
    //   195: pop
    //   196: new 343	java/io/File
    //   199: dup
    //   200: getstatic 348	com/tencent/smtt/utils/f:xzY	Ljava/lang/String;
    ...
    //   220: getstatic 348	com/tencent/smtt/utils/f:xzY	Ljava/lang/String;
    ...
    //   238: invokevirtual 356	com/tencent/smtt/sdk/r$c:clq	()V
    //   241: new 343	java/io/File
    //   244: dup
    //   245: getstatic 348	com/tencent/smtt/utils/f:xzY	Ljava/lang/String;
    //   248: ldc_w 358
    ...
    //   417: invokestatic 280	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
    //   420: aload_3
    //   421: invokevirtual 406	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   424: invokevirtual 302	com/tencent/smtt/utils/j:bD	([B)[B
    //   427: astore 5
    //   429: aload 4
  ...
  public final void clo()
  {
    ...
    try
    {
      localObject = g.a(com.tencent.smtt.utils.q.hz(this.mContext).xAF, ((JSONArray)localObject).toString().getBytes("utf-8"), new g.a()
      {
        public final void Ey(int paramAnonymousInt)
        {
          ...
          {
            SharedPreferences.Editor localEditor = r.this.clp().edit();
  ...
  private static final class c
  {
    ...
    private final String xyb;
    
    public c(String paramString1, String paramString2)
    {
      this.xya = paramString1;
    ...
    public final void clq()
    {
      ...
      //   15: dup
      //   16: aload_0
      //   17: getfield 19	com/tencent/smtt/sdk/r$c:xyb	Ljava/lang/String;
      ...
      //   46: astore 10
      //   48: aload_0
      //   49: getfield 17	com/tencent/smtt/sdk/r$c:xya	Ljava/lang/String;
      //   52: astore 11
      ...
      //   159: dup
      //   160: aload_0
      //   161: getfield 19	com/tencent/smtt/sdk/r$c:xyb	Ljava/lang/String;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/r.class
