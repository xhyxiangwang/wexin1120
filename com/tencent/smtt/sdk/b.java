  ...
  implements com.tencent.smtt.export.external.interfaces.DownloadListener
{
  ...
  public final void onDownloadStart(String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3, String paramString4, String paramString5, long paramLong, String paramString6, String paramString7)
  {
    if (this.xuY == null)
    {
      if (QbSdk.canOpenMimeFileType(this.xuZ.getContext(), paramString5))
      {
        ...
        this.xuZ.getContext().startActivity(paramString2);
        return;
      }
      c.a(this.xuZ.getContext(), paramString1, null, null);
      return;
    }
    this.xuY.onDownloadStart(paramString1, paramString3, paramString4, paramString5, paramLong);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/sdk/b.class
