...
{
  private static q xAB = null;
  private Context mContext = null;
  private File xAA = null;
  public String xAC = "http://log.tbs.qq.com/ajax?c=pu&v=2&k=";
  public String xAD = "http://log.tbs.qq.com/ajax?c=pu&tk=";
  private String xAE = "http://wup.imtt.qq.com:8080";
  public String xAF = "http://log.tbs.qq.com/ajax?c=dl&k=";
  public String xAG = "http://cfg.imtt.qq.com/tbs?v=2&mk=";
  public String xAH = "http://log.tbs.qq.com/ajax?c=ul&v=2&k=";
  private String xAI = "http://mqqad.html5.qq.com/adjs";
  private String xAJ = "http://log.tbs.qq.com/ajax?c=ucfu&k=";
  ...
  private void cme()
  {
    ...
    //   3: astore_1
    //   4: aload_0
    //   5: invokespecial 97	com/tencent/smtt/utils/q:cmf	()Ljava/io/File;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +13 -> 23
    //   13: ldc 69
    ...
    //   70: aload_0
    //   71: aload_3
    //   72: putfield 39	com/tencent/smtt/utils/q:xAC	Ljava/lang/String;
    //   75: aload_1
    //   76: ldc -122
    //   78: ldc 122
    ...
    //   93: aload_0
    //   94: aload_3
    //   95: putfield 47	com/tencent/smtt/utils/q:xAE	Ljava/lang/String;
    //   98: aload_1
    //   99: ldc -120
    //   101: ldc 122
    ...
    //   116: aload_0
    //   117: aload_3
    //   118: putfield 51	com/tencent/smtt/utils/q:xAF	Ljava/lang/String;
    //   121: aload_1
    //   122: ldc -118
    //   124: ldc 122
    ...
    //   139: aload_0
    //   140: aload_3
    //   141: putfield 55	com/tencent/smtt/utils/q:xAG	Ljava/lang/String;
    //   144: aload_1
    //   145: ldc -116
    //   147: ldc 122
    ...
    //   162: aload_0
    //   163: aload_3
    //   164: putfield 59	com/tencent/smtt/utils/q:xAH	Ljava/lang/String;
    //   167: aload_1
    //   168: ldc -114
    //   170: ldc 122
    ...
    //   185: aload_0
    //   186: aload_3
    //   187: putfield 63	com/tencent/smtt/utils/q:xAI	Ljava/lang/String;
    //   190: aload_1
    //   191: ldc -112
    //   193: ldc 122
    ...
    //   208: aload_0
    //   209: aload_3
    //   210: putfield 67	com/tencent/smtt/utils/q:xAJ	Ljava/lang/String;
    //   213: aload_1
    //   214: ldc -110
    //   216: ldc 122
    ...
    //   231: aload_0
    //   232: aload_1
    //   233: putfield 43	com/tencent/smtt/utils/q:xAD	Ljava/lang/String;
    //   236: aload_2
  ...
  private File cmf()
  {
    try
    {
      if (this.xAA == null)
      {
        this.xAA = new File(f.am(this.mContext, 5));
        if ((this.xAA == null) || (!this.xAA.isDirectory())) {
          break label177;
        }
      }
      localFile = new File(this.xAA, "tbsnet.conf");
      if (!localFile.exists())
      {
  ...
  public static q hz(Context paramContext)
  {
    try
    {
      if (xAB == null) {
        xAB = new q(paramContext);
      }
      paramContext = xAB;
      return paramContext;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/utils/q.class
