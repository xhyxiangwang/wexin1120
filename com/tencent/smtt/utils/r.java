...
{
  private static r xAM = null;
  private Context mContext = null;
  private File xAA = null;
  public boolean xAK = false;
  private boolean xAL = false;
  private File xAN = null;
  ...
  private void cme()
  {
    ...
    //   3: astore_2
    //   4: aload_0
    //   5: getfield 33	com/tencent/smtt/utils/r:xAN	Ljava/io/File;
    //   8: ifnonnull +11 -> 19
    //   11: aload_0
    //   12: aload_0
    //   13: invokespecial 50	com/tencent/smtt/utils/r:cmf	()Ljava/io/File;
    //   16: putfield 33	com/tencent/smtt/utils/r:xAN	Ljava/io/File;
    //   19: aload_0
    //   20: getfield 33	com/tencent/smtt/utils/r:xAN	Ljava/io/File;
    //   23: astore_1
    //   24: aload_1
    //   25: ifnonnull +6 -> 31
    //   28: aload_0
    ...
    //   38: dup
    //   39: aload_0
    //   40: getfield 33	com/tencent/smtt/utils/r:xAN	Ljava/io/File;
    ...
    //   86: putfield 29	com/tencent/smtt/utils/r:xAK	Z
    //   89: aload_1
  ...
  private File cmf()
  {
    try
    {
      if (this.xAA == null)
      {
        this.xAA = new File(this.mContext.getDir("tbs", 0), "core_private");
        if (this.xAA == null) {
          break label87;
        }
        if (!this.xAA.isDirectory()) {
          return null;
        }
      }
      File localFile2 = new File(this.xAA, "debug.conf");
  ...
  public final void mM(boolean paramBoolean)
  {
    ...
    //   5: aload_0
    //   6: iload_1
    //   7: putfield 31	com/tencent/smtt/utils/r:xAL	Z
    //   10: aload_0
    //   11: invokespecial 50	com/tencent/smtt/utils/r:cmf	()Ljava/io/File;
    //   14: astore 6
    //   16: aload 6
    //   18: ifnonnull +19 -> 37
    ...
    //   71: ldc 68
    //   73: aload_0
    //   74: getfield 29	com/tencent/smtt/utils/r:xAK	Z
    ...
    //   86: ldc -121
    //   88: aload_0
    //   89: getfield 31	com/tencent/smtt/utils/r:xAL	Z
    ...
    //   61	56	5	localProperties	java.util.Properties
    //   188	6	5	localObject10	Object
    //   14	94	6	localFile	File
    // Exception table:
    //   from	to	target	type
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/utils/r.class
