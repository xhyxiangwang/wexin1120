...
{
  private static String xAr = null;
  private static String xAs = "GA";
  private static String xAt = "GE";
  private static String xAu = "9422";
  private static String xAv = "0";
  private static String xAw = "";
  private static boolean xAx = false;
  private static boolean xAy = false;
  private static boolean xAz = false;
  ...
  private static String a(Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, boolean paramBoolean)
  {
    ...
    String str = hx(paramContext) + "*" + hy(paramContext);
      ...
      catch (PackageManager.NameNotFoundException paramString7)
      {
        for (;;)
        {
          ...
          else
          {
            ...
            {
              j = Math.min(hx(paramContext), hy(paramContext));
  ...
  public static String hw(Context paramContext)
  {
    ...
    paramContext = a(paramContext, String.valueOf(WebView.getTbsSDKVersion(paramContext)), "0", xAs, xAt, xAu, xAv, xAw, xAx);
    xAr = paramContext;
    return paramContext;
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/utils/p.class
