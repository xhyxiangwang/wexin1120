...
public final class g
{
  public static String a(String paramString, byte[] paramArrayOfByte, a parama, boolean paramBoolean)
  {
    ...
    try
    {
      String str = k.clX().clZ();
      str = paramString + str;
      if (paramBoolean) {}
      try
      {
        paramString = a.k(k.clX().xAl.getBytes(), paramArrayOfByte);
      ...
      do
      {
        ...
        str = j.clV();
        break;
        paramString = j.clU().bD(paramArrayOfByte);
        paramArrayOfByte = paramString;
        break label53;
  ...
  public static String a(HttpURLConnection paramHttpURLConnection, a parama, boolean paramBoolean)
  {
    ...
    //   184: aload 4
    //   186: areturn
    //   187: invokestatic 55	com/tencent/smtt/utils/j:clU	()Lcom/tencent/smtt/utils/j;
    //   190: pop
    //   191: new 39	java/lang/String
    //   194: dup
    //   195: aload_1
    //   196: invokevirtual 154	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   199: invokestatic 162	com/tencent/smtt/utils/j:bE	([B)[B
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/utils/g.class
