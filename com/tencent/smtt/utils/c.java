...
public final class c
{
  ...
  public static String xzG = "";
  public static String xzH = "";
  public static String xzI = "";
  ...
  private static String K(File paramFile)
  {
    for (;;)
    {
      try
      {
        ...
        String str1 = bC(a(localJarFile, paramFile, arrayOfByte)[0].getEncoded());
        ...
        if (localEnumeration.hasMoreElements())
        {
          ...
          if (paramFile != null)
          {
            paramFile = bC(paramFile[0].getEncoded());
            if (paramFile == null)
            {
  ...
  private static PackageInfo Xq(String paramString)
  {
    for (;;)
    {
      int i;
  ...
  private static String b(Context paramContext, File paramFile, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramContext = Xq(paramFile.getAbsolutePath());
  ...
  private static String bC(byte[] paramArrayOfByte)
  {
  ...
  {
    // Byte code:
    //   0: getstatic 20	com/tencent/smtt/utils/c:xzH	Ljava/lang/String;
    //   3: invokestatic 95	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +9 -> 15
    //   9: getstatic 20	com/tencent/smtt/utils/c:xzH	Ljava/lang/String;
    //   12: astore_0
    //   13: aload_0
    //   14: areturn
    ...
    //   64: astore_2
    //   65: ldc_w 319
    //   68: invokestatic 321	com/tencent/smtt/utils/c:Xl	(Ljava/lang/String;)Ljava/lang/String;
    //   71: astore 4
    //   73: aload 4
    //   75: astore_2
    //   76: aload_0
    ...
    //   99: invokestatic 321	com/tencent/smtt/utils/c:Xl	(Ljava/lang/String;)Ljava/lang/String;
    //   102: astore 4
    //   104: aload 4
    //   106: astore_2
    //   107: goto -31 -> 76
    ...
    //   125: invokestatic 321	com/tencent/smtt/utils/c:Xl	(Ljava/lang/String;)Ljava/lang/String;
    //   128: astore 4
    //   130: aload 4
    //   132: astore_2
    //   133: aload_0
  ...
  {
    if (!TextUtils.isEmpty(xzI)) {
      return xzI;
    }
    try
    {
      xzI = Settings.Secure.getString(paramContext.getContentResolver(), "android_id");
      return xzI;
    }
    catch (Exception paramContext)
    {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/smtt/utils/c.class
