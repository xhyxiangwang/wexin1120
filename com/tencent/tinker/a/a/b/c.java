...
public final class c
{
  ...
  public static int a(int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      int k = eT(paramArrayOfInt1[j], paramArrayOfInt2[j]);
      i = k;
      if (k != 0) {
        break;
      }
  ...
  public static int eS(int paramInt1, int paramInt2)
  {
  ...
  public static int eT(int paramInt1, int paramInt2)
  {
    if (paramInt1 == paramInt2) {
      return 0;
    }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/tinker/a/a/b/c.class
