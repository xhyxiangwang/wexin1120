...
{
  public static QbarPossibleInfo xrx = new QbarPossibleInfo();
  public byte[] data = new byte['ஸ'];
  public byte[] type = new byte[100];
  public byte[] xrA = new byte['Ĭ'];
  public int[] xrB = new int[2];
  public int xrC = -1;
  public byte[] xry = new byte[100];
  public int[] xrz = new int[4];
  ...
  {
    int i = GetOneResultReport(this.type, this.data, this.xry, this.xrA, this.xrB, this.xrz, this.xrC);
    try
    {
      paramArrayOfInt[0] = this.xrB[0];
      paramArrayOfInt[1] = this.xrB[1];
      paramArrayOfInt = new String(this.xry, 0, this.xrz[2], "UTF-8");
      paramStringBuilder3.append(paramArrayOfInt);
      if (paramArrayOfInt.equals("ANY"))
      {
        paramStringBuilder1.append(new String(this.type, 0, this.xrz[0], "UTF-8"));
        paramStringBuilder2.append(new String(this.data, 0, this.xrz[1], "UTF-8"));
        paramStringBuilder4.append(new String(this.xrA, 0, this.xrz[3], "UTF-8"));
        if (paramStringBuilder2.length() == 0)
        {
          paramStringBuilder1.append(new String(this.type, 0, this.xrz[0], "ASCII"));
          paramStringBuilder2.append(new String(this.data, 0, this.xrz[1], "ASCII"));
          paramStringBuilder4.append(new String(this.xrA, 0, this.xrz[3], "ASCII"));
          return i;
        }
      }
      else
      {
        paramStringBuilder1.append(new String(this.type, 0, this.xrz[0], paramArrayOfInt));
        paramStringBuilder2.append(new String(this.data, 0, this.xrz[1], paramArrayOfInt));
        paramStringBuilder4.append(new String(this.xrA, 0, this.xrz[3], paramArrayOfInt));
        return i;
      }
    }
  ...
  {
    return ScanImage(paramArrayOfByte, paramInt1, paramInt2, 0, this.xrC);
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/tencent/qbar/QbarNative.class
