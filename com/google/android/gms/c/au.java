...
public final class au
{
  ...
  private static av.a.a a(List<Asset> paramList, Object paramObject)
  {
    ...
    for (;;)
    {
      ...
      {
        locala1.type = 13;
        localObject1 = locala1.awH;
        paramList.add((Asset)paramObject);
        ((av.a.a.a)localObject1).awV = (paramList.size() - 1);
      }
      else
      {
        ...
        localObject2 = new TreeSet(((i)paramObject).aAw.keySet());
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localObject1[i].awF = a(paramList, ((i)paramObject).get((String)localObject3));
          i += 1;
        }
        locala1.awH.awQ = ((av.a[])localObject1);
      }
    }
    int j;
    label605:
    ...
    for (;;)
    {
      ...
      if (locala2.type != i)
      {
        ...
        locala1.awH.awR = ((av.a.a[])localObject3);
        break;
  ...
  {
    i locali = new i();
    av.a[] arrayOfa = parama.awB.awD;
    int j = arrayOfa.length;
    int i = 0;
    while (i < j)
    {
      av.a locala = arrayOfa[i];
      a(parama.awC, locali, locala.name, locala.awF);
      i += 1;
    }
    return locali;
  }
      ...
      for (;;)
      {
        ...
        if (paramInt == 9)
        {
          ...
          while (j < m)
          {
            ...
            a(paramList, locali, locala.name, locala.awF);
            j += 1;
          }
  ...
  private static void a(List<Asset> paramList, i parami, String paramString, av.a.a parama)
  {
    ...
    if (i == 1)
    {
      paramList = ((av.a.a.a)localObject1).awI;
      parami.aAw.put(paramString, paramList);
      return;
    }
    if (i == 11)
    {
      paramList = ((av.a.a.a)localObject1).awS;
      parami.aAw.put(paramString, paramList);
      return;
    }
    if (i == 12)
    {
      paramList = ((av.a.a.a)localObject1).awT;
      parami.aAw.put(paramString, paramList);
      return;
    }
    if (i == 15)
    {
      paramList = ((av.a.a.a)localObject1).awU;
      parami.aAw.put(paramString, paramList);
      return;
    }
    if (i == 2)
    {
      parami.putString(paramString, ((av.a.a.a)localObject1).awJ);
      return;
    }
    if (i == 3)
    {
      double d = ((av.a.a.a)localObject1).awK;
      parami.aAw.put(paramString, Double.valueOf(d));
      return;
    }
    if (i == 4)
    {
      float f = ((av.a.a.a)localObject1).awL;
      parami.aAw.put(paramString, Float.valueOf(f));
      return;
    }
    if (i == 5)
    {
      parami.putLong(paramString, ((av.a.a.a)localObject1).awM);
      return;
    }
    if (i == 6)
    {
      i = ((av.a.a.a)localObject1).awN;
      parami.aAw.put(paramString, Integer.valueOf(i));
      return;
    }
    if (i == 7)
    {
      byte b = (byte)((av.a.a.a)localObject1).awO;
      parami.aAw.put(paramString, Byte.valueOf(b));
      return;
    }
    if (i == 8)
    {
      boolean bool = ((av.a.a.a)localObject1).awP;
      parami.aAw.put(paramString, Boolean.valueOf(bool));
      return;
    }
    if (i == 13)
    {
      ...
      parami.a(paramString, (Asset)paramList.get((int)((av.a.a.a)localObject1).awV));
      return;
    }
    if (i == 9)
    {
      parama = new i();
      localObject1 = ((av.a.a.a)localObject1).awQ;
      int j = localObject1.length;
      i = 0;
      while (i < j)
      {
        Object localObject2 = localObject1[i];
        a(paramList, parama, ((av.a)localObject2).name, ((av.a)localObject2).awF);
        i += 1;
      }
      parami.aAw.put(paramString, parama);
      return;
    }
    if (i == 10)
    {
      i = a(paramString, ((av.a.a.a)localObject1).awR);
  ...
  {
    Object localObject1 = new TreeSet(parami.aAw.keySet());
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/c/au.class
