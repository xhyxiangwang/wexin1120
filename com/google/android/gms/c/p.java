...
abstract class p<K, V>
{
    ...
    implements Iterator<T>
  {
    ...
    {
      return this.mIndex < this.he;
    }
    
    public final T next()
    {
      Object localObject = p.this.j(this.mIndex, this.vv);
      this.mIndex += 1;
      this.vw = true;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/c/p.class
