...
{
  final ByteBuffer axf;
  
  private ax(ByteBuffer paramByteBuffer)
  {
    this.axf = paramByteBuffer;
  }
  ...
  public final void c(int paramInt, String paramString)
  {
    ...
    try
    {
      ...
      {
        int i = this.axf.position();
        this.axf.position(i + paramInt);
        a(paramString, this.axf);
        int j = this.axf.position();
        this.axf.position(i);
        cr(j - i - paramInt);
        this.axf.position(j);
        return;
    ...
    {
      throw new a(this.axf.position(), this.axf.limit());
    }
  }
  ...
  public final void g(byte[] paramArrayOfByte)
  {
    ...
    if (this.axf.remaining() >= i)
    {
      this.axf.put(paramArrayOfByte, 0, i);
      return;
    }
    throw new a(this.axf.position(), this.axf.limit());
  }
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/c/ax.class
