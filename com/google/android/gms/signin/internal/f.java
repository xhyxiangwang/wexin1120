    ...
    implements f
  {
      ...
      implements f
    {
          ...
          try
          {
            ...
            if (paramAccount != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.acm.transact(8, localParcel1, localParcel2, 0);
          ...
          try
          {
            ...
            if (paramAuthAccountRequest != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.acm.transact(2, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
          ...
          try
          {
            ...
            if (paramResolveAccountRequest != null)
            {
              ...
              if (paramt != null)
              {
                ...
                this.acm.transact(5, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
      ...
      public final void a(p paramp, int paramInt, boolean paramBoolean)
      {
        ...
        //   58: aload_0
        //   59: getfield 18	com/google/android/gms/signin/internal/f$a$a:acm	Landroid/os/IBinder;
        //   62: bipush 9
        //   64: aload 5
        //   66: aload 6
        //   68: iconst_0
      ...
      public final void a(CheckServerAuthResult paramCheckServerAuthResult)
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/signin/internal/f$a$a:acm	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
          ...
          try
          {
            ...
            if (paramRecordConsentRequest != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.acm.transact(10, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
      ...
      public final void a(e parame)
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/signin/internal/f$a$a:acm	Landroid/os/IBinder;
        //   34: bipush 11
        //   36: aload_2
        //   37: aload_3
        //   38: iconst_0
      ...
      public final void ah(boolean paramBoolean)
      {
        ...
        try
        {
          ...
          this.acm.transact(4, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
      ...
      public final void cy(int paramInt)
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.signin.internal.ISignInService");
          localParcel1.writeInt(paramInt);
          this.acm.transact(7, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/signin/internal/f.class
