  ...
  implements Parcelable.Creator<DataHolder>
{
  ...
  static void a(DataHolder paramDataHolder, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramDataHolder.ajm);
    b.c(paramParcel, 1000, paramDataHolder.mVersionCode);
    b.a(paramParcel, 2, paramDataHolder.ajo, paramInt);
    b.c(paramParcel, 3, paramDataHolder.agH);
    b.a(paramParcel, 4, paramDataHolder.ajp);
    b.u(paramParcel, i);
  }
}


/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/common/data/g.class
