...
{
  private static final k any = new k();
  ...
  private static boolean a(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramPackageInfo = j.la(); paramPackageInfo.contains(localab); paramPackageInfo = j.lb()) {
      return true;
    }
    if (Log.isLoggable("GoogleSignatureVerifier", 2)) {
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/common/k.class
