...
public final class e
{
  ...
  @Deprecated
  public static final int agK = 7887000;
  public static boolean agM = false;
  public static boolean agN = false;
  private static int agO = -1;
  private static String agP = null;
  private static Integer agQ = null;
  static final AtomicBoolean agR = new AtomicBoolean();
  ...
  private static boolean a(PackageManager paramPackageManager)
  {
    synchronized (abA)
    {
      ...
      try
      {
        ...
        k.ld();
        if (k.a(paramPackageManager, new j.a[] { j.anq[1] }) != null) {}
        for (agO = 1; agO != 0; agO = 0) {
          return true;
        }
      }
  ...
  public static boolean b(PackageManager paramPackageManager)
  {
    ...
    label23:
    for (boolean bool = agN; !bool; bool = "user".equals(Build.TYPE)) {
      return true;
    }
    return false;
  }
  ...
  public static boolean m(Context paramContext, int paramInt)
  {
    ...
    {
      paramContext = paramContext.getPackageManager();
      if (k.ld().a(paramContext, "com.google.android.gms")) {
        return true;
      }
    }
    return false;
      ...
      try
      {
        ...
        if (!"com.google.android.gms".equals(paramContext.getPackageName()))
        {
          for (;;)
          {
            synchronized (abA)
            {
              if (agP == null)
              {
                agP = paramContext.getPackageName();
                try
                {
                  ...
                  agQ = Integer.valueOf(((Bundle)localObject2).getInt("com.google.android.gms.version"));
                }
            ...
            if (!agP.equals(paramContext.getPackageName())) {
              throw new IllegalArgumentException("isGooglePlayServicesAvailable should only be called with Context from your application's package. A previous call used package '" + agP + "' and this call used package '" + paramContext.getPackageName() + "'.");
            }
          }
          if (localNameNotFoundException1.intValue() != agK) {
            throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected " + agK + " but found " + localNameNotFoundException1 + ".  You must have the following declaration within the <application> element:     <meta-data android:name=\"com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
          }
        }
        label314:
        do
        {
          try
          {
            ...
            {
              i = j;
              if (k.a((PackageInfo)???, j.aw.anu) == null) {
                break;
              }
              i = t.cd(agK);
              ...
              new StringBuilder("Google Play services out of date.  Requires ").append(agK).append(" but found ").append(((PackageInfo)???).versionCode);
              return 2;
            }
          }
          catch (PackageManager.NameNotFoundException paramContext)
          ...
          try
          {
            j.a locala = k.a(localPackageManager.getPackageInfo("com.android.vending", 64), j.aw.anu);
            i = j;
            if (locala == null) {
              break;
            }
        ...
        } while (k.a((PackageInfo)???, j.aw.anu) != null);
        return 9;
        label442:
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/com/google/android/gms/common/e.class
