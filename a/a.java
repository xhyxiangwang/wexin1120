...
public final class a
{
  ...
  private static Class<?> G(Class<?> paramClass)
  {
    Class<?> localClass;
    if (paramClass == null) {
      localClass = null;
  ...
  private static a a(Method paramMethod, Object paramObject, Object... paramVarArgs)
  {
    ...
    try
    {
      ...
      if (paramMethod.getReturnType() == Void.TYPE)
      {
        ...
        return ce(paramObject);
      }
      paramMethod = ce(paramMethod.invoke(paramObject, paramVarArgs));
      return paramMethod;
    }
  ...
  private static boolean a(Method paramMethod, String paramString, Class<?>[] paramArrayOfClass)
  {
    ...
    if (paramMethod.getName().equals(paramString))
    {
      ...
      {
        if ((paramArrayOfClass[i] != a.class) && (!G(paramMethod[i]).isAssignableFrom(G(paramArrayOfClass[i])))) {
          break label87;
        }
        i += 1;
      }
  ...
  public static a ce(Object paramObject)
  {
  ...
  {
    if (this.xSu) {
      return (Class)this.yF;
    }
    return this.yF.getClass();
  }
  
  public final boolean equals(Object paramObject)
  {
    if ((paramObject instanceof a)) {
      return this.yF.equals(((a)paramObject).yF);
    }
    return false;
  }
  ...
  public final a l(String paramString, Object... paramVarArgs)
  {
    ...
    try
    {
      localObject1 = a(a(paramString, arrayOfClass), this.yF, paramVarArgs);
    ...
    for (;;)
    {
      try
      {
        ...
        return a((Method)localObject2, this.yF, paramVarArgs);
      }
      ...
      else
      {
        ...
        if (localClass == null)
        {
          throw new NoSuchMethodException("No similar method " + paramString + " with params " + Arrays.toString(arrayOfClass) + " could be found on type " + cpD() + ".");
          label249:
          continue;
          label252:
          i += 1;
...
/* Location:              /Users/xianghongyan/decompile/dex2jar/classes2-dex2jar.jar!/a/a.class
